...
<div class="eegdash-ed-figpair">
  ...
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000221&sub=1&ses=0&task=rstate&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000221 — sub-1 · ses-0 · task-rstate · run-0"
