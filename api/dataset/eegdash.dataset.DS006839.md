...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006839</b></div><div>Iss. 6839 · 36 subjects · 144 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · EEG recordings during sham neurofeedback in virtual reality</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006839</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1016/j.cortex.2026.03.020">10.1016/j.cortex.2026.03.020</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>36</dd><dt>Recordings</dt><dd>144</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>29</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>26.6 h</dd><dt>Size</dt><dd>10.4 GB</dd><dt>Tasks</dt><dd>4 tasks · <code>control</code> · <code>negative</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006839</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006839">EEGDash/ds006839</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006839.v1.0.0">10.18112/openneuro.ds006839.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006839">OpenNeuro</a><a href="https://doi.org/10.1016/j.cortex.2026.03.020">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006839">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006839.croissant.json" download>Croissant</a></div></aside>

# DS006839: eeg dataset, 36 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"EEG recordings during sham neurofeedback in virtual reality","alternateName":"DS006839","description":"EEG recordings during sham neurofeedback in virtual reality. eeg dataset accessible via EEGDash as \`\`DS006839\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006839.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006839.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds006839.v1.0.0","https://openneuro.org/datasets/ds006839","https://nemar.org/dataexplorer/detail?dataset_id=ds006839"],"creator":[{"@type":"Person","name":"C. Brigitte Aguilar Gonzales"},{"@type":"Person","name":"Collaborators from the Experimental and Computational Neuroscience Group"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*EEG recordings during sham neurofeedback in virtual reality*

**Citation:** C. Brigitte Aguilar Gonzales, Collaborators from the Experimental and Computational Neuroscience Group (2019). *EEG recordings during sham neurofeedback in virtual reality*. [10.18112/openneuro.ds006839.v1.0.0](https://doi.org/10.18112/openneuro.ds006839.v1.0.0)

<p class="eegdash-ed-deck">36-participant EEG dataset — EEG recordings during sham neurofeedback in virtual reality.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>C. Brigitte Aguilar Gonzales</strong> · <strong>Collaborators from the Experimental and Computational Neuroscience Group</strong><br/><span class="role">Year</span> 2019 · Distributed via OpenNeuro<br/><span class="role">Funding</span> This work was supported by CONICET (Argentina) and Universidad Nacional de Entre Ríos.</div><div class="eegdash-ed-pills"><span class="pill">EEG · 29 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">4 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-13 · task-positive</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>36 subjects and 144 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006839" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006839&sub=13&task=positive&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006839 — sub-13 · task-positive"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006839) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006839) |
