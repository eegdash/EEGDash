...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000151</b></div><div>Iss. 151 · 12 subjects · 46 recordings · CC0-1.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Motor imagery dataset for three imaginary states of the same…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000151</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0-1.0</dd><dt>Updated</dt><dd>2026-04-17</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>12</dd><dt>Recordings</dt><dd>46</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>32</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>9.9 h</dd><dt>Size</dt><dd>3.2 GB</dd><dt>Tasks</dt><dd><code>imagery</code></dd><dt>Sessions</dt><dd>4 · <code>0</code> … <code>3</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000151</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000151">EEGDash/nm000151</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000151">10.82901/nemar.nm000151</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000151">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000151">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000151.croissant.json" download>Croissant</a></div></aside>

# NM000151: eeg dataset, 12 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Motor imagery dataset for three imaginary states of the same upper extremity","alternateName":"NM000151","description":"Motor imagery dataset for three imaginary states of the same upper extremity. eeg dataset accessible via EEGDash as \`\`NM000151\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000151.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.nm000151","sameAs":["https://doi.org/10.82901/nemar.nm000151","https://openneuro.org/datasets/nm000151","https://nemar.org/dataexplorer/detail?dataset_id=nm000151","https://nemar.org/dataexplorer/detail/nm000151"],"creator":[{"@type":"Person","name":"Mojgan Tavakolan"},{"@type":"Person","name":"Zack Frehlick"},{"@type":"Person","name":"Xinyi Yong"},{"@type":"Person","name":"Carlo Menon"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*Motor imagery dataset for three imaginary states of the same upper extremity*

**Citation:** Mojgan Tavakolan, Zack Frehlick, Xinyi Yong, Carlo Menon (2019). *Motor imagery dataset for three imaginary states of the same upper extremity*. [10.82901/nemar.nm000151](https://doi.org/10.82901/nemar.nm000151)

<p class="eegdash-ed-deck">12-participant EEG dataset — Motor imagery dataset for three imaginary states of the same upper extremity.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Mojgan Tavakolan</strong> · <strong>Zack Frehlick</strong> · Xinyi Yong · Carlo Menon<br/><span class="role">Year</span> 2019 · Distributed via NeMAR</div><div class="eegdash-ed-pills"><span class="pill">EEG · 32 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">Task · imagery</span><span class="pill">4 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 32 ch (n=46 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 1000.0 Hz (n=46 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">32 ch · EEG · 1000 Hz · 12 subjects, 46 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-12 · ses-3 · task-imagery · run-0</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>12 subjects and 46 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000151" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000151&sub=12&ses=3&task=imagery&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000151 — sub-12 · ses-3 · task-imagery · run-0"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000151). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000151" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000151/code/nm000151_histogram.png"
      alt="NEMAR pipeline statistics — NM000151"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000151/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000151"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000151">
  <div class="ee-bar">
...
| License        | CC0-1.0                                                                                                                                                                                  |
| Citation / DOI | [10.82901/nemar.nm000151](https://doi.org/10.82901/nemar.nm000151)                                                                                                                       |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000151</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Tavakolan2017</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000151</code> · <code>Tavakolan2017</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000151</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000151.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000151">Hugging Face mirror</a></div><div>CC0-1.0 · <b><a href="https://doi.org/10.82901/nemar.nm000151">10.82901/nemar.nm000151</a></b></div></footer>
