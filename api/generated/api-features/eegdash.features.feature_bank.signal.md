...
| `signal_bandpass_filter_preprocessor`(x, /, \*, ...)   | Linear-phase FIR band-pass filter.                                    |
|--------------------------------------------------------|-----------------------------------------------------------------------|
...
### eegdash.features.feature_bank.signal.signal_bandpass_filter_preprocessor(x, , , \_metadata, f_min, f_max, num_taps=None)
