...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS007714</b></div><div>Iss. 7714 · 64 subjects · 64 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Cambridge_data</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS007714</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>64</dd><dt>Recordings</dt><dd>64</dd><dt>Modality</dt><dd>fNIRS</dd><dt>Channels</dt><dd>864 (63), 600</dd><dt>Sample rate</dt><dd>5 Hz</dd><dt>Duration</dt><dd>9.5 h</dd><dt>Size</dt><dd>1.2 GB</dd><dt>Tasks</dt><dd><code>visual</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.10.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds007714</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds007714.v1.0.0">10.18112/openneuro.ds007714.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds007714">OpenNeuro</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/DS007714.croissant.json" download>Croissant</a></div></aside>

# DS007714: fnirs dataset, 64 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Cambridge_data","alternateName":"DS007714","description":"Cambridge_data. fnirs dataset accessible via EEGDash as \`\`DS007714\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS007714.html","keywords":["fnirs","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds007714.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds007714.v1.0.0","https://openneuro.org/datasets/ds007714","https://nemar.org/dataexplorer/detail?dataset_id=ds007714"],"creator":[{"@type":"Person","name":"Enter author names here"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Cambridge_data*

**Citation:** Enter author names here (—). *Cambridge_data*. [10.18112/openneuro.ds007714.v1.0.0](https://doi.org/10.18112/openneuro.ds007714.v1.0.0)

<p class="eegdash-ed-deck">64-participant fNIRS dataset — Cambridge_data.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Enter author names here</strong><br/><span class="role">Funding</span> Enter funding details here, if applicable.</div><div class="eegdash-ed-pills"><span class="pill">fNIRS · 864 (63), 600 ch</span><span class="pill">5 Hz</span><span class="pill is-info">BIDS 1.10.0</span><span class="pill">Task · visual</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:1%; background:#009E73; flex-shrink:0;" title="600 ch: 1"></div><div style="width:28px; height:100%; background:#009E73; flex-shrink:0;" title="864 ch: 63"></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">600</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">864</span>
  </div>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 5.0 Hz (n=64 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 9 h 31 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">864 (63), 600 ch · fNIRS · 5 Hz · 64 subjects, 64 recordings</span>
  </div>
  ...
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=a2b1ebdbc70a5e6b&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 900px; display: block;"
    title="Topomap of fNIRS · 42 sensors"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds007714). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds007714" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds007714/code/ds007714_histogram.png"
      alt="NEMAR pipeline statistics — DS007714"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds007714/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS007714"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds007714">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                                                                                 |
| Canonical      | —                                                                                                                                                                                 |
| Importable as  | `DS007714`                                                                                                                                                                        |
| Year           | —                                                                                                                                                                                 |
| Authors        | Enter author names here                                                                                                                                                           |
| License        | CC0                                                                                                                                                                               |
| Citation / DOI | [doi:10.18112/openneuro.ds007714.v1.0.0](https://doi.org/10.18112/openneuro.ds007714.v1.0.0)                                                                                      |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds007714) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds007714) | [Source URL](https://openneuro.org/datasets/ds007714) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS007714</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS007714</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS007714</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS007714.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds007714.v1.0.0">10.18112/openneuro.ds007714.v1.0.0</a></b></div></footer>
