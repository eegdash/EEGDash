...
Modality: eeg Subjects: 5 Recordings: 128 License: CC-BY-4.0 Source: nemar
...
- Duration (hours): 3.5955902777777777
...
- Source: nemar
- OpenNeuro: [nm000176](https://openneuro.org/datasets/nm000176)
- NeMAR: [nm000176](https://nemar.org/dataexplorer/detail?dataset_id=nm000176)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=5, range 23–27 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="20-24: 3"></div><div style="width:28px; height:66%; background:#4472c4; flex-shrink:0;" title="25-29: 2"></div>
  </div>
  ...
  <div style="display:flex; height:22px; width:100%; max-width:400px; border-radius:4px; overflow:hidden;">
    <div style="width:80.0%; background:#e07ab5; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Female: 4">4</div><div style="width:20.0%; background:#4472c4; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Male: 1">1</div>
  </div>
...
Use the `NM000176` class to access this dataset programmatically.
