...
```none
saved: /tmp/eegdash_save_wtqhhi_e/windows
...
```none
Zarr write_s=0.0159, read_s=0.0057, size_mb=0.0080
```
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0148, read_s=0.0113, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_wtqhhi_e/windows/0 already exists. Please select
