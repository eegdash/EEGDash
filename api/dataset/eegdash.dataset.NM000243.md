...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000243</b></div><div>Iss. 243 · 15 subjects · 15 recordings · CC-BY-NC-ND-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · BNCI 2016-002 Emergency Braking during Simulated Driving dataset</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000243</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-NC-ND-4.0</dd><dt>Updated</dt><dd>2026-03-25</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>15</dd><dt>Recordings</dt><dd>15</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>59</dd><dt>Sample rate</dt><dd>200 Hz</dd><dt>Duration</dt><dd>33.7 h</dd><dt>Size</dt><dd>4.0 GB</dd><dt>Tasks</dt><dd><code>p300</code></dd><dt>Sessions</dt><dd><code>0</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000243</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000243">EEGDash/nm000243</a></dd></dl><div class="actions"><a href="https://openneuro.org/datasets/nm000243">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000243">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000243.croissant.json" download>Croissant</a></div></aside>

# NM000243: eeg dataset, 15 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"BNCI 2016-002 Emergency Braking during Simulated Driving dataset","alternateName":"NM000243","description":"BNCI 2016-002 Emergency Braking during Simulated Driving dataset. eeg dataset accessible via EEGDash as \`\`NM000243\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000243.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"sameAs":["https://openneuro.org/datasets/nm000243","https://nemar.org/dataexplorer/detail?dataset_id=nm000243","https://nemar.org/dataexplorer/detail/nm000243"],"creator":[{"@type":"Person","name":"Stefan Haufe"},{"@type":"Person","name":"Matthias S Treder"},{"@type":"Person","name":"Manfred F Gugler"},{"@type":"Person","name":"Max Sagebaum"},{"@type":"Person","name":"Gabriel Curio"},{"@type":"Person","name":"Benjamin Blankertz"}],"license":"CC-BY-NC-ND-4.0","datePublished":"2011-01-01"}</script>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=15, range 31–31 yr, mean 30.0 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=15"><div style="width:100%; height:180px; background:#6b7785; flex-shrink:0;" title="30-34: other n=15"></div></div>
  </div>
  ...
  <p><strong>Channel counts</strong>: 59 ch (n=15 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 200.0 Hz (n=15 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">59 ch · EEG · 200 Hz · 15 subjects, 15 recordings</span>
  </div>
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/nm000243" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000243&sub=13&ses=0&task=p300&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000243 — sub-13 · ses-0 · task-p300 · run-0"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000243). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000243" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000243/code/nm000243_histogram.png"
      alt="NEMAR pipeline statistics — NM000243"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000243/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000243"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000243">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000243) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000243) | [Source URL](https://nemar.org/dataexplorer/detail/nm000243) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000243</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Haufe2016</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000243</code> · <code>Haufe2016</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000243</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000243.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000243">Hugging Face mirror</a></div><div>CC-BY-NC-ND-4.0 · <b><span style="opacity:.6">DOI not on file</span></b></div></footer>
