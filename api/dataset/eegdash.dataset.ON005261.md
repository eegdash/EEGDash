...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON005261</b></div><div>Iss. 5261 · 17 subjects · 128 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Gloups_MEG</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON005261</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-025-05127-0">10.1038/s41597-025-05127-0</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>17</dd><dt>Recordings</dt><dd>128</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>248 (71), 278 (31), 245 (24)</dd><dt>Sample rate</dt><dd>2035 Hz</dd><dt>Duration</dt><dd>3.0 h</dd><dt>Size</dt><dd>225.0 GB</dd><dt>Tasks</dt><dd><code>gloups</code> · <code>rest</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on005261</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on005261">10.82901/nemar.on005261</a></div><div class="actions"><a href="https://openneuro.org/datasets/on005261">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-025-05127-0">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON005261.croissant.json" download>Croissant</a></div></aside>

# ON005261: meg dataset, 17 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Gloups_MEG","alternateName":"ON005261","description":"Gloups_MEG. meg dataset accessible via EEGDash as \`\`ON005261\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON005261.html","keywords":["meg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on005261","sameAs":["https://doi.org/10.82901/nemar.on005261","https://openneuro.org/datasets/on005261","https://nemar.org/dataexplorer/detail?dataset_id=on005261"],"creator":[{"@type":"Person","name":"Snezana Todorovic"},{"@type":"Person","name":"Elin Runnqvist"},{"@type":"Person","name":"Valerie Chanoine"},{"@type":"Person","name":"Jean-Michel Badier"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*Gloups_MEG*

**Citation:** Snezana Todorovic, Elin Runnqvist, Valerie Chanoine, Jean-Michel Badier (2019). *Gloups_MEG*. [10.82901/nemar.on005261](https://doi.org/10.82901/nemar.on005261)

<p class="eegdash-ed-deck">17-participant MEG dataset — Gloups_MEG.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Snezana Todorovic</strong> · <strong>Elin Runnqvist</strong> · Valerie Chanoine · Jean-Michel Badier<br/><span class="role">Year</span> 2019 · Distributed via NeMAR<br/><span class="role">Funding</span> This research has been supported by funding from the Institute of Convergence ILCB (France 2030, ANR-16-CONV-0002) and the Excellence Initiative of Aix-Marseille University A\*MIDEX (ANR-11-IDEX-0001-02)</div><div class="eegdash-ed-pills"><span class="pill">MEG · 248 (71), 278 (31), 245 (24) ch</span><span class="pill">2035 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill">2 tasks</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
> [DOI](https://doi.org/10.82901/nemar.on005261)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-01 · task-gloups · run-02</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on005261" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_meg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?meg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on005261&sub=01&task=gloups&run=02&ext=fif&suffix=meg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live MEG trace viewer for on005261 — sub-01 · task-gloups · run-02"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on005261). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on005261" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on005261/code/on005261_histogram.png"
      alt="NEMAR pipeline statistics — ON005261"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on005261/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON005261"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on005261">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `ON005261`                                                                                                                |
| Year           | 2019                                                                                                                      |
| Authors        | Snezana Todorovic, Elin Runnqvist, Valerie Chanoine, Jean-Michel Badier                                                   |
| License        | CC0                                                                                                                       |
| Citation / DOI | [10.82901/nemar.on005261](https://doi.org/10.82901/nemar.on005261)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on005261) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on005261) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON005261</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON005261</code></span></div>
