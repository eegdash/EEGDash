...
```none
saved: /tmp/eegdash_save__qrt_1ua/windows
...
FIF write_s=0.0054 s, size_mb=0.0055
```
...
```none
Zarr write_s=0.0166, read_s=0.0060, size_mb=0.0080
```
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0153, read_s=0.0115, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save__qrt_1ua/windows/0 already exists. Please select
