...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006817</b></div><div>Iss. 6817 · 34 subjects · 34 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Visual Attribute-Specific Contextual Trajectory Paradigm 2.0</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006817</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2025.08.18.670829">10.1101/2025.08.18.670829</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>34</dd><dt>Recordings</dt><dd>34</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>65</dd><dt>Sample rate</dt><dd>1024 Hz</dd><dt>Duration</dt><dd>21.7 h</dd><dt>Size</dt><dd>11.4 GB</dd><dt>Tasks</dt><dd><code>CTP</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.1.0</dd><dt>Sidecars</dt><dd>events</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006817</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006817">EEGDash/ds006817</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006817.v1.0.0">10.18112/openneuro.ds006817.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006817">OpenNeuro</a><a href="https://doi.org/10.1101/2025.08.18.670829">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006817">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006817.croissant.json" download>Croissant</a></div></aside>

# DS006817: eeg dataset, 34 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Visual Attribute-Specific Contextual Trajectory Paradigm 2.0","alternateName":"DS006817","description":"Visual Attribute-Specific Contextual Trajectory Paradigm 2.0. eeg dataset accessible via EEGDash as \`\`DS006817\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006817.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006817.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds006817.v1.0.0","https://openneuro.org/datasets/ds006817","https://nemar.org/dataexplorer/detail?dataset_id=ds006817"],"creator":[{"@type":"Person","name":"Benjamin Lowe (ben.lowe@mq.edu.au)"},{"@type":"Person","name":"Naohide Yamamoto (naohide.yamamoto@qut.edu.au)"},{"@type":"Person","name":"Jonathan Robinson (jonathan.robinson@monash.edu)"},{"@type":"Person","name":"Patrick Johnston (dr.pat.johnston@icloud.com)"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Visual Attribute-Specific Contextual Trajectory Paradigm 2.0*

**Citation:** Benjamin Lowe ([ben.lowe@mq.edu.au](mailto:ben.lowe@mq.edu.au)), Naohide Yamamoto ([naohide.yamamoto@qut.edu.au](mailto:naohide.yamamoto@qut.edu.au)), Jonathan Robinson ([jonathan.robinson@monash.edu](mailto:jonathan.robinson@monash.edu)), Patrick Johnston ([dr.pat.johnston@icloud.com](mailto:dr.pat.johnston@icloud.com)) (20). *Visual Attribute-Specific Contextual Trajectory Paradigm 2.0*. [10.18112/openneuro.ds006817.v1.0.0](https://doi.org/10.18112/openneuro.ds006817.v1.0.0)

<p class="eegdash-ed-deck">34-participant EEG dataset — Visual Attribute-Specific Contextual Trajectory Paradigm 2.0.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Benjamin Lowe (ben.lowe@mq.edu.au)</strong> · <strong>Naohide Yamamoto (naohide.yamamoto@qut.edu.au)</strong> · Jonathan Robinson (jonathan.robinson@monash.edu) · Patrick Johnston (dr.pat.johnston@icloud.com)<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 65 ch</span><span class="pill">1024 Hz</span><span class="pill is-info">BIDS 1.1.0</span><span class="pill">Task · CTP</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <p><strong>Total recording duration</strong>: 21 h 40 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">65 ch · EEG · 1024 Hz · 34 subjects, 34 recordings</span>
  </div>
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds006817" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006817&sub=13&task=CTP&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006817 — sub-13 · task-CTP"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds006817). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds006817" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds006817/code/ds006817_histogram.png"
      alt="NEMAR pipeline statistics — DS006817"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds006817/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS006817"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds006817">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006817) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006817)                                                                                                                                                                                                          |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006817</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006817</code> · <code>Lowe2025</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006817</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006817.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006817">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006817.v1.0.0">10.18112/openneuro.ds006817.v1.0.0</a></b></div></footer>
