...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS004279</b></div><div>Iss. 4279 · 56 subjects · 60 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Large Spanish EEG</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS004279</dd><dt>Version</dt><dd>v1.1.2</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1088/1741-2552/ad88a3">10.1088/1741-2552/ad88a3</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>56</dd><dt>Recordings</dt><dd>60</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>69</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>53.7 h</dd><dt>Size</dt><dd>25.2 GB</dd><dt>Tasks</dt><dd><code>sentences</code></dd><dt>Sessions</dt><dd>4 · <code>01</code> … <code>04</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.6.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds004279</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds004279">EEGDash/ds004279</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds004279.v1.1.2">10.18112/openneuro.ds004279.v1.1.2</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds004279">OpenNeuro</a><a href="https://doi.org/10.1088/1741-2552/ad88a3">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds004279">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS004279.croissant.json" download>Croissant</a></div></aside>

# DS004279: eeg dataset, 56 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Large Spanish EEG","alternateName":"DS004279","description":"Large Spanish EEG. eeg dataset accessible via EEGDash as \`\`DS004279\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS004279.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds004279.v1.1.2","sameAs":["https://doi.org/10.18112/openneuro.ds004279.v1.1.2","https://openneuro.org/datasets/ds004279","https://nemar.org/dataexplorer/detail?dataset_id=ds004279"],"creator":[{"@type":"Person","name":"Carlos Valle Araya"},{"@type":"Person","name":"Carolina Mendez-Orellana"},{"@type":"Person","name":"Maria Rodriguez-Fernandez"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2024-01-01"}</script>

*Large Spanish EEG*

**Citation:** Carlos Valle Araya, Carolina Mendez-Orellana, Maria Rodriguez-Fernandez (2024). *Large Spanish EEG*. [10.18112/openneuro.ds004279.v1.1.2](https://doi.org/10.18112/openneuro.ds004279.v1.1.2)

<p class="eegdash-ed-deck">56-participant EEG dataset — Large Spanish EEG.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Carlos Valle Araya</strong> · <strong>Carolina Mendez-Orellana</strong> · Maria Rodriguez-Fernandez<br/><span class="role">Year</span> 2024 · Distributed via OpenNeuro<br/><span class="role">Funding</span> Doctoral scholarship N 21211883 (2021)383 by Agencia Nacional de Investigacion y Desarrollo (ANID Chile)</div><div class="eegdash-ed-pills"><span class="pill">EEG · 69 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.6.0</span><span class="pill">Task · sentences</span><span class="pill">4 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=56, range 19–29 yr, mean 22.5 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=6"><div style="width:100%; height:19px; background:#006ca3; flex-shrink:0;" title="15-19: female n=4"></div><div style="width:100%; height:9px; background:#f7941d; flex-shrink:0;" title="15-19: male n=2"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=37"><div style="width:100%; height:92px; background:#006ca3; flex-shrink:0;" title="20-24: female n=19"></div><div style="width:100%; height:87px; background:#f7941d; flex-shrink:0;" title="20-24: male n=18"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=13"><div style="width:100%; height:38px; background:#006ca3; flex-shrink:0;" title="25-29: female n=8"></div><div style="width:100%; height:24px; background:#f7941d; flex-shrink:0;" title="25-29: male n=5"></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-021 · ses-01 · task-sentences</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>56 subjects and 60 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds004279" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds004279&sub=021&ses=01&task=sentences&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds004279 — sub-021 · ses-01 · task-sentences"
