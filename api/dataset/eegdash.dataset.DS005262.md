...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005262</b></div><div>Iss. 5262 · 12 subjects · 186 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · ArEEG</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005262</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-025-05387-w">10.1038/s41597-025-05387-w</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>12</dd><dt>Recordings</dt><dd>186</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>8</dd><dt>Sample rate</dt><dd>250 Hz</dd><dt>Duration</dt><dd>25.0 h</dd><dt>Size</dt><dd>689.0 MB</dd><dt>Tasks</dt><dd><code>innerspeech</code></dd><dt>Sessions</dt><dd>21 · <code>0</code> … <code>9</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005262</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="other">other</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005262">EEGDash/ds005262</a></dd><dt>Citations</dt><dd>0</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005262.v1.0.1">10.18112/openneuro.ds005262.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005262">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-025-05387-w">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds005262">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005262.croissant.json" download>Croissant</a></div></aside>

# DS005262: eeg dataset, 12 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"ArEEG: Arabic Inner Speech EEG dataset","alternateName":"DS005262","description":"ArEEG: Arabic Inner Speech EEG dataset. eeg dataset accessible via EEGDash as \`\`DS005262\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS005262.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds005262.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds005262.v1.0.1","https://openneuro.org/datasets/ds005262","https://nemar.org/dataexplorer/detail?dataset_id=ds005262"],"creator":[{"@type":"Person","name":"Donia Metwalli"},{"@type":"Person","name":"Eslam Ahmed"},{"@type":"Person","name":"Antony Emil"},{"@type":"Person","name":"Yousef A. Radwan"},{"@type":"Person","name":"Mariam Barakat"},{"@type":"Person","name":"Anas Ahmed"},{"@type":"Person","name":"Amro Omar"},{"@type":"Person","name":"Sahar Selim"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*ArEEG: Arabic Inner Speech EEG dataset*

**Citation:** Donia Metwalli, Eslam Ahmed, Antony Emil, Yousef A. Radwan, Mariam Barakat, Anas Ahmed, Amro Omar, Sahar Selim (—). *ArEEG: Arabic Inner Speech EEG dataset*. [10.18112/openneuro.ds005262.v1.0.1](https://doi.org/10.18112/openneuro.ds005262.v1.0.1)

<p class="eegdash-ed-deck">12-participant EEG dataset — ArEEG: Arabic Inner Speech EEG dataset.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Donia Metwalli</strong> · <strong>Eslam Ahmed</strong> · Antony Emil · Yousef A. Radwan · Mariam Barakat · Anas Ahmed · …</div><div class="eegdash-ed-pills"><span class="pill">EEG · 8 ch</span><span class="pill">250 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">Task · innerspeech</span><span class="pill">21 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="other">other</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 8 ch (n=186 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 250.0 Hz (n=186 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">8 ch · EEG · 250 Hz · 12 subjects, 186 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-6 · ses-10 · task-innerspeech</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>12 subjects and 186 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds005262" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds005262&sub=6&ses=10&task=innerspeech&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds005262 — sub-6 · ses-10 · task-innerspeech"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds005262). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds005262" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds005262/code/ds005262_histogram.png"
      alt="NEMAR pipeline statistics — DS005262"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds005262/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS005262"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds005262">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds005262) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds005262) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS005262</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Metwalli2024</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS005262</code> · <code>Metwalli2024</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS005262</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS005262.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds005262">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds005262.v1.0.1">10.18112/openneuro.ds005262.v1.0.1</a></b></div></footer>
