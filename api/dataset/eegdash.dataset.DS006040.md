...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006040</b></div><div>Iss. 6040 · 28 subjects · 392 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Sustained Attention Task (gradCPT) Dataset using simultaneous…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006040</dd><dt>Version</dt><dd>v1.0.2</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-026-06616-6">10.1038/s41597-026-06616-6</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>28</dd><dt>Recordings</dt><dd>392</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>5000 Hz</dd><dt>Duration</dt><dd>38.4 h</dd><dt>Size</dt><dd>680.3 GB</dd><dt>Tasks</dt><dd>10 tasks · <code>CBOFF</code> · <code>CBON</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.4.0</dd><dt>Sidecars</dt><dd>eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006040</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="other">Other</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006040">EEGDash/ds006040</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006040.v1.0.2">10.18112/openneuro.ds006040.v1.0.2</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006040">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-026-06616-6">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006040">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006040.croissant.json" download>Croissant</a></div></aside>

# DS006040: eeg dataset, 28 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Sustained Attention Task (gradCPT) Dataset using simultaneous EEG-fMRI and DTI","alternateName":"DS006040","description":"Sustained Attention Task (gradCPT) Dataset using simultaneous EEG-fMRI and DTI. eeg dataset accessible via EEGDash as \`\`DS006040\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006040.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006040.v1.0.2","sameAs":["https://doi.org/10.18112/openneuro.ds006040.v1.0.2","https://openneuro.org/datasets/ds006040","https://nemar.org/dataexplorer/detail?dataset_id=ds006040"],"creator":[{"@type":"Person","name":"Younghwa Cha"},{"@type":"Person","name":"Yeji Lee"},{"@type":"Person","name":"Eunhee Ji"},{"@type":"Person","name":"SoHyun Han"},{"@type":"Person","name":"Sunhyun Min"},{"@type":"Person","name":"Hyoungkyu Kim"},{"@type":"Person","name":"Minseo Cho"},{"@type":"Person","name":"Hae Seong Lee"},{"@type":"Person","name":"Youngjai Park"},{"@type":"Person","name":"Joon-Young Moon"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Sustained Attention Task (gradCPT) Dataset using simultaneous EEG-fMRI and DTI*

**Citation:** Younghwa Cha, Yeji Lee, Eunhee Ji, SoHyun Han, Sunhyun Min, Hyoungkyu Kim, Minseo Cho, Hae Seong Lee, Youngjai Park, Joon-Young Moon (—). *Sustained Attention Task (gradCPT) Dataset using simultaneous EEG-fMRI and DTI*. [10.18112/openneuro.ds006040.v1.0.2](https://doi.org/10.18112/openneuro.ds006040.v1.0.2)

<p class="eegdash-ed-deck">28-participant EEG dataset — Sustained Attention Task (gradCPT) Dataset using simultaneous EEG-fMRI and DTI.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Younghwa Cha</strong> · <strong>Yeji Lee</strong> · Eunhee Ji · SoHyun Han · Sunhyun Min · Hyoungkyu Kim · …<br/><span class="role">Funding</span> The Institute for Basic Science of Korea (IBS, IBS-R015-Y3) · The National Research Foundation of Korea (NRF, RS-2023-00272652)</div><div class="eegdash-ed-pills"><span class="pill">EEG · 64 ch</span><span class="pill">5000 Hz</span><span class="pill is-info">BIDS 1.4.0</span><span class="pill">10 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="other">Other</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">64 ch · EEG · 5000 Hz · 28 subjects, 392 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-021 · task-ECOFF · run-1</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>28 subjects and 392 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006040" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006040&sub=021&task=ECOFF&run=1&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006040 — sub-021 · task-ECOFF · run-1"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006040) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006040)            |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006040</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Cha2025</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006040</code> · <code>Cha2025</code></span></div>
...
* [eegdash.dataset.DS006033](eegdash.dataset.DS006033.md)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006040</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006040.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006040">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006040.v1.0.2">10.18112/openneuro.ds006040.v1.0.2</a></b></div></footer>
