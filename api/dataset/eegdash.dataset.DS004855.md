...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS004855</b></div><div>Iss. 4855 · 1 subjects · 1 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · FT</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS004855</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1007/978-1-4757-3437-9">10.1007/978-1-4757-3437-9</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>1</dd><dt>Recordings</dt><dd>1</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>128 Hz</dd><dt>Duration</dt><dd>32 min</dd><dt>Size</dt><dd>79.3 MB</dd><dt>Tasks</dt><dd><code>nback</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd><a href="#nemar-processing-statistics">HED ✓</a></dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds004855</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="memory">Memory</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds004855">EEGDash/ds004855</a></dd><dt>Citations</dt><dd>0</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds004855.v1.0.0">10.18112/openneuro.ds004855.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds004855">OpenNeuro</a><a href="https://doi.org/10.1007/978-1-4757-3437-9">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds004855">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS004855.croissant.json" download>Croissant</a></div></aside>

# DS004855: eeg dataset, 1 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"FT","alternateName":"DS004855","description":"FT. eeg dataset accessible via EEGDash as \`\`DS004855\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS004855.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds004855.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds004855.v1.0.0","https://openneuro.org/datasets/ds004855","https://nemar.org/dataexplorer/detail?dataset_id=ds004855"],"creator":[{"@type":"Person","name":"Tony Johnson"},{"@type":"Person","name":"Stephen Gordon"},{"@type":"Person","name":"Jon Touryan"},{"@type":"Person","name":"Kevin King"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*FT*

**Citation:** Tony Johnson, Stephen Gordon, Jon Touryan, Kevin King (—). *FT*. [10.18112/openneuro.ds004855.v1.0.0](https://doi.org/10.18112/openneuro.ds004855.v1.0.0)

<p class="eegdash-ed-deck">1-participant EEG dataset — FT.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Tony Johnson</strong> · <strong>Stephen Gordon</strong> · Jon Touryan · Kevin King</div><div class="eegdash-ed-pills"><span class="pill">EEG · 64 ch</span><span class="pill">128 Hz</span><span class="pill is-info">BIDS 1.8.0</span><span class="pill is-warning">HED ✓</span><span class="pill">Task · nback</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="memory">Memory</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = DS004855(cache_dir="./data", subject="01")
```
...
@dataset{ds004855,
  ...
  doi = {10.18112/openneuro.ds004855.v1.0.0},
  url = {https://doi.org/10.18112/openneuro.ds004855.v1.0.0},
}
```
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-001 · task-nback</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds004855" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds004855&sub=001&task=nback&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds004855 — sub-001 · task-nback"
...
<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds004855" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds004855/code/ds004855_histogram.png"
      alt="NEMAR pipeline statistics — DS004855"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds004855/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS004855"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds004855">
  <div class="ee-bar">
...
|----------------|---------------------------------------------------------------------------------------------------------------------------|
| Title          | FT                                                                                                                        |
| Author (year)  | `Johnson2023_FT`                                                                                                          |
| Canonical      | —                                                                                                                         |
| Importable as  | `DS004855`, `Johnson2023_FT`                                                                                              |
| Year           | —                                                                                                                         |
| Authors        | Tony Johnson, Stephen Gordon, Jon Touryan, Kevin King                                                                     |
| License        | CC0                                                                                                                       |
| Citation / DOI | [doi:10.18112/openneuro.ds004855.v1.0.0](https://doi.org/10.18112/openneuro.ds004855.v1.0.0)                              |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds004855) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds004855) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS004855</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Johnson2023_FT</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS004855</code> · <code>Johnson2023_FT</code></span></div>
...
OpenNeuro dataset: [https://openneuro.org/datasets/ds004855](https://openneuro.org/datasets/ds004855)
NeMAR dataset: [https://nemar.org/dataexplorer/detail?dataset_id=ds004855](https://nemar.org/dataexplorer/detail?dataset_id=ds004855)
DOI: [https://doi.org/10.18112/openneuro.ds004855.v1.0.0](https://doi.org/10.18112/openneuro.ds004855.v1.0.0)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS004855</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS004855.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds004855">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds004855.v1.0.0">10.18112/openneuro.ds004855.v1.0.0</a></b></div></footer>
