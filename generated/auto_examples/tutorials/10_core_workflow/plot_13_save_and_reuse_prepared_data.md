...
```none
saved: /tmp/eegdash_save_g4_lefia/windows
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0170, read_s=0.0126, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_g4_lefia/windows/0 already exists. Please select
