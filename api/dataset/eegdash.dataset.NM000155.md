...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000155</b></div><div>Iss. 155 · 6 subjects · 11 recordings · CC0 BY 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · MUniverse Caillet et al 2023</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000155</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0 BY 4.0</dd><dt>Updated</dt><dd>2026-04-08</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>6</dd><dt>Recordings</dt><dd>11</dd><dt>Modality</dt><dd>EMG</dd><dt>Channels</dt><dd>259</dd><dt>Sample rate</dt><dd>2048 Hz</dd><dt>Duration</dt><dd>7 min</dd><dt>Size</dt><dd>448.3 MB</dd><dt>Tasks</dt><dd><code>isometric30percentmvc</code> · <code>isometric50percentmvc</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.11.1</dd><dt>Sidecars</dt><dd>events · channels · electrodes</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000155</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000155">EEGDash/nm000155</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/https://doi.org/10.7910/DVN/F9GWIW">https://doi.org/10.7910/DVN/F9GWIW</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000155">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000155">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000155.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section eegdash-ed-sex" style="margin-bottom:1rem;">
  ...
  <div class="sex-wrap" style="display:flex; align-items:center; gap:30px; flex-wrap:wrap;">
    ...
    <div class="sex-legend" style="flex:1; font-family:JetBrains Mono,monospace; font-size:13px; min-width:220px;"><div class="row"><div class="sw" style="background:#f7941d"></div><div class="lbl">Male</div><div class="v">6</div></div></div>
  </div>


</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 259 ch (n=11 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 2048.0 Hz (n=11 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 7 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">259 ch · EMG · 2048 Hz · 6 subjects, 11 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-01 · task-isometric30percentmvc · run-01</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>6 subjects and 11 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000155" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_emg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?emg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000155&sub=01&task=isometric30percentmvc&run=01&ext=edf&suffix=emg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EMG trace viewer for nm000155 — sub-01 · task-isometric30percentmvc · run-01"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000155). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000155" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000155/code/nm000155_histogram.png"
      alt="NEMAR pipeline statistics — NM000155"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000155/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000155"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000155">
  <div class="ee-bar">
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000155</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Caillet2023</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000155</code> · <code>Caillet2023</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000155</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000155.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000155">Hugging Face mirror</a></div><div>CC0 BY 4.0 · <b><a href="https://doi.org/https://doi.org/10.7910/DVN/F9GWIW">https://doi.org/10.7910/DVN/F9GWIW</a></b></div></footer>
