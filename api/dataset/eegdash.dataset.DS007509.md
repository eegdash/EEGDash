...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS007509</b></div><div>Iss. 7509 · 69 subjects · 70 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · 1hrPVTdataset_allSubjects</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS007509</dd><dt>Version</dt><dd>v1.0.3</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2025.08.25.671937">10.1101/2025.08.25.671937</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>69</dd><dt>Recordings</dt><dd>70</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>Varies</dd><dt>Sample rate</dt><dd>Varies</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>14.8 GB</dd><dt>Tasks</dt><dd><code>PVT</code></dd><dt>Sessions</dt><dd>2 · <code>1</code> · <code>2</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>80% · Good</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds007509</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds007509.v1.0.3">10.18112/openneuro.ds007509.v1.0.3</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds007509">OpenNeuro</a><a href="https://doi.org/10.1101/2025.08.25.671937">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/DS007509.croissant.json" download>Croissant</a></div></aside>

# DS007509: eeg dataset, 69 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"1hrPVTdataset_allSubjects","alternateName":"DS007509","description":"1hrPVTdataset_allSubjects. eeg dataset accessible via EEGDash as \`\`DS007509\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS007509.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds007509.v1.0.3","sameAs":["https://doi.org/10.18112/openneuro.ds007509.v1.0.3","https://openneuro.org/datasets/ds007509","https://nemar.org/dataexplorer/detail?dataset_id=ds007509"],"creator":[{"@type":"Person","name":"Matthew Attokaren"},{"@type":"Person","name":"Annabelle Singer"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*1hrPVTdataset_allSubjects*

**Citation:** Matthew Attokaren, Annabelle Singer (—). *1hrPVTdataset_allSubjects*. [10.18112/openneuro.ds007509.v1.0.3](https://doi.org/10.18112/openneuro.ds007509.v1.0.3)

<p class="eegdash-ed-deck">69-participant EEG dataset — 1hrPVTdataset_allSubjects.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Matthew Attokaren</strong> · <strong>Annabelle Singer</strong></div><div class="eegdash-ed-pills"><span class="pill is-info">BIDS 1.8.0</span><span class="pill">Task · PVT</span><span class="pill">2 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = DS007509(cache_dir="./data", subject="01")
```
...
```bibtex
@dataset{ds007509,
  title = {1hrPVTdataset_allSubjects},
  author = {Matthew Attokaren and Annabelle Singer},
  doi = {10.18112/openneuro.ds007509.v1.0.3},
  url = {https://doi.org/10.18112/openneuro.ds007509.v1.0.3},
}
```
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=69, range 18–35 yr, mean 20.6 yr · sex per subject not reported)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="flex:1 1 0; min-width:0; height:105px; background:#006ca3;" title="15-19: 24"></div><div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="20-24: 41"></div><div style="flex:1 1 0; min-width:0; height:13px; background:#006ca3;" title="25-29: 3"></div><div style="flex:1 1 0; min-width:0; height:4px; background:#006ca3;" title="35-39: 1"></div>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">— ch · EEG · Varies · 69 subjects, 70 recordings</span>
  </div>
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds007509). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds007509" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds007509/code/ds007509_histogram.png"
      alt="NEMAR pipeline statistics — DS007509"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds007509/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS007509"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds007509">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `DS007509`                                                                                                                |
| Year           | —                                                                                                                         |
| Authors        | Matthew Attokaren, Annabelle Singer                                                                                       |
| License        | CC0                                                                                                                       |
| Citation / DOI | [doi:10.18112/openneuro.ds007509.v1.0.3](https://doi.org/10.18112/openneuro.ds007509.v1.0.3)                              |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds007509) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds007509) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS007509</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS007509</code></span></div>
