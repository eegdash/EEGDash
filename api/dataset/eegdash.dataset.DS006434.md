...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006434</b></div><div>Iss. 6434 · 66 subjects · 118 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · The auditory brainstem response to natural speech is not affe…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006434</dd><dt>Version</dt><dd>v1.2.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1371/journal.pbio.3003407">10.1371/journal.pbio.3003407</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>66</dd><dt>Recordings</dt><dd>118</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>32 (52), 2 (28), 1 (24), 3 (14)</dd><dt>Sample rate</dt><dd>500, 1000, 10000, 25000 Hz</dd><dt>Duration</dt><dd>263 h</dd><dt>Size</dt><dd>103.0 GB</dd><dt>Tasks</dt><dd>5 tasks · <code>exp1DioticCortex</code> · <code>exp1DioticSubcortex</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006434</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006434">EEGDash/ds006434</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006434.v1.2.0">10.18112/openneuro.ds006434.v1.2.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006434">OpenNeuro</a><a href="https://doi.org/10.1371/journal.pbio.3003407">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006434">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006434.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=9"><div style="width:100%; height:68px; background:#006ca3; flex-shrink:0;" title="15-19: female n=8"></div><div style="width:100%; height:8px; background:#f7941d; flex-shrink:0;" title="15-19: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=21"><div style="width:100%; height:8px; background:#6b7785; flex-shrink:0;" title="20-24: other n=1"></div><div style="width:100%; height:111px; background:#006ca3; flex-shrink:0;" title="20-24: female n=13"></div><div style="width:100%; height:60px; background:#f7941d; flex-shrink:0;" title="20-24: male n=7"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=8"><div style="width:100%; height:51px; background:#006ca3; flex-shrink:0;" title="25-29: female n=6"></div><div style="width:100%; height:17px; background:#f7941d; flex-shrink:0;" title="25-29: male n=2"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=2"><div style="width:100%; height:17px; background:#006ca3; flex-shrink:0;" title="30-34: female n=2"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="35-39: n=2"><div style="width:100%; height:17px; background:#f7941d; flex-shrink:0;" title="35-39: male n=2"></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-dichotic20 · task-exp2DichoticSubcortex</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>66 subjects and 118 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006434" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006434&sub=dichotic20&task=exp2DichoticSubcortex&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006434 — sub-dichotic20 · task-exp2DichoticSubcortex"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — EEG · 32 sensors — 32 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=74312cfc81298cfa&embed=1"
    loading="lazy"
    width="100%" height="640"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006434) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006434) |
