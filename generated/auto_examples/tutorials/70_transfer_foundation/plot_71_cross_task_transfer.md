...
```none
pretrain losses (RestingState): [0.041, 0.001, 0.001, 0.001, 0.0]
```
...
```none
finetune losses (CCD): [0.588, 0.481, 0.45, 0.365, 0.333]
```
...
```none
finetune=0.650 | scratch=0.567 | chance=0.583 | metric=accuracy | gap=+0.083
```
...
RestingState                    0.083         0.433         0.000
surroundSupp                    0.333         0.433         0.000
symbolSearch                    0.183         0.283        -0.033
```
...
{"encoder_weights_path": "plot_71_pretrained_encoder.pt", "pretext_subjects": 8, "target_subjects": 8, "transfer_gap": 0.0833, "transfer_matrix_mean_delta": 0.1907}
```
