...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005530</b></div><div>Iss. 5530 · 17 subjects · 21 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Depotentiation of emotional reactivity using TMR during REM s…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005530</dd><dt>Version</dt><dd>v1.0.9</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Updated</dt><dd>2025-02-24</dd><dt>Contact</dt><dd>Tamas Foldes, viviana greco</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>17</dd><dt>Recordings</dt><dd>21</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>10</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>145 h</dd><dt>Size</dt><dd>6.5 GB</dd><dt>Tasks</dt><dd><code>sleep</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005530</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="sleep">Sleep</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005530">EEGDash/ds005530</a></dd><dt>Citations</dt><dd>0</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005530.v1.0.9">10.18112/openneuro.ds005530.v1.0.9</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005530">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/ds005530">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005530.croissant.json" download>Croissant</a></div></aside>
...
<p class="eegdash-ed-deck">17-participant EEG dataset — Depotentiation of emotional reactivity using TMR during REM sleep.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Viviana Greco</strong> · <strong>Tamas A. Foldes</strong> · Neil A. Harrison · Kevin Murphy · Marta Wawrzuta · Mahmoud E. A. Abdellahi · …<br/><span class="role">Senior author</span> <strong>Penelope A. Lewis</strong><br/><span class="role">Year</span> 2024 · Distributed via OpenNeuro<br/><span class="role">Funding</span> ERC consolidator grant SolutionSleep to Lewis P.A. · The Wellcome Trust [WT224267] to Murphy K</div><div class="eegdash-ed-pills"><span class="pill">EEG · 10 ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.8.0</span><span class="pill">Task · sleep</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="sleep">Sleep</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=17, range 21–32 yr, mean 25.1 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=8"><div style="width:100%; height:157px; background:#006ca3; flex-shrink:0;" title="20-24: female n=7"></div><div style="width:100%; height:22px; background:#f7941d; flex-shrink:0;" title="20-24: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=8"><div style="width:100%; height:67px; background:#006ca3; flex-shrink:0;" title="25-29: female n=3"></div><div style="width:100%; height:112px; background:#f7941d; flex-shrink:0;" title="25-29: male n=5"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=1"><div style="width:100%; height:22px; background:#f7941d; flex-shrink:0;" title="30-34: male n=1"></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">10 ch · EEG · 500 Hz · 17 subjects, 21 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-12012022301 · task-sleep · run-02</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>17 subjects and 21 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds005530" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds005530&sub=12012022301&task=sleep&run=02&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds005530 — sub-12012022301 · task-sleep · run-02"
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS005530</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Greco2024</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS005530</code> · <code>Greco2024</code></span></div>
...
* [eegdash.dataset.DS007006](eegdash.dataset.DS007006.md)
* [eegdash.dataset.DS005815](eegdash.dataset.DS005815.md)
* [eegdash.dataset.DS006222](eegdash.dataset.DS006222.md)

<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS005530</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS005530.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds005530">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds005530.v1.0.9">10.18112/openneuro.ds005530.v1.0.9</a></b></div></footer>
