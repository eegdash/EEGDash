<a id="concepts-preprocessing-decisions"></a>
...
and forwards your data to MNE-Python [[Gramfort *et al.*, 2013](../references.md#id25)] <sup>[1](#id5)</sup> and
...
Cisotto & Chicco (2024) <sup>[2](#id6)</sup>, which give the same advice in a clinical
setting.
...
Pernet et al. (2019) <sup>[3](#id7)</sup> require the reference to be declared in the
...
* <a id='id5'>**[1]**</a> Gramfort, A., Luessi, M., Larson, E., Engemann, D. A., Strohmeier, D., Brodbeck, C., Goj, R., Jas, M., Brooks, T., Parkkonen, L., & Hämäläinen, M. S. (2013). MEG and EEG data analysis with MNE-Python. *Frontiers in Neuroscience*, 7, 267. [https://doi.org/10.3389/fnins.2013.00267](https://doi.org/10.3389/fnins.2013.00267)
* <a id='id6'>**[2]**</a> Cisotto, G., & Chicco, D. (2024). Ten quick tips for clinical electroencephalographic (EEG) data acquisition and signal processing. *PeerJ Computer Science*, 10, e2256. [https://doi.org/10.7717/peerj-cs.2256](https://doi.org/10.7717/peerj-cs.2256)
* <a id='id7'>**[3]**</a> Pernet, C. R., et al. (2019). EEG-BIDS, an extension to the brain imaging data structure for electroencephalography. *Scientific Data*, 6(1), 103. [https://doi.org/10.1038/s41597-019-0104-8](https://doi.org/10.1038/s41597-019-0104-8)
- Widmann, A., & Schröger, E. (2012). Filter effects and filter
  ...
  *Frontiers in Psychology*, 3, 233.
  [https://doi.org/10.3389/fpsyg.2012.00233](https://doi.org/10.3389/fpsyg.2012.00233)
- Tanner, D., Morgan-Short, K., & Luck, S. J. (2015). How inappropriate
  ...
  *Psychophysiology*, 52(8), 997–1009.
  [https://doi.org/10.1111/psyp.12437](https://doi.org/10.1111/psyp.12437)
