...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON003194</b></div><div>Iss. 3194 · 15 subjects · 29 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Neuroepo multisession</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON003194</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.3389/fnins.2022.841428">10.3389/fnins.2022.841428</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>15</dd><dt>Recordings</dt><dd>29</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>19 (24), 20 (4), 21</dd><dt>Sample rate</dt><dd>200 Hz</dd><dt>Duration</dt><dd>7.2 h</dd><dt>Size</dt><dd>189.3 MB</dd><dt>Tasks</dt><dd><code>task6mnepo</code> · <code>taskprenepo</code></dd><dt>Sessions</dt><dd>2 · <code>Nepopre</code> · <code>nepo6m</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.2.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on003194</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on003194">10.82901/nemar.on003194</a></div><div class="actions"><a href="https://openneuro.org/datasets/on003194">OpenNeuro</a><a href="https://doi.org/10.3389/fnins.2022.841428">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON003194.croissant.json" download>Croissant</a></div></aside>

# ON003194: eeg dataset, 15 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Neuroepo multisession","alternateName":"ON003194","description":"Neuroepo multisession. eeg dataset accessible via EEGDash as \`\`ON003194\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON003194.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on003194","sameAs":["https://doi.org/10.82901/nemar.on003194","https://openneuro.org/datasets/on003194","https://nemar.org/dataexplorer/detail?dataset_id=on003194"],"creator":[{"@type":"Person","name":"Maria Luisa Bringas Vega"},{"@type":"Person","name":"Lilia Morales Chacon"},{"@type":"Person","name":"Ivonne Pedroso Ibanez"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*Neuroepo multisession*

**Citation:** Maria Luisa Bringas Vega, Lilia Morales Chacon, Ivonne Pedroso Ibanez (2019). *Neuroepo multisession*. [10.82901/nemar.on003194](https://doi.org/10.82901/nemar.on003194)

<p class="eegdash-ed-deck">15-participant EEG dataset — Neuroepo multisession.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Maria Luisa Bringas Vega</strong> · <strong>Lilia Morales Chacon</strong> · Ivonne Pedroso Ibanez<br/><span class="role">Year</span> 2019 · Distributed via NeMAR<br/><span class="role">Funding</span> National Nature and Science Foundation of China (NSFC) No. 61871105, 61673090, 81330032 · CNS Program of UESTC (No. Y0301902610100201)</div><div class="eegdash-ed-pills"><span class="pill">EEG · 19 (24), 20 (4), 21 ch</span><span class="pill">200 Hz</span><span class="pill is-info">BIDS 1.2.0</span><span class="pill">2 tasks</span><span class="pill">2 sessions</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = ON003194(cache_dir="./data", subject="01")
```
...
@dataset{on003194,
  ...
  doi = {10.82901/nemar.on003194},
  url = {https://doi.org/10.82901/nemar.on003194},
}
```
...
> [DOI](https://doi.org/10.82901/nemar.on003194)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-NEPO01 · ses-Nepopre · task-taskprenepo</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on003194" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on003194&sub=NEPO01&ses=Nepopre&task=taskprenepo&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on003194 — sub-NEPO01 · ses-Nepopre · task-taskprenepo"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on003194). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on003194" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on003194/code/on003194_histogram.png"
      alt="NEMAR pipeline statistics — ON003194"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on003194/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON003194"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on003194">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `ON003194`                                                                                                                |
| Year           | 2019                                                                                                                      |
| Authors        | Maria Luisa Bringas Vega, Lilia Morales Chacon, Ivonne Pedroso Ibanez                                                     |
| License        | CC0                                                                                                                       |
| Citation / DOI | [10.82901/nemar.on003194](https://doi.org/10.82901/nemar.on003194)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on003194) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on003194) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON003194</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON003194</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON003194</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON003194.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on003194">10.82901/nemar.on003194</a></b></div></footer>
