...
<details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-xp101 · task-motorloc</strong> <span class="trace-viewer-fmt">(BrainVision · 64 channels · 5000 Hz)</span></summary>
  ...
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds002336&sub=xp101&task=motorloc&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds002336 — sub-xp101 · task-motorloc"
