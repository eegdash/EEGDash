...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003195</b></div><div>Iss. 3195 · 10 subjects · 20 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Placebo Neuroepo multisession</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003195</dd><dt>Version</dt><dd>v1.0.3</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.2139/ssrn.4966719">10.2139/ssrn.4966719</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>10</dd><dt>Recordings</dt><dd>20</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>19</dd><dt>Sample rate</dt><dd>200 Hz</dd><dt>Duration</dt><dd>4.6 h</dd><dt>Size</dt><dd>121.2 MB</dd><dt>Tasks</dt><dd><code>taskplacebo6m</code> · <code>taskplacebopre</code></dd><dt>Sessions</dt><dd>2 · <code>placebo6m</code> · <code>placebopre</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.2.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003195</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="parkinson&#x27;s">Parkinson&#x27;s</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="resting-state">Resting State</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003195">EEGDash/ds003195</a></dd><dt>Citations</dt><dd>3</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003195.v1.0.3">10.18112/openneuro.ds003195.v1.0.3</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003195">OpenNeuro</a><a href="https://doi.org/10.2139/ssrn.4966719">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003195">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003195.croissant.json" download>Croissant</a></div></aside>

# DS003195: eeg dataset, 10 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Placebo Neuroepo multisession","alternateName":"DS003195","description":"Placebo Neuroepo multisession. eeg dataset accessible via EEGDash as \`\`DS003195\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS003195.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds003195.v1.0.3","sameAs":["https://doi.org/10.18112/openneuro.ds003195.v1.0.3","https://openneuro.org/datasets/ds003195","https://nemar.org/dataexplorer/detail?dataset_id=ds003195"],"creator":[{"@type":"Person","name":"Maria Luisa Bringas Vega"},{"@type":"Person","name":"Lilia Morales Chacon"},{"@type":"Person","name":"Ivonne Pedroso Ibanez"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*Placebo Neuroepo multisession*

**Citation:** Maria Luisa Bringas Vega, Lilia Morales Chacon, Ivonne Pedroso Ibanez (2019). *Placebo Neuroepo multisession*. [10.18112/openneuro.ds003195.v1.0.3](https://doi.org/10.18112/openneuro.ds003195.v1.0.3)

<p class="eegdash-ed-deck">10-participant EEG dataset — Placebo Neuroepo multisession.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Maria Luisa Bringas Vega</strong> · <strong>Lilia Morales Chacon</strong> · Ivonne Pedroso Ibanez<br/><span class="role">Year</span> 2019 · Distributed via OpenNeuro<br/><span class="role">Funding</span> National Nature and Science Foundation of China (NSFC) No. 61871105, 61673090, 81330032 · CNS Program of UESTC (No. Y0301902610100201)</div><div class="eegdash-ed-pills"><span class="pill">EEG · 19 ch</span><span class="pill">200 Hz</span><span class="pill is-info">BIDS 1.2.0</span><span class="pill">2 tasks</span><span class="pill">2 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="parkinson&#x27;s">Parkinson&#x27;s</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="resting-state">Resting State</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section eegdash-ed-sex" style="margin-bottom:1rem;">
  ...
  <div class="sex-wrap" style="display:flex; align-items:center; gap:30px; flex-wrap:wrap;">
    ...
    <div class="sex-legend" style="flex:1; font-family:JetBrains Mono,monospace; font-size:13px; min-width:220px;"><div class="row"><div class="sw" style="background:#6b7785"></div><div class="lbl">Other</div><div class="v">10</div></div></div>
  </div>
  ...
  <p><strong>Total recording duration</strong>: 4 h 37 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">19 ch · EEG · 200 Hz · 10 subjects, 20 recordings</span>
  </div>
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003195) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003195) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003195</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Vega2020_Placebo</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003195</code> · <code>Vega2020_Placebo</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003195</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003195.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003195">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003195.v1.0.3">10.18112/openneuro.ds003195.v1.0.3</a></b></div></footer>
