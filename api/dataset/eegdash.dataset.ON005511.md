...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON005511</b></div><div>Iss. 5511 · 381 subjects · 3100 recordings · CC-BY-SA 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Healthy Brain Network (HBN) EEG - Release 7</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON005511</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-SA 4.0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2024.10.03.615261">10.1101/2024.10.03.615261</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>381</dd><dt>Recordings</dt><dd>3100</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>129 (3090), 6 (10)</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>280 h</dd><dt>Size</dt><dd>244.8 GB</dd><dt>Tasks</dt><dd>10 tasks · <code>DespicableMe</code> · <code>DiaryOfAWimpyKid</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on005511</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on005511">10.82901/nemar.on005511</a></div><div class="actions"><a href="https://openneuro.org/datasets/on005511">OpenNeuro</a><a href="https://doi.org/10.1101/2024.10.03.615261">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON005511.croissant.json" download>Croissant</a></div></aside>

# ON005511: eeg dataset, 381 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Healthy Brain Network (HBN) EEG - Release 7","alternateName":"ON005511","description":"Healthy Brain Network (HBN) EEG - Release 7. eeg dataset accessible via EEGDash as \`\`ON005511\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON005511.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on005511","sameAs":["https://doi.org/10.82901/nemar.on005511","https://openneuro.org/datasets/on005511","https://nemar.org/dataexplorer/detail?dataset_id=on005511"],"creator":[{"@type":"Person","name":"Seyed Yahya Shirazi"},{"@type":"Person","name":"Alexandre Franco"},{"@type":"Person","name":"Maurício Scopel Hoffmann"},{"@type":"Person","name":"Nathalia B. Esper"},{"@type":"Person","name":"Dung Truong"},{"@type":"Person","name":"Arnaud Delorme"},{"@type":"Person","name":"Michael Milham"},{"@type":"Person","name":"Scott Makeig"}],"license":"https://creativecommons.org/licenses/by-sa/4.0/"}</script>

*Healthy Brain Network (HBN) EEG - Release 7*

**Citation:** Seyed Yahya Shirazi, Alexandre Franco, Maurício Scopel Hoffmann, Nathalia B. Esper, Dung Truong, Arnaud Delorme, Michael Milham, Scott Makeig (20). *Healthy Brain Network (HBN) EEG - Release 7*. [10.82901/nemar.on005511](https://doi.org/10.82901/nemar.on005511)

<p class="eegdash-ed-deck">381-participant EEG dataset — Healthy Brain Network (HBN) EEG - Release 7.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Seyed Yahya Shirazi</strong> · <strong>Alexandre Franco</strong> · Maurício Scopel Hoffmann · Nathalia B. Esper · Dung Truong · Arnaud Delorme · …<br/><span class="role">Year</span> 20 · Distributed via NeMAR<br/><span class="role">Funding</span> See https://childmind.org/science/global-open-science/healthy-brain-network/#donors · NIH/NIMH R01MH125934 for BIDS data preparation</div><div class="eegdash-ed-pills"><span class="pill">EEG · 129 (3090), 6 (10) ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">10 tasks</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = ON005511(cache_dir="./data", subject="01")
```
...
@dataset{on005511,
  ...
  doi = {10.82901/nemar.on005511},
  url = {https://doi.org/10.82901/nemar.on005511},
}
```
...
[DOI](https://doi.org/10.82901/nemar.on005511)
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=381, range 5–22 yr, mean 10.2 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="5-9: n=192"><div style="width:100%; height:60px; background:#006ca3; flex-shrink:0;" title="5-9: female n=64"></div><div style="width:100%; height:120px; background:#f7941d; flex-shrink:0;" title="5-9: male n=128"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="10-14: n=138"><div style="width:100%; height:42px; background:#006ca3; flex-shrink:0;" title="10-14: female n=45"></div><div style="width:100%; height:87px; background:#f7941d; flex-shrink:0;" title="10-14: male n=93"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=45"><div style="width:100%; height:11px; background:#006ca3; flex-shrink:0;" title="15-19: female n=12"></div><div style="width:100%; height:30px; background:#f7941d; flex-shrink:0;" title="15-19: male n=33"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=6"><div style="width:100%; height:3px; background:#006ca3; flex-shrink:0;" title="20-24: female n=4"></div><div style="width:100%; height:1px; background:#f7941d; flex-shrink:0;" title="20-24: male n=2"></div></div>
  </div>
  ...
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 125</span><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#f7941d; display:inline-block;"></i>Male · 256</span></div>
  ...
  <p><strong>Sampling frequencies</strong>: 500.0 Hz (n=3100 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 279 h</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">129 (3090), 6 (10) ch · EEG · 500 Hz · 381 subjects, 3100 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-NDARAC462DZH · task-DespicableMe</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>381 subjects and 3100 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/on005511" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on005511&sub=NDARAC462DZH&task=DespicableMe&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on005511 — sub-NDARAC462DZH · task-DespicableMe"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on005511). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on005511" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on005511/code/on005511_histogram.png"
      alt="NEMAR pipeline statistics — ON005511"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on005511/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON005511"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on005511">
  <div class="ee-bar">
...
| Citation / DOI | [10.82901/nemar.on005511](https://doi.org/10.82901/nemar.on005511)                                                                            |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on005511) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on005511)                     |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON005511</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON005511</code></span></div>
