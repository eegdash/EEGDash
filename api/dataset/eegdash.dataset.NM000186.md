...
Modality: eeg Subjects: 8 Recordings: 88 License: CC-BY-4.0 Source: nemar
...
- Duration (hours): 2.3882378472222223
...
- Source: nemar
- OpenNeuro: [nm000186](https://openneuro.org/datasets/nm000186)
- NeMAR: [nm000186](https://nemar.org/dataexplorer/detail?dataset_id=nm000186)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div style="display:flex; height:22px; width:100%; max-width:400px; border-radius:4px; overflow:hidden;">
    <div style="width:62.5%; background:#e07ab5; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Female: 5">5</div><div style="width:37.5%; background:#4472c4; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Male: 3">3</div>
  </div>
...
Use the `NM000186` class to access this dataset programmatically.
