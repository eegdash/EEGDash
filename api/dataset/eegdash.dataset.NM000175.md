...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:80px; border-bottom:1px solid #34404e;">
    <div style="width:28px; height:40px; background:#006ca3; flex-shrink:0;" title="20-24: 1"></div><div style="width:28px; height:40px; background:#006ca3; flex-shrink:0;" title="25-29: 1"></div><div style="width:28px; height:80px; background:#006ca3; flex-shrink:0;" title="30-34: 2"></div><div style="width:28px; height:40px; background:#006ca3; flex-shrink:0;" title="50-54: 1"></div>
  </div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000175</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000175.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><span style="opacity:.6">DOI not on file</span></b></div></footer>
