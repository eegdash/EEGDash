...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON005420</b></div><div>Iss. 5420 · 37 subjects · 72 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Resting state EEG with closed eyes and open eyes in females f…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON005420</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>37</dd><dt>Recordings</dt><dd>72</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>20</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>5.4 h</dd><dt>Size</dt><dd>372.2 MB</dd><dt>Tasks</dt><dd><code>oa</code> · <code>oc</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd>channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on005420</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on005420">10.82901/nemar.on005420</a></div><div class="actions"><a href="https://openneuro.org/datasets/on005420">OpenNeuro</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON005420.croissant.json" download>Croissant</a></div></aside>

# ON005420: eeg dataset, 37 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Resting state EEG with closed eyes and open eyes in females from 60 to 80 years old","alternateName":"ON005420","description":"Resting state EEG with closed eyes and open eyes in females from 60 to 80 years old. eeg dataset accessible via EEGDash as \`\`ON005420\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON005420.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on005420","sameAs":["https://doi.org/10.82901/nemar.on005420","https://openneuro.org/datasets/on005420","https://nemar.org/dataexplorer/detail?dataset_id=on005420","https://nemar.org/dataexplorer/detail/on005420"],"creator":[{"@type":"Person","name":"Miriam de Jesús Sánchez Gama"},{"@type":"Person","name":"Luis Alberto Barradas Chacón"},{"@type":"Person","name":"Leticia Chacón Gutiérrez"},{"@type":"Person","name":"Thalía Fernández Harmony"},{"@type":"Person","name":"Carlos Augusto Novo Olivas"},{"@type":"Person","name":"José María De La Roca Chiapas"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*Resting state EEG with closed eyes and open eyes in females from 60 to 80 years old*

**Citation:** Miriam de Jesús Sánchez Gama, Luis Alberto Barradas Chacón, Leticia Chacón Gutiérrez, Thalía Fernández Harmony, Carlos Augusto Novo Olivas, José María De La Roca Chiapas (2019). *Resting state EEG with closed eyes and open eyes in females from 60 to 80 years old*. [10.82901/nemar.on005420](https://doi.org/10.82901/nemar.on005420)

<p class="eegdash-ed-deck">37-participant EEG dataset — Resting state EEG with closed eyes and open eyes in females from 60 to 80 years old.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Miriam de Jesús Sánchez Gama</strong> · <strong>Luis Alberto Barradas Chacón</strong> · Leticia Chacón Gutiérrez · Thalía Fernández Harmony · Carlos Augusto Novo Olivas · José María De La Roca Chiapas<br/><span class="role">Year</span> 2019 · Distributed via NeMAR</div><div class="eegdash-ed-pills"><span class="pill">EEG · 20 ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill">2 tasks</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = ON005420(cache_dir="./data", subject="01")
```
...
@dataset{on005420,
  ...
  doi = {10.82901/nemar.on005420},
  url = {https://doi.org/10.82901/nemar.on005420},
}
```
...
> [DOI](https://doi.org/10.82901/nemar.on005420)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-1 · task-oa</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on005420" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on005420&sub=1&task=oa&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on005420 — sub-1 · task-oa"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on005420). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on005420" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on005420/code/on005420_histogram.png"
      alt="NEMAR pipeline statistics — ON005420"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on005420/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON005420"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on005420">
  <div class="ee-bar">
...
| License        | CC0                                                                                                                                                                                      |
| Citation / DOI | [10.82901/nemar.on005420](https://doi.org/10.82901/nemar.on005420)                                                                                                                       |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on005420) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on005420) | [Source URL](https://nemar.org/dataexplorer/detail/on005420) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON005420</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON005420</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON005420</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON005420.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on005420">10.82901/nemar.on005420</a></b></div></footer>
