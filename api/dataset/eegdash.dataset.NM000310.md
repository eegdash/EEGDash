...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000310</b></div><div>Iss. 310 · 11 subjects · 26 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Guttmann-Flury et al. 2025 (SSVEP) — Dataset combining EEG, e…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000310</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Updated</dt><dd>2026-04-11</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>11</dd><dt>Recordings</dt><dd>26</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>65</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>3.2 h</dd><dt>Size</dt><dd>2.1 GB</dd><dt>Tasks</dt><dd><code>ssvep</code></dd><dt>Sessions</dt><dd>3 · <code>0</code> · <code>1</code> · <code>2</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000310</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000310">EEGDash/nm000310</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.1038/s41597-025-04861-9">10.1038/s41597-025-04861-9</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000310">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000310">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000310.croissant.json" download>Croissant</a></div></aside>

# NM000310: eeg dataset, 11 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Guttmann-Flury et al. 2025 (SSVEP) — Dataset combining EEG, eye-tracking, and high-speed video for ocular activity analysis across BCI paradigms","alternateName":"NM000310","description":"Guttmann-Flury et al. 2025 (SSVEP) — Dataset combining EEG, eye-tracking, and high-speed video for ocular activity analysis across BCI paradigms. eeg dataset accessible via EEGDash as \`\`NM000310\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000310.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.1038/s41597-025-04861-9","sameAs":["https://doi.org/10.1038/s41597-025-04861-9","https://openneuro.org/datasets/nm000310","https://nemar.org/dataexplorer/detail?dataset_id=nm000310","https://nemar.org/dataexplorer/detail/nm000310"],"creator":[{"@type":"Person","name":"Eva Guttmann-Flury"},{"@type":"Person","name":"Xinjun Sheng"},{"@type":"Person","name":"Xiangyang Zhu"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2025-01-01"}</script>
...
```bibtex
@dataset{nm000310,
  title = {Guttmann-Flury et al. 2025 (SSVEP) — Dataset combining EEG, eye-tracking, and high-speed video for ocular activity analysis across BCI paradigms},
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=11"><div style="width:100%; height:81px; background:#006ca3; flex-shrink:0;" title="25-29: female n=5"></div><div style="width:100%; height:98px; background:#f7941d; flex-shrink:0;" title="25-29: male n=6"></div></div>
  </div>
  ...
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 5</span><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#f7941d; display:inline-block;"></i>Male · 6</span></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">65 ch · EEG · 1000 Hz · 11 subjects, 26 recordings</span>
  </div>
  ...
  <p class="trace-viewer-caption">
    ...
    <strong>11 subjects and 26 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000310" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000310&sub=1&ses=0&task=ssvep&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000310 — sub-1 · ses-0 · task-ssvep · run-0"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000310). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000310" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000310/code/nm000310_histogram.png"
      alt="NEMAR pipeline statistics — NM000310"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000310/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000310"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000310">
  <div class="ee-bar">
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000310</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>GuttmannFlury2025_SSVEP</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000310</code> · <code>GuttmannFlury2025_SSVEP</code></span></div>
...
* [eegdash.dataset.NM000124](eegdash.dataset.NM000124.md)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000310</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000310.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000310">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.1038/s41597-025-04861-9">10.1038/s41597-025-04861-9</a></b></div></footer>
