...
```none
saved: /tmp/eegdash_save_dco9h63l/windows
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0158, read_s=0.0121, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_dco9h63l/windows/0 already exists. Please select
