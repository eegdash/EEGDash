...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006110</b></div><div>Iss. 6110 · 65 subjects · 124 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · PsiConnect</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006110</dd><dt>Version</dt><dd>v1.2.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2025.04.11.643415">10.1101/2025.04.11.643415</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>65</dd><dt>Recordings</dt><dd>124</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>66 (117), 67 (7)</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>46.3 h</dd><dt>Size</dt><dd>935.7 GB</dd><dt>Tasks</dt><dd><code>series</code></dd><dt>Sessions</dt><dd>2 · <code>01</code> · <code>02</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006110</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006110.v1.2.0">10.18112/openneuro.ds006110.v1.2.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006110">OpenNeuro</a><a href="https://doi.org/10.1101/2025.04.11.643415">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/DS006110.croissant.json" download>Croissant</a></div></aside>

# DS006110: eeg dataset, 65 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"PsiConnect","alternateName":"DS006110","description":"PsiConnect. eeg dataset accessible via EEGDash as \`\`DS006110\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006110.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006110.v1.2.0","sameAs":["https://doi.org/10.18112/openneuro.ds006110.v1.2.0","https://openneuro.org/datasets/ds006110","https://nemar.org/dataexplorer/detail?dataset_id=ds006110"],"creator":[{"@type":"Person","name":"Adeel Razi"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2025-01-01"}</script>

*PsiConnect*

**Citation:** Adeel Razi (2025). *PsiConnect*. [10.18112/openneuro.ds006110.v1.2.0](https://doi.org/10.18112/openneuro.ds006110.v1.2.0)

<p class="eegdash-ed-deck">65-participant EEG dataset — PsiConnect.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Adeel Razi</strong><br/><span class="role">Year</span> 2025 · Distributed via OpenNeuro<br/><span class="role">Funding</span> Australian Research Council (Refs: DE170100128 and DP200100757) · Australian National Health and Medical Research Council (Investigator Grant 1194910) · + 2 more</div><div class="eegdash-ed-pills"><span class="pill">EEG · 66 (117), 67 (7) ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill">Task · series</span><span class="pill">2 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
- Novelli, L. et al. (2025). PsiConnect: A Multimodal Neuroimaging Study of Psilocybin-Induced Changes in Brain and Behaviour. [https://doi.org/10.1101/2025.04.11.643415](https://doi.org/10.1101/2025.04.11.643415)
- Stoliker, D. et al. (2025). Psychedelics Align Brain Activity with Context. 2025. [https://doi.org/10.1101/2025.03.09.642197](https://doi.org/10.1101/2025.03.09.642197)
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=65, range 19–54 yr, mean 37.8 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=2"><div style="width:100%; height:27px; background:#6b7785; flex-shrink:0;" title="15-19: other n=2"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=9"><div style="width:100%; height:124px; background:#6b7785; flex-shrink:0;" title="20-24: other n=9"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=7"><div style="width:100%; height:96px; background:#6b7785; flex-shrink:0;" title="25-29: other n=7"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=6"><div style="width:100%; height:83px; background:#6b7785; flex-shrink:0;" title="30-34: other n=6"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="35-39: n=8"><div style="width:100%; height:110px; background:#6b7785; flex-shrink:0;" title="35-39: other n=8"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="40-44: n=10"><div style="width:100%; height:138px; background:#6b7785; flex-shrink:0;" title="40-44: other n=10"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="45-49: n=13"><div style="width:100%; height:180px; background:#6b7785; flex-shrink:0;" title="45-49: other n=13"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="50-54: n=10"><div style="width:100%; height:138px; background:#6b7785; flex-shrink:0;" title="50-54: other n=10"></div></div>
  </div>
  ...
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#6b7785; display:inline-block;"></i>Other · 65</span></div>
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#009E73; flex-shrink:0;" title="66 ch: 117"></div><div style="width:28px; height:5%; background:#009E73; flex-shrink:0;" title="67 ch: 7"></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
  ...
  <p><strong>Sampling frequencies</strong>: 500.0 Hz (n=124 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">66 (117), 67 (7) ch · EEG · 500 Hz · 65 subjects, 124 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-PC211 · ses-02 · task-series</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>65 subjects and 124 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006110" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006110&sub=PC211&ses=02&task=series&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006110 — sub-PC211 · ses-02 · task-series"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — EEG · 64 sensors — 64 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=94bb3fb583af963e&embed=1"
    loading="lazy"
    width="100%" height="640"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds006110). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds006110" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds006110/code/ds006110_histogram.png"
      alt="NEMAR pipeline statistics — DS006110"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds006110/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS006110"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds006110">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `DS006110`                                                                                                                |
| Year           | 2025                                                                                                                      |
| Authors        | Adeel Razi                                                                                                                |
| License        | CC0                                                                                                                       |
| Citation / DOI | [doi:10.18112/openneuro.ds006110.v1.2.0](https://doi.org/10.18112/openneuro.ds006110.v1.2.0)                              |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006110) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006110) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006110</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006110</code></span></div>
