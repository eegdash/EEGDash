...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS004819</b></div><div>Iss. 4819 · 1 subjects · 8 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Flexible, Scalable, High Channel Count Stereo-Electrode for R…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS004819</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Updated</dt><dd>2023-10-26</dd><dt>Contact</dt><dd>Angelique Paulk</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>1</dd><dt>Recordings</dt><dd>8</dd><dt>Modality</dt><dd>iEEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>30000 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>688.7 MB</dd><dt>Tasks</dt><dd><code>BaselineandStimRecordingRAWEDF</code></dd><dt>Sessions</dt><dd><code>postimp</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd>events · channels · electrodes</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds004819</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="surgery">Surgery</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds004819">EEGDash/ds004819</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds004819.v1.0.0">10.18112/openneuro.ds004819.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds004819">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/ds004819">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS004819.croissant.json" download>Croissant</a></div></aside>
...
<p class="eegdash-ed-deck">1-participant iEEG dataset — Flexible, Scalable, High Channel Count Stereo-Electrode for Recording in the Human Brain.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Keundong Lee</strong> · <strong>Angelique C. Paulk</strong> · Yun Goo Ro · Daniel R. Cleary · Karen J. Tonsfeldt · Yoav Kfir · …<br/><span class="role">Senior author</span> <strong>Shadi. A. Dayeh</strong><br/><span class="role">Year</span> 2023 · Distributed via OpenNeuro<br/><span class="role">Funding</span> NIH UG3NS123723-01 · NIH R01NS123655-01 · + 11 more</div><div class="eegdash-ed-pills"><span class="pill">iEEG · 64 ch</span><span class="pill">30000 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill">Task · BaselineandStimRecordingRAWEDF</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="surgery">Surgery</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=1, range 1–1 yr, mean 12.5 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="0-4: n=1"><div style="width:100%; height:180px; background:#006ca3; flex-shrink:0;" title="0-4: female n=1"></div></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">0</span>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">64 ch · iEEG · 30000 Hz · 1 subjects, 8 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-SS01MicrosEEG · ses-postimp · task-BaselineandStimRecordingRAWEDF · run-01</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>1 subjects and 8 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds004819" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_ieeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?ieeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds004819&sub=SS01MicrosEEG&ses=postimp&task=BaselineandStimRecordingRAWEDF&run=01&ext=edf&suffix=ieeg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live iEEG trace viewer for ds004819 — sub-SS01MicrosEEG · ses-postimp · task-BaselineandStimRecordingRAWEDF · run-01"
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS004819</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Lee2023</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS004819</code> · <code>Lee2023</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS004819</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS004819.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds004819">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds004819.v1.0.0">10.18112/openneuro.ds004819.v1.0.0</a></b></div></footer>
