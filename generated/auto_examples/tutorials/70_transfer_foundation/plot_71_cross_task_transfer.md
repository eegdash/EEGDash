...
```none
pretrain losses (RestingState): [0.059, 0.002, 0.0, 0.0, 0.0]
```
...
```none
finetune losses (CCD): [0.555, 0.46, 0.396, 0.349, 0.317]
```
...
```none
finetune=0.600 | scratch=0.567 | chance=0.533 | metric=accuracy | gap=+0.033
```
...
RestingState                    0.217         0.067         0.067
surroundSupp                    0.417         0.067         0.067
symbolSearch                    0.250         0.067         0.067
```
...
{"encoder_weights_path": "plot_71_pretrained_encoder.pt", "pretext_subjects": 8, "target_subjects": 8, "transfer_gap": 0.0333, "transfer_matrix_mean_delta": 0.1426}
```
