...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:80px; border-bottom:1px solid #34404e;">
    <div style="width:28px; height:80px; background:#006ca3; flex-shrink:0;" title="5-9: 90"></div><div style="width:28px; height:42px; background:#006ca3; flex-shrink:0;" title="10-14: 48"></div><div style="width:28px; height:10px; background:#006ca3; flex-shrink:0;" title="15-19: 12"></div>
  </div>
