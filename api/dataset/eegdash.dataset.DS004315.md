...
- Duration (hours): 21.10388888888889
...
- Source: openneuro
- OpenNeuro: [ds004315](https://openneuro.org/datasets/ds004315)
- NeMAR: [ds004315](https://nemar.org/dataexplorer/detail?dataset_id=ds004315)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=50, range 19–55 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:9%; background:#4472c4; flex-shrink:0;" title="15-19: 1"></div><div style="width:28px; height:54%; background:#4472c4; flex-shrink:0;" title="20-24: 6"></div><div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="25-29: 11"></div><div style="width:28px; height:45%; background:#4472c4; flex-shrink:0;" title="30-34: 5"></div><div style="width:28px; height:90%; background:#4472c4; flex-shrink:0;" title="35-39: 10"></div><div style="width:28px; height:63%; background:#4472c4; flex-shrink:0;" title="40-44: 7"></div><div style="width:28px; height:36%; background:#4472c4; flex-shrink:0;" title="45-49: 4"></div><div style="width:28px; height:36%; background:#4472c4; flex-shrink:0;" title="50-54: 4"></div><div style="width:28px; height:18%; background:#4472c4; flex-shrink:0;" title="55-59: 2"></div>
  </div>
  ...
  <div style="display:flex; height:22px; width:100%; max-width:400px; border-radius:4px; overflow:hidden;">
    <div style="width:56.0%; background:#e07ab5; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Female: 28">28</div><div style="width:44.0%; background:#4472c4; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Male: 22">22</div>
  </div>
...
Use the `DS004315` class to access this dataset programmatically.
