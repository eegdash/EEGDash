...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000120</b></div><div>Iss. 120 · 11 subjects · 55 recordings · ODC-By-1.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Oikonomou2016 – SSVEP MAMEM 2 dataset</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000120</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>ODC-By-1.0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.48550/arxiv.1602.00904">10.48550/arxiv.1602.00904</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>11</dd><dt>Recordings</dt><dd>55</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>256</dd><dt>Sample rate</dt><dd>250 Hz</dd><dt>Duration</dt><dd>5.1 h</dd><dt>Size</dt><dd>4.4 GB</dd><dt>Tasks</dt><dd><code>ssvep</code></dd><dt>Sessions</dt><dd><code>0</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000120</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000120">10.82901/nemar.nm000120</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000120">OpenNeuro</a><a href="https://doi.org/10.48550/arxiv.1602.00904">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/NM000120.croissant.json" download>Croissant</a></div></aside>

# NM000120: eeg dataset, 11 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Oikonomou2016 – SSVEP MAMEM 2 dataset","alternateName":"NM000120","description":"Oikonomou2016 – SSVEP MAMEM 2 dataset. eeg dataset accessible via EEGDash as \`\`NM000120\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000120.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.nm000120","sameAs":["https://doi.org/10.82901/nemar.nm000120","https://openneuro.org/datasets/nm000120","https://nemar.org/dataexplorer/detail?dataset_id=nm000120"],"creator":[{"@type":"Person","name":"Vangelis P. Oikonomou"},{"@type":"Person","name":"Georgios Liaros"},{"@type":"Person","name":"Kostantinos Georgiadis"},{"@type":"Person","name":"Elisavet Chatzilari"},{"@type":"Person","name":"Katerina Adam"},{"@type":"Person","name":"Spiros Nikolopoulos"},{"@type":"Person","name":"Ioannis Kompatsiaris"}],"license":"ODC-By-1.0","datePublished":"2016-01-01"}</script>

*Oikonomou2016 – SSVEP MAMEM 2 dataset*

**Citation:** Vangelis P. Oikonomou, Georgios Liaros, Kostantinos Georgiadis, Elisavet Chatzilari, Katerina Adam, Spiros Nikolopoulos, Ioannis Kompatsiaris (2016). *Oikonomou2016 – SSVEP MAMEM 2 dataset*. [10.82901/nemar.nm000120](https://doi.org/10.82901/nemar.nm000120)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-6 · ses-0 · task-ssvep · run-4</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>11 subjects and 55 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000120" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000120&sub=6&ses=0&task=ssvep&run=4&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000120 — sub-6 · ses-0 · task-ssvep · run-4"
...
| License        | ODC-By-1.0                                                                                                                                    |
| Citation / DOI | [10.82901/nemar.nm000120](https://doi.org/10.82901/nemar.nm000120)                                                                            |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000120) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000120)                     |
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000120</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000120.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>ODC-By-1.0 · <b><a href="https://doi.org/10.82901/nemar.nm000120">10.82901/nemar.nm000120</a></b></div></footer>
