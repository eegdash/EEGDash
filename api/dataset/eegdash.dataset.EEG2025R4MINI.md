...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>EEG2025R4MINI</b></div><div>Iss. 20254 · 20 subjects · 240 recordings · CC-BY-SA 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Healthy Brain Network (HBN) EEG - Release 4 (BDF Converted)</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>EEG2025R4MINI</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-SA 4.0</dd><dt>Updated</dt><dd>2024-10-04</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>20</dd><dt>Recordings</dt><dd>240</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>129</dd><dt>Sample rate</dt><dd>100 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>3.3 GB</dd><dt>Tasks</dt><dd>10 tasks · <code>DespicableMe</code> · <code>DiaryOfAWimpyKid</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="development">Development</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/eeg2025r4mini">EEGDash/eeg2025r4mini</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005508.v1.0.1">10.18112/openneuro.ds005508.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/eeg2025r4mini">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/eeg2025r4mini">🤗 HF</a><a href="../../_static/dataset_generated/croissant/EEG2025R4MINI.croissant.json" download>Croissant</a></div></aside>

# EEG2025R4MINI: eeg dataset, 20 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Healthy Brain Network (HBN) EEG - Release 4 (BDF Converted)","alternateName":"EEG2025R4MINI","description":"Healthy Brain Network (HBN) EEG - Release 4 (BDF Converted). eeg dataset accessible via EEGDash as \`\`EEG2025R4MINI\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.EEG2025R4MINI.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds005508.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds005508.v1.0.1","https://openneuro.org/datasets/eeg2025r4mini","https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r4mini","https://nemar.org/dataexplorer/detail/EEG2025r4mini"],"creator":[{"@type":"Person","name":"Seyed Yahya Shirazi"},{"@type":"Person","name":"Alexandre Franco"},{"@type":"Person","name":"Maurício Scopel Hoffmann"},{"@type":"Person","name":"Nathalia B. Esper"},{"@type":"Person","name":"Dung Truong"},{"@type":"Person","name":"Arnaud Delorme"},{"@type":"Person","name":"Michael Milham"},{"@type":"Person","name":"Scott Makeig"}],"license":"https://creativecommons.org/licenses/by-sa/4.0/","datePublished":"2024-01-01"}</script>
...
```python
dataset = EEG2025R4MINI(cache_dir="./data", subject="01")
```
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=20, range 5–15 yr, mean 9.3 yr · sex per subject not reported)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="5-9: 12"></div><div style="flex:1 1 0; min-width:0; height:90px; background:#006ca3;" title="10-14: 6"></div><div style="flex:1 1 0; min-width:0; height:30px; background:#006ca3;" title="15-19: 2"></div>
  </div>
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r4mini). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r4mini" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/eeg2025r4mini/code/eeg2025r4mini_histogram.png"
      alt="NEMAR pipeline statistics — EEG2025R4MINI"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/eeg2025r4mini/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — EEG2025R4MINI"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="eeg2025r4mini">
  <div class="ee-bar">
...
|----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Title          | Healthy Brain Network (HBN) EEG - Release 4 (BDF Converted)                                                                                                                                             |
| Author (year)  | `Shirazi2024_R4_bdf_mini`                                                                                                                                                                               |
| Canonical      | `HBN_r4_bdf_mini`                                                                                                                                                                                       |
| Importable as  | `EEG2025R4MINI`, `Shirazi2024_R4_bdf_mini`, `HBN_r4_bdf_mini`                                                                                                                                           |
| Year           | 2024                                                                                                                                                                                                    |
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/eeg2025r4mini) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r4mini) | [Source URL](https://nemar.org/dataexplorer/detail/EEG2025r4mini) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">EEG2025R4MINI</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Shirazi2024_R4_bdf_mini</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v"><code>HBN_r4_bdf_mini</code></span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>EEG2025R4MINI</code> · <code>Shirazi2024_R4_bdf_mini</code> · <code>HBN_r4_bdf_mini</code></span></div>
...
OpenNeuro dataset: [https://openneuro.org/datasets/EEG2025r4mini](https://openneuro.org/datasets/EEG2025r4mini)
NeMAR dataset: [https://nemar.org/dataexplorer/detail?dataset_id=EEG2025r4mini](https://nemar.org/dataexplorer/detail?dataset_id=EEG2025r4mini)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — EEG2025R4MINI</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/EEG2025R4MINI.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/eeg2025r4mini">Hugging Face mirror</a></div><div>CC-BY-SA 4.0 · <b><a href="https://doi.org/10.18112/openneuro.ds005508.v1.0.1">10.18112/openneuro.ds005508.v1.0.1</a></b></div></footer>
