...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000115</b></div><div>Iss. 115 · 4 subjects · 24 recordings · CC-BY-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Zhou2016</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000115</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-4.0</dd><dt>Updated</dt><dd>2026-03-03</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>4</dd><dt>Recordings</dt><dd>24</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>14</dd><dt>Sample rate</dt><dd>250 Hz</dd><dt>Duration</dt><dd>6.3 h</dd><dt>Size</dt><dd>152.1 MB</dd><dt>Tasks</dt><dd><code>imagery</code></dd><dt>Sessions</dt><dd>3 · <code>0</code> · <code>1</code> · <code>2</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000115</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000115">EEGDash/nm000115</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000115">10.82901/nemar.nm000115</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000115">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000115">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000115.croissant.json" download>Croissant</a></div></aside>

# NM000115: eeg dataset, 4 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Zhou2016","alternateName":"NM000115","description":"Zhou2016. eeg dataset accessible via EEGDash as \`\`NM000115\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000115.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.nm000115","sameAs":["https://doi.org/10.82901/nemar.nm000115","https://openneuro.org/datasets/nm000115","https://nemar.org/dataexplorer/detail?dataset_id=nm000115","https://nemar.org/dataexplorer/detail/nm000115"],"creator":[{"@type":"Person","name":"Bangyan Zhou"},{"@type":"Person","name":"Xiaopei Wu"},{"@type":"Person","name":"Zongtan Lv"},{"@type":"Person","name":"Lei Zhang"},{"@type":"Person","name":"Xiaojin Guo"}],"license":"https://creativecommons.org/licenses/by/4.0/","datePublished":"2016-01-01"}</script>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">14 ch · EEG · 250 Hz · 4 subjects, 24 recordings</span>
  </div>
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/nm000115" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000115&sub=1&ses=2&task=imagery&run=1&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000115 — sub-1 · ses-2 · task-imagery · run-1"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — EEG · 14 sensors — 14 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=8e33b38a66763dcd&embed=1"
    loading="lazy"
    width="100%" height="640"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000115). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000115" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000115/code/nm000115_histogram.png"
      alt="NEMAR pipeline statistics — NM000115"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000115/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000115"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000115">
  <div class="ee-bar">
...
|----------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Title          | Zhou2016                                                                                                                                                                                 |
| Author (year)  | `Zhou2016`                                                                                                                                                                               |
| Canonical      | —                                                                                                                                                                                        |
| Importable as  | `NM000115`, `Zhou2016`                                                                                                                                                                   |
| Year           | 2016                                                                                                                                                                                     |
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000115) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000115) | [Source URL](https://nemar.org/dataexplorer/detail/nm000115) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000115</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Zhou2016</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000115</code> · <code>Zhou2016</code></span></div>
...
OpenNeuro dataset: [https://openneuro.org/datasets/nm000115](https://openneuro.org/datasets/nm000115)
NeMAR dataset: [https://nemar.org/dataexplorer/detail?dataset_id=nm000115](https://nemar.org/dataexplorer/detail?dataset_id=nm000115)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000115</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000115.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000115">Hugging Face mirror</a></div><div>CC-BY-4.0 · <b><a href="https://doi.org/10.82901/nemar.nm000115">10.82901/nemar.nm000115</a></b></div></footer>
