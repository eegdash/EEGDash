...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006334</b></div><div>Iss. 6334 · 30 subjects · 128 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Neocortical and Hippocampal Theta Oscillations Track Audiovis…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006334</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1523/jneurosci.1797-24.2025">10.1523/jneurosci.1797-24.2025</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>30</dd><dt>Recordings</dt><dd>128</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>331 (74), 332 (54)</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>36.7 h</dd><dt>Size</dt><dd>171.9 GB</dd><dt>Tasks</dt><dd><code>AVspeech</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.0.2</dd><dt>Sidecars</dt><dd>events · channels · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006334</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="memory">Memory</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006334">EEGDash/ds006334</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006334.v1.0.0">10.18112/openneuro.ds006334.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006334">OpenNeuro</a><a href="https://doi.org/10.1523/jneurosci.1797-24.2025">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006334">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006334.croissant.json" download>Croissant</a></div></aside>
...
<p class="eegdash-ed-deck">30-participant MEG dataset — Neocortical and Hippocampal Theta Oscillations Track Audiovisual Integration and Replay of Speech Memories.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Biau E</strong> · <strong>Wang D</strong> · Park H · Jensen O · Hanslmayr S<br/><span class="role">Year</span> 2025 · Distributed via OpenNeuro<br/><span class="role">Funding</span> Sir Henry Wellcome Fellowship (210924/Z/18/Z) · European Research Council (Consolidator Grant 647954) · + 1 more</div><div class="eegdash-ed-pills"><span class="pill">MEG · 331 (74), 332 (54) ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.0.2</span><span class="pill">Task · AVspeech</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="memory">Memory</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=30, range 19–31 yr, mean 23.8 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=1"><div style="width:100%; height:9px; background:#006ca3; flex-shrink:0;" title="15-19: female n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=19"><div style="width:100%; height:85px; background:#006ca3; flex-shrink:0;" title="20-24: female n=9"></div><div style="width:100%; height:94px; background:#f7941d; flex-shrink:0;" title="20-24: male n=10"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=8"><div style="width:100%; height:18px; background:#006ca3; flex-shrink:0;" title="25-29: female n=2"></div><div style="width:100%; height:56px; background:#f7941d; flex-shrink:0;" title="25-29: male n=6"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=2"><div style="width:100%; height:9px; background:#006ca3; flex-shrink:0;" title="30-34: female n=1"></div><div style="width:100%; height:9px; background:#f7941d; flex-shrink:0;" title="30-34: male n=1"></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">331 (74), 332 (54) ch · MEG · 1000 Hz · 30 subjects, 128 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-13 · task-AVspeech · run-4</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>30 subjects and 128 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006334" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_meg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?meg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006334&sub=13&task=AVspeech&run=4&ext=fif&suffix=meg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live MEG trace viewer for ds006334 — sub-13 · task-AVspeech · run-4"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006334) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006334) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006334</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Biau2025</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006334</code> · <code>Biau2025</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006334</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006334.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006334">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006334.v1.0.0">10.18112/openneuro.ds006334.v1.0.0</a></b></div></footer>
