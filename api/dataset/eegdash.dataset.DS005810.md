...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005810</b></div><div>Iss. 5810 · 31 subjects · 305 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · NOD-MEG</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005810</dd><dt>Version</dt><dd>v2.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-025-05174-7">10.1038/s41597-025-05174-7</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>31</dd><dt>Recordings</dt><dd>305</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>409 (285), 378 (20)</dd><dt>Sample rate</dt><dd>1200 Hz</dd><dt>Duration</dt><dd>25.5 h</dd><dt>Size</dt><dd>215.1 GB</dd><dt>Tasks</dt><dd><code>ImageNet</code> · <code>noise</code></dd><dt>Sessions</dt><dd>24 · <code>20210413</code> … <code>ImageNet04</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.10.1</dd><dt>Sidecars</dt><dd>events · events.json · channels · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005810</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005810">EEGDash/ds005810</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005810.v2.0.0">10.18112/openneuro.ds005810.v2.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005810">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-025-05174-7">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds005810">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005810.croissant.json" download>Croissant</a></div></aside>

# DS005810: meg dataset, 31 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"NOD-MEG","alternateName":"DS005810","description":"NOD-MEG. meg dataset accessible via EEGDash as \`\`DS005810\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS005810.html","keywords":["meg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds005810.v2.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds005810.v2.0.0","https://openneuro.org/datasets/ds005810","https://nemar.org/dataexplorer/detail?dataset_id=ds005810"],"creator":[{"@type":"Person","name":"Guohao Zhang"},{"@type":"Person","name":"Ming Zhou"},{"@type":"Person","name":"Shuyi Zhen"},{"@type":"Person","name":"Shaohua Tang"},{"@type":"Person","name":"Zheng Li"},{"@type":"Person","name":"Zonglei Zhen"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2018-01-01"}</script>

*NOD-MEG*

**Citation:** Guohao Zhang, Ming Zhou, Shuyi Zhen, Shaohua Tang, Zheng Li, Zonglei Zhen (2018). *NOD-MEG*. [10.18112/openneuro.ds005810.v2.0.0](https://doi.org/10.18112/openneuro.ds005810.v2.0.0)

<p class="eegdash-ed-deck">31-participant MEG dataset — NOD-MEG.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Guohao Zhang</strong> · <strong>Ming Zhou</strong> · Shuyi Zhen · Shaohua Tang · Zheng Li · Zonglei Zhen<br/><span class="role">Year</span> 2018 · Distributed via OpenNeuro<br/><span class="role">Funding</span> Beijing Natural Science Foundation (#L247010) · National Natural Science Foundation of China (#62433015, #31771251) · + 1 more</div><div class="eegdash-ed-pills"><span class="pill">MEG · 409 (285), 378 (20) ch</span><span class="pill">1200 Hz</span><span class="pill is-info">BIDS 1.10.1</span><span class="pill">2 tasks</span><span class="pill">24 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=30, range 18–26 yr, mean 21.2 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=5"><div style="width:100%; height:23px; background:#006ca3; flex-shrink:0;" title="15-19: female n=3"></div><div style="width:100%; height:15px; background:#f7941d; flex-shrink:0;" title="15-19: male n=2"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=23"><div style="width:100%; height:101px; background:#006ca3; flex-shrink:0;" title="20-24: female n=13"></div><div style="width:100%; height:78px; background:#f7941d; flex-shrink:0;" title="20-24: male n=10"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=2"><div style="width:100%; height:7px; background:#006ca3; flex-shrink:0;" title="25-29: female n=1"></div><div style="width:100%; height:7px; background:#f7941d; flex-shrink:0;" title="25-29: male n=1"></div></div>
  </div>
  ...
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 17</span><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#f7941d; display:inline-block;"></i>Male · 13</span></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">409 (285), 378 (20) ch · MEG · 1200 Hz · 31 subjects, 305 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-13 · ses-ImageNet01 · task-ImageNet · run-01</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>31 subjects and 305 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds005810" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_meg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?meg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds005810&sub=13&ses=ImageNet01&task=ImageNet&run=01&ext=fif&suffix=meg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live MEG trace viewer for ds005810 — sub-13 · ses-ImageNet01 · task-ImageNet · run-01"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — MEG · 273 sensors — 273 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=da5ff8cd2ea1a0bf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 900px; display: block;"
    title="Topomap of MEG · 273 sensors"
    referrerpolicy="no-referrer">
  </iframe>
</details></div></div></div>
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds005810) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds005810) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS005810</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Zhang2025_MEG</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS005810</code> · <code>Zhang2025_MEG</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS005810</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS005810.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds005810">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds005810.v2.0.0">10.18112/openneuro.ds005810.v2.0.0</a></b></div></footer>
