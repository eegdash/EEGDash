...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS004075</b></div><div>Iss. 4075 · 29 subjects · 116 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · what_are_we_talking_about</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS004075</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2024.12.12.628085">10.1101/2024.12.12.628085</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>29</dd><dt>Recordings</dt><dd>116</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>7.4 GB</dd><dt>Tasks</dt><dd>4 tasks · <code>context03</code> · <code>context09</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>v1.7.0</dd><dt>Sidecars</dt><dd>eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds004075</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds004075">EEGDash/ds004075</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds004075.v1.0.0">10.18112/openneuro.ds004075.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds004075">OpenNeuro</a><a href="https://doi.org/10.1101/2024.12.12.628085">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds004075">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS004075.croissant.json" download>Croissant</a></div></aside>

# DS004075: eeg dataset, 29 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"what_are_we_talking_about","alternateName":"DS004075","description":"what_are_we_talking_about. eeg dataset accessible via EEGDash as \`\`DS004075\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS004075.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds004075.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds004075.v1.0.0","https://openneuro.org/datasets/ds004075","https://nemar.org/dataexplorer/detail?dataset_id=ds004075"],"creator":[{"@type":"Person","name":"Adam Boncz"},{"@type":"Person","name":"Brigitta Toth"},{"@type":"Person","name":"István Winkler"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*what_are_we_talking_about*

**Citation:** Adam Boncz, Brigitta Toth, István Winkler (—). *what_are_we_talking_about*. [10.18112/openneuro.ds004075.v1.0.0](https://doi.org/10.18112/openneuro.ds004075.v1.0.0)

<p class="eegdash-ed-deck">29-participant EEG dataset — what_are_we_talking_about.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Adam Boncz</strong> · <strong>Brigitta Toth</strong> · István Winkler<br/><span class="role">Funding</span> Hungarian Academy of Sciences, grant LP2012-36/2012 (IW) · National Research, Development and Innovation Office, Hungary, grant K132642 (IW) · + 1 more</div><div class="eegdash-ed-pills"><span class="pill">EEG · 64 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS v1.7.0</span><span class="pill">4 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 64 ch (n=115 recordings)</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">64 ch · EEG · 1000 Hz · 29 subjects, 116 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-13 · task-context09 · run-04</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds004075" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds004075&sub=13&task=context09&run=04&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds004075 — sub-13 · task-context09 · run-04"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds004075). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds004075" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds004075/code/ds004075_histogram.png"
      alt="NEMAR pipeline statistics — DS004075"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds004075/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS004075"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds004075">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds004075) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds004075) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS004075</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Boncz2022</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS004075</code> · <code>Boncz2022</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS004075</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS004075.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds004075">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds004075.v1.0.0">10.18112/openneuro.ds004075.v1.0.0</a></b></div></footer>
