...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000222</b></div><div>Iss. 222 · 10 subjects · 305 recordings · CC-BY-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Air conditioner control experiment (10 subjects, 4 classes, 2…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000222</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-4.0</dd><dt>Updated</dt><dd>2026-03-25</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>10</dd><dt>Recordings</dt><dd>305</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>25</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>3.2 h</dd><dt>Size</dt><dd>415.3 MB</dd><dt>Tasks</dt><dd><code>p300</code></dd><dt>Sessions</dt><dd><code>0</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000222</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000222">EEGDash/nm000222</a></dd></dl><div class="actions"><a href="https://openneuro.org/datasets/nm000222">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000222">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000222.croissant.json" download>Croissant</a></div></aside>

# NM000222: eeg dataset, 10 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Air conditioner control experiment (10 subjects, 4 classes, 25 EEG ch)","alternateName":"NM000222","description":"Air conditioner control experiment (10 subjects, 4 classes, 25 EEG ch). eeg dataset accessible via EEGDash as \`\`NM000222\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000222.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"sameAs":["https://openneuro.org/datasets/nm000222","https://nemar.org/dataexplorer/detail?dataset_id=nm000222","https://nemar.org/dataexplorer/detail/nm000222"],"creator":[{"@type":"Person","name":"Jongmin Lee"},{"@type":"Person","name":"Minju Kim"},{"@type":"Person","name":"Dojin Heo"},{"@type":"Person","name":"Jongsu Kim"},{"@type":"Person","name":"Min-Ki Kim"},{"@type":"Person","name":"Taejun Lee"},{"@type":"Person","name":"Jongwoo Park"},{"@type":"Person","name":"HyunYoung Kim"},{"@type":"Person","name":"Minho Hwang"},{"@type":"Person","name":"Laehyun Kim"},{"@type":"Person","name":"Sung-Phil Kim"}],"license":"https://creativecommons.org/licenses/by/4.0/","datePublished":"2019-01-01"}</script>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=10, range 22–22 yr, mean 22.0 yr)</p>
  ...
  <p><strong>Channel counts</strong>: 25 ch (n=305 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 500.0 Hz (n=305 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 3 h 11 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">25 ch · EEG · 500 Hz · 10 subjects, 305 recordings</span>
  </div>
  ...
  <p class="trace-viewer-caption">
    ...
    <strong>10 subjects and 305 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000222" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000222&sub=6&ses=0&task=p300&run=15&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000222 — sub-6 · ses-0 · task-p300 · run-15"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000222). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000222" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000222/code/nm000222_histogram.png"
      alt="NEMAR pipeline statistics — NM000222"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000222/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000222"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000222">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000222) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000222) | [Source URL](https://nemar.org/dataexplorer/detail/nm000222) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000222</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Lee2024_Air_conditioner_control</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000222</code> · <code>Lee2024_Air_conditioner_control</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000222</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000222.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000222">Hugging Face mirror</a></div><div>CC-BY-4.0 · <b><span style="opacity:.6">DOI not on file</span></b></div></footer>
