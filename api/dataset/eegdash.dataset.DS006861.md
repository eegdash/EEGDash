...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006861</b></div><div>Iss. 6861 · 120 subjects · 239 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Targeted Neuromodulation of the Left Dorsolateral Prefrontal…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006861</dd><dt>Version</dt><dd>v1.0.2</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1016/j.biopsycho.2025.109175">10.1016/j.biopsycho.2025.109175</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>120</dd><dt>Recordings</dt><dd>239</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>37</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>99.6 h</dd><dt>Size</dt><dd>53.6 GB</dd><dt>Tasks</dt><dd><code>EmotionProcessingandRegulationtask</code></dd><dt>Sessions</dt><dd>2 · <code>1</code> · <code>2</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006861</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006861">EEGDash/ds006861</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006861.v1.0.2">10.18112/openneuro.ds006861.v1.0.2</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006861">OpenNeuro</a><a href="https://doi.org/10.1016/j.biopsycho.2025.109175">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006861">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006861.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=120, range 18–35 yr, mean 24.1 yr · sex per subject not reported)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="flex:1 1 0; min-width:0; height:57px; background:#006ca3;" title="15-19: 18"></div><div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="20-24: 56"></div><div style="flex:1 1 0; min-width:0; height:93px; background:#006ca3;" title="25-29: 29"></div><div style="flex:1 1 0; min-width:0; height:41px; background:#006ca3;" title="30-34: 13"></div><div style="flex:1 1 0; min-width:0; height:12px; background:#006ca3;" title="35-39: 4"></div>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">37 ch · EEG · 1000 Hz · 120 subjects, 239 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-021 · ses-2 · task-EmotionProcessingandRegulationtask</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>120 subjects and 239 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006861" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006861&sub=021&ses=2&task=EmotionProcessingandRegulationtask&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006861 — sub-021 · ses-2 · task-EmotionProcessingandRegulationtask"
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006861</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Maka2025_Targeted</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006861</code> · <code>Maka2025_Targeted</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006861</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006861.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006861">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006861.v1.0.2">10.18112/openneuro.ds006861.v1.0.2</a></b></div></footer>
