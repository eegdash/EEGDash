...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003774</b></div><div>Iss. 3774 · 20 subjects · 240 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Music Listening- Genre EEG dataset (MUSIN-G)</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003774</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1016/j.dib.2022.108663">10.1016/j.dib.2022.108663</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>20</dd><dt>Recordings</dt><dd>240</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>129</dd><dt>Sample rate</dt><dd>250, 1000 Hz</dd><dt>Duration</dt><dd>8.6 h</dd><dt>Size</dt><dd>10.1 GB</dd><dt>Tasks</dt><dd><code>MusicListening</code></dd><dt>Sessions</dt><dd>12 · <code>01</code> … <code>12</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.1.1</dd><dt>Sidecars</dt><dd>events · events.json · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003774</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003774">EEGDash/ds003774</a></dd><dt>Citations</dt><dd>8</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003774.v1.0.0">10.18112/openneuro.ds003774.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003774">OpenNeuro</a><a href="https://doi.org/10.1016/j.dib.2022.108663">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003774">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003774.croissant.json" download>Croissant</a></div></aside>

# DS003774: eeg dataset, 20 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Music Listening- Genre EEG dataset (MUSIN-G)","alternateName":"DS003774","description":"Music Listening- Genre EEG dataset (MUSIN-G). eeg dataset accessible via EEGDash as \`\`DS003774\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS003774.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds003774.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds003774.v1.0.0","https://openneuro.org/datasets/ds003774","https://nemar.org/dataexplorer/detail?dataset_id=ds003774"],"creator":[{"@type":"Person","name":"Krishna Prasad Miyapuram"},{"@type":"Person","name":"Pankaj Pandey"},{"@type":"Person","name":"Nashra Ahmad"},{"@type":"Person","name":"Bharatesh R Shiraguppi"},{"@type":"Person","name":"Esha Sharma"},{"@type":"Person","name":"Prashant Lawhatre"},{"@type":"Person","name":"Dhananjay Sonawane"},{"@type":"Person","name":"Derek Lomas"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Music Listening- Genre EEG dataset (MUSIN-G)*

**Citation:** Krishna Prasad Miyapuram, Pankaj Pandey, Nashra Ahmad, Bharatesh R Shiraguppi, Esha Sharma, Prashant Lawhatre, Dhananjay Sonawane, Derek Lomas (—). *Music Listening- Genre EEG dataset (MUSIN-G)*. [10.18112/openneuro.ds003774.v1.0.0](https://doi.org/10.18112/openneuro.ds003774.v1.0.0)

<p class="eegdash-ed-deck">20-participant EEG dataset — Music Listening- Genre EEG dataset (MUSIN-G).</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Krishna Prasad Miyapuram</strong> · <strong>Pankaj Pandey</strong> · Nashra Ahmad · Bharatesh R Shiraguppi · Esha Sharma · Prashant Lawhatre · …</div><div class="eegdash-ed-pills"><span class="pill">EEG · 129 ch</span><span class="pill">250, 1000 Hz</span><span class="pill is-info">BIDS 1.1.1</span><span class="pill">Task · MusicListening</span><span class="pill">12 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:81%; background:#D55E00; flex-shrink:0;" title="250 Hz: 108"></div><div style="width:28px; height:100%; background:#D55E00; flex-shrink:0;" title="1000 Hz: 132"></div>
  </div>
  ...
  <p><strong>Total recording duration</strong>: 8 h 38 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">129 ch · EEG · 250, 1000 Hz · 20 subjects, 240 recordings</span>
  </div>
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds003774). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds003774" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds003774/code/ds003774_histogram.png"
      alt="NEMAR pipeline statistics — DS003774"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds003774/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS003774"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds003774">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003774) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003774)                      |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003774</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Miyapuram2021</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003774</code> · <code>Miyapuram2021</code></span></div>
...
* [eegdash.dataset.DS005876](eegdash.dataset.DS005876.md)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003774</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003774.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003774">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003774.v1.0.0">10.18112/openneuro.ds003774.v1.0.0</a></b></div></footer>
