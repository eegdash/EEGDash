...
- Source: nemar
- OpenNeuro: [eeg2025r1mini](https://openneuro.org/datasets/eeg2025r1mini)
- NeMAR: [eeg2025r1mini](https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r1mini)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=20, range 6–13 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="5-9: 10"></div><div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="10-14: 10"></div>
  </div>
...
Use the `EEG2025R1MINI` class to access this dataset programmatically.
