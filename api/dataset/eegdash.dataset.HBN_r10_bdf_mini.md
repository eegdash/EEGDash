...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>HBN_r10_bdf_mini</b></div><div>Iss. 10 · — subjects · — recordings · See source</div></div><div class="eegdash-ed-kicker">Dataset Brief · HBN_r10_bdf_mini</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>HBN_r10_bdf_mini</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>See source</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>—</dd><dt>Recordings</dt><dd>—</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>Varies</dd><dt>Sample rate</dt><dd>Varies</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>—</dd><dt>Tasks</dt><dd>—</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>—</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>0% · Limited</dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="actions"><a href="https://openneuro.org/datasets/hbn_r10_bdf_mini">OpenNeuro</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/HBN_r10_bdf_mini.croissant.json" download>Croissant</a></div></aside>

# HBN_r10_bdf_mini: EEG dataset

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"HBN_R10_BDF_MINI","alternateName":"HBN_R10_BDF_MINI","description":"EEG dataset accessible via EEGDash as \`\`HBN_r10_bdf_mini\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.HBN_r10_bdf_mini.html","keywords":["EEG","BIDS","neuroscience","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"sameAs":["https://openneuro.org/datasets/hbn_r10_bdf_mini","https://nemar.org/dataexplorer/detail?dataset_id=hbn_r10_bdf_mini"]}</script>
...
```python
from eegdash.dataset import HBN_r10_bdf_mini

dataset = HBN_r10_bdf_mini(cache_dir="./data")
...
```python
dataset = HBN_r10_bdf_mini(cache_dir="./data", subject="01")
```
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=hbn_r10_bdf_mini). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=hbn_r10_bdf_mini" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/hbn_r10_bdf_mini/code/hbn_r10_bdf_mini_histogram.png"
      alt="NEMAR pipeline statistics — HBN_R10_BDF_MINI"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/hbn_r10_bdf_mini/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — HBN_R10_BDF_MINI"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="hbn_r10_bdf_mini">
  <div class="ee-bar">
...
| Dataset ID     | `HBN_R10_BDF_MINI`                                                                                                                        |
|----------------|-------------------------------------------------------------------------------------------------------------------------------------------|
| Title          | —                                                                                                                                         |
| Author (year)  | —                                                                                                                                         |
| Canonical      | —                                                                                                                                         |
| Importable as  | `HBN_R10_BDF_MINI`                                                                                                                        |
| Year           | —                                                                                                                                         |
| Authors        | Unknown                                                                                                                                   |
| License        | —                                                                                                                                         |
| Citation / DOI | Unknown                                                                                                                                   |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/hbn_r10_bdf_mini) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=hbn_r10_bdf_mini) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">HBN_r10_bdf_mini</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>HBN_R10_BDF_MINI</code></span></div>
