...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000251</b></div><div>Iss. 251 · 1 subjects · 6 recordings · CC BY 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · He et al. 2025 — VocalMind</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000251</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC BY 4.0</dd><dt>Updated</dt><dd>2026-04-12</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>1</dd><dt>Recordings</dt><dd>6</dd><dt>Modality</dt><dd>iEEG</dd><dt>Channels</dt><dd>110</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>1.1 h</dd><dt>Size</dt><dd>1.9 GB</dd><dt>Tasks</dt><dd><code>imagined</code> · <code>mimed</code> · <code>vocalized</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · channels</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000251</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000251">EEGDash/nm000251</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.1038/s41597-025-04741-2">10.1038/s41597-025-04741-2</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000251">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000251">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000251.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 110 ch (n=6 recordings)</p>
  ...
  <p><strong>Total recording duration</strong>: 1 h 7 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">110 ch · iEEG · 1000 Hz · 1 subjects, 6 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-01 · task-imagined</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/nm000251" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_ieeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?ieeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000251&sub=01&task=imagined&ext=vhdr&suffix=ieeg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live iEEG trace viewer for nm000251 — sub-01 · task-imagined"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000251). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000251" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000251/code/nm000251_histogram.png"
      alt="NEMAR pipeline statistics — NM000251"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000251/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000251"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000251">
  <div class="ee-bar">
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000251</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>He2025</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000251</code> · <code>He2025</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000251</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000251.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000251">Hugging Face mirror</a></div><div>CC BY 4.0 · <b><a href="https://doi.org/10.1038/s41597-025-04741-2">10.1038/s41597-025-04741-2</a></b></div></footer>
