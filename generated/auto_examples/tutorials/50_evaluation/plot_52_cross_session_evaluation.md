...
<!-- "generated/auto_examples/tutorials/50_evaluation/plot_52_cross_session_evaluation.py" -->
...
- Sklearn: [`sklearn.linear_model.LogisticRegression`](https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.LogisticRegression.html#sklearn.linear_model.LogisticRegression),
...
- Chevallier, Aristimunha et al. 2024
  ([https://doi.org/10.48550/arXiv.2404.15319](https://doi.org/10.48550/arXiv.2404.15319)), MOABB benchmark,
  cross-session evaluation, calibration drift.
- Cisotto & Chicco 2024 ([https://doi.org/10.7717/peerj-cs.2256](https://doi.org/10.7717/peerj-cs.2256)) –
  ten quick tips for clinical EEG, Tip 9.
- Delorme et al. 2022, NEMAR ([https://doi.org/10.1162/imag_a_00026](https://doi.org/10.1162/imag_a_00026))

> , BIDS metadata source for EEGDash queries.
- Jayaram & Barachant 2018
  ([https://doi.org/10.1088/1741-2552/aabea9](https://doi.org/10.1088/1741-2552/aabea9)), covariate shift and
  transfer learning in BCI calibration.

<a id="sphx-glr-download-generated-auto-examples-tutorials-50-evaluation-plot-52-cross-session-evaluation-py"></a>
