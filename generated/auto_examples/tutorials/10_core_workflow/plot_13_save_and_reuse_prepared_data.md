...
```none
saved: /tmp/eegdash_save_urg2nyhq/windows
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0166, read_s=0.0128, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_urg2nyhq/windows/0 already exists. Please select
