...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON003343</b></div><div>Iss. 3343 · 20 subjects · 59 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Disentangling the percepts of illusory movement and sensory s…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON003343</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1016/j.neuroimage.2021.118431">10.1016/j.neuroimage.2021.118431</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>20</dd><dt>Recordings</dt><dd>59</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>20</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>6.4 h</dd><dt>Size</dt><dd>663.7 MB</dd><dt>Tasks</dt><dd><code>fps</code></dd><dt>Sessions</dt><dd><code>01</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.4.1</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on003343</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on003343">10.82901/nemar.on003343</a></div><div class="actions"><a href="https://openneuro.org/datasets/on003343">OpenNeuro</a><a href="https://doi.org/10.1016/j.neuroimage.2021.118431">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON003343.croissant.json" download>Croissant</a></div></aside>

# ON003343: eeg dataset, 20 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Disentangling the percepts of illusory movement and sensory stimulation during tendon vibration in the EEG","alternateName":"ON003343","description":"Disentangling the percepts of illusory movement and sensory stimulation during tendon vibration in the EEG. eeg dataset accessible via EEGDash as \`\`ON003343\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON003343.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on003343","sameAs":["https://doi.org/10.82901/nemar.on003343","https://openneuro.org/datasets/on003343","https://nemar.org/dataexplorer/detail?dataset_id=on003343"],"creator":[{"@type":"Person","name":"Christoph Schneider"},{"@type":"Person","name":"Renaud Marquis"},{"@type":"Person","name":"Jane Johr"},{"@type":"Person","name":"Marina Da Silva Lopes"},{"@type":"Person","name":"Philippe Ryvlin"},{"@type":"Person","name":"Andrea Serino"},{"@type":"Person","name":"Marzia De Lucia"},{"@type":"Person","name":"Karin Diserens"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2003-01-01"}</script>

*Disentangling the percepts of illusory movement and sensory stimulation during tendon vibration in the EEG*

**Citation:** Christoph Schneider, Renaud Marquis, Jane Johr, Marina Da Silva Lopes, Philippe Ryvlin, Andrea Serino, Marzia De Lucia, Karin Diserens (2003). *Disentangling the percepts of illusory movement and sensory stimulation during tendon vibration in the EEG*. [10.82901/nemar.on003343](https://doi.org/10.82901/nemar.on003343)

<p class="eegdash-ed-deck">20-participant EEG dataset — Disentangling the percepts of illusory movement and sensory stimulation during tendon vibration in the EEG.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Christoph Schneider</strong> · <strong>Renaud Marquis</strong> · Jane Johr · Marina Da Silva Lopes · Philippe Ryvlin · Andrea Serino · …<br/><span class="role">Year</span> 2003 · Distributed via NeMAR<br/><span class="role">Funding</span> This work was supported by the Fondation CHUV, Lausanne, Switzerland; the Loterie Romande, Lausanne, Switzerland; and Techno Concept, Mane, France.</div><div class="eegdash-ed-pills"><span class="pill">EEG · 20 ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.4.1</span><span class="pill">Task · fps</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
> [DOI](https://doi.org/10.82901/nemar.on003343)
...
<div class="eegdash-ed-figpair">
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on003343" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on003343&sub=13&ses=01&task=fps&run=01&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on003343 — sub-13 · ses-01 · task-fps · run-01"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on003343). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on003343" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on003343/code/on003343_histogram.png"
      alt="NEMAR pipeline statistics — ON003343"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on003343/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON003343"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on003343">
  <div class="ee-bar">
...
| License        | CC0                                                                                                                                    |
| Citation / DOI | [10.82901/nemar.on003343](https://doi.org/10.82901/nemar.on003343)                                                                     |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on003343) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on003343)              |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON003343</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON003343</code></span></div>
