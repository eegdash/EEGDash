...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS007822</b></div><div>Iss. 7822 · 33 subjects · 99 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Prisoner's Dilemma EEG Dataset</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS007822</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>33</dd><dt>Recordings</dt><dd>99</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>19</dd><dt>Sample rate</dt><dd>300 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>362.0 MB</dd><dt>Tasks</dt><dd><code>pddecision</code> · <code>pdfeedback</code> · <code>pdrest</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.10.0</dd><dt>Sidecars</dt><dd>events · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds007822</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds007822.v1.0.0">10.18112/openneuro.ds007822.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds007822">OpenNeuro</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/DS007822.croissant.json" download>Croissant</a></div></aside>

# DS007822: eeg dataset, 33 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Prisoner's Dilemma EEG Dataset","alternateName":"DS007822","description":"Prisoner's Dilemma EEG Dataset. eeg dataset accessible via EEGDash as \`\`DS007822\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS007822.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds007822.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds007822.v1.0.0","https://openneuro.org/datasets/ds007822","https://nemar.org/dataexplorer/detail?dataset_id=ds007822"],"creator":[{"@type":"Person","name":"n/a"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Prisoner’s Dilemma EEG Dataset*

**Citation:** n/a (—). *Prisoner’s Dilemma EEG Dataset*. [10.18112/openneuro.ds007822.v1.0.0](https://doi.org/10.18112/openneuro.ds007822.v1.0.0)

<p class="eegdash-ed-deck">33-participant EEG dataset — Prisoner's Dilemma EEG Dataset.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>n/a</strong></div><div class="eegdash-ed-pills"><span class="pill">EEG · 19 ch</span><span class="pill">300 Hz</span><span class="pill is-info">BIDS 1.10.0</span><span class="pill">3 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 19 ch (n=99 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 300.0 Hz (n=99 recordings)</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">19 ch · EEG · 300 Hz · 33 subjects, 99 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-G03S02 · task-pddecision</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>33 subjects and 99 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds007822" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds007822&sub=G03S02&task=pddecision&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds007822 — sub-G03S02 · task-pddecision"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — EEG · 19 sensors — 19 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=c46ede269be04c5b&embed=1"
    loading="lazy"
    width="100%" height="640"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds007822). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds007822" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds007822/code/ds007822_histogram.png"
      alt="NEMAR pipeline statistics — DS007822"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds007822/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS007822"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds007822">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                                                                                 |
| Canonical      | —                                                                                                                                                                                 |
| Importable as  | `DS007822`                                                                                                                                                                        |
| Year           | —                                                                                                                                                                                 |
| Authors        | n/a                                                                                                                                                                               |
| License        | CC0                                                                                                                                                                               |
| Citation / DOI | [doi:10.18112/openneuro.ds007822.v1.0.0](https://doi.org/10.18112/openneuro.ds007822.v1.0.0)                                                                                      |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds007822) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds007822) | [Source URL](https://openneuro.org/datasets/ds007822) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS007822</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS007822</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS007822</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS007822.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds007822.v1.0.0">10.18112/openneuro.ds007822.v1.0.0</a></b></div></footer>
