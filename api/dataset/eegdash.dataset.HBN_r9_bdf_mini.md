...
- Source: OpenNeuro
- OpenNeuro: [hbn_r9_bdf_mini](https://openneuro.org/datasets/hbn_r9_bdf_mini)
- NeMAR: [hbn_r9_bdf_mini](https://nemar.org/dataexplorer/detail?dataset_id=hbn_r9_bdf_mini)
...
Use the `HBN_r9_bdf_mini` class to access this dataset programmatically.
