...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003708</b></div><div>Iss. 3708 · 1 subjects · 1 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Basis profile curve identification to understand electrical s…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003708</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2021.01.24.428020">10.1101/2021.01.24.428020</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>1</dd><dt>Recordings</dt><dd>1</dd><dt>Modality</dt><dd>iEEG</dd><dt>Channels</dt><dd>89</dd><dt>Sample rate</dt><dd>2048 Hz</dd><dt>Duration</dt><dd>1.1 h</dd><dt>Size</dt><dd>620.3 MB</dd><dt>Tasks</dt><dd><code>ccep</code></dd><dt>Sessions</dt><dd><code>ieeg01</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>v 1.3.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003708</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003708">EEGDash/ds003708</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003708.v1.0.0">10.18112/openneuro.ds003708.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003708">OpenNeuro</a><a href="https://doi.org/10.1101/2021.01.24.428020">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003708">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003708.croissant.json" download>Croissant</a></div></aside>

# DS003708: ieeg dataset, 1 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Basis profile curve identification to understand electrical stimulation effects in human brain networks","alternateName":"DS003708","description":"Basis profile curve identification to understand electrical stimulation effects in human brain networks. ieeg dataset accessible via EEGDash as \`\`DS003708\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS003708.html","keywords":["ieeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds003708.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds003708.v1.0.0","https://openneuro.org/datasets/ds003708","https://nemar.org/dataexplorer/detail?dataset_id=ds003708"],"creator":[{"@type":"Person","name":"Dora Hermes"},{"@type":"Person","name":"Gabriella Ojeda"},{"@type":"Person","name":"Kai J. Miller"},{"@type":"Person","name":"Multimodal Neuroimaging Laboratory at Mayo Clinic"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Basis profile curve identification to understand electrical stimulation effects in human brain networks*

**Citation:** Dora Hermes, Gabriella Ojeda, Kai J. Miller, Multimodal Neuroimaging Laboratory at Mayo Clinic (20). *Basis profile curve identification to understand electrical stimulation effects in human brain networks*. [10.18112/openneuro.ds003708.v1.0.0](https://doi.org/10.18112/openneuro.ds003708.v1.0.0)

<p class="eegdash-ed-deck">1-participant iEEG dataset — Basis profile curve identification to understand electrical stimulation effects in human brain networks.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Dora Hermes</strong> · <strong>Gabriella Ojeda</strong> · Kai J. Miller · Multimodal Neuroimaging Laboratory at Mayo Clinic<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro<br/><span class="role">Funding</span> R01 MH122258 CRCNS: Processing speed in the human connectome across the lifespan</div><div class="eegdash-ed-pills"><span class="pill">iEEG · 89 ch</span><span class="pill">2048 Hz</span><span class="pill is-info">BIDS v 1.3.0</span><span class="pill">Task · ccep</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="other">Other</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 89 ch (n=1 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 2048.0 Hz (n=1 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">89 ch · iEEG · 2048 Hz · 1 subjects, 1 recordings</span>
  </div>
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds003708). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds003708" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds003708/code/ds003708_histogram.png"
      alt="NEMAR pipeline statistics — DS003708"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds003708/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS003708"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds003708">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003708) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003708) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003708</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Hermes2021</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003708</code> · <code>Hermes2021</code></span></div>
...
* [eegdash.dataset.DS004127](eegdash.dataset.DS004127.md)
* [eegdash.dataset.DS004738](eegdash.dataset.DS004738.md)
* [eegdash.dataset.DS004457](eegdash.dataset.DS004457.md)

<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003708</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003708.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003708">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003708.v1.0.0">10.18112/openneuro.ds003708.v1.0.0</a></b></div></footer>
