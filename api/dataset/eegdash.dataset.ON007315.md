...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON007315</b></div><div>Iss. 7315 · 2 subjects · 14 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · tACS for Patients with Post-Stroke Anomia</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON007315</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1371/journal.pone.0342191">10.1371/journal.pone.0342191</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>2</dd><dt>Recordings</dt><dd>14</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>32</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>4.9 h</dd><dt>Size</dt><dd>1.1 GB</dd><dt>Tasks</dt><dd><code>PictureNaming</code></dd><dt>Sessions</dt><dd>7 · <code>1</code> … <code>8</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on007315</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on007315">10.82901/nemar.on007315</a></div><div class="actions"><a href="https://openneuro.org/datasets/on007315">OpenNeuro</a><a href="https://doi.org/10.1371/journal.pone.0342191">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON007315.croissant.json" download>Croissant</a></div></aside>

# ON007315: eeg dataset, 2 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"tACS for Patients with Post-Stroke Anomia","alternateName":"ON007315","description":"tACS for Patients with Post-Stroke Anomia. eeg dataset accessible via EEGDash as \`\`ON007315\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON007315.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on007315","sameAs":["https://doi.org/10.82901/nemar.on007315","https://openneuro.org/datasets/on007315","https://nemar.org/dataexplorer/detail?dataset_id=on007315"],"creator":[{"@type":"Person","name":"Maria Martzoukou"},{"@type":"Person","name":"Nefeli K. Dimitriou"},{"@type":"Person","name":"Binbin Xu"},{"@type":"Person","name":"Malo Renaud-d’Ambra"},{"@type":"Person","name":"Anastasia Nousia"},{"@type":"Person","name":"Alexandre Aksenov"},{"@type":"Person","name":"Anne Beuter"},{"@type":"Person","name":"Grigorios Nasios"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*tACS for Patients with Post-Stroke Anomia*

**Citation:** Maria Martzoukou, Nefeli K. Dimitriou, Binbin Xu, Malo Renaud-d’Ambra, Anastasia Nousia, Alexandre Aksenov, Anne Beuter, Grigorios Nasios (—). *tACS for Patients with Post-Stroke Anomia*. [10.82901/nemar.on007315](https://doi.org/10.82901/nemar.on007315)

<p class="eegdash-ed-deck">2-participant EEG dataset — tACS for Patients with Post-Stroke Anomia.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Maria Martzoukou</strong> · <strong>Nefeli K. Dimitriou</strong> · Binbin Xu · Malo Renaud-d’Ambra · Anastasia Nousia · Alexandre Aksenov · …<br/><span class="role">Funding</span> No formal funding reported.</div><div class="eegdash-ed-pills"><span class="pill">EEG · 32 ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.8.0</span><span class="pill">Task · PictureNaming</span><span class="pill">7 sessions</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
> [DOI](https://doi.org/10.82901/nemar.on007315)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-G01 · ses-1 · task-PictureNaming · run-1</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on007315" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on007315&sub=G01&ses=1&task=PictureNaming&run=1&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on007315 — sub-G01 · ses-1 · task-PictureNaming · run-1"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on007315). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on007315" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on007315/code/on007315_histogram.png"
      alt="NEMAR pipeline statistics — ON007315"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on007315/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON007315"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on007315">
  <div class="ee-bar">
...
| License        | CC0                                                                                                                                       |
| Citation / DOI | [10.82901/nemar.on007315](https://doi.org/10.82901/nemar.on007315)                                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on007315) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on007315)                 |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON007315</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON007315</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON007315</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON007315.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on007315">10.82901/nemar.on007315</a></b></div></footer>
