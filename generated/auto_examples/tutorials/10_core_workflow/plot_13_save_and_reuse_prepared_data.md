...
```none
saved: /tmp/eegdash_save_50tq1pvh/windows
...
```none
Zarr write_s=0.0165, read_s=0.0058, size_mb=0.0080
```
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0149, read_s=0.0115, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_50tq1pvh/windows/0 already exists. Please select
