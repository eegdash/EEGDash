...
```none
saved: /tmp/eegdash_save_gjtsewqh/windows
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0154, read_s=0.0119, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_gjtsewqh/windows/0 already exists. Please select
