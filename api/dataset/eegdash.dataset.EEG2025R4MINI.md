...
- Source: nemar
- OpenNeuro: [eeg2025r4mini](https://openneuro.org/datasets/eeg2025r4mini)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=20, range 5–15 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="5-9: 12"></div><div style="width:28px; height:50%; background:#4472c4; flex-shrink:0;" title="10-14: 6"></div><div style="width:28px; height:16%; background:#4472c4; flex-shrink:0;" title="15-19: 2"></div>
  </div>
...
Use the `EEG2025R4MINI` class to access this dataset programmatically.
