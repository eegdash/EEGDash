...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000230</b></div><div>Iss. 230 · 30 subjects · 118 recordings · CC-BY-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Lower-limb MI dataset for knee pain patients from Zuo et al…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000230</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-4.0</dd><dt>Updated</dt><dd>2026-03-25</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>30</dd><dt>Recordings</dt><dd>118</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>30</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>38.1 h</dd><dt>Size</dt><dd>5.8 GB</dd><dt>Tasks</dt><dd><code>imagery</code></dd><dt>Sessions</dt><dd>5 · <code>01</code> … <code>05</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000230</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000230">EEGDash/nm000230</a></dd></dl><div class="actions"><a href="https://openneuro.org/datasets/nm000230">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000230">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000230.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=30, range 34–34 yr, mean 33.0 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=30"><div style="width:100%; height:180px; background:#6b7785; flex-shrink:0;" title="30-34: other n=30"></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-13 · ses-02 · task-imagery · run-0</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>30 subjects and 118 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000230" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000230&sub=13&ses=02&task=imagery&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000230 — sub-13 · ses-02 · task-imagery · run-0"
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000230</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000230.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000230">Hugging Face mirror</a></div><div>CC-BY-4.0 · <b><span style="opacity:.6">DOI not on file</span></b></div></footer>
