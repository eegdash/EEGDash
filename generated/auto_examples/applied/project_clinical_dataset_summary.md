...
<!-- "generated/auto_examples/applied/project_clinical_dataset_summary.py" -->
...
[NEMAR](https://nemar.org) [[Delorme *et al.*, 2022](../../../references.md#id6)]; the polished clinical
...
- Run [`EEGDashDataset`](../../../api/dataset/eegdash.EEGDashDataset.md#eegdash.EEGDashDataset) on a clinical OpenNeuro release and read its `description` DataFrame.
...
[`EEGDashDataset`](../../../api/dataset/eegdash.EEGDashDataset.md#eegdash.EEGDashDataset) is a thin query layer over the eegdash
...
without [`EEGDashDataset`](../../../api/dataset/eegdash.EEGDashDataset.md#eegdash.EEGDashDataset) would take a custom S3 listing,
...
<a id="sphx-glr-download-generated-auto-examples-applied-project-clinical-dataset-summary-py"></a>
