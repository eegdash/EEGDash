...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000163</b></div><div>Iss. 163 · 12 subjects · 12 recordings · CC-BY-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · c-VEP and Burst-VEP dataset from Castillos et al. (2023)</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000163</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-4.0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1016/j.neuroimage.2023.120446">10.1016/j.neuroimage.2023.120446</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>12</dd><dt>Recordings</dt><dd>12</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>32</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>53 min</dd><dt>Size</dt><dd>160.1 MB</dd><dt>Tasks</dt><dd><code>cvep</code></dd><dt>Sessions</dt><dd><code>0</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000163</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000163">10.82901/nemar.nm000163</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000163">OpenNeuro</a><a href="https://doi.org/10.1016/j.neuroimage.2023.120446">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/NM000163.croissant.json" download>Croissant</a></div></aside>

# NM000163: eeg dataset, 12 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"c-VEP and Burst-VEP dataset from Castillos et al. (2023)","alternateName":"NM000163","description":"c-VEP and Burst-VEP dataset from Castillos et al. (2023). eeg dataset accessible via EEGDash as \`\`NM000163\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000163.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.nm000163","sameAs":["https://doi.org/10.82901/nemar.nm000163","https://openneuro.org/datasets/nm000163","https://nemar.org/dataexplorer/detail?dataset_id=nm000163"],"creator":[{"@type":"Person","name":"Kalou Cabrera Castillos"},{"@type":"Person","name":"Simon Ladouce"},{"@type":"Person","name":"Ludovic Darmet"},{"@type":"Person","name":"Frédéric Dehais"}],"license":"https://creativecommons.org/licenses/by/4.0/","datePublished":"2023-01-01"}</script>

*c-VEP and Burst-VEP dataset from Castillos et al. (2023)*

**Citation:** Kalou Cabrera Castillos, Simon Ladouce, Ludovic Darmet, Frédéric Dehais (2023). *c-VEP and Burst-VEP dataset from Castillos et al. (2023)*. [10.82901/nemar.nm000163](https://doi.org/10.82901/nemar.nm000163)

<p class="eegdash-ed-deck">12-participant EEG dataset — c-VEP and Burst-VEP dataset from Castillos et al. (2023).</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Kalou Cabrera Castillos</strong> · <strong>Simon Ladouce</strong> · Ludovic Darmet · Frédéric Dehais<br/><span class="role">Year</span> 2023 · Distributed via NeMAR<br/><span class="role">Funding</span> AID (Powerbrain project), France · AXA Research Fund Chair for Neuroergonomics, France · + 1 more</div><div class="eegdash-ed-pills"><span class="pill">EEG · 32 ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">Task · cvep</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/nm000163" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000163&sub=12&ses=0&task=cvep&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000163 — sub-12 · ses-0 · task-cvep · run-0"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000163). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000163" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000163/code/nm000163_histogram.png"
      alt="NEMAR pipeline statistics — NM000163"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000163/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000163"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000163">
  <div class="ee-bar">
...
| License        | CC-BY-4.0                                                                                                                 |
| Citation / DOI | [10.82901/nemar.nm000163](https://doi.org/10.82901/nemar.nm000163)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000163) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000163) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000163</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Castillos2023_VEP</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000163</code> · <code>Castillos2023_VEP</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000163</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000163.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC-BY-4.0 · <b><a href="https://doi.org/10.82901/nemar.nm000163">10.82901/nemar.nm000163</a></b></div></footer>
