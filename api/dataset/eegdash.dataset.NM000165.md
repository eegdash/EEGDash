...
<div class="eegdash-ed-figpair">
  ...
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000165&sub=01&task=isometric10percentmvc&run=01&ext=edf&suffix=emg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EMG trace viewer for nm000165 — sub-01 · task-isometric10percentmvc · run-01"
