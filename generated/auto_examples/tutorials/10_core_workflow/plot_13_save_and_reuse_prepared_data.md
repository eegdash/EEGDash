...
```none
saved: /tmp/eegdash_save_ny336ppg/windows
...
```none
Zarr write_s=0.0160, read_s=0.0058, size_mb=0.0080
```
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0165, read_s=0.0124, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_ny336ppg/windows/0 already exists. Please select
