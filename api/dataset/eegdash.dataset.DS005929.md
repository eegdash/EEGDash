...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005929</b></div><div>Iss. 5929 · 7 subjects · 7 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Motion-Yucel2014</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005929</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1016/j.neuroimage.2013.06.054">10.1016/j.neuroimage.2013.06.054</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>7</dd><dt>Recordings</dt><dd>7</dd><dt>Modality</dt><dd>fNIRS</dd><dt>Channels</dt><dd>28</dd><dt>Sample rate</dt><dd>50 Hz</dd><dt>Duration</dt><dd>1.1 h</dd><dt>Size</dt><dd>68.6 MB</dd><dt>Tasks</dt><dd><code>MA</code></dd><dt>Sessions</dt><dd><code>1</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.1</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005929</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="motor">Motor</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005929">EEGDash/ds005929</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005929.v1.0.1">10.18112/openneuro.ds005929.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005929">OpenNeuro</a><a href="https://doi.org/10.1016/j.neuroimage.2013.06.054">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds005929">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005929.croissant.json" download>Croissant</a></div></aside>

# DS005929: fnirs dataset, 7 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Motion-Yucel2014","alternateName":"DS005929","description":"Motion-Yucel2014. fnirs dataset accessible via EEGDash as \`\`DS005929\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS005929.html","keywords":["fnirs","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds005929.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds005929.v1.0.1","https://openneuro.org/datasets/ds005929","https://nemar.org/dataexplorer/detail?dataset_id=ds005929"],"creator":[{"@type":"Person","name":"Yücel, Meryem"},{"@type":"Person","name":"Selb, Juliette"},{"@type":"Person","name":"Boas, David"},{"@type":"Person","name":"Cash, Sydney"},{"@type":"Person","name":"Cooper, Robert"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Motion-Yucel2014*

**Citation:** Yücel, Meryem, Selb, Juliette, Boas, David, Cash, Sydney, Cooper, Robert (—). *Motion-Yucel2014*. [10.18112/openneuro.ds005929.v1.0.1](https://doi.org/10.18112/openneuro.ds005929.v1.0.1)

<p class="eegdash-ed-deck">7-participant fNIRS dataset — Motion-Yucel2014.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Yücel, Meryem</strong> · <strong>Selb, Juliette</strong> · Boas, David · Cash, Sydney · Cooper, Robert<br/><span class="role">Funding</span> NIH grants P41-RR14075, R01-EB006385 and R90-DA023427</div><div class="eegdash-ed-pills"><span class="pill">fNIRS · 28 ch</span><span class="pill">50 Hz</span><span class="pill is-info">BIDS 1.7.1</span><span class="pill">Task · MA</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="motor">Motor</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 28 ch (n=7 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 50.0 Hz (n=7 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">28 ch · fNIRS · 50 Hz · 7 subjects, 7 recordings</span>
  </div>
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds005929). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds005929" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds005929/code/ds005929_histogram.png"
      alt="NEMAR pipeline statistics — DS005929"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds005929/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS005929"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds005929">
  <div class="ee-bar">
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS005929</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>MotionYucel2014</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS005929</code> · <code>MotionYucel2014</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS005929</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS005929.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds005929">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds005929.v1.0.1">10.18112/openneuro.ds005929.v1.0.1</a></b></div></footer>
