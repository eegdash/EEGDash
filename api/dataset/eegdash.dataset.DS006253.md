...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006253</b></div><div>Iss. 6253 · 23 subjects · 201 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · MetaRDK</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006253</dd><dt>Version</dt><dd>v1.0.3</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41467-025-61744-8">10.1038/s41467-025-61744-8</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>23</dd><dt>Recordings</dt><dd>201</dd><dt>Modality</dt><dd>iEEG</dd><dt>Channels</dt><dd>122 (13), 185 (2), 120, 143, 156, 186, 201, 132</dd><dt>Sample rate</dt><dd>Varies</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>656.2 KB</dd><dt>Tasks</dt><dd>4 tasks · <code>.gitattributes</code> · <code>CHANGES</code> · …</dd><dt>Sessions</dt><dd><code>01</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>—</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="epilepsy">Epilepsy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006253">EEGDash/ds006253</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006253.v1.0.3">10.18112/openneuro.ds006253.v1.0.3</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006253">OpenNeuro</a><a href="https://doi.org/10.1038/s41467-025-61744-8">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006253">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006253.croissant.json" download>Croissant</a></div></aside>

# DS006253: ieeg dataset, 23 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"MetaRDK","alternateName":"DS006253","description":"MetaRDK. ieeg dataset accessible via EEGDash as \`\`DS006253\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006253.html","keywords":["ieeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006253.v1.0.3","sameAs":["https://doi.org/10.18112/openneuro.ds006253.v1.0.3","https://openneuro.org/datasets/ds006253","https://nemar.org/dataexplorer/detail?dataset_id=ds006253"],"creator":[{"@type":"Person","name":"Dorian Goueytes"},{"@type":"Person","name":"Francois Stockart"},{"@type":"Person","name":"Alexis Robin"},{"@type":"Person","name":"Lucien Gyger"},{"@type":"Person","name":"Martin Rouy"},{"@type":"Person","name":"Dominique Hoffmann"},{"@type":"Person","name":"Lorella Minotti"},{"@type":"Person","name":"Philippe Kahane"},{"@type":"Person","name":"Michael Pereira"},{"@type":"Person","name":"Nathan Faivre"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:7%; background:#009E73; flex-shrink:0;" title="120 ch: 1"></div><div style="width:28px; height:100%; background:#009E73; flex-shrink:0;" title="122 ch: 13"></div><div style="width:28px; height:7%; background:#009E73; flex-shrink:0;" title="132 ch: 1"></div><div style="width:28px; height:7%; background:#009E73; flex-shrink:0;" title="143 ch: 1"></div><div style="width:28px; height:7%; background:#009E73; flex-shrink:0;" title="156 ch: 1"></div><div style="width:28px; height:15%; background:#009E73; flex-shrink:0;" title="185 ch: 2"></div><div style="width:28px; height:7%; background:#009E73; flex-shrink:0;" title="186 ch: 1"></div><div style="width:28px; height:7%; background:#009E73; flex-shrink:0;" title="201 ch: 1"></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">120</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">122</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">132</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">143</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">156</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">185</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">186</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">201</span>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">122 (13), 185 (2), 120, 143, 156, 186, 201, 132 ch · iEEG · Varies · 23 subjects, 201 recordings</span>
  </div>
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds006253). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds006253" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds006253/code/ds006253_histogram.png"
      alt="NEMAR pipeline statistics — DS006253"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds006253/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS006253"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds006253">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006253) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006253)                                         |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006253</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Goueytes2024</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v"><code>MetaRDK</code></span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006253</code> · <code>Goueytes2024</code> · <code>MetaRDK</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006253</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006253.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006253">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006253.v1.0.3">10.18112/openneuro.ds006253.v1.0.3</a></b></div></footer>
