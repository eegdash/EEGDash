...
Modality: eeg Subjects: 20 Recordings: 20 License: CC-BY-4.0 Source: nemar
...
- Duration (hours): 44.44853333333333

- Pathology: Healthy
- Modality: Visual
- Type: Motor

- Size on disk: 15.0 GB
- File count: 20
- Format: BIDS
...
- Source: nemar
- OpenNeuro: [nm000162](https://openneuro.org/datasets/nm000162)
- NeMAR: [nm000162](https://nemar.org/dataexplorer/detail?dataset_id=nm000162)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=20, range 26–26 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="25-29: 20"></div>
  </div>
...
Use the `NM000162` class to access this dataset programmatically.
