...
def multimodal_ds(tmp_path):
    ...
    # BIDS requirement
    (ds_root / "dataset_description.json").write_text('{"Name": "Multimodal Test", "BIDSVersion": "1.4.0", "DatasetType": "raw"}')
...
def test_multimodal_discovery_eeg_only(multimodal_ds):
    ...
    records = discover_local_bids_records(multimodal_ds, {"dataset": "multimodal_ds", "modality": "eeg"})
...
def test_multimodal_discovery_nirs_aliases(multimodal_ds):
    ...
    records = discover_local_bids_records(multimodal_ds, {"dataset": "multimodal_ds", "modality": "nirs"})
...
def test_multimodal_discovery_fnirs_alias(multimodal_ds):
    ...
    records = discover_local_bids_records(multimodal_ds, {"dataset": "multimodal_ds", "modality": "fnirs"})
