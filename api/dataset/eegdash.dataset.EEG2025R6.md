...
Modality: eeg Subjects: 135 Recordings: 1227 License: CC-BY-SA 4.0 Source: nemar
...
- Source: nemar
- OpenNeuro: [eeg2025r6](https://openneuro.org/datasets/eeg2025r6)
- NeMAR: [eeg2025r6](https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r6)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=135, range 5–21 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="5-9: 72"></div><div style="width:28px; height:59%; background:#4472c4; flex-shrink:0;" title="10-14: 43"></div><div style="width:28px; height:25%; background:#4472c4; flex-shrink:0;" title="15-19: 18"></div><div style="width:28px; height:2%; background:#4472c4; flex-shrink:0;" title="20-24: 2"></div>
  </div>
  ...
  <div style="display:flex; height:22px; width:100%; max-width:400px; border-radius:4px; overflow:hidden;">
    <div style="width:38.5%; background:#e07ab5; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Female: 52">52</div><div style="width:61.5%; background:#4472c4; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Male: 83">83</div>
  </div>
  <div style="font-size:11px;margin-top:4px;"><span style="display:inline-block;width:12px;height:12px;background:#e07ab5;border-radius:2px;margin-right:4px;"></span>Female&nbsp;&nbsp;<span style="display:inline-block;width:12px;height:12px;background:#4472c4;border-radius:2px;margin-right:4px;"></span>Male&nbsp;&nbsp;<strong>Total: 135</strong></div>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
Use the `EEG2025R6` class to access this dataset programmatically.
