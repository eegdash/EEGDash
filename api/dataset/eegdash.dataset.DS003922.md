...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003922</b></div><div>Iss. 3922 · 14 subjects · 164 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Multisensory Correlation Detector</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003922</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41467-022-29687-6">10.1038/s41467-022-29687-6</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>14</dd><dt>Recordings</dt><dd>164</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>342 (128), 323 (23)</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>16.5 h</dd><dt>Size</dt><dd>75.7 GB</dd><dt>Tasks</dt><dd><code>mcd</code> · <code>noise</code> · <code>rest</code></dd><dt>Sessions</dt><dd>9 · <code>01</code> … <code>20161214</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.6.0</dd><dt>Sidecars</dt><dd>coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003922</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003922">EEGDash/ds003922</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003922.v1.0.1">10.18112/openneuro.ds003922.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003922">OpenNeuro</a><a href="https://doi.org/10.1038/s41467-022-29687-6">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003922">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003922.croissant.json" download>Croissant</a></div></aside>

# DS003922: meg dataset, 14 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Multisensory Correlation Detector","alternateName":"DS003922","description":"Multisensory Correlation Detector. meg dataset accessible via EEGDash as \`\`DS003922\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS003922.html","keywords":["meg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds003922.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds003922.v1.0.1","https://openneuro.org/datasets/ds003922","https://nemar.org/dataexplorer/detail?dataset_id=ds003922"],"creator":[{"@type":"Person","name":"Pesnot Lerousseau, J."},{"@type":"Person","name":"Parise, C."},{"@type":"Person","name":"Ernst, MO."},{"@type":"Person","name":"van Wassenhove, V."}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2022-01-01"}</script>

*Multisensory Correlation Detector*

**Citation:** Pesnot Lerousseau, J., Parise, C., Ernst, MO., van Wassenhove, V. (2022). *Multisensory Correlation Detector*. [10.18112/openneuro.ds003922.v1.0.1](https://doi.org/10.18112/openneuro.ds003922.v1.0.1)

<p class="eegdash-ed-deck">14-participant MEG dataset — Multisensory Correlation Detector.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Pesnot Lerousseau, J.</strong> · <strong>Parise, C.</strong> · Ernst, MO. · van Wassenhove, V.<br/><span class="role">Year</span> 2022 · Distributed via OpenNeuro<br/><span class="role">Funding</span> ERC-YStG-263584 · ANR-16-CE37-0004-04</div><div class="eegdash-ed-pills"><span class="pill">MEG · 342 (128), 323 (23) ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.6.0</span><span class="pill">3 tasks</span><span class="pill">9 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=6"><div style="width:100%; height:120px; background:#006ca3; flex-shrink:0;" title="20-24: female n=4"></div><div style="width:100%; height:60px; background:#f7941d; flex-shrink:0;" title="20-24: male n=2"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=6"><div style="width:100%; height:120px; background:#006ca3; flex-shrink:0;" title="25-29: female n=4"></div><div style="width:100%; height:60px; background:#f7941d; flex-shrink:0;" title="25-29: male n=2"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=1"><div style="width:100%; height:30px; background:#006ca3; flex-shrink:0;" title="30-34: female n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="85-89: n=1"><div style="width:100%; height:30px; background:#f7941d; flex-shrink:0;" title="85-89: male n=1"></div></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">20</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">25</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">30</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">85</span>
  </div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-emptyroom · ses-20161129 · task-noise</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>14 subjects and 164 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds003922" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_meg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?meg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds003922&sub=emptyroom&ses=20161129&task=noise&ext=fif&suffix=meg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live MEG trace viewer for ds003922 — sub-emptyroom · ses-20161129 · task-noise"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003922) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003922) |
