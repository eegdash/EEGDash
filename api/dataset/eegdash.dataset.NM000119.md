...
<div class="eegdash-ed-figpair">
  ...
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000119&sub=1&ses=0&task=ssvep&run=0&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000119 — sub-1 · ses-0 · task-ssvep · run-0"
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000119</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000119.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>ODC-By-1.0 · <b><span style="opacity:.6">DOI not on file</span></b></div></footer>
