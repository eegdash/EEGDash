...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON001787</b></div><div>Iss. 1787 · 24 subjects · 40 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · EEG meditation study</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON001787</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.3389/fpsyg.2013.00688">10.3389/fpsyg.2013.00688</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>24</dd><dt>Recordings</dt><dd>40</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>79</dd><dt>Sample rate</dt><dd>256 Hz</dd><dt>Duration</dt><dd>27.6 h</dd><dt>Size</dt><dd>5.7 GB</dd><dt>Tasks</dt><dd><code>meditation</code></dd><dt>Sessions</dt><dd>3 · <code>01</code> · <code>02</code> · <code>03</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.1.1</dd><dt>Sidecars</dt><dd>events · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on001787</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on001787">10.82901/nemar.on001787</a></div><div class="actions"><a href="https://openneuro.org/datasets/on001787">OpenNeuro</a><a href="https://doi.org/10.3389/fpsyg.2013.00688">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON001787.croissant.json" download>Croissant</a></div></aside>

# ON001787: eeg dataset, 24 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"EEG meditation study","alternateName":"ON001787","description":"EEG meditation study. eeg dataset accessible via EEGDash as \`\`ON001787\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON001787.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on001787","sameAs":["https://doi.org/10.82901/nemar.on001787","https://openneuro.org/datasets/on001787","https://nemar.org/dataexplorer/detail?dataset_id=on001787"],"creator":[{"@type":"Person","name":"Arnaud Delorme"},{"@type":"Person","name":"Tracy Brandmeyer"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*EEG meditation study*

**Citation:** Arnaud Delorme, Tracy Brandmeyer (20). *EEG meditation study*. [10.82901/nemar.on001787](https://doi.org/10.82901/nemar.on001787)

<p class="eegdash-ed-deck">24-participant EEG dataset — EEG meditation study.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Arnaud Delorme</strong> · <strong>Tracy Brandmeyer</strong><br/><span class="role">Year</span> 20 · Distributed via NeMAR</div><div class="eegdash-ed-pills"><span class="pill">EEG · 79 ch</span><span class="pill">256 Hz</span><span class="pill is-info">BIDS 1.1.1</span><span class="pill">Task · meditation</span><span class="pill">3 sessions</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = ON001787(cache_dir="./data", subject="01")
```
...
@dataset{on001787,
  ...
  doi = {10.82901/nemar.on001787},
  url = {https://doi.org/10.82901/nemar.on001787},
}
```
...
- Arnaud Delorme (October 17, 2018; updated June 2024)
  > [DOI](https://doi.org/10.82901/nemar.on001787)
...
<div class="eegdash-ed-figpair">
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on001787" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on001787&sub=001&ses=01&task=meditation&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on001787 — sub-001 · ses-01 · task-meditation"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on001787). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on001787" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on001787/code/on001787_histogram.png"
      alt="NEMAR pipeline statistics — ON001787"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on001787/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON001787"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on001787">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `ON001787`                                                                                                                |
| Year           | 20                                                                                                                        |
| Authors        | Arnaud Delorme, Tracy Brandmeyer                                                                                          |
| License        | CC0                                                                                                                       |
| Citation / DOI | [10.82901/nemar.on001787](https://doi.org/10.82901/nemar.on001787)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on001787) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on001787) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON001787</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON001787</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON001787</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON001787.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on001787">10.82901/nemar.on001787</a></b></div></footer>
