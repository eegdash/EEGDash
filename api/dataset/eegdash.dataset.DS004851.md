...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS004851</b></div><div>Iss. 4851 · 66 subjects · 66 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · HID</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS004851</dd><dt>Version</dt><dd>v2.1.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Updated</dt><dd>2024-07-09</dd><dt>Contact</dt><dd>Kevin King</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>66</dd><dt>Recordings</dt><dd>66</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>72</dd><dt>Sample rate</dt><dd>2048 Hz</dd><dt>Duration</dt><dd>18.6 h</dd><dt>Size</dt><dd>55.9 GB</dd><dt>Tasks</dt><dd><code>HID</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd><a href="#nemar-processing-statistics">HED ✓</a></dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds004851</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds004851">EEGDash/ds004851</a></dd><dt>Citations</dt><dd>0</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds004851.v2.1.0">10.18112/openneuro.ds004851.v2.1.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds004851">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/ds004851">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS004851.croissant.json" download>Croissant</a></div></aside>

# DS004851: eeg dataset, 66 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"HID","alternateName":"DS004851","description":"HID. eeg dataset accessible via EEGDash as \`\`DS004851\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS004851.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds004851.v2.1.0","sameAs":["https://doi.org/10.18112/openneuro.ds004851.v2.1.0","https://openneuro.org/datasets/ds004851","https://nemar.org/dataexplorer/detail?dataset_id=ds004851"],"creator":[{"@type":"Person","name":"Tony Johnson"},{"@type":"Person","name":"Stephen Gordon"},{"@type":"Person","name":"Jon Touryan"},{"@type":"Person","name":"Kevin King"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2023-01-01"}</script>

*HID*

**Citation:** Tony Johnson, Stephen Gordon, Jon Touryan, Kevin King (2023). *HID*. [10.18112/openneuro.ds004851.v2.1.0](https://doi.org/10.18112/openneuro.ds004851.v2.1.0)

<p class="eegdash-ed-deck">66-participant EEG dataset — HID.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Tony Johnson</strong> · <strong>Stephen Gordon</strong> · Jon Touryan · Kevin King<br/><span class="role">Senior author</span> <strong>Kevin King</strong><br/><span class="role">Year</span> 2023 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 72 ch</span><span class="pill">2048 Hz</span><span class="pill is-info">BIDS 1.8.0</span><span class="pill is-warning">HED ✓</span><span class="pill">Task · HID</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = DS004851(cache_dir="./data", subject="01")
```
...
@dataset{ds004851,
  ...
  doi = {10.18112/openneuro.ds004851.v2.1.0},
  url = {https://doi.org/10.18112/openneuro.ds004851.v2.1.0},
}
```
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 72 ch (n=66 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 2048.0 Hz (n=66 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 18 h 34 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">72 ch · EEG · 2048 Hz · 66 subjects, 66 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-021 · task-HID</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>66 subjects and 66 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds004851" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds004851&sub=021&task=HID&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds004851 — sub-021 · task-HID"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds004851). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds004851" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds004851/code/ds004851_histogram.png"
      alt="NEMAR pipeline statistics — DS004851"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds004851/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS004851"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds004851">
  <div class="ee-bar">
...
| License        | CC0                                                                                                                                                                               |
| Citation / DOI | [doi:10.18112/openneuro.ds004851.v2.1.0](https://doi.org/10.18112/openneuro.ds004851.v2.1.0)                                                                                      |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds004851) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds004851) | [Source URL](https://openneuro.org/datasets/ds004851) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS004851</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Johnson2023_HID</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS004851</code> · <code>Johnson2023_HID</code></span></div>
...
OpenNeuro dataset: [https://openneuro.org/datasets/ds004851](https://openneuro.org/datasets/ds004851)
NeMAR dataset: [https://nemar.org/dataexplorer/detail?dataset_id=ds004851](https://nemar.org/dataexplorer/detail?dataset_id=ds004851)
DOI: [https://doi.org/10.18112/openneuro.ds004851.v2.1.0](https://doi.org/10.18112/openneuro.ds004851.v2.1.0)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS004851</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS004851.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds004851">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds004851.v2.1.0">10.18112/openneuro.ds004851.v2.1.0</a></b></div></footer>
