...
```none
pretrain losses (RestingState): [0.052, 0.005, 0.001, 0.0, 0.0]
```
...
```none
finetune losses (CCD): [0.576, 0.488, 0.437, 0.366, 0.321]
```
...
```none
finetune=0.583 | scratch=0.550 | chance=0.550 | metric=accuracy | gap=+0.033
```
...
RestingState                    0.017         0.183           0.0
surroundSupp                    0.333         0.183           0.0
symbolSearch                    0.267         0.133           0.0
```
...
{"encoder_weights_path": "plot_71_pretrained_encoder.pt", "pretext_subjects": 8, "target_subjects": 8, "transfer_gap": 0.0333, "transfer_matrix_mean_delta": 0.1241}
```
