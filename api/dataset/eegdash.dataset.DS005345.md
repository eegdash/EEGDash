...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005345</b></div><div>Iss. 5345 · 26 subjects · 26 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Le Petit Prince (LPP) Multi-talker</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005345</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-025-05158-7">10.1038/s41597-025-05158-7</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>26</dd><dt>Recordings</dt><dd>26</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>19.1 h</dd><dt>Size</dt><dd>405.1 GB</dd><dt>Tasks</dt><dd><code>multitalker</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005345</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005345">EEGDash/ds005345</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005345.v1.0.1">10.18112/openneuro.ds005345.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005345">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-025-05158-7">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds005345">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005345.croissant.json" download>Croissant</a></div></aside>

# DS005345: eeg dataset, 26 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Le Petit Prince (LPP) Multi-talker: Naturalistic 7T fMRI and EEG Dataset","alternateName":"DS005345","description":"Le Petit Prince (LPP) Multi-talker: Naturalistic 7T fMRI and EEG Dataset. eeg dataset accessible via EEGDash as \`\`DS005345\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS005345.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds005345.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds005345.v1.0.1","https://openneuro.org/datasets/ds005345","https://nemar.org/dataexplorer/detail?dataset_id=ds005345"],"creator":[{"@type":"Person","name":"Zhengwu Ma"},{"@type":"Person","name":"Nan Wang"},{"@type":"Person","name":"Jixing Li"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Le Petit Prince (LPP) Multi-talker: Naturalistic 7T fMRI and EEG Dataset*

**Citation:** Zhengwu Ma, Nan Wang, Jixing Li (20). *Le Petit Prince (LPP) Multi-talker: Naturalistic 7T fMRI and EEG Dataset*. [10.18112/openneuro.ds005345.v1.0.1](https://doi.org/10.18112/openneuro.ds005345.v1.0.1)

<p class="eegdash-ed-deck">26-participant EEG dataset — Le Petit Prince (LPP) Multi-talker: Naturalistic 7T fMRI and EEG Dataset.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Zhengwu Ma</strong> · <strong>Nan Wang</strong> · Jixing Li<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 64 ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.8.0</span><span class="pill">Task · multitalker</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 15</span><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#f7941d; display:inline-block;"></i>Male · 11</span></div>
  ...
  <p><strong>Total recording duration</strong>: 19 h 4 min</p>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-13 · task-multitalker</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds005345" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds005345&sub=13&task=multitalker&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds005345 — sub-13 · task-multitalker"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds005345) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds005345) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS005345</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Ma2024</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS005345</code> · <code>Ma2024</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS005345</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS005345.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds005345">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds005345.v1.0.1">10.18112/openneuro.ds005345.v1.0.1</a></b></div></footer>
