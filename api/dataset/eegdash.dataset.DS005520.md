...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005520</b></div><div>Iss. 5520 · 23 subjects · 69 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Research data supporting 'EEG recording during playing MOBA g…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005520</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.3389/fnhum.2018.00047">10.3389/fnhum.2018.00047</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>23</dd><dt>Recordings</dt><dd>69</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>67</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>48.9 h</dd><dt>Size</dt><dd>276.0 GB</dd><dt>Tasks</dt><dd><code>MOBAgame</code> · <code>restingeyeclosed</code> · <code>restingeyeopen</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.2</dd><dt>Sidecars</dt><dd>channels · electrodes · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005520</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="other">Other</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005520">EEGDash/ds005520</a></dd><dt>Citations</dt><dd>0</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005520.v1.0.1">10.18112/openneuro.ds005520.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005520">OpenNeuro</a><a href="https://doi.org/10.3389/fnhum.2018.00047">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds005520">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005520.croissant.json" download>Croissant</a></div></aside>

# DS005520: eeg dataset, 23 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Research data supporting 'EEG recording during playing MOBA game'","alternateName":"DS005520","description":"Research data supporting 'EEG recording during playing MOBA game'. eeg dataset accessible via EEGDash as \`\`DS005520\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS005520.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds005520.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds005520.v1.0.1","https://openneuro.org/datasets/ds005520","https://nemar.org/dataexplorer/detail?dataset_id=ds005520"],"creator":[{"@type":"Person","name":"Hong-Zhi Li"},{"@type":"Person","name":"Jia-Jia Yang"},{"@type":"Person","name":"Zhen Lv"},{"@type":"Person","name":"Li-Yang Wan"},{"@type":"Person","name":"Wo Wang"},{"@type":"Person","name":"Da-Qi Li"},{"@type":"Person","name":"Dong-Dong Zhou"},{"@type":"Person","name":"Li Kuang"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Research data supporting ‘EEG recording during playing MOBA game’*

**Citation:** Hong-Zhi Li, Jia-Jia Yang, Zhen Lv, Li-Yang Wan, Wo Wang, Da-Qi Li, Dong-Dong Zhou, Li Kuang (20). *Research data supporting ‘EEG recording during playing MOBA game’*. [10.18112/openneuro.ds005520.v1.0.1](https://doi.org/10.18112/openneuro.ds005520.v1.0.1)

<p class="eegdash-ed-deck">23-participant EEG dataset — Research data supporting 'EEG recording during playing MOBA game'.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Hong-Zhi Li</strong> · <strong>Jia-Jia Yang</strong> · Zhen Lv · Li-Yang Wan · Wo Wang · Da-Qi Li · …<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro<br/><span class="role">Funding</span> This work was supported by a grant from the Chongqing Medical Youth Top Talent Project in Chongqing Municipal Health Commission (DDZ).</div><div class="eegdash-ed-pills"><span class="pill">EEG · 67 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.2</span><span class="pill">3 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="other">Other</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=23, range 15–23 yr, mean 19.7 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=11"><div style="width:100%; height:165px; background:#6b7785; flex-shrink:0;" title="15-19: other n=11"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=12"><div style="width:100%; height:180px; background:#6b7785; flex-shrink:0;" title="20-24: other n=12"></div></div>
  </div>
  ...
  <div class="sex-wrap" style="display:flex; align-items:center; gap:30px; flex-wrap:wrap;">
    ...
    <div class="sex-legend" style="flex:1; font-family:JetBrains Mono,monospace; font-size:13px; min-width:220px;"><div class="row"><div class="sw" style="background:#6b7785"></div><div class="lbl">Other</div><div class="v">23</div></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">67 ch · EEG · 1000 Hz · 23 subjects, 69 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-13 · task-restingeyeclosed</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds005520" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds005520&sub=13&task=restingeyeclosed&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds005520 — sub-13 · task-restingeyeclosed"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds005520) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds005520) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS005520</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Li2024_Research_supporting_playing</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS005520</code> · <code>Li2024_Research_supporting_playing</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS005520</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS005520.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds005520">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds005520.v1.0.1">10.18112/openneuro.ds005520.v1.0.1</a></b></div></footer>
