...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON004853</b></div><div>Iss. 4853 · 1 subjects · 1 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · TX17</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON004853</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>1</dd><dt>Recordings</dt><dd>1</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>128 Hz</dd><dt>Duration</dt><dd>32 min</dd><dt>Size</dt><dd>79.3 MB</dd><dt>Tasks</dt><dd><code>nback</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on004853</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on004853">10.82901/nemar.on004853</a></div><div class="actions"><a href="https://openneuro.org/datasets/on004853">OpenNeuro</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON004853.croissant.json" download>Croissant</a></div></aside>

# ON004853: eeg dataset, 1 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"TX17","alternateName":"ON004853","description":"TX17. eeg dataset accessible via EEGDash as \`\`ON004853\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON004853.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on004853","sameAs":["https://doi.org/10.82901/nemar.on004853","https://openneuro.org/datasets/on004853","https://nemar.org/dataexplorer/detail?dataset_id=on004853","https://nemar.org/dataexplorer/detail/on004853"],"creator":[{"@type":"Person","name":"Tony Johnson"},{"@type":"Person","name":"Stephen Gordon"},{"@type":"Person","name":"Jon Touryan"},{"@type":"Person","name":"Kevin King"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*TX17*

**Citation:** Tony Johnson, Stephen Gordon, Jon Touryan, Kevin King (—). *TX17*. [10.82901/nemar.on004853](https://doi.org/10.82901/nemar.on004853)
...
```python
dataset = ON004853(cache_dir="./data", subject="01")
```
...
@dataset{on004853,
  ...
  doi = {10.82901/nemar.on004853},
  url = {https://doi.org/10.82901/nemar.on004853},
}
```
...
> [DOI](https://doi.org/10.82901/nemar.on004853)
...
<div class="eegdash-ed-figpair">
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on004853" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on004853&sub=001&task=nback&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on004853 — sub-001 · task-nback"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on004853). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on004853" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on004853/code/on004853_histogram.png"
      alt="NEMAR pipeline statistics — ON004853"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on004853/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON004853"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on004853">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                                                                                        |
| Canonical      | —                                                                                                                                                                                        |
| Importable as  | `ON004853`                                                                                                                                                                               |
| Year           | —                                                                                                                                                                                        |
| Authors        | Tony Johnson, Stephen Gordon, Jon Touryan, Kevin King                                                                                                                                    |
| License        | CC0                                                                                                                                                                                      |
| Citation / DOI | [10.82901/nemar.on004853](https://doi.org/10.82901/nemar.on004853)                                                                                                                       |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on004853) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on004853) | [Source URL](https://nemar.org/dataexplorer/detail/on004853) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON004853</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON004853</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON004853</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON004853.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on004853">10.82901/nemar.on004853</a></b></div></footer>
