...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=48, range 5–10 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="5-9: 46"></div><div style="width:28px; height:4%; background:#4472c4; flex-shrink:0;" title="10-14: 2"></div>
  </div>
