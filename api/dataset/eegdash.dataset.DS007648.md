...
- Source: openneuro
- OpenNeuro: [ds007648](https://openneuro.org/datasets/ds007648)
- NeMAR: [ds007648](https://nemar.org/dataexplorer/detail?dataset_id=ds007648)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=22, range 18–27 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="15-19: 18"></div><div style="width:28px; height:16%; background:#4472c4; flex-shrink:0;" title="20-24: 3"></div><div style="width:28px; height:5%; background:#4472c4; flex-shrink:0;" title="25-29: 1"></div>
  </div>
  ...
  <div style="display:flex; height:22px; width:100%; max-width:400px; border-radius:4px; overflow:hidden;">
    <div style="width:68.2%; background:#e07ab5; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Female: 15">15</div><div style="width:31.8%; background:#4472c4; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Male: 7">7</div>
  </div>
