...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-13 · ses-joy · task-Rotation</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds004460" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds004460&sub=13&ses=joy&task=Rotation&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds004460 — sub-13 · ses-joy · task-Rotation"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — EEG · 157 sensors — 157 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=e71deb89dac89c49&embed=1"
    loading="lazy"
    width="100%" height="640"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds004460) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds004460) |
