...
- Source: OpenNeuro
- OpenNeuro: [hbn_r2_bdf](https://openneuro.org/datasets/hbn_r2_bdf)
- NeMAR: [hbn_r2_bdf](https://nemar.org/dataexplorer/detail?dataset_id=hbn_r2_bdf)
...
Use the `HBN_r2_bdf` class to access this dataset programmatically.
