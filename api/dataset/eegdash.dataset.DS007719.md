...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS007719</b></div><div>Iss. 7719 · 65 subjects · 65 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Cambridge_data_resting</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS007719</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>65</dd><dt>Recordings</dt><dd>65</dd><dt>Modality</dt><dd>fNIRS</dd><dt>Channels</dt><dd>3456</dd><dt>Sample rate</dt><dd>12 Hz · mixed</dd><dt>Duration</dt><dd>7.0 h</dd><dt>Size</dt><dd>8.6 GB</dd><dt>Tasks</dt><dd><code>resting</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.10.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds007719</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="resting-state">Resting State</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="resting-state">Resting-state</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds007719.v1.0.0">10.18112/openneuro.ds007719.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds007719">OpenNeuro</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/DS007719.croissant.json" download>Croissant</a></div></aside>

# DS007719: fnirs dataset, 65 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Cambridge_data_resting","alternateName":"DS007719","description":"Cambridge_data_resting. fnirs dataset accessible via EEGDash as \`\`DS007719\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS007719.html","keywords":["fnirs","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds007719.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds007719.v1.0.0","https://openneuro.org/datasets/ds007719","https://nemar.org/dataexplorer/detail?dataset_id=ds007719"],"creator":[{"@type":"Person","name":"Enter author names here"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Cambridge_data_resting*

**Citation:** Enter author names here (—). *Cambridge_data_resting*. [10.18112/openneuro.ds007719.v1.0.0](https://doi.org/10.18112/openneuro.ds007719.v1.0.0)

<p class="eegdash-ed-deck">65-participant fNIRS dataset — Cambridge_data_resting.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Enter author names here</strong><br/><span class="role">Funding</span> Enter funding details here, if applicable.</div><div class="eegdash-ed-pills"><span class="pill">fNIRS · 3456 ch</span><span class="pill">12 Hz · mixed</span><span class="pill is-info">BIDS 1.10.0</span><span class="pill">Task · resting</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="resting-state">Resting State</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="resting-state">Resting-state</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = DS007719(cache_dir="./data", subject="01")
```
...
```bibtex
@dataset{ds007719,
  title = {Cambridge_data_resting},
  author = {Enter author names here},
  doi = {10.18112/openneuro.ds007719.v1.0.0},
  url = {https://doi.org/10.18112/openneuro.ds007719.v1.0.0},
}
```
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 3456 ch (n=65 recordings)</p>
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#D55E00; flex-shrink:0;" title="12.5 Hz: 59"></div><div style="width:28px; height:10%; background:#D55E00; flex-shrink:0;" title="12.5 Hz: 6"></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">12.5</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">12.5</span>
  </div>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 6 h 58 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">3456 ch · fNIRS · 12 Hz · mixed · 65 subjects, 65 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — fNIRS · 84 sensors — 84 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=c2b09a581de0c07d&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 900px; display: block;"
    title="Topomap of fNIRS · 84 sensors"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds007719). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds007719" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds007719/code/ds007719_histogram.png"
      alt="NEMAR pipeline statistics — DS007719"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds007719/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS007719"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds007719">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                                                                                 |
| Canonical      | —                                                                                                                                                                                 |
| Importable as  | `DS007719`                                                                                                                                                                        |
| Year           | —                                                                                                                                                                                 |
| Authors        | Enter author names here                                                                                                                                                           |
| License        | CC0                                                                                                                                                                               |
| Citation / DOI | [doi:10.18112/openneuro.ds007719.v1.0.0](https://doi.org/10.18112/openneuro.ds007719.v1.0.0)                                                                                      |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds007719) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds007719) | [Source URL](https://openneuro.org/datasets/ds007719) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS007719</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS007719</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS007719</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS007719.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds007719.v1.0.0">10.18112/openneuro.ds007719.v1.0.0</a></b></div></footer>
