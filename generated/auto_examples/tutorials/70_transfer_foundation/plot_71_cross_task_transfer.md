...
```none
pretrain losses (RestingState): [0.06, 0.005, 0.0, 0.0, 0.0]
```
...
```none
finetune losses (CCD): [0.585, 0.483, 0.44, 0.367, 0.334]
```
...
```none
finetune=0.567 | scratch=0.617 | chance=0.567 | metric=accuracy | gap=-0.050
```
...
RestingState                    0.083         0.250           0.0
surroundSupp                    0.400         0.267           0.0
symbolSearch                    0.217         0.050           0.0
```
...
{"encoder_weights_path": "plot_71_pretrained_encoder.pt", "pretext_subjects": 8, "target_subjects": 8, "transfer_gap": -0.05, "transfer_matrix_mean_delta": 0.1407}
```
