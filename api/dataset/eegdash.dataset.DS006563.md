...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006563</b></div><div>Iss. 6563 · 12 subjects · 12 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Dimension-based attention modulates early visual processing</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006563</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1111/j.1469-8986.2010.00998.x">10.1111/j.1469-8986.2010.00998.x</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>12</dd><dt>Recordings</dt><dd>12</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>12.6 h</dd><dt>Size</dt><dd>5.6 GB</dd><dt>Tasks</dt><dd><code>DimensionDiscrimination</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006563</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006563">EEGDash/ds006563</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006563.v1.0.0">10.18112/openneuro.ds006563.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006563">OpenNeuro</a><a href="https://doi.org/10.1111/j.1469-8986.2010.00998.x">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006563">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006563.croissant.json" download>Croissant</a></div></aside>

# DS006563: eeg dataset, 12 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Dimension-based attention modulates early visual processing","alternateName":"DS006563","description":"Dimension-based attention modulates early visual processing. eeg dataset accessible via EEGDash as \`\`DS006563\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006563.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006563.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds006563.v1.0.0","https://openneuro.org/datasets/ds006563","https://nemar.org/dataexplorer/detail?dataset_id=ds006563"],"creator":[{"@type":"Person","name":"Klaus Gramann, Thomas Töllner, Hermann J. Müller"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2010-01-01"}</script>

*Dimension-based attention modulates early visual processing*

**Citation:** Klaus Gramann, Thomas Töllner, Hermann J. Müller (2010). *Dimension-based attention modulates early visual processing*. [10.18112/openneuro.ds006563.v1.0.0](https://doi.org/10.18112/openneuro.ds006563.v1.0.0)

<p class="eegdash-ed-deck">12-participant EEG dataset — Dimension-based attention modulates early visual processing.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Klaus Gramann, Thomas Töllner, Hermann J. Müller</strong><br/><span class="role">Year</span> 2010 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 64 ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.8.0</span><span class="pill">Task · DimensionDiscrimination</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">64 ch · EEG · 500 Hz · 12 subjects, 12 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-S12 · task-DimensionDiscrimination</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds006563" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006563&sub=S12&task=DimensionDiscrimination&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006563 — sub-S12 · task-DimensionDiscrimination"
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006563</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Gramann2025</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006563</code> · <code>Gramann2025</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006563</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006563.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006563">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006563.v1.0.0">10.18112/openneuro.ds006563.v1.0.0</a></b></div></footer>
