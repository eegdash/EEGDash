...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000107</b></div><div>Iss. 107 · 100 subjects · 182 recordings · CC-BY-NC 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · FRL Wrist Control</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000107</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-NC 4.0</dd><dt>Updated</dt><dd>2026-02-25</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>100</dd><dt>Recordings</dt><dd>182</dd><dt>Modality</dt><dd>EMG</dd><dt>Channels</dt><dd>16</dd><dt>Sample rate</dt><dd>2000 Hz</dd><dt>Duration</dt><dd>77.2 h</dd><dt>Size</dt><dd>24.9 GB</dd><dt>Tasks</dt><dd><code>wrist</code></dd><dt>Sessions</dt><dd>2 · <code>000</code> · <code>001</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.11.0</dd><dt>Sidecars</dt><dd>events · channels · electrodes</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000107</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000107">EEGDash/nm000107</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000107">10.82901/nemar.nm000107</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000107">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000107">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000107.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">16 ch · EMG · 2000 Hz · 100 subjects, 182 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-021 · ses-001 · task-wrist</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>100 subjects and 182 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000107" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_emg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?emg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000107&sub=021&ses=001&task=wrist&ext=bdf&suffix=emg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EMG trace viewer for nm000107 — sub-021 · ses-001 · task-wrist"
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000107</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Kaifosh2025_107</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000107</code> · <code>Kaifosh2025_107</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000107</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000107.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000107">Hugging Face mirror</a></div><div>CC-BY-NC 4.0 · <b><a href="https://doi.org/10.82901/nemar.nm000107">10.82901/nemar.nm000107</a></b></div></footer>
