...
```none
pretrain losses (RestingState): [0.045, 0.003, 0.001, 0.0, 0.0]
```
...
```none
finetune losses (CCD): [0.57, 0.483, 0.427, 0.361, 0.303]
```
...
```none
finetune=0.550 | scratch=0.550 | chance=0.500 | metric=accuracy | gap=+0.000
```
...
RestingState                   -0.050         0.200         0.000
surroundSupp                    0.250         0.217         0.000
symbolSearch                    0.117         0.033        -0.017
```
...
{"encoder_weights_path": "plot_71_pretrained_encoder.pt", "pretext_subjects": 8, "target_subjects": 8, "transfer_gap": 0.0, "transfer_matrix_mean_delta": 0.0833}
```
