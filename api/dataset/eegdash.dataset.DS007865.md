...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS007865</b></div><div>Iss. 7865 · 24 subjects · 47 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Placebo Neuroepo multisession Phase II and III</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS007865</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.2139/ssrn.4966719">10.2139/ssrn.4966719</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>24</dd><dt>Recordings</dt><dd>47</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>19 (41), 21 (6)</dd><dt>Sample rate</dt><dd>200 Hz</dd><dt>Duration</dt><dd>10.2 h</dd><dt>Size</dt><dd>271.3 MB</dd><dt>Tasks</dt><dd><code>resteyesclosed</code></dd><dt>Sessions</dt><dd>2 · <code>1</code> · <code>2</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.2.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds007865</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="parkinson&#x27;s">Parkinson&#x27;s</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds007865.v1.0.0">10.18112/openneuro.ds007865.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds007865">OpenNeuro</a><a href="https://doi.org/10.2139/ssrn.4966719">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/DS007865.croissant.json" download>Croissant</a></div></aside>

# DS007865: eeg dataset, 24 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Placebo Neuroepo multisession Phase II and III","alternateName":"DS007865","description":"Placebo Neuroepo multisession Phase II and III. eeg dataset accessible via EEGDash as \`\`DS007865\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS007865.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds007865.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds007865.v1.0.0","https://openneuro.org/datasets/ds007865","https://nemar.org/dataexplorer/detail?dataset_id=ds007865"],"creator":[{"@type":"Person","name":"Maria Luisa Bringas Vega"},{"@type":"Person","name":"Lilia Morales Chacon"},{"@type":"Person","name":"Ivonne Pedroso Ibanez"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Placebo Neuroepo multisession Phase II and III*

**Citation:** Maria Luisa Bringas Vega, Lilia Morales Chacon, Ivonne Pedroso Ibanez (20). *Placebo Neuroepo multisession Phase II and III*. [10.18112/openneuro.ds007865.v1.0.0](https://doi.org/10.18112/openneuro.ds007865.v1.0.0)

<p class="eegdash-ed-deck">24-participant EEG dataset — Placebo Neuroepo multisession Phase II and III.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Maria Luisa Bringas Vega</strong> · <strong>Lilia Morales Chacon</strong> · Ivonne Pedroso Ibanez<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro<br/><span class="role">Funding</span> National Key R&D Program of China, (2024YFE0215100)</div><div class="eegdash-ed-pills"><span class="pill">EEG · 19 (41), 21 (6) ch</span><span class="pill">200 Hz</span><span class="pill is-info">BIDS 1.2.0</span><span class="pill">Task · resteyesclosed</span><span class="pill">2 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="parkinson&#x27;s">Parkinson&#x27;s</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
Participants were enrolled in a randomized, placebo-controlled study. NeuroEPO exposure was administered according to the intervention protocol (Cuban Public Registry of Clinical Trials: RPCEC00000233-En; [https://rpcec.sld.cu/en/trials/RPCEC00000233-En](https://rpcec.sld.cu/en/trials/RPCEC00000233-En) ), while placebo participants received identical procedures without active compound. Cumulative treatment exposure was quantified as total NeuroEPO dose; placebo participants were coded as dose = 0. Clinical and EEG assessments were conducted at baseline (pre-intervention) and after 9 months of completion of the intervention period (post-intervention).
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section eegdash-ed-sex" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#009E73; flex-shrink:0;" title="19 ch: 41"></div><div style="width:28px; height:14%; background:#009E73; flex-shrink:0;" title="21 ch: 6"></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">19</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">21</span>
  </div>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 200.0 Hz (n=47 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 10 h 14 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">19 (41), 21 (6) ch · EEG · 200 Hz · 24 subjects, 47 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-subPLAC24 · ses-2 · task-resteyesclosed</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>24 subjects and 47 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds007865" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds007865&sub=subPLAC24&ses=2&task=resteyesclosed&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds007865 — sub-subPLAC24 · ses-2 · task-resteyesclosed"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds007865). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds007865" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds007865/code/ds007865_histogram.png"
      alt="NEMAR pipeline statistics — DS007865"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds007865/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS007865"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds007865">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `DS007865`                                                                                                                |
| Year           | 20                                                                                                                        |
| Authors        | Maria Luisa Bringas Vega, Lilia Morales Chacon, Ivonne Pedroso Ibanez                                                     |
| License        | CC0                                                                                                                       |
| Citation / DOI | [doi:10.18112/openneuro.ds007865.v1.0.0](https://doi.org/10.18112/openneuro.ds007865.v1.0.0)                              |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds007865) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds007865) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS007865</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS007865</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS007865</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS007865.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds007865.v1.0.0">10.18112/openneuro.ds007865.v1.0.0</a></b></div></footer>
