...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS007666</b></div><div>Iss. 7666 · 55 subjects · 110 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Grupos Pre and Post bids</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS007666</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>55</dd><dt>Recordings</dt><dd>110</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>19 (95), 21 (13), 20 (2)</dd><dt>Sample rate</dt><dd>200 Hz</dd><dt>Duration</dt><dd>23.5 h</dd><dt>Size</dt><dd>626.3 MB</dd><dt>Tasks</dt><dd>20 tasks · <code>001</code> · <code>002</code> · …</dd><dt>Sessions</dt><dd>2 · <code>post</code> · <code>pre</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.6.0</dd><dt>Sidecars</dt><dd>events · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds007666</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds007666.v1.0.0">10.18112/openneuro.ds007666.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds007666">OpenNeuro</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/DS007666.croissant.json" download>Croissant</a></div></aside>

# DS007666: eeg dataset, 55 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Grupos Pre and Post bids","alternateName":"DS007666","description":"Grupos Pre and Post bids. eeg dataset accessible via EEGDash as \`\`DS007666\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS007666.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds007666.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds007666.v1.0.0","https://openneuro.org/datasets/ds007666","https://nemar.org/dataexplorer/detail?dataset_id=ds007666"],"creator":[{"@type":"Person","name":"MENGSHA QI"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Grupos Pre and Post bids*

**Citation:** MENGSHA QI (—). *Grupos Pre and Post bids*. [10.18112/openneuro.ds007666.v1.0.0](https://doi.org/10.18112/openneuro.ds007666.v1.0.0)

<p class="eegdash-ed-deck">55-participant EEG dataset — Grupos Pre and Post bids.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>MENGSHA QI</strong></div><div class="eegdash-ed-pills"><span class="pill">EEG · 19 (95), 21 (13), 20 (2) ch</span><span class="pill">200 Hz</span><span class="pill is-info">BIDS 1.6.0</span><span class="pill">20 tasks</span><span class="pill">2 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = DS007666(cache_dir="./data", subject="01")
```
...
@dataset{ds007666,
  ...
  author = {MENGSHA QI},
  doi = {10.18112/openneuro.ds007666.v1.0.0},
  url = {https://doi.org/10.18112/openneuro.ds007666.v1.0.0},
}
```
...
<div class="eegdash-ed-figpair">
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds007666" target="_blank" rel="noopener">OpenNeuro</a>;
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds007666). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds007666" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds007666/code/ds007666_histogram.png"
      alt="NEMAR pipeline statistics — DS007666"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds007666/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS007666"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds007666">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                                                                                 |
| Canonical      | —                                                                                                                                                                                 |
| Importable as  | `DS007666`                                                                                                                                                                        |
| Year           | —                                                                                                                                                                                 |
| Authors        | MENGSHA QI                                                                                                                                                                        |
| License        | CC0                                                                                                                                                                               |
| Citation / DOI | [doi:10.18112/openneuro.ds007666.v1.0.0](https://doi.org/10.18112/openneuro.ds007666.v1.0.0)                                                                                      |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds007666) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds007666) | [Source URL](https://openneuro.org/datasets/ds007666) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS007666</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS007666</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS007666</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS007666.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds007666.v1.0.0">10.18112/openneuro.ds007666.v1.0.0</a></b></div></footer>
