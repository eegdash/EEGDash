...
- Source: nemar
- OpenNeuro: [nm000217](https://openneuro.org/datasets/nm000217)
- NeMAR: [nm000217](https://nemar.org/dataexplorer/detail?dataset_id=nm000217)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=44, range 23–23 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="20-24: 44"></div>
  </div>
