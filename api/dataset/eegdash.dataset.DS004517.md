...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS004517</b></div><div>Iss. 4517 · 7 subjects · 7 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · EEG recordings for semantic decoding of imagined animals and…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS004517</dd><dt>Version</dt><dd>v1.0.2</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-025-04967-0">10.1038/s41597-025-04967-0</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>7</dd><dt>Recordings</dt><dd>7</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>80</dd><dt>Sample rate</dt><dd>2048 Hz</dd><dt>Duration</dt><dd>7.7 h</dd><dt>Size</dt><dd>12.7 GB</dd><dt>Tasks</dt><dd><code>eeg</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds004517</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="other">Other</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds004517">EEGDash/ds004517</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds004517.v1.0.2">10.18112/openneuro.ds004517.v1.0.2</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds004517">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-025-04967-0">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds004517">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS004517.croissant.json" download>Croissant</a></div></aside>

# DS004517: eeg dataset, 7 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"EEG recordings for semantic decoding of imagined animals and tools during auditory imagery task","alternateName":"DS004517","description":"EEG recordings for semantic decoding of imagined animals and tools during auditory imagery task. eeg dataset accessible via EEGDash as \`\`DS004517\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS004517.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds004517.v1.0.2","sameAs":["https://doi.org/10.18112/openneuro.ds004517.v1.0.2","https://openneuro.org/datasets/ds004517","https://nemar.org/dataexplorer/detail?dataset_id=ds004517"],"creator":[{"@type":"Person","name":"Milan Rybář"},{"@type":"Person","name":"Riccardo Poli"},{"@type":"Person","name":"Ian Daly"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*EEG recordings for semantic decoding of imagined animals and tools during auditory imagery task*

**Citation:** Milan Rybář, Riccardo Poli, Ian Daly (20). *EEG recordings for semantic decoding of imagined animals and tools during auditory imagery task*. [10.18112/openneuro.ds004517.v1.0.2](https://doi.org/10.18112/openneuro.ds004517.v1.0.2)

<p class="eegdash-ed-deck">7-participant EEG dataset — EEG recordings for semantic decoding of imagined animals and tools during auditory imagery task.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Milan Rybář</strong> · <strong>Riccardo Poli</strong> · Ian Daly<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 80 ch</span><span class="pill">2048 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill">Task · eeg</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="other">Other</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=7, range 25–44 yr, mean 34.0 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=2"><div style="width:100%; height:60px; background:#006ca3; flex-shrink:0;" title="25-29: female n=1"></div><div style="width:100%; height:60px; background:#f7941d; flex-shrink:0;" title="25-29: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=1"><div style="width:100%; height:60px; background:#f7941d; flex-shrink:0;" title="30-34: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="35-39: n=3"><div style="width:100%; height:60px; background:#006ca3; flex-shrink:0;" title="35-39: female n=1"></div><div style="width:100%; height:120px; background:#f7941d; flex-shrink:0;" title="35-39: male n=2"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="40-44: n=1"><div style="width:100%; height:60px; background:#f7941d; flex-shrink:0;" title="40-44: male n=1"></div></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">25</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">30</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">35</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">40</span>
  </div>
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 2</span><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#f7941d; display:inline-block;"></i>Male · 5</span></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">80 ch · EEG · 2048 Hz · 7 subjects, 7 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-01 · task-eeg</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>7 subjects and 7 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds004517" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds004517&sub=01&task=eeg&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds004517 — sub-01 · task-eeg"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds004517). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds004517" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds004517/code/ds004517_histogram.png"
      alt="NEMAR pipeline statistics — DS004517"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds004517/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS004517"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds004517">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds004517) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds004517) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS004517</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Rybar2023_semantic</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS004517</code> · <code>Rybar2023_semantic</code></span></div>
...
* [eegdash.dataset.DS003420](eegdash.dataset.DS003420.md)
* [eegdash.dataset.DS005932](eegdash.dataset.DS005932.md)

<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS004517</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS004517.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds004517">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds004517.v1.0.2">10.18112/openneuro.ds004517.v1.0.2</a></b></div></footer>
