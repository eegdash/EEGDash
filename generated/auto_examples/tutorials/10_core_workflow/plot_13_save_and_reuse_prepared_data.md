...
```none
saved: /tmp/eegdash_save_ka7xx9ix/windows
...
```none
Zarr write_s=0.0167, read_s=0.0062, size_mb=0.0080
```
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0159, read_s=0.0125, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_ka7xx9ix/windows/0 already exists. Please select
