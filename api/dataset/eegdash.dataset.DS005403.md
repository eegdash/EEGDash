...
<details class="electrode-explorer">
  ...
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=7f889a9280507688&embed=1"
    loading="lazy"
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div style="display:flex; height:22px; width:100%; max-width:400px; border-radius:4px; overflow:hidden;">
    <div style="width:53.1%; background:#e07ab5; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Female: 17">17</div><div style="width:46.9%; background:#4472c4; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Male: 15">15</div>
  </div>
