...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006392</b></div><div>Iss. 6392 · 1 subjects · 1 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · HED schema library for SCORE annotations example</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006392</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-025-05791-2">10.1038/s41597-025-05791-2</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>1</dd><dt>Recordings</dt><dd>1</dd><dt>Modality</dt><dd>iEEG</dd><dt>Channels</dt><dd>166</dd><dt>Sample rate</dt><dd>512 Hz</dd><dt>Duration</dt><dd>3 min</dd><dt>Size</dt><dd>32.4 MB</dd><dt>Tasks</dt><dd><code>photicstim</code></dd><dt>Sessions</dt><dd><code>ieeg01</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006392</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006392">EEGDash/ds006392</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006392.v1.0.1">10.18112/openneuro.ds006392.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006392">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-025-05791-2">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006392">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006392.croissant.json" download>Croissant</a></div></aside>

# DS006392: ieeg dataset, 1 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"HED schema library for SCORE annotations example","alternateName":"DS006392","description":"HED schema library for SCORE annotations example. ieeg dataset accessible via EEGDash as \`\`DS006392\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006392.html","keywords":["ieeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006392.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds006392.v1.0.1","https://openneuro.org/datasets/ds006392","https://nemar.org/dataexplorer/detail?dataset_id=ds006392"],"creator":[{"@type":"Person","name":"Tal Pal Attia"},{"@type":"Person","name":"Kay Robbins"},{"@type":"Person","name":"Dora Hermes"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*HED schema library for SCORE annotations example*

**Citation:** Tal Pal Attia, Kay Robbins, Dora Hermes (20). *HED schema library for SCORE annotations example*. [10.18112/openneuro.ds006392.v1.0.1](https://doi.org/10.18112/openneuro.ds006392.v1.0.1)

<p class="eegdash-ed-deck">1-participant iEEG dataset — HED schema library for SCORE annotations example.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Tal Pal Attia</strong> · <strong>Kay Robbins</strong> · Dora Hermes<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro<br/><span class="role">Funding</span> National Institute of Health Grant R01MH126700 (SM) · National Institute of Health Grant R01MH122258 (DH)</div><div class="eegdash-ed-pills"><span class="pill">iEEG · 166 ch</span><span class="pill">512 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">Task · photicstim</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006392) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006392) |
