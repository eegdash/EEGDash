...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000235</b></div><div>Iss. 235 · 31 subjects · 63 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Eye-BCI multimodal MI/ME dataset from Guttmann-Flury et al 2025</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000235</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Updated</dt><dd>2026-03-25</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>31</dd><dt>Recordings</dt><dd>63</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>66</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>7.0 h</dd><dt>Size</dt><dd>4.6 GB</dd><dt>Tasks</dt><dd><code>imagery</code></dd><dt>Sessions</dt><dd>3 · <code>0</code> · <code>1</code> · <code>2</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000235</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000235">EEGDash/nm000235</a></dd></dl><div class="actions"><a href="https://openneuro.org/datasets/nm000235">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000235">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000235.croissant.json" download>Croissant</a></div></aside>

# NM000235: eeg dataset, 31 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Eye-BCI multimodal MI/ME dataset from Guttmann-Flury et al 2025","alternateName":"NM000235","description":"Eye-BCI multimodal MI/ME dataset from Guttmann-Flury et al 2025. eeg dataset accessible via EEGDash as \`\`NM000235\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000235.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"sameAs":["https://openneuro.org/datasets/nm000235","https://nemar.org/dataexplorer/detail?dataset_id=nm000235","https://nemar.org/dataexplorer/detail/nm000235"],"creator":[{"@type":"Person","name":"Eva Guttmann-Flury"},{"@type":"Person","name":"Xinjun Sheng"},{"@type":"Person","name":"Xiangyang Zhu"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2025-01-01"}</script>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <p><strong>Channel counts</strong>: 66 ch (n=63 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">66 ch · EEG · 1000 Hz · 31 subjects, 63 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-13 · ses-2 · task-imagery · run-0</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>31 subjects and 63 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000235" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000235&sub=13&ses=2&task=imagery&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000235 — sub-13 · ses-2 · task-imagery · run-0"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000235). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000235" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000235/code/nm000235_histogram.png"
      alt="NEMAR pipeline statistics — NM000235"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000235/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000235"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000235">
  <div class="ee-bar">
...
|----------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Title          | Eye-BCI multimodal MI/ME dataset from Guttmann-Flury et al 2025                                                                                                                          |
| Author (year)  | `GuttmannFlury2025_Eye_BCI`                                                                                                                                                              |
| Canonical      | —                                                                                                                                                                                        |
| Importable as  | `NM000235`, `GuttmannFlury2025_Eye_BCI`                                                                                                                                                  |
| Year           | 2025                                                                                                                                                                                     |
| Authors        | Eva Guttmann-Flury, Xinjun Sheng, Xiangyang Zhu                                                                                                                                          |
| License        | CC0                                                                                                                                                                                      |
| Citation / DOI | Unknown                                                                                                                                                                                  |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000235) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000235) | [Source URL](https://nemar.org/dataexplorer/detail/nm000235) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000235</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>GuttmannFlury2025_Eye_BCI</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000235</code> · <code>GuttmannFlury2025_Eye_BCI</code></span></div>
...
OpenNeuro dataset: [https://openneuro.org/datasets/nm000235](https://openneuro.org/datasets/nm000235)
NeMAR dataset: [https://nemar.org/dataexplorer/detail?dataset_id=nm000235](https://nemar.org/dataexplorer/detail?dataset_id=nm000235)
...
* [eegdash.dataset.NM000151](eegdash.dataset.NM000151.md)

<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000235</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000235.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000235">Hugging Face mirror</a></div><div>CC0 · <b><span style="opacity:.6">DOI not on file</span></b></div></footer>
