...
```none
saved: /tmp/eegdash_save_quzfsds1/windows
...
```none
Zarr write_s=0.0168, read_s=0.0057, size_mb=0.0080
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_quzfsds1/windows/0 already exists. Please select
