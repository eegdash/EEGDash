...
```none
finetune losses (CCD): [0.589, 0.501, 0.461, 0.373, 0.335]
```
...
```none
finetune=0.567 | scratch=0.683 | chance=0.517 | metric=accuracy | gap=-0.117
```
...
RestingState                    0.200           0.1          0.00
surroundSupp                    0.367           0.1          0.00
symbolSearch                    0.200          -0.1         -0.05
```
...
{"encoder_weights_path": "plot_71_pretrained_encoder.pt", "pretext_subjects": 8, "target_subjects": 8, "transfer_gap": -0.1167, "transfer_matrix_mean_delta": 0.0907}
```
