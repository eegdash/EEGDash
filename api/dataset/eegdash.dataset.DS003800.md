...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003800</b></div><div>Iss. 3800 · 13 subjects · 24 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Auditory Gamma Entrainment</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003800</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Updated</dt><dd>2021-09-27</dd><dt>Contact</dt><dd>Mojtaba Lahijanian</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>13</dd><dt>Recordings</dt><dd>24</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>19</dd><dt>Sample rate</dt><dd>250 Hz</dd><dt>Duration</dt><dd>1.4 h</dd><dt>Size</dt><dd>189.3 MB</dd><dt>Tasks</dt><dd><code>AuditoryGammaEntrainment</code> · <code>Rest</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.0.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003800</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="dementia">Dementia</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003800">EEGDash/ds003800</a></dd><dt>Citations</dt><dd>4</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003800.v1.0.0">10.18112/openneuro.ds003800.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003800">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/ds003800">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003800.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=13, range 57–89 yr, mean 72.6 yr · sex per subject not reported)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="flex:1 1 0; min-width:0; height:90px; background:#006ca3;" title="55-59: 1"></div><div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="60-64: 2"></div><div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="65-69: 2"></div><div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="70-74: 2"></div><div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="75-79: 2"></div><div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="80-84: 2"></div><div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="85-89: 2"></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">55</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">60</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">65</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">70</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">75</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">80</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">85</span>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">19 ch · EEG · 250 Hz · 13 subjects, 24 recordings</span>
  </div>
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003800</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Lahijanian2021_Auditory</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003800</code> · <code>Lahijanian2021_Auditory</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003800</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003800.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003800">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003800.v1.0.0">10.18112/openneuro.ds003800.v1.0.0</a></b></div></footer>
