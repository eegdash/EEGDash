...
```none
saved: /tmp/eegdash_save_tvyd4f19/windows
...
```none
Zarr write_s=0.0173, read_s=0.0065, size_mb=0.0080
```
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0164, read_s=0.0124, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_tvyd4f19/windows/0 already exists. Please select
