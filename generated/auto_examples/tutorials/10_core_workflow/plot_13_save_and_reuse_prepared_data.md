...
```none
saved: /tmp/eegdash_save_01x10fu7/windows
...
```none
reload OK: type=BaseConcatDataset, n=2, read_s=0.0061
```
...
```none
Zarr write_s=0.0162, read_s=0.0057, size_mb=0.0080
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_01x10fu7/windows/0 already exists. Please select
