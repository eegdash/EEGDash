...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000255</b></div><div>Iss. 255 · 30 subjects · 291 recordings · CC BY 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · The Brain, Body, and Behaviour Dataset (1.0.0) - Experiment 2</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000255</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC BY 4.0</dd><dt>Updated</dt><dd>2026-04-13</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>30</dd><dt>Recordings</dt><dd>291</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>128 Hz</dd><dt>Duration</dt><dd>2 min</dd><dt>Size</dt><dd>5.3 GB</dd><dt>Tasks</dt><dd>5 tasks · <code>stim01</code> · <code>stim02</code> · …</dd><dt>Sessions</dt><dd>2 · <code>01</code> · <code>02</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.10.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000255</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000255">EEGDash/nm000255</a></dd></dl><div class="actions"><a href="https://openneuro.org/datasets/nm000255">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000255">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000255.croissant.json" download>Croissant</a></div></aside>

# NM000255: eeg dataset, 30 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"The Brain, Body, and Behaviour Dataset (1.0.0) - Experiment 2","alternateName":"NM000255","description":"The Brain, Body, and Behaviour Dataset (1.0.0) - Experiment 2. eeg dataset accessible via EEGDash as \`\`NM000255\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000255.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"sameAs":["https://openneuro.org/datasets/nm000255","https://nemar.org/dataexplorer/detail?dataset_id=nm000255","https://nemar.org/dataexplorer/detail/nm000255"],"creator":[{"@type":"Person","name":"Jens Madsen"},{"@type":"Person","name":"Nikhil Kuppa"},{"@type":"Person","name":"Lucas Parra"}],"license":"https://creativecommons.org/licenses/by/4.0/"}</script>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=31, range 18–50 yr, mean 26.0 yr · sex per subject not reported)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="flex:1 1 0; min-width:0; height:75px; background:#006ca3;" title="15-19: 5"></div><div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="20-24: 12"></div><div style="flex:1 1 0; min-width:0; height:90px; background:#006ca3;" title="25-29: 6"></div><div style="flex:1 1 0; min-width:0; height:45px; background:#006ca3;" title="30-34: 3"></div><div style="flex:1 1 0; min-width:0; height:45px; background:#006ca3;" title="35-39: 3"></div><div style="flex:1 1 0; min-width:0; height:15px; background:#006ca3;" title="45-49: 1"></div><div style="flex:1 1 0; min-width:0; height:15px; background:#006ca3;" title="50-54: 1"></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">15</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">20</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">25</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">30</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">35</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">45</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">50</span>
  </div>
  ...
  <p><strong>Channel counts</strong>: 64 ch (n=291 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 128.0 Hz (n=291 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">64 ch · EEG · 128 Hz · 30 subjects, 291 recordings</span>
  </div>
  ...
  <p class="trace-viewer-caption">
    ...
    <strong>30 subjects and 291 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000255" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000255&sub=01&ses=01&task=stim01&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000255 — sub-01 · ses-01 · task-stim01"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000255). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000255" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000255/code/nm000255_histogram.png"
      alt="NEMAR pipeline statistics — NM000255"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000255/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000255"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000255">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000255) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000255) | [Source URL](https://nemar.org/dataexplorer/detail/nm000255) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000255</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Madsen2024_E2</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000255</code> · <code>Madsen2024_E2</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000255</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000255.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000255">Hugging Face mirror</a></div><div>CC BY 4.0 · <b><span style="opacity:.6">DOI not on file</span></b></div></footer>
