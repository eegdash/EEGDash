...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005866</b></div><div>Iss. 5866 · 60 subjects · 60 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Flankers-NEAR</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005866</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Updated</dt><dd>2025-01-21</dd><dt>Contact</dt><dd>Emily M. Akers</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>60</dd><dt>Recordings</dt><dd>60</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>32</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>16.0 h</dd><dt>Size</dt><dd>3.6 GB</dd><dt>Tasks</dt><dd><code>FlankerNEAR</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005866</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005866">EEGDash/ds005866</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005866.v1.0.1">10.18112/openneuro.ds005866.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005866">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/ds005866">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005866.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=60, range 20–54 yr, mean 31.9 yr · sex per subject not reported)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="flex:1 1 0; min-width:0; height:130px; background:#006ca3;" title="20-24: 13"></div><div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="25-29: 18"></div><div style="flex:1 1 0; min-width:0; height:70px; background:#006ca3;" title="30-34: 7"></div><div style="flex:1 1 0; min-width:0; height:120px; background:#006ca3;" title="35-39: 12"></div><div style="flex:1 1 0; min-width:0; height:40px; background:#006ca3;" title="40-44: 4"></div><div style="flex:1 1 0; min-width:0; height:30px; background:#006ca3;" title="45-49: 3"></div><div style="flex:1 1 0; min-width:0; height:30px; background:#006ca3;" title="50-54: 3"></div>
  </div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-13 · task-FlankerNEAR</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>60 subjects and 60 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds005866" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds005866&sub=13&task=FlankerNEAR&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds005866 — sub-13 · task-FlankerNEAR"
...
* [eegdash.dataset.DS006563](eegdash.dataset.DS006563.md)
