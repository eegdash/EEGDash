...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000272</b></div><div>Iss. 272 · 22 subjects · 120 recordings · CC-BY-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Romani et al. 2025 — BrainForm</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000272</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-4.0</dd><dt>Updated</dt><dd>2026-04-11</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>22</dd><dt>Recordings</dt><dd>120</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>8</dd><dt>Sample rate</dt><dd>250 Hz</dd><dt>Duration</dt><dd>6.3 h</dd><dt>Size</dt><dd>134.3 MB</dd><dt>Tasks</dt><dd><code>p300</code></dd><dt>Sessions</dt><dd>6 · <code>0cb</code> … <code>2grainExtra</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000272</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000272">EEGDash/nm000272</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.48550/arXiv.2510.10169">10.48550/arXiv.2510.10169</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000272">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000272">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000272.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">8 ch · EEG · 250 Hz · 22 subjects, 120 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-0 · ses-0grain · task-p300 · run-1</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>22 subjects and 120 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000272" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000272&sub=0&ses=0grain&task=p300&run=1&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000272 — sub-0 · ses-0grain · task-p300 · run-1"
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000272</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Romani2025_BF_ERP</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000272</code> · <code>Romani2025_BF_ERP</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000272</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000272.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000272">Hugging Face mirror</a></div><div>CC-BY-4.0 · <b><a href="https://doi.org/10.48550/arXiv.2510.10169">10.48550/arXiv.2510.10169</a></b></div></footer>
