...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS002778</b></div><div>Iss. 2778 · 31 subjects · 46 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · UC San Diego Resting State EEG Data from Patients with Parkin…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS002778</dd><dt>Version</dt><dd>v1.0.5</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1523/eneuro.0151-19.2019">10.1523/eneuro.0151-19.2019</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>31</dd><dt>Recordings</dt><dd>46</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>41</dd><dt>Sample rate</dt><dd>512 Hz</dd><dt>Duration</dt><dd>2.5 h</dd><dt>Size</dt><dd>545.2 MB</dd><dt>Tasks</dt><dd><code>rest</code></dd><dt>Sessions</dt><dd>3 · <code>hc</code> · <code>off</code> · <code>on</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.2.2</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds002778</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="parkinson&#x27;s">Parkinson&#x27;s</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="resting-state">Resting State</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds002778">EEGDash/ds002778</a></dd><dt>Citations</dt><dd>42</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds002778.v1.0.5">10.18112/openneuro.ds002778.v1.0.5</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds002778">OpenNeuro</a><a href="https://doi.org/10.1523/eneuro.0151-19.2019">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds002778">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS002778.croissant.json" download>Croissant</a></div></aside>
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds002778) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds002778) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS002778</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Rockhill2020</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS002778</code> · <code>Rockhill2020</code></span></div>
...
* [eegdash.dataset.DS004324](eegdash.dataset.DS004324.md)
* [eegdash.dataset.DS003519](eegdash.dataset.DS003519.md)
* [eegdash.dataset.DS003516](eegdash.dataset.DS003516.md)

<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS002778</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS002778.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds002778">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds002778.v1.0.5">10.18112/openneuro.ds002778.v1.0.5</a></b></div></footer>
