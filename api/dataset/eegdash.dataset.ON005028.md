...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON005028</b></div><div>Iss. 5028 · 11 subjects · 105 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Comparing P300 Flashing paradigms in online typing with langu…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON005028</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2022.06.24.22276882">10.1101/2022.06.24.22276882</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>11</dd><dt>Recordings</dt><dd>105</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>Varies</dd><dt>Sample rate</dt><dd>Varies</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>1.5 GB</dd><dt>Tasks</dt><dd><code>cb</code> · <code>comb</code> · <code>rc</code></dd><dt>Sessions</dt><dd>2 · <code>test</code> · <code>train</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>80% · Good</dd><dt>Storage</dt><dd><code>s3://nemar/on005028</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on005028">10.82901/nemar.on005028</a></div><div class="actions"><a href="https://openneuro.org/datasets/on005028">OpenNeuro</a><a href="https://doi.org/10.1101/2022.06.24.22276882">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON005028.croissant.json" download>Croissant</a></div></aside>

# ON005028: eeg dataset, 11 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Comparing P300 Flashing paradigms in online typing with language models","alternateName":"ON005028","description":"Comparing P300 Flashing paradigms in online typing with language models. eeg dataset accessible via EEGDash as \`\`ON005028\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON005028.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on005028","sameAs":["https://doi.org/10.82901/nemar.on005028","https://openneuro.org/datasets/on005028","https://nemar.org/dataexplorer/detail?dataset_id=on005028"],"creator":[{"@type":"Person","name":"Nand Chandravadia"},{"@type":"Person","name":"Shrita Pendekanti"},{"@type":"Person","name":"Dustin Roberts"},{"@type":"Person","name":"Robert Tran"},{"@type":"Person","name":"Saarang Panchavati"},{"@type":"Person","name":"Corey Arnold"},{"@type":"Person","name":"Nader Pouratian"},{"@type":"Person","name":"William Speier"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Comparing P300 Flashing paradigms in online typing with language models*

**Citation:** Nand Chandravadia, Shrita Pendekanti, Dustin Roberts, Robert Tran, Saarang Panchavati, Corey Arnold, Nader Pouratian, William Speier (20). *Comparing P300 Flashing paradigms in online typing with language models*. [10.82901/nemar.on005028](https://doi.org/10.82901/nemar.on005028)

<p class="eegdash-ed-deck">11-participant EEG dataset — Comparing P300 Flashing paradigms in online typing with language models.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Nand Chandravadia</strong> · <strong>Shrita Pendekanti</strong> · Dustin Roberts · Robert Tran · Saarang Panchavati · Corey Arnold · …<br/><span class="role">Year</span> 20 · Distributed via NeMAR<br/><span class="role">Funding</span> National Science Foundation Graduate Research Fellowship Program under grant no. DGE-2034835</div><div class="eegdash-ed-pills"><span class="pill is-info">BIDS 1.8.0</span><span class="pill">3 tasks</span><span class="pill">2 sessions</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
> [DOI](https://doi.org/10.82901/nemar.on005028)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-01 · ses-test · run-1</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on005028" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on005028&sub=01&ses=test&run=1&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on005028 — sub-01 · ses-test · run-1"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on005028). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on005028" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on005028/code/on005028_histogram.png"
      alt="NEMAR pipeline statistics — ON005028"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on005028/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON005028"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on005028">
  <div class="ee-bar">
...
| License        | CC0                                                                                                                                  |
| Citation / DOI | [10.82901/nemar.on005028](https://doi.org/10.82901/nemar.on005028)                                                                   |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on005028) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on005028)            |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON005028</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON005028</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON005028</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON005028.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on005028">10.82901/nemar.on005028</a></b></div></footer>
