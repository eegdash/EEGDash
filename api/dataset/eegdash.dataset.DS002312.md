...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS002312</b></div><div>Iss. 2312 · 19 subjects · 23 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · OcularLDT</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS002312</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.7551/mitpress/11442.003.0076">10.7551/mitpress/11442.003.0076</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>19</dd><dt>Recordings</dt><dd>23</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>257</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>7.1 h</dd><dt>Size</dt><dd>35.0 GB</dd><dt>Tasks</dt><dd><code>OcularLDT</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.2.0</dd><dt>Sidecars</dt><dd>events · channels · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds002312</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds002312">EEGDash/ds002312</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds002312.v1.0.0">10.18112/openneuro.ds002312.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds002312">OpenNeuro</a><a href="https://doi.org/10.7551/mitpress/11442.003.0076">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds002312">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS002312.croissant.json" download>Croissant</a></div></aside>

# DS002312: meg dataset, 19 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"OcularLDT","alternateName":"DS002312","description":"OcularLDT. meg dataset accessible via EEGDash as \`\`DS002312\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS002312.html","keywords":["meg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds002312.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds002312.v1.0.0","https://openneuro.org/datasets/ds002312","https://nemar.org/dataexplorer/detail?dataset_id=ds002312"],"creator":[{"@type":"Person","name":"Teon L Brooks"},{"@type":"Person","name":"Laura Gwilliams"},{"@type":"Person","name":"Alexandre Gramfort"},{"@type":"Person","name":"Alec Marantz"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*OcularLDT*

**Citation:** Teon L Brooks, Laura Gwilliams, Alexandre Gramfort, Alec Marantz (—). *OcularLDT*. [10.18112/openneuro.ds002312.v1.0.0](https://doi.org/10.18112/openneuro.ds002312.v1.0.0)

<p class="eegdash-ed-deck">19-participant MEG dataset — OcularLDT.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Teon L Brooks</strong> · <strong>Laura Gwilliams</strong> · Alexandre Gramfort · Alec Marantz<br/><span class="role">Funding</span> NSF DGE-1342536 (TB) · Abu Dhabi Institute Grant G1001 (AM)</div><div class="eegdash-ed-pills"><span class="pill">MEG · 257 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.2.0</span><span class="pill">Task · OcularLDT</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 257 ch (n=23 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 1000.0 Hz (n=15 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">257 ch · MEG · 1000 Hz · 19 subjects, 23 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-A0134 · task-OcularLDT</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>19 subjects and 23 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds002312" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_meg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?meg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds002312&sub=A0134&task=OcularLDT&ext=fif&suffix=meg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live MEG trace viewer for ds002312 — sub-A0134 · task-OcularLDT"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — MEG · 208 sensors — 208 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=816450299df3ba08&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 900px; display: block;"
    title="Topomap of MEG · 208 sensors"
    referrerpolicy="no-referrer">
  </iframe>
</details></div></div></div>
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds002312). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds002312" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds002312/code/ds002312_histogram.png"
      alt="NEMAR pipeline statistics — DS002312"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds002312/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS002312"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds002312">
  <div class="ee-bar">
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS002312</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Brooks2019</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS002312</code> · <code>Brooks2019</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS002312</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS002312.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds002312">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds002312.v1.0.0">10.18112/openneuro.ds002312.v1.0.0</a></b></div></footer>
