...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000170</b></div><div>Iss. 170 · 10 subjects · 90 recordings · CC-BY-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · BNCI 2025-002 Continuous 2D Trajectory Decoding dataset</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000170</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-4.0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1088/1741-2552/ac689f">10.1088/1741-2552/ac689f</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>10</dd><dt>Recordings</dt><dd>90</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>60</dd><dt>Sample rate</dt><dd>200 Hz</dd><dt>Duration</dt><dd>56.4 h</dd><dt>Size</dt><dd>3.4 GB</dd><dt>Tasks</dt><dd><code>imagery</code></dd><dt>Sessions</dt><dd>3 · <code>0ses1</code> · <code>1ses2</code> · <code>2ses3</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000170</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000170">10.82901/nemar.nm000170</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000170">OpenNeuro</a><a href="https://doi.org/10.1088/1741-2552/ac689f">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/NM000170.croissant.json" download>Croissant</a></div></aside>

# NM000170: eeg dataset, 10 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"BNCI 2025-002 Continuous 2D Trajectory Decoding dataset","alternateName":"NM000170","description":"BNCI 2025-002 Continuous 2D Trajectory Decoding dataset. eeg dataset accessible via EEGDash as \`\`NM000170\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000170.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.nm000170","sameAs":["https://doi.org/10.82901/nemar.nm000170","https://openneuro.org/datasets/nm000170","https://nemar.org/dataexplorer/detail?dataset_id=nm000170"],"creator":[{"@type":"Person","name":"Hannah S Pulferer"},{"@type":"Person","name":"Brynja Ásgeirsdóttir"},{"@type":"Person","name":"Valeria Mondini"},{"@type":"Person","name":"Andreea I Sburlea"},{"@type":"Person","name":"Gernot R Müller-Putz"}],"license":"https://creativecommons.org/licenses/by/4.0/","datePublished":"2022-01-01"}</script>

*BNCI 2025-002 Continuous 2D Trajectory Decoding dataset*

**Citation:** Hannah S Pulferer, Brynja Ásgeirsdóttir, Valeria Mondini, Andreea I Sburlea, Gernot R Müller-Putz (2022). *BNCI 2025-002 Continuous 2D Trajectory Decoding dataset*. [10.82901/nemar.nm000170](https://doi.org/10.82901/nemar.nm000170)

<p class="eegdash-ed-deck">10-participant EEG dataset — BNCI 2025-002 Continuous 2D Trajectory Decoding dataset.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Hannah S Pulferer</strong> · <strong>Brynja Ásgeirsdóttir</strong> · Valeria Mondini · Andreea I Sburlea · Gernot R Müller-Putz<br/><span class="role">Year</span> 2022 · Distributed via NeMAR<br/><span class="role">Funding</span> European Research Council ERC-CoG 2015 681231 'Feel Your Reach' · NTU-TUG joint PhD program</div><div class="eegdash-ed-pills"><span class="pill">EEG · 60 ch</span><span class="pill">200 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">Task · imagery</span><span class="pill">3 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
[DOI](https://doi.org/10.82901/nemar.nm000170)
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">60 ch · EEG · 200 Hz · 10 subjects, 90 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-6 · ses-1ses2 · task-imagery · run-0</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/nm000170" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000170&sub=6&ses=1ses2&task=imagery&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000170 — sub-6 · ses-1ses2 · task-imagery · run-0"
...
| License        | CC-BY-4.0                                                                                                                 |
| Citation / DOI | [10.82901/nemar.nm000170](https://doi.org/10.82901/nemar.nm000170)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000170) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000170) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000170</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Pulferer2025</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000170</code> · <code>Pulferer2025</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000170</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000170.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC-BY-4.0 · <b><a href="https://doi.org/10.82901/nemar.nm000170">10.82901/nemar.nm000170</a></b></div></footer>
