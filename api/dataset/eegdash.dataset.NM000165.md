...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-01 · task-isometric35percentmvc · run-01</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>1 subjects and 10 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000165" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_emg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?emg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000165&sub=01&task=isometric35percentmvc&run=01&ext=edf&suffix=emg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EMG trace viewer for nm000165 — sub-01 · task-isometric35percentmvc · run-01"
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000165</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000165.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000165">Hugging Face mirror</a></div><div>CC0 BY 4.0 · <b><a href="https://doi.org/https://doi.org/10.7910/DVN/ID1WNQ">https://doi.org/10.7910/DVN/ID1WNQ</a></b></div></footer>
