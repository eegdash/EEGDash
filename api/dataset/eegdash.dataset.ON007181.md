...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON007181</b></div><div>Iss. 7181 · 59 subjects · 59 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Structural MRI, Resting-state fMRI, and PSG/EEG Dataset of Zo…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON007181</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1186/s10194-025-02204-y">10.1186/s10194-025-02204-y</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>59</dd><dt>Recordings</dt><dd>59</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>24</dd><dt>Sample rate</dt><dd>1024 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>59.2 GB</dd><dt>Tasks</dt><dd><code>sleep</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on007181</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on007181">10.82901/nemar.on007181</a></div><div class="actions"><a href="https://openneuro.org/datasets/on007181">OpenNeuro</a><a href="https://doi.org/10.1186/s10194-025-02204-y">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON007181.croissant.json" download>Croissant</a></div></aside>

# ON007181: eeg dataset, 59 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Structural MRI, Resting-state fMRI, and PSG/EEG Dataset of Zoster-associated Neuralgia","alternateName":"ON007181","description":"Structural MRI, Resting-state fMRI, and PSG/EEG Dataset of Zoster-associated Neuralgia. eeg dataset accessible via EEGDash as \`\`ON007181\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON007181.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on007181","sameAs":["https://doi.org/10.82901/nemar.on007181","https://openneuro.org/datasets/on007181","https://nemar.org/dataexplorer/detail?dataset_id=on007181"],"creator":[{"@type":"Person","name":"Li Li"},{"@type":"Person","name":"Qi Han"},{"@type":"Person","name":"Haolei Bai"},{"@type":"Person","name":"Xiaolong Zhang"},{"@type":"Person","name":"Yong Liu"},{"@type":"Person","name":"Chao He"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Structural MRI, Resting-state fMRI, and PSG/EEG Dataset of Zoster-associated Neuralgia*

**Citation:** Li Li, Qi Han, Haolei Bai, Xiaolong Zhang, Yong Liu, Chao He (—). *Structural MRI, Resting-state fMRI, and PSG/EEG Dataset of Zoster-associated Neuralgia*. [10.82901/nemar.on007181](https://doi.org/10.82901/nemar.on007181)

<p class="eegdash-ed-deck">59-participant EEG dataset — Structural MRI, Resting-state fMRI, and PSG/EEG Dataset of Zoster-associated Neuralgia.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Li Li</strong> · <strong>Qi Han</strong> · Haolei Bai · Xiaolong Zhang · Yong Liu · Chao He</div><div class="eegdash-ed-pills"><span class="pill">EEG · 24 ch</span><span class="pill">1024 Hz</span><span class="pill is-info">BIDS 1.8.0</span><span class="pill">Task · sleep</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = ON007181(cache_dir="./data", subject="01")
```
...
@dataset{on007181,
  ...
  doi = {10.82901/nemar.on007181},
  url = {https://doi.org/10.82901/nemar.on007181},
}
```
...
> > [DOI](https://doi.org/10.82901/nemar.on007181)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-02 · task-sleep</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on007181" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on007181&sub=02&task=sleep&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on007181 — sub-02 · task-sleep"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on007181). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on007181" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on007181/code/on007181_histogram.png"
      alt="NEMAR pipeline statistics — ON007181"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on007181/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON007181"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on007181">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `ON007181`                                                                                                                |
| Year           | —                                                                                                                         |
| Authors        | Li Li, Qi Han, Haolei Bai, Xiaolong Zhang, Yong Liu, Chao He                                                              |
| License        | CC0                                                                                                                       |
| Citation / DOI | [10.82901/nemar.on007181](https://doi.org/10.82901/nemar.on007181)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on007181) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on007181) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON007181</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON007181</code></span></div>
