...
<details class="electrode-explorer">
  <summary>Electrode layout — EEG · 206 sensors — 206 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=7cdd85eb4a0fa34a&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 900px; display: block;"
    title="Topomap of EEG · 206 sensors"
