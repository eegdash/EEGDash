...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON004022</b></div><div>Iss. 4022 · 7 subjects · 21 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Multimodal EEG and fNIRS Biosignal Acquisition during Motor I…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON004022</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>7</dd><dt>Recordings</dt><dd>21</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>18 (19), 16 (2)</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>4.5 h</dd><dt>Size</dt><dd>635.0 MB</dd><dt>Tasks</dt><dd><code>motorimagery</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.0.2</dd><dt>Sidecars</dt><dd>electrodes · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on004022</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on004022">10.82901/nemar.on004022</a></div><div class="actions"><a href="https://openneuro.org/datasets/on004022">OpenNeuro</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON004022.croissant.json" download>Croissant</a></div></aside>

# ON004022: eeg dataset, 7 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Multimodal EEG and fNIRS Biosignal Acquisition during Motor Imagery Tasks in Patients with Orthopedic Impairment","alternateName":"ON004022","description":"Multimodal EEG and fNIRS Biosignal Acquisition during Motor Imagery Tasks in Patients with Orthopedic Impairment. eeg dataset accessible via EEGDash as \`\`ON004022\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON004022.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on004022","sameAs":["https://doi.org/10.82901/nemar.on004022","https://openneuro.org/datasets/on004022","https://nemar.org/dataexplorer/detail?dataset_id=on004022","https://nemar.org/dataexplorer/detail/on004022"],"creator":[{"@type":"Person","name":"Seho Lee"},{"@type":"Person","name":"Hee Ra Jung"},{"@type":"Person","name":"In-Nea Wang"},{"@type":"Person","name":"Min-Kyung Jung"},{"@type":"Person","name":"Hakseung Kim"},{"@type":"Person","name":"Dong-Joo Kim"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Multimodal EEG and fNIRS Biosignal Acquisition during Motor Imagery Tasks in Patients with Orthopedic Impairment*

**Citation:** Seho Lee, Hee Ra Jung, In-Nea Wang, Min-Kyung Jung, Hakseung Kim, Dong-Joo Kim (—). *Multimodal EEG and fNIRS Biosignal Acquisition during Motor Imagery Tasks in Patients with Orthopedic Impairment*. [10.82901/nemar.on004022](https://doi.org/10.82901/nemar.on004022)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-01 · task-motorimagery · run-1</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on004022" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on004022&sub=01&task=motorimagery&run=1&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on004022 — sub-01 · task-motorimagery · run-1"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on004022). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on004022" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on004022/code/on004022_histogram.png"
      alt="NEMAR pipeline statistics — ON004022"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on004022/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON004022"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on004022">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                                                                                        |
| Canonical      | —                                                                                                                                                                                        |
| Importable as  | `ON004022`                                                                                                                                                                               |
| Year           | —                                                                                                                                                                                        |
| Authors        | Seho Lee, Hee Ra Jung, In-Nea Wang, Min-Kyung Jung, Hakseung Kim, Dong-Joo Kim                                                                                                           |
| License        | CC0                                                                                                                                                                                      |
| Citation / DOI | [10.82901/nemar.on004022](https://doi.org/10.82901/nemar.on004022)                                                                                                                       |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on004022) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on004022) | [Source URL](https://nemar.org/dataexplorer/detail/on004022) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON004022</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON004022</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON004022</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON004022.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on004022">10.82901/nemar.on004022</a></b></div></footer>
