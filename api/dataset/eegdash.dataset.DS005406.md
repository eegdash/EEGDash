...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005406</b></div><div>Iss. 5406 · 29 subjects · 29 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · EEG frequency tagging reveals the integration of dissimilar o…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005406</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1016/j.cortex.2024.10.015">10.1016/j.cortex.2024.10.015</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>29</dd><dt>Recordings</dt><dd>29</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>15.5 h</dd><dt>Size</dt><dd>13.3 GB</dd><dt>Tasks</dt><dd><code>FTdiss</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005406</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005406">EEGDash/ds005406</a></dd><dt>Citations</dt><dd>0</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005406.v1.0.0">10.18112/openneuro.ds005406.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005406">OpenNeuro</a><a href="https://doi.org/10.1016/j.cortex.2024.10.015">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds005406">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005406.croissant.json" download>Croissant</a></div></aside>

# DS005406: eeg dataset, 29 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"EEG frequency tagging reveals the integration of dissimilar observed actions","alternateName":"DS005406","description":"EEG frequency tagging reveals the integration of dissimilar observed actions. eeg dataset accessible via EEGDash as \`\`DS005406\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS005406.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds005406.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds005406.v1.0.0","https://openneuro.org/datasets/ds005406","https://nemar.org/dataexplorer/detail?dataset_id=ds005406"],"creator":[{"@type":"Person","name":"Silvia Formica"},{"@type":"Person","name":"Anna Chaiken"},{"@type":"Person","name":"Jan R. Wiersema"},{"@type":"Person","name":"Emiel Cracco"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*EEG frequency tagging reveals the integration of dissimilar observed actions*

**Citation:** Silvia Formica, Anna Chaiken, Jan R. Wiersema, Emiel Cracco (2019). *EEG frequency tagging reveals the integration of dissimilar observed actions*. [10.18112/openneuro.ds005406.v1.0.0](https://doi.org/10.18112/openneuro.ds005406.v1.0.0)

<p class="eegdash-ed-deck">29-participant EEG dataset — EEG frequency tagging reveals the integration of dissimilar observed actions.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Silvia Formica</strong> · <strong>Anna Chaiken</strong> · Jan R. Wiersema · Emiel Cracco<br/><span class="role">Year</span> 2019 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 64 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill">Task · FTdiss</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = DS005406(cache_dir="./data", subject="01")
```
...
@dataset{ds005406,
  ...
  author = {Silvia Formica and Anna Chaiken and Jan R. Wiersema and Emiel Cracco},
  doi = {10.18112/openneuro.ds005406.v1.0.0},
  url = {https://doi.org/10.18112/openneuro.ds005406.v1.0.0},
}
```
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 64 ch (n=29 recordings)</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">64 ch · EEG · 1000 Hz · 29 subjects, 29 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-13 · task-FTdiss</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds005406" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds005406&sub=13&task=FTdiss&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds005406 — sub-13 · task-FTdiss"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — EEG · 63 sensors — 63 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=2c784797fe197a57&embed=1"
    loading="lazy"
    width="100%" height="640"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds005406). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds005406" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds005406/code/ds005406_histogram.png"
      alt="NEMAR pipeline statistics — DS005406"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds005406/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS005406"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds005406">
  <div class="ee-bar">
...
| License        | CC0                                                                                                                       |
| Citation / DOI | [doi:10.18112/openneuro.ds005406.v1.0.0](https://doi.org/10.18112/openneuro.ds005406.v1.0.0)                              |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds005406) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds005406) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS005406</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Formica2024</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS005406</code> · <code>Formica2024</code></span></div>
...
OpenNeuro dataset: [https://openneuro.org/datasets/ds005406](https://openneuro.org/datasets/ds005406)
NeMAR dataset: [https://nemar.org/dataexplorer/detail?dataset_id=ds005406](https://nemar.org/dataexplorer/detail?dataset_id=ds005406)
DOI: [https://doi.org/10.18112/openneuro.ds005406.v1.0.0](https://doi.org/10.18112/openneuro.ds005406.v1.0.0)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS005406</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS005406.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds005406">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds005406.v1.0.0">10.18112/openneuro.ds005406.v1.0.0</a></b></div></footer>
