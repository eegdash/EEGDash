...
<div class="eegdash-ed-figpair">
  ...
  <p class="trace-viewer-caption">
    ...
    <strong>45 subjects and 300 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds007176" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds007176&sub=G2003&ses=V0&task=CE&ext=vhdr&embed=1"
    loading="lazy"
