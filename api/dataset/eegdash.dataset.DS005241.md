...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005241</b></div><div>Iss. 5241 · 24 subjects · 117 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · NeuroMorph</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005241</dd><dt>Version</dt><dd>v1.1.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>24</dd><dt>Recordings</dt><dd>117</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>256</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>3.7 h</dd><dt>Size</dt><dd>140.5 GB</dd><dt>Tasks</dt><dd><code>lexicaldecision</code> · <code>localizer</code></dd><dt>Sessions</dt><dd>3 · <code>01</code> · <code>02</code> · <code>tark</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005241</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005241">EEGDash/ds005241</a></dd><dt>Citations</dt><dd>0</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005241.v1.1.0">10.18112/openneuro.ds005241.v1.1.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005241">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/ds005241">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005241.croissant.json" download>Croissant</a></div></aside>

# DS005241: meg dataset, 24 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"NeuroMorph: A High-Temporal Resolution MEG Dataset for Morpheme-Based Linguistic Analysis","alternateName":"DS005241","description":"NeuroMorph: A High-Temporal Resolution MEG Dataset for Morpheme-Based Linguistic Analysis. meg dataset accessible via EEGDash as \`\`DS005241\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS005241.html","keywords":["meg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds005241.v1.1.0","sameAs":["https://doi.org/10.18112/openneuro.ds005241.v1.1.0","https://openneuro.org/datasets/ds005241","https://nemar.org/dataexplorer/detail?dataset_id=ds005241"],"creator":[{"@type":"Person","name":"Amilleah Rodriguez"},{"@type":"Person","name":"Dan Zhao"},{"@type":"Person","name":"Kyra Wilson"},{"@type":"Person","name":"Ritika Saboo"},{"@type":"Person","name":"Sergey V Samsonau"},{"@type":"Person","name":"Alec Marantz"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*NeuroMorph: A High-Temporal Resolution MEG Dataset for Morpheme-Based Linguistic Analysis*

**Citation:** Amilleah Rodriguez, Dan Zhao, Kyra Wilson, Ritika Saboo, Sergey V Samsonau, Alec Marantz (2019). *NeuroMorph: A High-Temporal Resolution MEG Dataset for Morpheme-Based Linguistic Analysis*. [10.18112/openneuro.ds005241.v1.1.0](https://doi.org/10.18112/openneuro.ds005241.v1.1.0)

<p class="eegdash-ed-deck">24-participant MEG dataset — NeuroMorph: A High-Temporal Resolution MEG Dataset for Morpheme-Based Linguistic Analysis.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Amilleah Rodriguez</strong> · <strong>Dan Zhao</strong> · Kyra Wilson · Ritika Saboo · Sergey V Samsonau · Alec Marantz<br/><span class="role">Year</span> 2019 · Distributed via OpenNeuro<br/><span class="role">Funding</span> New York University Abu Dhabi Institute Grant G1001</div><div class="eegdash-ed-pills"><span class="pill">MEG · 256 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill">2 tasks</span><span class="pill">3 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">256 ch · MEG · 1000 Hz · 24 subjects, 117 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-A0503 · ses-02 · task-lexicaldecision</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>24 subjects and 117 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds005241" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_meg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?meg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds005241&sub=A0503&ses=02&task=lexicaldecision&ext=fif&suffix=meg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live MEG trace viewer for ds005241 — sub-A0503 · ses-02 · task-lexicaldecision"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — MEG · 207 sensors — 207 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=36db5a14ab0058c9&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 900px; display: block;"
    title="Topomap of MEG · 207 sensors"
    referrerpolicy="no-referrer">
  </iframe>
</details></div></div></div>
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS005241</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Rodriguez2024</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS005241</code> · <code>Rodriguez2024</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS005241</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS005241.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds005241">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds005241.v1.1.0">10.18112/openneuro.ds005241.v1.1.0</a></b></div></footer>
