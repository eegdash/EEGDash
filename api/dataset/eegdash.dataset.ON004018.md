...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON004018</b></div><div>Iss. 4018 · 16 subjects · 32 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · EEG recordings for 200 object images presented in RSVP sequen…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON004018</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1016/j.neuroimage.2018.12.046">10.1016/j.neuroimage.2018.12.046</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>16</dd><dt>Recordings</dt><dd>32</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>63</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>10.6 GB</dd><dt>Tasks</dt><dd><code>rsvp</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.0.0 + bep006</dd><dt>Sidecars</dt><dd>events</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on004018</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on004018">10.82901/nemar.on004018</a></div><div class="actions"><a href="https://openneuro.org/datasets/on004018">OpenNeuro</a><a href="https://doi.org/10.1016/j.neuroimage.2018.12.046">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON004018.croissant.json" download>Croissant</a></div></aside>

# ON004018: eeg dataset, 16 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"EEG recordings for 200 object images presented in RSVP sequences at 5Hz or 20Hz","alternateName":"ON004018","description":"EEG recordings for 200 object images presented in RSVP sequences at 5Hz or 20Hz. eeg dataset accessible via EEGDash as \`\`ON004018\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON004018.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on004018","sameAs":["https://doi.org/10.82901/nemar.on004018","https://openneuro.org/datasets/on004018","https://nemar.org/dataexplorer/detail?dataset_id=on004018","https://nemar.org/dataexplorer/detail/on004018"],"creator":[{"@type":"Person","name":"Grootswagers, T."},{"@type":"Person","name":"Robinson, A.K."},{"@type":"Person","name":"Carlson, T.A."}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*EEG recordings for 200 object images presented in RSVP sequences at 5Hz or 20Hz*

**Citation:** Grootswagers, T., Robinson, A.K., Carlson, T.A. (2019). *EEG recordings for 200 object images presented in RSVP sequences at 5Hz or 20Hz*. [10.82901/nemar.on004018](https://doi.org/10.82901/nemar.on004018)

<p class="eegdash-ed-deck">16-participant EEG dataset — EEG recordings for 200 object images presented in RSVP sequences at 5Hz or 20Hz.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Grootswagers, T.</strong> · <strong>Robinson, A.K.</strong> · Carlson, T.A.<br/><span class="role">Year</span> 2019 · Distributed via NeMAR</div><div class="eegdash-ed-pills"><span class="pill">EEG · 63 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.0.0 + bep006</span><span class="pill">Task · rsvp</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = ON004018(cache_dir="./data", subject="01")
```
...
@dataset{on004018,
  ...
  doi = {10.82901/nemar.on004018},
  url = {https://doi.org/10.82901/nemar.on004018},
}
```
...
> [DOI](https://doi.org/10.82901/nemar.on004018)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-01 · task-rsvp · run-01</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on004018" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on004018&sub=01&task=rsvp&run=01&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on004018 — sub-01 · task-rsvp · run-01"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on004018). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on004018" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on004018/code/on004018_histogram.png"
      alt="NEMAR pipeline statistics — ON004018"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on004018/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON004018"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on004018">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                                                                                        |
| Canonical      | —                                                                                                                                                                                        |
| Importable as  | `ON004018`                                                                                                                                                                               |
| Year           | 2019                                                                                                                                                                                     |
| Authors        | Grootswagers, T., Robinson, A.K., Carlson, T.A.                                                                                                                                          |
| License        | CC0                                                                                                                                                                                      |
| Citation / DOI | [10.82901/nemar.on004018](https://doi.org/10.82901/nemar.on004018)                                                                                                                       |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on004018) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on004018) | [Source URL](https://nemar.org/dataexplorer/detail/on004018) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON004018</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON004018</code></span></div>
