...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON006126</b></div><div>Iss. 6126 · 5 subjects · 90 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · TDCS Modulation of Visual Cortex in Motor Imagery</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON006126</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41598-026-42691-w">10.1038/s41598-026-42691-w</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>5</dd><dt>Recordings</dt><dd>90</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>3</dd><dt>Sample rate</dt><dd>5000 Hz</dd><dt>Duration</dt><dd>10.7 h</dd><dt>Size</dt><dd>1.1 GB</dd><dt>Tasks</dt><dd>6 tasks · <code>B1</code> · <code>B2</code> · …</dd><dt>Sessions</dt><dd>3 · <code>An</code> · <code>Ca</code> · <code>Sh</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on006126</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on006126">10.82901/nemar.on006126</a></div><div class="actions"><a href="https://openneuro.org/datasets/on006126">OpenNeuro</a><a href="https://doi.org/10.1038/s41598-026-42691-w">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON006126.croissant.json" download>Croissant</a></div></aside>

# ON006126: eeg dataset, 5 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"TDCS Modulation of Visual Cortex in Motor Imagery","alternateName":"ON006126","description":"TDCS Modulation of Visual Cortex in Motor Imagery. eeg dataset accessible via EEGDash as \`\`ON006126\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON006126.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on006126","sameAs":["https://doi.org/10.82901/nemar.on006126","https://openneuro.org/datasets/on006126","https://nemar.org/dataexplorer/detail?dataset_id=on006126"],"creator":[{"@type":"Person","name":"Anthony Mensah"},{"@type":"Person","name":"Gleb Perevoznyuk"},{"@type":"Person","name":"Artyom Batov"},{"@type":"Person","name":"Aleksandra S. Pleskovskaya"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*TDCS Modulation of Visual Cortex in Motor Imagery*

**Citation:** Anthony Mensah, Gleb Perevoznyuk, Artyom Batov, Aleksandra S. Pleskovskaya (2019). *TDCS Modulation of Visual Cortex in Motor Imagery*. [10.82901/nemar.on006126](https://doi.org/10.82901/nemar.on006126)

<p class="eegdash-ed-deck">5-participant EEG dataset — TDCS Modulation of Visual Cortex in Motor Imagery.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Anthony Mensah</strong> · <strong>Gleb Perevoznyuk</strong> · Artyom Batov · Aleksandra S. Pleskovskaya<br/><span class="role">Year</span> 2019 · Distributed via NeMAR<br/><span class="role">Funding</span> Insitute for Cognitive Neuroscience - Higher School of Economics</div><div class="eegdash-ed-pills"><span class="pill">EEG · 3 ch</span><span class="pill">5000 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill">6 tasks</span><span class="pill">3 sessions</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
[DOI](https://doi.org/10.82901/nemar.on006126)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-AnSt01 · ses-An · task-B1 · run-01</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on006126" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on006126&sub=AnSt01&ses=An&task=B1&run=01&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on006126 — sub-AnSt01 · ses-An · task-B1 · run-01"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on006126). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on006126" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on006126/code/on006126_histogram.png"
      alt="NEMAR pipeline statistics — ON006126"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on006126/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON006126"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on006126">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `ON006126`                                                                                                                |
| Year           | 2019                                                                                                                      |
| Authors        | Anthony Mensah, Gleb Perevoznyuk, Artyom Batov, Aleksandra S. Pleskovskaya                                                |
| License        | CC0                                                                                                                       |
| Citation / DOI | [10.82901/nemar.on006126](https://doi.org/10.82901/nemar.on006126)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on006126) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on006126) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON006126</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON006126</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON006126</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON006126.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on006126">10.82901/nemar.on006126</a></b></div></footer>
