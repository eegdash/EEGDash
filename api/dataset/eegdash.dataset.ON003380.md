...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON003380</b></div><div>Iss. 3380 · 1 subjects · 1 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Corticothalamic communication under analgesia, sedation and g…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON003380</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-020-00781-y">10.1038/s41597-020-00781-y</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>1</dd><dt>Recordings</dt><dd>1</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>9</dd><dt>Sample rate</dt><dd>Varies</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>1.4 GB</dd><dt>Tasks</dt><dd>—</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.1.1</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on003380</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on003380">10.82901/nemar.on003380</a></div><div class="actions"><a href="https://openneuro.org/datasets/on003380">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-020-00781-y">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON003380.croissant.json" download>Croissant</a></div></aside>

# ON003380: eeg dataset, 1 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Corticothalamic communication under analgesia, sedation and gradual ischemia: a multimodal model of controlled gradual cerebral ischemia in pig","alternateName":"ON003380","description":"Corticothalamic communication under analgesia, sedation and gradual ischemia: a multimodal model of controlled gradual cerebral ischemia in pig. eeg dataset accessible via EEGDash as \`\`ON003380\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON003380.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on003380","sameAs":["https://doi.org/10.82901/nemar.on003380","https://openneuro.org/datasets/on003380","https://nemar.org/dataexplorer/detail?dataset_id=on003380"],"creator":[{"@type":"Person","name":"Martin G. Frasch"},{"@type":"Person","name":"Bernd Walter"},{"@type":"Person","name":"Chrstophe L. Herry"},{"@type":"Person","name":"Reinhard Bauer"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>
...
```python
dataset = ON003380(cache_dir="./data", subject="01")
```
...
@dataset{on003380,
  ...
  doi = {10.82901/nemar.on003380},
  url = {https://doi.org/10.82901/nemar.on003380},
}
```
...
> [DOI](https://doi.org/10.82901/nemar.on003380)
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 9 ch (n=1 recordings)</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">9 ch · EEG · Varies · 1 subjects, 1 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-12</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on003380" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on003380&sub=12&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on003380 — sub-12"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on003380). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on003380" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on003380/code/on003380_histogram.png"
      alt="NEMAR pipeline statistics — ON003380"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on003380/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON003380"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on003380">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                                               |
| Canonical      | —                                                                                                                                               |
| Importable as  | `ON003380`                                                                                                                                      |
| Year           | 20                                                                                                                                              |
| Authors        | Martin G. Frasch, Bernd Walter, Chrstophe L. Herry, Reinhard Bauer                                                                              |
| License        | CC0                                                                                                                                             |
| Citation / DOI | [10.82901/nemar.on003380](https://doi.org/10.82901/nemar.on003380)                                                                              |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on003380) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on003380)                       |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON003380</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON003380</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON003380</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON003380.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on003380">10.82901/nemar.on003380</a></b></div></footer>
