...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006466</b></div><div>Iss. 6466 · 66 subjects · 1257 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · HeartBEAM</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006466</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2025.10.02.680040">10.1101/2025.10.02.680040</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>66</dd><dt>Recordings</dt><dd>1257</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>65</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>132 h</dd><dt>Size</dt><dd>117.5 GB</dd><dt>Tasks</dt><dd>6 tasks · <code>active</code> · <code>activeS</code> · …</dd><dt>Sessions</dt><dd>2 · <code>post</code> · <code>pre</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.1.1</dd><dt>Sidecars</dt><dd>events · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006466</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006466">EEGDash/ds006466</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006466.v1.0.1">10.18112/openneuro.ds006466.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006466">OpenNeuro</a><a href="https://doi.org/10.1101/2025.10.02.680040">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006466">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006466.croissant.json" download>Croissant</a></div></aside>

# DS006466: eeg dataset, 66 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"HeartBEAM: Older Adult Resting State and Auditory Oddball Task EEG Data","alternateName":"DS006466","description":"HeartBEAM: Older Adult Resting State and Auditory Oddball Task EEG Data. eeg dataset accessible via EEGDash as \`\`DS006466\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006466.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006466.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds006466.v1.0.1","https://openneuro.org/datasets/ds006466","https://nemar.org/dataexplorer/detail?dataset_id=ds006466"],"creator":[{"@type":"Person","name":"Andy Jeesu Kim"},{"@type":"Person","name":"Santiago Morales"},{"@type":"Person","name":"Joshua Senior"},{"@type":"Person","name":"Mara Mather"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2024-01-01"}</script>

*HeartBEAM: Older Adult Resting State and Auditory Oddball Task EEG Data*

**Citation:** Andy Jeesu Kim, Santiago Morales, Joshua Senior, Mara Mather (2024). *HeartBEAM: Older Adult Resting State and Auditory Oddball Task EEG Data*. [10.18112/openneuro.ds006466.v1.0.1](https://doi.org/10.18112/openneuro.ds006466.v1.0.1)

<p class="eegdash-ed-deck">66-participant EEG dataset — HeartBEAM: Older Adult Resting State and Auditory Oddball Task EEG Data.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Andy Jeesu Kim</strong> · <strong>Santiago Morales</strong> · Joshua Senior · Mara Mather<br/><span class="role">Year</span> 2024 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 65 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.1.1</span><span class="pill">6 tasks</span><span class="pill">2 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 65 ch (n=1257 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 1000.0 Hz (n=1257 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 131 h</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">65 ch · EEG · 1000 Hz · 66 subjects, 1257 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-FivePly · ses-pre · task-active · run-1</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>66 subjects and 1257 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006466" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006466&sub=FivePly&ses=pre&task=active&run=1&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006466 — sub-FivePly · ses-pre · task-active · run-1"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — EEG · 65 sensors — 65 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=253370dc876b8f3b&embed=1"
    loading="lazy"
    width="100%" height="640"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds006466). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds006466" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds006466/code/ds006466_histogram.png"
      alt="NEMAR pipeline statistics — DS006466"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds006466/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS006466"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds006466">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006466) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006466) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006466</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Kim2025_HeartBEAM_Older_Adult</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006466</code> · <code>Kim2025_HeartBEAM_Older_Adult</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006466</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006466.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006466">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006466.v1.0.1">10.18112/openneuro.ds006466.v1.0.1</a></b></div></footer>
