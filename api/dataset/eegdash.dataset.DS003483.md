...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003483</b></div><div>Iss. 3483 · 21 subjects · 41 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Logical reasoning study</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003483</dd><dt>Version</dt><dd>v1.0.2</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.3390/ijms25042251">10.3390/ijms25042251</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>21</dd><dt>Recordings</dt><dd>41</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>320</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>11.0 h</dd><dt>Size</dt><dd>68.3 GB</dd><dt>Tasks</dt><dd><code>deduction</code> · <code>induction</code></dd><dt>Sessions</dt><dd><code>1</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>BIDS 1.2.0</dd><dt>Sidecars</dt><dd>events · channels · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003483</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003483">EEGDash/ds003483</a></dd><dt>Citations</dt><dd>3</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003483.v1.0.2">10.18112/openneuro.ds003483.v1.0.2</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003483">OpenNeuro</a><a href="https://doi.org/10.3390/ijms25042251">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003483">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003483.croissant.json" download>Croissant</a></div></aside>

# DS003483: meg dataset, 21 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Logical reasoning study","alternateName":"DS003483","description":"Logical reasoning study. meg dataset accessible via EEGDash as \`\`DS003483\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS003483.html","keywords":["meg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds003483.v1.0.2","sameAs":["https://doi.org/10.18112/openneuro.ds003483.v1.0.2","https://openneuro.org/datasets/ds003483","https://nemar.org/dataexplorer/detail?dataset_id=ds003483"],"creator":[{"@type":"Person","name":"Cognitive and Computational Neuroscience Laboratory (UPM - UCM)."},{"@type":"Person","name":"PI: Fernando Maestu."},{"@type":"Person","name":"PI: Carmen Requena"},{"@type":"Person","name":"PI: Francisco Salto Alemany"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Logical reasoning study*

**Citation:** Cognitive and Computational Neuroscience Laboratory (UPM - UCM)., PI: Fernando Maestu., PI: Carmen Requena, PI: Francisco Salto Alemany (—). *Logical reasoning study*. [10.18112/openneuro.ds003483.v1.0.2](https://doi.org/10.18112/openneuro.ds003483.v1.0.2)

<p class="eegdash-ed-deck">21-participant MEG dataset — Logical reasoning study.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Cognitive and Computational Neuroscience Laboratory (UPM - UCM).</strong> · <strong>PI: Fernando Maestu.</strong> · PI: Carmen Requena · PI: Francisco Salto Alemany</div><div class="eegdash-ed-pills"><span class="pill">MEG · 320 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS BIDS 1.2.0</span><span class="pill">2 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">320 ch · MEG · 1000 Hz · 21 subjects, 41 recordings</span>
  </div>
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003483) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003483)               |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003483</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Cognitive2021</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003483</code> · <code>Cognitive2021</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003483</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003483.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003483">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003483.v1.0.2">10.18112/openneuro.ds003483.v1.0.2</a></b></div></footer>
