...
<!-- "generated/auto_examples/tutorials/noplot_tutorial_sex_classification_cnn.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-generated-auto-examples-tutorials-noplot-tutorial-sex-classification-cnn-py"></a>

<a id="sex-classification"></a>
...
[BrainDecode]([https://braindecode.org/stable/install/install.html](https://braindecode.org/stable/install/install.html)) is a specialized library for preprocessing EEG and MEG data.
...
<!-- GENERATED FROM PYTHON SOURCE LINES 105-163 -->
```Python
...
[1] Truong, D., Milham, M., Makeig, S., & Delorme, A. (2021). Deep Convolutional Neural Network Applied to Electroencephalography: Raw Data vs Spectral Features. IEEE Engineering in Medicine and Biology Society. Annual International Conference, 2021, 1039–1042. [https://doi.org/10.1109/EMBC46164.2021.9630708](https://doi.org/10.1109/EMBC46164.2021.9630708)
...
<!-- GENERATED FROM PYTHON SOURCE LINES 327-388 -->
```Python
...
<a id="sphx-glr-download-generated-auto-examples-tutorials-noplot-tutorial-sex-classification-cnn-py"></a>
