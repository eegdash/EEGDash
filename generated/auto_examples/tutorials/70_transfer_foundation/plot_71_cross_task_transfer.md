...
```none
pretrain losses (RestingState): [0.057, 0.002, 0.001, 0.002, 0.0]
```
...
```none
finetune losses (CCD): [0.652, 0.537, 0.472, 0.405, 0.358]
```
...
```none
finetune=0.550 | scratch=0.467 | chance=0.517 | metric=accuracy | gap=+0.083
```
...
RestingState                    0.267         0.017           0.0
surroundSupp                    0.450         0.017           0.0
symbolSearch                    0.267        -0.100           0.0
```
...
{"encoder_weights_path": "plot_71_pretrained_encoder.pt", "pretext_subjects": 8, "target_subjects": 8, "transfer_gap": 0.0833, "transfer_matrix_mean_delta": 0.1019}
```
