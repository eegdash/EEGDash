...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS002723</b></div><div>Iss. 2723 · 8 subjects · 44 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · A dataset recorded during development of an affective brain-c…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS002723</dd><dt>Version</dt><dd>v1.1.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1145/3059005">10.1145/3059005</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>8</dd><dt>Recordings</dt><dd>44</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>37</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>10.5 h</dd><dt>Size</dt><dd>2.6 GB</dd><dt>Tasks</dt><dd>—</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.0.2</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds002723</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds002723">EEGDash/ds002723</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds002723.v1.1.0">10.18112/openneuro.ds002723.v1.1.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds002723">OpenNeuro</a><a href="https://doi.org/10.1145/3059005">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds002723">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS002723.croissant.json" download>Croissant</a></div></aside>

# DS002723: eeg dataset, 8 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"A dataset recorded during development of an affective brain-computer music interface: testing session","alternateName":"DS002723","description":"A dataset recorded during development of an affective brain-computer music interface: testing session. eeg dataset accessible via EEGDash as \`\`DS002723\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS002723.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds002723.v1.1.0","sameAs":["https://doi.org/10.18112/openneuro.ds002723.v1.1.0","https://openneuro.org/datasets/ds002723","https://nemar.org/dataexplorer/detail?dataset_id=ds002723"],"creator":[{"@type":"Person","name":"Ian Daly"},{"@type":"Person","name":"Nicoletta Nicolaou"},{"@type":"Person","name":"Duncan Williams"},{"@type":"Person","name":"Faustina Hwang"},{"@type":"Person","name":"Alexis Kirke"},{"@type":"Person","name":"Eduardo Miranda"},{"@type":"Person","name":"Slawomir J. Nasuto"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2018-01-01"}</script>

*A dataset recorded during development of an affective brain-computer music interface: testing session*

**Citation:** Ian Daly, Nicoletta Nicolaou, Duncan Williams, Faustina Hwang, Alexis Kirke, Eduardo Miranda, Slawomir J. Nasuto (2018). *A dataset recorded during development of an affective brain-computer music interface: testing session*. [10.18112/openneuro.ds002723.v1.1.0](https://doi.org/10.18112/openneuro.ds002723.v1.1.0)

<p class="eegdash-ed-deck">8-participant EEG dataset — A dataset recorded during development of an affective brain-computer music interface: testing session.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Ian Daly</strong> · <strong>Nicoletta Nicolaou</strong> · Duncan Williams · Faustina Hwang · Alexis Kirke · Eduardo Miranda · …<br/><span class="role">Year</span> 2018 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 37 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.0.2</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=8, range 19–30 yr, mean 22.5 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=1"><div style="width:100%; height:30px; background:#006ca3; flex-shrink:0;" title="15-19: female n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=6"><div style="width:100%; height:150px; background:#006ca3; flex-shrink:0;" title="20-24: female n=5"></div><div style="width:100%; height:30px; background:#f7941d; flex-shrink:0;" title="20-24: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=1"><div style="width:100%; height:30px; background:#f7941d; flex-shrink:0;" title="30-34: male n=1"></div></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">15</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">20</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">30</span>
  </div>
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 6</span><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#f7941d; display:inline-block;"></i>Male · 2</span></div>
  ...
  <div class="sex-wrap" style="display:flex; align-items:center; gap:30px; flex-wrap:wrap;">
    ...
    <div class="sex-legend" style="flex:1; font-family:JetBrains Mono,monospace; font-size:13px; min-width:220px;"><div class="row"><div class="sw" style="background:#006ca3"></div><div class="lbl">Female</div><div class="v">6</div></div><div class="row"><div class="sw" style="background:#f7941d"></div><div class="lbl">Male</div><div class="v">2</div></div><div class="row ratio"><div class="sw" style="visibility:hidden"></div><div class="lbl">F : M ratio</div><div class="v">3.00 : 1</div></div></div>
  </div>
  <div class="sex-note" style="margin-top:14px; font-size:13px; color:#34404e; line-height:1.5; max-width:520px; font-family:Spectral,Georgia,serif;">75% female · n = 8 subjects with reported sex.</div>
  ...
  <p><strong>Total recording duration</strong>: 10 h 28 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">37 ch · EEG · 1000 Hz · 8 subjects, 44 recordings</span>
  </div>
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds002723) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds002723) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS002723</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Daly2020_session</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS002723</code> · <code>Daly2020_session</code></span></div>
...
* [eegdash.dataset.DS004840](eegdash.dataset.DS004840.md)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS002723</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS002723.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds002723">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds002723.v1.1.0">10.18112/openneuro.ds002723.v1.1.0</a></b></div></footer>
