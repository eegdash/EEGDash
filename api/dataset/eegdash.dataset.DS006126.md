...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006126</b></div><div>Iss. 6126 · 5 subjects · 90 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · TDCS Modulation of Visual Cortex in Motor Imagery</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006126</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41598-026-42691-w">10.1038/s41598-026-42691-w</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>5</dd><dt>Recordings</dt><dd>90</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>3</dd><dt>Sample rate</dt><dd>5000 Hz</dd><dt>Duration</dt><dd>10.7 h</dd><dt>Size</dt><dd>1.1 GB</dd><dt>Tasks</dt><dd>6 tasks · <code>B1</code> · <code>B2</code> · …</dd><dt>Sessions</dt><dd>3 · <code>An</code> · <code>Ca</code> · <code>Sh</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006126</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="motor">Motor</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006126">EEGDash/ds006126</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006126.v1.0.0">10.18112/openneuro.ds006126.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006126">OpenNeuro</a><a href="https://doi.org/10.1038/s41598-026-42691-w">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006126">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006126.croissant.json" download>Croissant</a></div></aside>
...
**Citation:** Anthony Mensah, Gleb Perevoznyuk, Artyom Batov, Aleksandra S. Pleskovskaya (2019). *TDCS Modulation of Visual Cortex in Motor Imagery*. [10.18112/openneuro.ds006126.v1.0.0](https://doi.org/10.18112/openneuro.ds006126.v1.0.0)

<p class="eegdash-ed-deck">5-participant EEG dataset — TDCS Modulation of Visual Cortex in Motor Imagery.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Anthony Mensah</strong> · <strong>Gleb Perevoznyuk</strong> · Artyom Batov · Aleksandra S. Pleskovskaya<br/><span class="role">Year</span> 2019 · Distributed via OpenNeuro<br/><span class="role">Funding</span> Insitute for Cognitive Neuroscience - Higher School of Economics</div><div class="eegdash-ed-pills"><span class="pill">EEG · 3 ch</span><span class="pill">5000 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill">6 tasks</span><span class="pill">3 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="motor">Motor</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=5, range 19–30 yr, mean 23.0 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=2"><div style="width:100%; height:90px; background:#006ca3; flex-shrink:0;" title="15-19: female n=1"></div><div style="width:100%; height:90px; background:#f7941d; flex-shrink:0;" title="15-19: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=1"><div style="width:100%; height:90px; background:#006ca3; flex-shrink:0;" title="20-24: female n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=2"><div style="width:100%; height:180px; background:#f7941d; flex-shrink:0;" title="30-34: male n=2"></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">3 ch · EEG · 5000 Hz · 5 subjects, 90 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-FeKl03 · ses-Ca · task-B2 · run-06</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>5 subjects and 90 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006126" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006126&sub=FeKl03&ses=Ca&task=B2&run=06&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006126 — sub-FeKl03 · ses-Ca · task-B2 · run-06"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds006126). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds006126" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds006126/code/ds006126_histogram.png"
      alt="NEMAR pipeline statistics — DS006126"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds006126/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS006126"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds006126">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006126) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006126) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006126</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Mensah2025</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006126</code> · <code>Mensah2025</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006126</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006126.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006126">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006126.v1.0.0">10.18112/openneuro.ds006126.v1.0.0</a></b></div></footer>
