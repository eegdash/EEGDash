...
Modality: eeg Subjects: 8 Recordings: 160 License: CC-BY-4.0 Source: nemar
...
- Duration (hours): 8.200868055555556
...
- Source: nemar
- OpenNeuro: [nm000187](https://openneuro.org/datasets/nm000187)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div style="display:flex; height:22px; width:100%; max-width:400px; border-radius:4px; overflow:hidden;">
    <div style="width:25.0%; background:#e07ab5; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Female: 1">1</div><div style="width:75.0%; background:#4472c4; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Male: 3">3</div>
  </div>
...
Use the `NM000187` class to access this dataset programmatically.
