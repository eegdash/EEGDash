...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON005262</b></div><div>Iss. 5262 · 12 subjects · 186 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · ArEEG</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON005262</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-025-05387-w">10.1038/s41597-025-05387-w</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>12</dd><dt>Recordings</dt><dd>186</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>Varies</dd><dt>Sample rate</dt><dd>Varies</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>689.0 MB</dd><dt>Tasks</dt><dd><code>innerspeech</code></dd><dt>Sessions</dt><dd>21 · <code>0</code> … <code>9</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>80% · Good</dd><dt>Storage</dt><dd><code>s3://nemar/on005262</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on005262">10.82901/nemar.on005262</a></div><div class="actions"><a href="https://openneuro.org/datasets/on005262">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-025-05387-w">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON005262.croissant.json" download>Croissant</a></div></aside>

# ON005262: eeg dataset, 12 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"ArEEG: Arabic Inner Speech EEG dataset","alternateName":"ON005262","description":"ArEEG: Arabic Inner Speech EEG dataset. eeg dataset accessible via EEGDash as \`\`ON005262\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON005262.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on005262","sameAs":["https://doi.org/10.82901/nemar.on005262","https://openneuro.org/datasets/on005262","https://nemar.org/dataexplorer/detail?dataset_id=on005262"],"creator":[{"@type":"Person","name":"Donia Metwalli"},{"@type":"Person","name":"Eslam Ahmed"},{"@type":"Person","name":"Antony Emil"},{"@type":"Person","name":"Yousef A. Radwan"},{"@type":"Person","name":"Mariam Barakat"},{"@type":"Person","name":"Anas Ahmed"},{"@type":"Person","name":"Amro Omar"},{"@type":"Person","name":"Sahar Selim"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*ArEEG: Arabic Inner Speech EEG dataset*

**Citation:** Donia Metwalli, Eslam Ahmed, Antony Emil, Yousef A. Radwan, Mariam Barakat, Anas Ahmed, Amro Omar, Sahar Selim (—). *ArEEG: Arabic Inner Speech EEG dataset*. [10.82901/nemar.on005262](https://doi.org/10.82901/nemar.on005262)

<p class="eegdash-ed-deck">12-participant EEG dataset — ArEEG: Arabic Inner Speech EEG dataset.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Donia Metwalli</strong> · <strong>Eslam Ahmed</strong> · Antony Emil · Yousef A. Radwan · Mariam Barakat · Anas Ahmed · …</div><div class="eegdash-ed-pills"><span class="pill is-info">BIDS 1.9.0</span><span class="pill">Task · innerspeech</span><span class="pill">21 sessions</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
[DOI](https://doi.org/10.82901/nemar.on005262)
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">— ch · EEG · Varies · 12 subjects, 186 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-0 · ses-0 · task-innerspeech</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on005262" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on005262&sub=0&ses=0&task=innerspeech&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on005262 — sub-0 · ses-0 · task-innerspeech"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on005262). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on005262" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on005262/code/on005262_histogram.png"
      alt="NEMAR pipeline statistics — ON005262"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on005262/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON005262"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on005262">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `ON005262`                                                                                                                |
| Year           | —                                                                                                                         |
| Authors        | Donia Metwalli, Eslam Ahmed, Antony Emil, Yousef A. Radwan, Mariam Barakat, Anas Ahmed, Amro Omar, Sahar Selim            |
| License        | CC0                                                                                                                       |
| Citation / DOI | [10.82901/nemar.on005262](https://doi.org/10.82901/nemar.on005262)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on005262) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on005262) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON005262</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON005262</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON005262</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON005262.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on005262">10.82901/nemar.on005262</a></b></div></footer>
