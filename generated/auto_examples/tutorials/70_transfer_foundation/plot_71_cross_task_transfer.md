...
```none
pretrain losses (RestingState): [0.055, 0.003, 0.001, 0.0, 0.0]
```
...
```none
finetune losses (CCD): [0.524, 0.476, 0.409, 0.362, 0.355]
```
...
```none
finetune=0.567 | scratch=0.583 | chance=0.517 | metric=accuracy | gap=-0.017
```
...
RestingState                    0.083         0.067         0.000
surroundSupp                    0.467         0.067         0.000
symbolSearch                    0.233         0.000        -0.017
```
...
{"encoder_weights_path": "plot_71_pretrained_encoder.pt", "pretext_subjects": 8, "target_subjects": 8, "transfer_gap": -0.0167, "transfer_matrix_mean_delta": 0.1}
```
