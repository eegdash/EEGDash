...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006374</b></div><div>Iss. 6374 · 36 subjects · 358 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Expectation effects on repetition suppression in nociception</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006374</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2025.07.11.664149">10.1101/2025.07.11.664149</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>36</dd><dt>Recordings</dt><dd>358</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>35</dd><dt>Sample rate</dt><dd>2000 Hz</dd><dt>Duration</dt><dd>31.6 h</dd><dt>Size</dt><dd>42.8 GB</dd><dt>Tasks</dt><dd><code>detection</code> · <code>expsupp</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.6.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006374</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="tactile">Tactile</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006374">EEGDash/ds006374</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006374.v1.0.0">10.18112/openneuro.ds006374.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006374">OpenNeuro</a><a href="https://doi.org/10.1101/2025.07.11.664149">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006374">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006374.croissant.json" download>Croissant</a></div></aside>

# DS006374: eeg dataset, 36 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Expectation effects on repetition suppression in nociception","alternateName":"DS006374","description":"Expectation effects on repetition suppression in nociception. eeg dataset accessible via EEGDash as \`\`DS006374\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006374.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006374.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds006374.v1.0.0","https://openneuro.org/datasets/ds006374","https://nemar.org/dataexplorer/detail?dataset_id=ds006374"],"creator":[{"@type":"Person","name":"Lisa-Marie Pohle"},{"@type":"Person","name":"Moritz Nickel"},{"@type":"Person","name":"Birgit Nierula"},{"@type":"Person","name":"Markus Ploner"},{"@type":"Person","name":"Ulrike Horn"},{"@type":"Person","name":"Falk Eippert"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*Expectation effects on repetition suppression in nociception*

**Citation:** Lisa-Marie Pohle, Moritz Nickel, Birgit Nierula, Markus Ploner, Ulrike Horn, Falk Eippert (2019). *Expectation effects on repetition suppression in nociception*. [10.18112/openneuro.ds006374.v1.0.0](https://doi.org/10.18112/openneuro.ds006374.v1.0.0)

<p class="eegdash-ed-deck">36-participant EEG dataset — Expectation effects on repetition suppression in nociception.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Lisa-Marie Pohle</strong> · <strong>Moritz Nickel</strong> · Birgit Nierula · Markus Ploner · Ulrike Horn · Falk Eippert<br/><span class="role">Year</span> 2019 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 35 ch</span><span class="pill">2000 Hz</span><span class="pill is-info">BIDS 1.6.0</span><span class="pill">2 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="tactile">Tactile</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">35 ch · EEG · 2000 Hz · 36 subjects, 358 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-es46 · task-expsupp · run-03</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>36 subjects and 358 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006374" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006374&sub=es46&task=expsupp&run=03&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006374 — sub-es46 · task-expsupp · run-03"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006374) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006374) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006374</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Pohle2025</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006374</code> · <code>Pohle2025</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006374</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006374.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006374">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006374.v1.0.0">10.18112/openneuro.ds006374.v1.0.0</a></b></div></footer>
