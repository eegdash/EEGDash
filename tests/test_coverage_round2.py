...
# ==============================================================================
class TestBidsDatasetChannelsTsv:
    """Test EEGBIDSDataset channel type methods."""

    def test_channel_types_exception(self, tmp_path):
...
# ==============================================================================
class TestBidsDatasetParticipantTsv:
    """Test participant TSV reading with exception handling."""

    def test_subject_participant_tsv_exception_reading(self, tmp_path):
    ...
    def test_subject_participant_tsv_empty_file(self, tmp_path):
...
# ==============================================================================
class TestPathsMNEData:
    """Test get_default_cache_dir with MNE_DATA environment variable."""

    def test_get_default_cache_dir_mne_data_env(self, tmp_path, monkeypatch):
...
# ==============================================================================
class TestDatasetCacheDir:
    """Test EEGDashDataset cache directory handling."""

    def test_cache_dir_does_not_exist_creates(self, tmp_path, caplog):
...
# ==============================================================================
class TestDatasetMergeParticipants:
    """Test dataset participant merging edge cases."""

    def test_iterate_local_with_participants_exception(self, tmp_path):
...
# ==============================================================================
class TestHBNWindowsTrialTable:
    """Test HBN windows trial table building."""

    def test_build_trial_table_with_sad_face_feedback(self):
    ...
    def test_build_trial_table_no_response(self):
...
# ==============================================================================
class TestHBNWindowsConversions:
    """Test HBN windows type conversion functions."""

    def test_to_int_or_none_bool(self):
    ...
    def test_to_int_or_none_numpy_int(self):
...
# ==============================================================================
class TestExtractorsTrainableFeature:
    """Test TrainableFeature class."""

    def test_trainable_feature_interface(self):
    ...
    def test_feature_extractor_with_trainable(self):
...
# ==============================================================================
class TestExtractorsMultivariateFeature:
    """Test MultivariateFeature classes."""

    def test_multivariate_feature_dict_input(self):
    ...
    def test_bivariate_feature_channel_names(self):
    ...
    def test_directed_bivariate_feature(self):
...
# ==============================================================================
class TestFeaturesInspect:
    """Test feature inspection functions."""

    def test_get_feature_predecessors_none(self):
    ...
    def test_get_feature_predecessors_multiple(self):
    ...
    def test_get_all_feature_preprocessors(self):
    ...
    def test_get_all_feature_kinds(self):
...
# ==============================================================================
class TestFeaturesSerializationLoad:
    """Test features serialization loading."""

    def test_load_features_concat_dataset_auto_discovery(self, tmp_path):
...
# ==============================================================================
class TestFeaturesUtilsExtract:
    """Test features extraction utilities."""

    def test_extract_features_list_input(self):
...
# ==============================================================================
class TestDownloaderIncomplete:
    """Test downloader incomplete file handling."""

    def test_download_file_incomplete_error(self, tmp_path):
...
# ==============================================================================
class TestDatasetFindDatasets:
    """Test EEGDashDataset _find_datasets method."""

    def test_normalize_records_with_list(self):
...
# ==============================================================================
class TestExtractorsPartialFit:
    """Test FeatureExtractor partial_fit and fit methods."""

    def test_feature_extractor_clear_non_trainable(self):
    ...
    def test_feature_extractor_partial_fit_non_trainable(self):
    ...
    def test_feature_extractor_fit_non_trainable(self):
...
# ==============================================================================
class TestExtractorPreprocessorKwargs:
    """Test FeatureExtractor with preprocessor arguments."""

    def test_feature_extractor_with_partial_preprocessor(self):
...
# ==============================================================================
class TestMultivariateFeatureEmpty:
    """Test MultivariateFeature edge cases."""

    def test_array_to_dict_empty_channels(self):
...
# ==============================================================================
class TestAddAuxAnchorsComputed:
    """Test add_aux_anchors with computed stimulus onset."""

    def test_add_aux_anchors_compute_stim_from_rt(self):
...
# ==============================================================================
class TestKeepOnlyRecordingsWith:
    """Test keep_only_recordings_with function."""

    def test_keep_only_recordings_with_missing_desc(self):
...
# ==============================================================================
class TestFeaturesInspectKind:
    """Test feature kind inspection."""

    def test_get_feature_kind(self):
...
# ==============================================================================
class TestFeaturesInspectPredecessorsExtractor:
    """Test feature predecessor inspection with FeatureExtractor."""

    def test_get_feature_predecessors_with_extractor(self):
...
# ==============================================================================
class TestSerializationLoadParallel:
    """Test serialization loading functions."""

    def test_load_features_with_raw_info(self, tmp_path):
...
# ==============================================================================
class TestAnnotateTrialsWithTarget:
    """Test annotate_trials_with_target function."""

    def test_annotate_trials_with_target(self, tmp_path):
...
# ==============================================================================
class TestAddExtrasColumns:
    """Test add_extras_columns function."""

    def test_add_extras_columns_no_matching_desc(self):
...
# ==============================================================================
class TestFeatureExtractorNested:
    """Test FeatureExtractor with nested extractors."""

    def test_feature_extractor_nested_check_trainable(self):
    ...
    def test_feature_extractor_preprocess_none(self):
