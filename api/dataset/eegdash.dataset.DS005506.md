...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005506</b></div><div>Iss. 5506 · 150 subjects · 1405 recordings · CC-BY-SA 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Healthy Brain Network (HBN) EEG - Release 2</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005506</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC-BY-SA 4.0</dd><dt>Updated</dt><dd>2025-03-11</dd><dt>Contact</dt><dd>Seyed Yahya Shirazi</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>150</dd><dt>Recordings</dt><dd>1405</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>129</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>128 h</dd><dt>Size</dt><dd>111.9 GB</dd><dt>Tasks</dt><dd>10 tasks · <code>DespicableMe</code> · <code>DiaryOfAWimpyKid</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005506</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="development">Development</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005506">EEGDash/ds005506</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005506.v1.0.1">10.18112/openneuro.ds005506.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005506">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/ds005506">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005506.croissant.json" download>Croissant</a></div></aside>

# DS005506: eeg dataset, 150 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Healthy Brain Network (HBN) EEG - Release 2","alternateName":"DS005506","description":"Healthy Brain Network (HBN) EEG - Release 2. eeg dataset accessible via EEGDash as \`\`DS005506\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS005506.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds005506.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds005506.v1.0.1","https://openneuro.org/datasets/ds005506","https://nemar.org/dataexplorer/detail?dataset_id=ds005506"],"creator":[{"@type":"Person","name":"Seyed Yahya Shirazi"},{"@type":"Person","name":"Alexandre Franco"},{"@type":"Person","name":"Maurício Scopel Hoffmann"},{"@type":"Person","name":"Nathalia B. Esper"},{"@type":"Person","name":"Dung Truong"},{"@type":"Person","name":"Arnaud Delorme"},{"@type":"Person","name":"Michael Milham"},{"@type":"Person","name":"Scott Makeig"}],"license":"https://creativecommons.org/licenses/by-sa/4.0/","datePublished":"2024-01-01"}</script>

*Healthy Brain Network (HBN) EEG - Release 2*

**Citation:** Seyed Yahya Shirazi, Alexandre Franco, Maurício Scopel Hoffmann, Nathalia B. Esper, Dung Truong, Arnaud Delorme, Michael Milham, Scott Makeig (2024). *Healthy Brain Network (HBN) EEG - Release 2*. [10.18112/openneuro.ds005506.v1.0.1](https://doi.org/10.18112/openneuro.ds005506.v1.0.1)

<p class="eegdash-ed-deck">150-participant EEG dataset — Healthy Brain Network (HBN) EEG - Release 2.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Seyed Yahya Shirazi</strong> · <strong>Alexandre Franco</strong> · Maurício Scopel Hoffmann · Nathalia B. Esper · Dung Truong · Arnaud Delorme · …<br/><span class="role">Senior author</span> <strong>Scott Makeig</strong><br/><span class="role">Year</span> 2024 · Distributed via OpenNeuro<br/><span class="role">Funding</span> See https://childmind.org/science/global-open-science/healthy-brain-network/#donors · NIH/NIMH R01MH125934 for BIDS data preparation</div><div class="eegdash-ed-pills"><span class="pill">EEG · 129 ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">10 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="development">Development</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=150, range 5–19 yr, mean 9.2 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="5-9: n=90"><div style="width:100%; height:58px; background:#006ca3; flex-shrink:0;" title="5-9: female n=29"></div><div style="width:100%; height:122px; background:#f7941d; flex-shrink:0;" title="5-9: male n=61"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="10-14: n=48"><div style="width:100%; height:38px; background:#006ca3; flex-shrink:0;" title="10-14: female n=19"></div><div style="width:100%; height:58px; background:#f7941d; flex-shrink:0;" title="10-14: male n=29"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=12"><div style="width:100%; height:12px; background:#006ca3; flex-shrink:0;" title="15-19: female n=6"></div><div style="width:100%; height:12px; background:#f7941d; flex-shrink:0;" title="15-19: male n=6"></div></div>
  </div>
  ...
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 54</span><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#f7941d; display:inline-block;"></i>Male · 96</span></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">129 ch · EEG · 500 Hz · 150 subjects, 1405 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-NDARVV199XK2 · task-RestingState</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>150 subjects and 1405 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds005506" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds005506&sub=NDARVV199XK2&task=RestingState&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds005506 — sub-NDARVV199XK2 · task-RestingState"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds005506). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds005506" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds005506/code/ds005506_histogram.png"
      alt="NEMAR pipeline statistics — DS005506"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds005506/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS005506"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds005506">
  <div class="ee-bar">
...
|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Title          | Healthy Brain Network (HBN) EEG - Release 2                                                                                                                                       |
| Author (year)  | `Shirazi2024_R2`                                                                                                                                                                  |
| Canonical      | —                                                                                                                                                                                 |
| Importable as  | `DS005506`, `Shirazi2024_R2`                                                                                                                                                      |
| Year           | 2024                                                                                                                                                                              |
...
| Citation / DOI | [doi:10.18112/openneuro.ds005506.v1.0.1](https://doi.org/10.18112/openneuro.ds005506.v1.0.1)                                                                                      |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds005506) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds005506) | [Source URL](https://openneuro.org/datasets/ds005506) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS005506</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Shirazi2024_R2</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS005506</code> · <code>Shirazi2024_R2</code></span></div>
...
OpenNeuro dataset: [https://openneuro.org/datasets/ds005506](https://openneuro.org/datasets/ds005506)
NeMAR dataset: [https://nemar.org/dataexplorer/detail?dataset_id=ds005506](https://nemar.org/dataexplorer/detail?dataset_id=ds005506)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS005506</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS005506.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds005506">Hugging Face mirror</a></div><div>CC-BY-SA 4.0 · <b><a href="https://doi.org/10.18112/openneuro.ds005506.v1.0.1">10.18112/openneuro.ds005506.v1.0.1</a></b></div></footer>
