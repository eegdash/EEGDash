<a id="concepts-leakage-and-evaluation"></a>
...
The advice below is consistent with Tip 9 of Cisotto & Chicco (2024) <sup>[1](#id2)</sup>,
...
4. Always include a chance-level baseline and, where possible, a
   simple feature baseline (see [Features vs. deep learning](features_vs_deep_learning.md)).
...
* <a id='id2'>**[1]**</a> Cisotto, G., & Chicco, D. (2024). Ten quick tips for clinical electroencephalographic (EEG) data acquisition and signal processing. *PeerJ Computer Science*, 10, e2256. [https://doi.org/10.7717/peerj-cs.2256](https://doi.org/10.7717/peerj-cs.2256)
- Saeb, S., Lonini, L., Jayaraman, A., Mohr, D. C., & Kording, K. P.
  ...
  [https://doi.org/10.1093/gigascience/gix019](https://doi.org/10.1093/gigascience/gix019)
- Roy, Y., Banville, H., Albuquerque, I., Gramfort, A., Falk, T. H., &
  ...
  [https://doi.org/10.1088/1741-2552/ab260c](https://doi.org/10.1088/1741-2552/ab260c)
