...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS004000</b></div><div>Iss. 4000 · 43 subjects · 86 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Fribourg Ultimatum Game in Schizophrenia Study</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS004000</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.3389/fnint.2017.00013">10.3389/fnint.2017.00013</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>43</dd><dt>Recordings</dt><dd>86</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>132</dd><dt>Sample rate</dt><dd>2048 Hz</dd><dt>Duration</dt><dd>12.1 h</dd><dt>Size</dt><dd>22.5 GB</dd><dt>Tasks</dt><dd><code>proposer</code> · <code>responder</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>v1.6.0</dd><dt>Sidecars</dt><dd>electrodes · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds004000</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="schizophrenia/psychosis">Schizophrenia/Psychosis</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds004000">EEGDash/ds004000</a></dd><dt>Citations</dt><dd>6</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds004000.v1.0.0">10.18112/openneuro.ds004000.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds004000">OpenNeuro</a><a href="https://doi.org/10.3389/fnint.2017.00013">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds004000">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS004000.croissant.json" download>Croissant</a></div></aside>

# DS004000: eeg dataset, 43 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Fribourg Ultimatum Game in Schizophrenia Study","alternateName":"DS004000","description":"Fribourg Ultimatum Game in Schizophrenia Study. eeg dataset accessible via EEGDash as \`\`DS004000\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS004000.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds004000.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds004000.v1.0.0","https://openneuro.org/datasets/ds004000","https://nemar.org/dataexplorer/detail?dataset_id=ds004000"],"creator":[{"@type":"Person","name":"Anna Padée"},{"@type":"Person","name":"Pascal Missonnier"},{"@type":"Person","name":"Anne Prévot"},{"@type":"Person","name":"Grégoire Favre"},{"@type":"Person","name":"Isabelle Gothuey"},{"@type":"Person","name":"Marco Merlo"},{"@type":"Person","name":"Jonas Richiardi"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Fribourg Ultimatum Game in Schizophrenia Study*

**Citation:** Anna Padée, Pascal Missonnier, Anne Prévot, Grégoire Favre, Isabelle Gothuey, Marco Merlo, Jonas Richiardi (—). *Fribourg Ultimatum Game in Schizophrenia Study*. [10.18112/openneuro.ds004000.v1.0.0](https://doi.org/10.18112/openneuro.ds004000.v1.0.0)

<p class="eegdash-ed-deck">43-participant EEG dataset — Fribourg Ultimatum Game in Schizophrenia Study.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Anna Padée</strong> · <strong>Pascal Missonnier</strong> · Anne Prévot · Grégoire Favre · Isabelle Gothuey · Marco Merlo · …</div><div class="eegdash-ed-pills"><span class="pill">EEG · 132 ch</span><span class="pill">2048 Hz</span><span class="pill is-info">BIDS v1.6.0</span><span class="pill">2 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="schizophrenia/psychosis">Schizophrenia/Psychosis</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <p><strong>Total recording duration</strong>: 12 h 3 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">132 ch · EEG · 2048 Hz · 43 subjects, 86 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-021 · task-proposer · run-1</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>43 subjects and 86 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds004000" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds004000&sub=021&task=proposer&run=1&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds004000 — sub-021 · task-proposer · run-1"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds004000) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds004000) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS004000</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Padee2022</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS004000</code> · <code>Padee2022</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS004000</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS004000.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds004000">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds004000.v1.0.0">10.18112/openneuro.ds004000.v1.0.0</a></b></div></footer>
