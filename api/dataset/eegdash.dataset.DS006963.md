...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006963</b></div><div>Iss. 6963 · 32 subjects · 32 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Motor Control Processes Moderate Visual Working Memory Gating…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006963</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1523/jneurosci.0673-25.2025">10.1523/jneurosci.0673-25.2025</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>32</dd><dt>Recordings</dt><dd>32</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>85.3 h</dd><dt>Size</dt><dd>52.8 GB</dd><dt>Tasks</dt><dd><code>VisuomotorDelayedMatchToSampleWithInterference</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>v1.10.1</dd><dt>Sidecars</dt><dd>events · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006963</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="memory">Memory</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006963">EEGDash/ds006963</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006963.v1.0.1">10.18112/openneuro.ds006963.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006963">OpenNeuro</a><a href="https://doi.org/10.1523/jneurosci.0673-25.2025">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006963">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006963.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-021 · task-VisuomotorDelayedMatchToSampleWithInterference</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds006963" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006963&sub=021&task=VisuomotorDelayedMatchToSampleWithInterference&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006963 — sub-021 · task-VisuomotorDelayedMatchToSampleWithInterference"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006963) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006963) |
