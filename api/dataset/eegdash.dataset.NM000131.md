...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000131</b></div><div>Iss. 131 · 8 subjects · 22 recordings · CC BY 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Wang2021 – Combined SSVEP dataset with single stimulus locati…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000131</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC BY 4.0</dd><dt>Updated</dt><dd>2026-04-29</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>8</dd><dt>Recordings</dt><dd>22</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>31</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>6.2 h</dd><dt>Size</dt><dd>2.6 GB</dd><dt>Tasks</dt><dd><code>ssvep</code></dd><dt>Sessions</dt><dd><code>0</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000131</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000131">EEGDash/nm000131</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000131">10.82901/nemar.nm000131</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000131">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000131">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000131.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-figpair">
  ...
  <p class="trace-viewer-caption">
    ...
    <strong>8 subjects and 22 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000131" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000131&sub=6&ses=0&task=ssvep&run=1&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000131 — sub-6 · ses-0 · task-ssvep · run-1"
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000131</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000131.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000131">Hugging Face mirror</a></div><div>CC BY 4.0 · <b><a href="https://doi.org/10.82901/nemar.nm000131">10.82901/nemar.nm000131</a></b></div></footer>
