...
```none
saved: /tmp/eegdash_save_t28iyhx9/windows
...
```none
Zarr write_s=0.0167, read_s=0.0061, size_mb=0.0080
```
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0156, read_s=0.0118, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_t28iyhx9/windows/0 already exists. Please select
