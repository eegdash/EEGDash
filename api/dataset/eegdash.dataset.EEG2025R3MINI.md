...
- Source: nemar
- OpenNeuro: [eeg2025r3mini](https://openneuro.org/datasets/eeg2025r3mini)
- NeMAR: [eeg2025r3mini](https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r3mini)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="5-9: 11"></div><div style="width:28px; height:63%; background:#4472c4; flex-shrink:0;" title="10-14: 7"></div><div style="width:28px; height:18%; background:#4472c4; flex-shrink:0;" title="15-19: 2"></div>
  </div>
...
Use the `EEG2025R3MINI` class to access this dataset programmatically.
