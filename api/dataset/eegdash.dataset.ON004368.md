...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON004368</b></div><div>Iss. 4368 · 39 subjects · 40 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Meta-rdk</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON004368</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41537-023-00333-4">10.1038/s41537-023-00333-4</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>39</dd><dt>Recordings</dt><dd>40</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>63</dd><dt>Sample rate</dt><dd>128 Hz</dd><dt>Duration</dt><dd>8.5 h</dd><dt>Size</dt><dd>997.6 MB</dd><dt>Tasks</dt><dd><code>task</code></dd><dt>Sessions</dt><dd>2 · <code>1</code> · <code>2</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.1.1</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on004368</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on004368">10.82901/nemar.on004368</a></div><div class="actions"><a href="https://openneuro.org/datasets/on004368">OpenNeuro</a><a href="https://doi.org/10.1038/s41537-023-00333-4">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON004368.croissant.json" download>Croissant</a></div></aside>

# ON004368: eeg dataset, 39 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Meta-rdk: Preprocessed EEG data","alternateName":"ON004368","description":"Meta-rdk: Preprocessed EEG data. eeg dataset accessible via EEGDash as \`\`ON004368\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON004368.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on004368","sameAs":["https://doi.org/10.82901/nemar.on004368","https://openneuro.org/datasets/on004368","https://nemar.org/dataexplorer/detail?dataset_id=on004368"],"creator":[{"@type":"Person","name":"Martin Rouy"},{"@type":"Person","name":"Matthieu Roger"},{"@type":"Person","name":"Dorian Goueytes"},{"@type":"Person","name":"Michael Pereira"},{"@type":"Person","name":"Paul Roux"},{"@type":"Person","name":"Nathan Faivre"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Meta-rdk: Preprocessed EEG data*

**Citation:** Martin Rouy, Matthieu Roger, Dorian Goueytes, Michael Pereira, Paul Roux, Nathan Faivre (—). *Meta-rdk: Preprocessed EEG data*. [10.82901/nemar.on004368](https://doi.org/10.82901/nemar.on004368)

<p class="eegdash-ed-deck">39-participant EEG dataset — Meta-rdk: Preprocessed EEG data.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Martin Rouy</strong> · <strong>Matthieu Roger</strong> · Dorian Goueytes · Michael Pereira · Paul Roux · Nathan Faivre</div><div class="eegdash-ed-pills"><span class="pill">EEG · 63 ch</span><span class="pill">128 Hz</span><span class="pill is-info">BIDS 1.1.1</span><span class="pill">Task · task</span><span class="pill">2 sessions</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-S01 · ses-1 · task-task</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on004368" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on004368&sub=S01&ses=1&task=task&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on004368 — sub-S01 · ses-1 · task-task"
...
<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on004368" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on004368/code/on004368_histogram.png"
      alt="NEMAR pipeline statistics — ON004368"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on004368/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON004368"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on004368">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `ON004368`                                                                                                                |
| Year           | —                                                                                                                         |
| Authors        | Martin Rouy, Matthieu Roger, Dorian Goueytes, Michael Pereira, Paul Roux, Nathan Faivre                                   |
| License        | CC0                                                                                                                       |
| Citation / DOI | [10.82901/nemar.on004368](https://doi.org/10.82901/nemar.on004368)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on004368) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on004368) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON004368</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON004368</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON004368</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON004368.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on004368">10.82901/nemar.on004368</a></b></div></footer>
