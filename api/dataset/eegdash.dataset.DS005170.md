...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005170</b></div><div>Iss. 5170 · 5 subjects · 225 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Chisco</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005170</dd><dt>Version</dt><dd>v1.1.2</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Updated</dt><dd>2024-12-12</dd><dt>Contact</dt><dd>Zihan Zhang</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>5</dd><dt>Recordings</dt><dd>225</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>Varies</dd><dt>Sample rate</dt><dd>Varies</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>90.7 GB</dd><dt>Tasks</dt><dd><code>imagine</code></dd><dt>Sessions</dt><dd>6 · <code>01</code> … <code>06</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.6.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>80% · Good</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005170</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005170">EEGDash/ds005170</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005170.v1.1.2">10.18112/openneuro.ds005170.v1.1.2</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005170">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/ds005170">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005170.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">— ch · EEG · Varies · 5 subjects, 225 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-01 · ses-02 · task-imagine · run-012</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>5 subjects and 225 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds005170" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds005170&sub=01&ses=02&task=imagine&run=012&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds005170 — sub-01 · ses-02 · task-imagine · run-012"
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS005170</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Zhang2024_Chisco</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS005170</code> · <code>Zhang2024_Chisco</code></span></div>
...
* [eegdash.dataset.NM000152](eegdash.dataset.NM000152.md)

<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS005170</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS005170.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds005170">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds005170.v1.1.2">10.18112/openneuro.ds005170.v1.1.2</a></b></div></footer>
