...
- Source: nemar
- OpenNeuro: [nm000126](https://openneuro.org/datasets/nm000126)
- NeMAR: [nm000126](https://nemar.org/dataexplorer/detail?dataset_id=nm000126)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=34, range 22–22 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="20-24: 34"></div>
  </div>
