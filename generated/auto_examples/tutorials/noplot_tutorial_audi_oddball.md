...
<!-- "generated/auto_examples/tutorials/noplot_tutorial_audi_oddball.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-generated-auto-examples-tutorials-noplot-tutorial-audi-oddball-py"></a>

<a id="auditory-oddball-tutorial"></a>
...
[Braindecode]([https://braindecode.org/](https://braindecode.org/)) provides a powerful framework for EEG data preprocessing and analysis.
...
<!-- GENERATED FROM PYTHON SOURCE LINES 97-143 -->
```Python
...
<!-- GENERATED FROM PYTHON SOURCE LINES 155-201 -->
```Python
import torch
...
<!-- GENERATED FROM PYTHON SOURCE LINES 234-278 -->
```Python
...
<a id="sphx-glr-download-generated-auto-examples-tutorials-noplot-tutorial-audi-oddball-py"></a>
