...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003766</b></div><div>Iss. 3766 · 31 subjects · 124 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · A resource for assessing dynamic binary choices in the adult…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003766</dd><dt>Version</dt><dd>v2.0.3</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-022-01538-5">10.1038/s41597-022-01538-5</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>31</dd><dt>Recordings</dt><dd>124</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>129</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>40.8 h</dd><dt>Size</dt><dd>152.8 GB</dd><dt>Tasks</dt><dd>4 tasks · <code>foodchoice</code> · <code>imagechoice</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.6.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003766</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003766">EEGDash/ds003766</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003766.v2.0.3">10.18112/openneuro.ds003766.v2.0.3</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003766">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-022-01538-5">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003766">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003766.croissant.json" download>Croissant</a></div></aside>

# DS003766: eeg dataset, 31 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"A resource for assessing dynamic binary choices in the adult brain using EEG and mouse-tracking","alternateName":"DS003766","description":"A resource for assessing dynamic binary choices in the adult brain using EEG and mouse-tracking. eeg dataset accessible via EEGDash as \`\`DS003766\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS003766.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds003766.v2.0.3","sameAs":["https://doi.org/10.18112/openneuro.ds003766.v2.0.3","https://openneuro.org/datasets/ds003766","https://nemar.org/dataexplorer/detail?dataset_id=ds003766"],"creator":[{"@type":"Person","name":"Kun Chen"},{"@type":"Person","name":"Ruien Wang"},{"@type":"Person","name":"Jiamin Huang"},{"@type":"Person","name":"Fei Gao"},{"@type":"Person","name":"Zhen Yuan"},{"@type":"Person","name":"Yanyan Qi"},{"@type":"Person","name":"Haiyan Wu"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2022-01-01"}</script>

*A resource for assessing dynamic binary choices in the adult brain using EEG and mouse-tracking*

**Citation:** Kun Chen, Ruien Wang, Jiamin Huang, Fei Gao, Zhen Yuan, Yanyan Qi, Haiyan Wu (2022). *A resource for assessing dynamic binary choices in the adult brain using EEG and mouse-tracking*. [10.18112/openneuro.ds003766.v2.0.3](https://doi.org/10.18112/openneuro.ds003766.v2.0.3)

<p class="eegdash-ed-deck">31-participant EEG dataset — A resource for assessing dynamic binary choices in the adult brain using EEG and mouse-tracking.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Kun Chen</strong> · <strong>Ruien Wang</strong> · Jiamin Huang · Fei Gao · Zhen Yuan · Yanyan Qi · …<br/><span class="role">Year</span> 2022 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 129 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.6.0</span><span class="pill">4 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=31, range 18–33 yr, mean 20.7 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=13"><div style="width:100%; height:108px; background:#006ca3; flex-shrink:0;" title="15-19: female n=9"></div><div style="width:100%; height:48px; background:#f7941d; flex-shrink:0;" title="15-19: male n=4"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=15"><div style="width:100%; height:72px; background:#006ca3; flex-shrink:0;" title="20-24: female n=6"></div><div style="width:100%; height:108px; background:#f7941d; flex-shrink:0;" title="20-24: male n=9"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=2"><div style="width:100%; height:12px; background:#006ca3; flex-shrink:0;" title="25-29: female n=1"></div><div style="width:100%; height:12px; background:#f7941d; flex-shrink:0;" title="25-29: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=1"><div style="width:100%; height:12px; background:#006ca3; flex-shrink:0;" title="30-34: female n=1"></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">129 ch · EEG · 1000 Hz · 31 subjects, 124 recordings</span>
  </div>
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003766) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003766) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003766</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Chen2021</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003766</code> · <code>Chen2021</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003766</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003766.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003766">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003766.v2.0.3">10.18112/openneuro.ds003766.v2.0.3</a></b></div></footer>
