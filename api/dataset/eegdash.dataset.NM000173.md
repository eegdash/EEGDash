...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000173</b></div><div>Iss. 173 · 15 subjects · 300 recordings · CC-BY-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Motor Imagery ataset from Ofner et al 2017</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000173</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-4.0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1371/journal.pone.0182578">10.1371/journal.pone.0182578</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>15</dd><dt>Recordings</dt><dd>300</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>61</dd><dt>Sample rate</dt><dd>512 Hz</dd><dt>Duration</dt><dd>27.1 h</dd><dt>Size</dt><dd>8.5 GB</dd><dt>Tasks</dt><dd><code>imagery</code></dd><dt>Sessions</dt><dd>2 · <code>0execution</code> · <code>1imagination</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000173</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000173">10.82901/nemar.nm000173</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000173">OpenNeuro</a><a href="https://doi.org/10.1371/journal.pone.0182578">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/NM000173.croissant.json" download>Croissant</a></div></aside>

# NM000173: eeg dataset, 15 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Motor Imagery ataset from Ofner et al 2017","alternateName":"NM000173","description":"Motor Imagery ataset from Ofner et al 2017. eeg dataset accessible via EEGDash as \`\`NM000173\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000173.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.nm000173","sameAs":["https://doi.org/10.82901/nemar.nm000173","https://openneuro.org/datasets/nm000173","https://nemar.org/dataexplorer/detail?dataset_id=nm000173"],"creator":[{"@type":"Person","name":"Patrick Ofner"},{"@type":"Person","name":"Andreas Schwarz"},{"@type":"Person","name":"Joana Pereira"},{"@type":"Person","name":"Gernot R. Müller-Putz"}],"license":"https://creativecommons.org/licenses/by/4.0/","datePublished":"2019-01-01"}</script>

*Motor Imagery ataset from Ofner et al 2017*

**Citation:** Patrick Ofner, Andreas Schwarz, Joana Pereira, Gernot R. Müller-Putz (2019). *Motor Imagery ataset from Ofner et al 2017*. [10.82901/nemar.nm000173](https://doi.org/10.82901/nemar.nm000173)

<p class="eegdash-ed-deck">15-participant EEG dataset — Motor Imagery ataset from Ofner et al 2017.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Patrick Ofner</strong> · <strong>Andreas Schwarz</strong> · Joana Pereira · Gernot R. Müller-Putz<br/><span class="role">Year</span> 2019 · Distributed via NeMAR<br/><span class="role">Funding</span> H2020-643955 MoreGrasp · ERC Consolidator Grant ERC-681231 Feel Your Reach</div><div class="eegdash-ed-pills"><span class="pill">EEG · 61 ch</span><span class="pill">512 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">Task · imagery</span><span class="pill">2 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
[DOI](https://doi.org/10.82901/nemar.nm000173)
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="2010-2014: n=15"><div style="width:100%; height:180px; background:#6b7785; flex-shrink:0;" title="2010-2014: other n=15"></div></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">2010</span>
  </div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-13 · ses-0execution · task-imagery · run-2</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>15 subjects and 300 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000173" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000173&sub=13&ses=0execution&task=imagery&run=2&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000173 — sub-13 · ses-0execution · task-imagery · run-2"
...
| License        | CC-BY-4.0                                                                                                                 |
| Citation / DOI | [10.82901/nemar.nm000173](https://doi.org/10.82901/nemar.nm000173)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000173) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000173) |
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000173</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000173.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC-BY-4.0 · <b><a href="https://doi.org/10.82901/nemar.nm000173">10.82901/nemar.nm000173</a></b></div></footer>
