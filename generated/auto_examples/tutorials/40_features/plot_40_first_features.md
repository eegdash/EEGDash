...
<!-- "generated/auto_examples/tutorials/40_features/plot_40_first_features.py" -->
...
- Compute per-channel band power for theta, alpha, beta, and gamma on a windowed dataset with [`eegdash.features.extract_features()`](../../../../api/features_overview.md#eegdash.features.extract_features).
...
- **Welch psd_array_welch under the hood.** The spectral preprocessor
  wraps [`mne.time_frequency.psd_array_welch()`](https://mne.tools/stable/generated/mne.time_frequency.psd_array_welch.html#mne.time_frequency.psd_array_welch) so the FFT runs once
...
**Run.** [`extract_features()`](../../../../api/features_overview.md#eegdash.features.extract_features) walks every
...
Extracting features: 100%|██████████| 2/2 [00:00<00:00, 145.78it/s]
```
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <th>n_cols (incl. target)</th>
      <td>145</td>
    </tr>
    <tr>
      <th>first 4 columns</th>
      <td>['var_O1', 'var_Oz', 'var_O2', 'var_POz']</td>
    </tr>
    <tr>
      <th>alpha cols</th>
      <td>24</td>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <th>feature_tensor.shape</th>
      <td>(32, 4, 24)</td>
    </tr>
    <tr>
      <th>feature_tensor.dtype</th>
      <td>float64</td>
    </tr>
    <tr>
      <th>mean per (band, ch).shape</th>
      <td>(4, 24)</td>
    </tr>
  </tbody>
</table>
...
expect [[Pedregosa *et al.*, 2011](../../../../references.md#id33)]. Saving the tidy DataFrame rather than
...
[`extract_features()`](../../../../api/features_overview.md#eegdash.features.extract_features) raises `TypeError` because
...
```none
Extracting features:   0%|          | 0/2 [00:00<?, ?it/s]
Extracting features: 100%|██████████| 2/2 [00:00<00:00, 147.75it/s]
...
- API: [`eegdash.features.extract_features()`](../../../../api/features_overview.md#eegdash.features.extract_features),
...
<a id="sphx-glr-download-generated-auto-examples-tutorials-40-features-plot-40-first-features-py"></a>
