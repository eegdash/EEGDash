...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-000 · ses-000 · task-discretegestures</strong></summary>
  ...
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000105&sub=000&ses=000&task=discretegestures&ext=bdf&suffix=emg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EMG trace viewer for nm000105 — sub-000 · ses-000 · task-discretegestures"
