...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS004121</b></div><div>Iss. 4121 · 21 subjects · 60 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · BCIT Mind Wandering</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS004121</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1016/j.neuroimage.2017.02.057">10.1016/j.neuroimage.2017.02.057</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>21</dd><dt>Recordings</dt><dd>60</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>74</dd><dt>Sample rate</dt><dd>1024 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>23.9 GB</dd><dt>Tasks</dt><dd><code>DriveWithTaskAudio</code></dd><dt>Sessions</dt><dd><code>01</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd>events · channels · electrodes · coordsystem</dd><dt>Events ann.</dt><dd><a href="#nemar-processing-statistics">HED ✓</a></dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds004121</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds004121">EEGDash/ds004121</a></dd><dt>Citations</dt><dd>0</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds004121.v1.0.0">10.18112/openneuro.ds004121.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds004121">OpenNeuro</a><a href="https://doi.org/10.1016/j.neuroimage.2017.02.057">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds004121">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS004121.croissant.json" download>Croissant</a></div></aside>

# DS004121: eeg dataset, 21 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"BCIT Mind Wandering","alternateName":"DS004121","description":"BCIT Mind Wandering. eeg dataset accessible via EEGDash as \`\`DS004121\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS004121.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds004121.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds004121.v1.0.0","https://openneuro.org/datasets/ds004121","https://nemar.org/dataexplorer/detail?dataset_id=ds004121"],"creator":[{"@type":"Person","name":"Jonathan Touryan (data and curation)"},{"@type":"Person","name":"Greg Apker (data)"},{"@type":"Person","name":"Brent Lance (data)"},{"@type":"Person","name":"Scott Kerick (data)"},{"@type":"Person","name":"Anthony Ries (data)"},{"@type":"Person","name":"Justin Brooks (data)"},{"@type":"Person","name":"Kaleb McDowell (data)"},{"@type":"Person","name":"Tony Johnson (curation)"},{"@type":"Person","name":"Kay Robbins (curation)"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*BCIT Mind Wandering*

**Citation:** Jonathan Touryan (data and curation), Greg Apker (data), Brent Lance (data), Scott Kerick (data), Anthony Ries (data), Justin Brooks (data), Kaleb McDowell (data), Tony Johnson (curation), Kay Robbins (curation) (20). *BCIT Mind Wandering*. [10.18112/openneuro.ds004121.v1.0.0](https://doi.org/10.18112/openneuro.ds004121.v1.0.0)

<p class="eegdash-ed-deck">21-participant EEG dataset — BCIT Mind Wandering.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Jonathan Touryan (data and curation)</strong> · <strong>Greg Apker (data)</strong> · Brent Lance (data) · Scott Kerick (data) · Anthony Ries (data) · Justin Brooks (data) · …<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro<br/><span class="role">Funding</span> This research was sponsored by the Army Research Laboratory and was accomplished under Cooperative Agreement Number W911NF-10-0-0002.</div><div class="eegdash-ed-pills"><span class="pill">EEG · 74 ch</span><span class="pill">1024 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill is-warning">HED ✓</span><span class="pill">Task · DriveWithTaskAudio</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 74 ch (n=60 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 1024.0 Hz (n=60 recordings)</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">74 ch · EEG · 1024 Hz · 21 subjects, 60 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-13 · ses-01 · task-DriveWithTaskAudio · run-2</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>21 subjects and 60 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds004121" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds004121&sub=13&ses=01&task=DriveWithTaskAudio&run=2&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds004121 — sub-13 · ses-01 · task-DriveWithTaskAudio · run-2"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds004121). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds004121" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds004121/code/ds004121_histogram.png"
      alt="NEMAR pipeline statistics — DS004121"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds004121/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS004121"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds004121">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds004121) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds004121)                                                                                           |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS004121</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Touryan2022_BCIT_Mind</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS004121</code> · <code>Touryan2022_BCIT_Mind</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS004121</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS004121.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds004121">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds004121.v1.0.0">10.18112/openneuro.ds004121.v1.0.0</a></b></div></footer>
