...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000186</b></div><div>Iss. 186 · 8 subjects · 88 recordings · CC-BY-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · BigP3BCI Study E — 6x6 checkerboard (8 healthy subjects)</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000186</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-4.0</dd><dt>Updated</dt><dd>2026-04-02</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>8</dd><dt>Recordings</dt><dd>88</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>16</dd><dt>Sample rate</dt><dd>256 Hz</dd><dt>Duration</dt><dd>2.4 h</dd><dt>Size</dt><dd>104.7 MB</dd><dt>Tasks</dt><dd><code>p300</code></dd><dt>Sessions</dt><dd><code>0</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000186</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000186">EEGDash/nm000186</a></dd></dl><div class="actions"><a href="https://openneuro.org/datasets/nm000186">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000186">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000186.croissant.json" download>Croissant</a></div></aside>

# NM000186: eeg dataset, 8 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"BigP3BCI Study E — 6x6 checkerboard (8 healthy subjects)","alternateName":"NM000186","description":"BigP3BCI Study E — 6x6 checkerboard (8 healthy subjects). eeg dataset accessible via EEGDash as \`\`NM000186\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000186.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"sameAs":["https://openneuro.org/datasets/nm000186","https://nemar.org/dataexplorer/detail?dataset_id=nm000186","https://nemar.org/dataexplorer/detail/nm000186"],"creator":[{"@type":"Person","name":"Boyla Mainsah"},{"@type":"Person","name":"Chance Fleeting"},{"@type":"Person","name":"Thomas Balmat"},{"@type":"Person","name":"Eric Sellers"},{"@type":"Person","name":"Leslie Collins"}],"license":"https://creativecommons.org/licenses/by/4.0/","datePublished":"2019-01-01"}</script>

*BigP3BCI Study E — 6x6 checkerboard (8 healthy subjects)*

**Citation:** Boyla Mainsah, Chance Fleeting, Thomas Balmat, Eric Sellers, Leslie Collins (2019). *BigP3BCI Study E — 6x6 checkerboard (8 healthy subjects)*.

<p class="eegdash-ed-deck">8-participant EEG dataset — BigP3BCI Study E — 6x6 checkerboard (8 healthy subjects).</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Boyla Mainsah</strong> · <strong>Chance Fleeting</strong> · Thomas Balmat · Eric Sellers · Leslie Collins<br/><span class="role">Year</span> 2019 · Distributed via NeMAR</div><div class="eegdash-ed-pills"><span class="pill">EEG · 16 ch</span><span class="pill">256 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">Task · p300</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = NM000186(cache_dir="./data", subject="01")
```
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section eegdash-ed-sex" style="margin-bottom:1rem;">
  ...
  <div class="sex-wrap" style="display:flex; align-items:center; gap:30px; flex-wrap:wrap;">
    ...
    <div class="sex-legend" style="flex:1; font-family:JetBrains Mono,monospace; font-size:13px; min-width:220px;"><div class="row"><div class="sw" style="background:#006ca3"></div><div class="lbl">Female</div><div class="v">5</div></div><div class="row"><div class="sw" style="background:#f7941d"></div><div class="lbl">Male</div><div class="v">3</div></div><div class="row ratio"><div class="sw" style="visibility:hidden"></div><div class="lbl">F : M ratio</div><div class="v">1.67 : 1</div></div></div>
  </div>
  <div class="sex-note" style="margin-top:14px; font-size:13px; color:#34404e; line-height:1.5; max-width:520px; font-family:Spectral,Georgia,serif;">62% female · n = 8 subjects with reported sex.</div>

</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 16 ch (n=88 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 256.0 Hz (n=88 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">16 ch · EEG · 256 Hz · 8 subjects, 88 recordings</span>
  </div>
  ...
  <p class="trace-viewer-caption">
    ...
    <strong>8 subjects and 88 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000186" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000186&sub=6&ses=0&task=p300&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000186 — sub-6 · ses-0 · task-p300 · run-0"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000186). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000186" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000186/code/nm000186_histogram.png"
      alt="NEMAR pipeline statistics — NM000186"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000186/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000186"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000186">
  <div class="ee-bar">
...
|----------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Title          | BigP3BCI Study E — 6x6 checkerboard (8 healthy subjects)                                                                                                                                 |
| Author (year)  | `Mainsah2025_BigP3BCI_E`                                                                                                                                                                 |
| Canonical      | —                                                                                                                                                                                        |
| Importable as  | `NM000186`, `Mainsah2025_BigP3BCI_E`                                                                                                                                                     |
| Year           | 2019                                                                                                                                                                                     |
| Authors        | Boyla Mainsah, Chance Fleeting, Thomas Balmat, Eric Sellers, Leslie Collins                                                                                                              |
| License        | CC-BY-4.0                                                                                                                                                                                |
| Citation / DOI | Unknown                                                                                                                                                                                  |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000186) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000186) | [Source URL](https://nemar.org/dataexplorer/detail/nm000186) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000186</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Mainsah2025_BigP3BCI_E</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000186</code> · <code>Mainsah2025_BigP3BCI_E</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000186</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000186.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000186">Hugging Face mirror</a></div><div>CC-BY-4.0 · <b><span style="opacity:.6">DOI not on file</span></b></div></footer>
