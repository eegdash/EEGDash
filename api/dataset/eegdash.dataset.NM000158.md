...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000158</b></div><div>Iss. 158 · 50 subjects · 50 recordings · CC-BY-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Liu, Lv et al. 2023 — EEG datasets of stroke patients (motor…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000158</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-4.0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-023-02787-8">10.1038/s41597-023-02787-8</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>50</dd><dt>Recordings</dt><dd>50</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>29</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>4.4 h</dd><dt>Size</dt><dd>673.6 MB</dd><dt>Tasks</dt><dd><code>imagery</code></dd><dt>Sessions</dt><dd><code>0</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000158</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000158">10.82901/nemar.nm000158</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000158">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-023-02787-8">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/NM000158.croissant.json" download>Croissant</a></div></aside>

# NM000158: eeg dataset, 50 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Liu, Lv et al. 2023 — EEG datasets of stroke patients (motor imagery)","alternateName":"NM000158","description":"Liu, Lv et al. 2023 — EEG datasets of stroke patients (motor imagery). eeg dataset accessible via EEGDash as \`\`NM000158\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000158.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.nm000158","sameAs":["https://doi.org/10.82901/nemar.nm000158","https://openneuro.org/datasets/nm000158","https://nemar.org/dataexplorer/detail?dataset_id=nm000158"],"creator":[{"@type":"Person","name":"Haijie Liu"},{"@type":"Person","name":"Penghu Wei"},{"@type":"Person","name":"Haochong Wang"},{"@type":"Person","name":"Xiaodong Lv"},{"@type":"Person","name":"Wei Duan"},{"@type":"Person","name":"Meijie Li"},{"@type":"Person","name":"Yan Zhao"},{"@type":"Person","name":"Qingmei Wang"},{"@type":"Person","name":"Xinyuan Chen"},{"@type":"Person","name":"Gaige Shi"},{"@type":"Person","name":"Bo Han"},{"@type":"Person","name":"Junwei Hao"}],"license":"https://creativecommons.org/licenses/by/4.0/","datePublished":"2022-01-01"}</script>

*Liu, Lv et al. 2023 — EEG datasets of stroke patients (motor imagery)*

**Citation:** Haijie Liu, Penghu Wei, Haochong Wang, Xiaodong Lv, Wei Duan, Meijie Li, Yan Zhao, Qingmei Wang, Xinyuan Chen, Gaige Shi, Bo Han, Junwei Hao (2022). *Liu, Lv et al. 2023 — EEG datasets of stroke patients (motor imagery)*. [10.82901/nemar.nm000158](https://doi.org/10.82901/nemar.nm000158)

<p class="eegdash-ed-deck">50-participant EEG dataset — Liu, Lv et al. 2023 — EEG datasets of stroke patients (motor imagery).</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Haijie Liu</strong> · <strong>Penghu Wei</strong> · Haochong Wang · Xiaodong Lv · Wei Duan · Meijie Li · …<br/><span class="role">Year</span> 2022 · Distributed via NeMAR<br/><span class="role">Funding</span> National Natural Science Foundation of China (grant nos. 82090043 and 81825008)</div><div class="eegdash-ed-pills"><span class="pill">EEG · 29 ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">Task · imagery</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="motor">Motor</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
[DOI](https://doi.org/10.82901/nemar.nm000158)
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="70-74: n=50"><div style="width:100%; height:180px; background:#6b7785; flex-shrink:0;" title="70-74: other n=50"></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/nm000158" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000158&sub=13&ses=0&task=imagery&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000158 — sub-13 · ses-0 · task-imagery · run-0"
...
| License        | CC-BY-4.0                                                                                                                                    |
| Citation / DOI | [10.82901/nemar.nm000158](https://doi.org/10.82901/nemar.nm000158)                                                                           |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000158) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000158)                    |
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000158</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000158.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC-BY-4.0 · <b><a href="https://doi.org/10.82901/nemar.nm000158">10.82901/nemar.nm000158</a></b></div></footer>
