...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006366</b></div><div>Iss. 6366 · 92 subjects · 148 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Mouse Sleep Staging Validation dataset (MSSV)</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006366</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1093/sleepadvances/zpaf025">10.1093/sleepadvances/zpaf025</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>92</dd><dt>Recordings</dt><dd>148</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>3 (71), 2 (43), 5 (34)</dd><dt>Sample rate</dt><dd>128 Hz</dd><dt>Duration</dt><dd>2163 h</dd><dt>Size</dt><dd>6.1 GB</dd><dt>Tasks</dt><dd><code>sleep</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.10.0</dd><dt>Sidecars</dt><dd>events</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006366</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="sleep">Sleep</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006366">EEGDash/ds006366</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006366.v1.0.1">10.18112/openneuro.ds006366.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006366">OpenNeuro</a><a href="https://doi.org/10.1093/sleepadvances/zpaf025">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006366">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006366.croissant.json" download>Croissant</a></div></aside>

# DS006366: eeg dataset, 92 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Mouse Sleep Staging Validation dataset (MSSV)","alternateName":"DS006366","description":"Mouse Sleep Staging Validation dataset (MSSV). eeg dataset accessible via EEGDash as \`\`DS006366\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006366.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006366.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds006366.v1.0.1","https://openneuro.org/datasets/ds006366","https://nemar.org/dataexplorer/detail?dataset_id=ds006366"],"creator":[{"@type":"Person","name":"Laura Rose"},{"@type":"Person","name":"Alexander Neergaard Zahid"},{"@type":"Person","name":"Javier García Ciudad"},{"@type":"Person","name":"Christine Egebjerg"},{"@type":"Person","name":"Louise Piilgaard"},{"@type":"Person","name":"Frederikke Lynge Sørensen"},{"@type":"Person","name":"Mie Andersen"},{"@type":"Person","name":"Tessa Radovanovic"},{"@type":"Person","name":"Anastasia Tsopanidou"},{"@type":"Person","name":"Maiken Nedergaard"},{"@type":"Person","name":"Sébastien Arthaud"},{"@type":"Person","name":"Renato Maciel"},{"@type":"Person","name":"Christelle Peyron"},{"@type":"Person","name":"Chiara Berteotti"},{"@type":"Person","name":"Viviana Lo Martire"},{"@type":"Person","name":"Alessandro Silvani"},{"@type":"Person","name":"Giovanna Zoccoli"},{"@type":"Person","name":"Micaela Borsa"},{"@type":"Person","name":"Antoine Adamantidis"},{"@type":"Person","name":"Morten Mørup"},{"@type":"Person","name":"Birgitte Rahbek Kornum"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <p><strong>Total recording duration</strong>: 2163 h</p>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-021 · task-sleep · run-1</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>92 subjects and 148 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006366" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006366&sub=021&task=sleep&run=1&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006366 — sub-021 · task-sleep · run-1"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006366) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006366)                                                                                                                                                                                                                                                                                         |
