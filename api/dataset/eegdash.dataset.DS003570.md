...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003570</b></div><div>Iss. 3570 · 40 subjects · 40 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · EEG</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003570</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Updated</dt><dd>2021-03-19</dd><dt>Contact</dt><dd>Andrew Goldman, Josef Faller</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>40</dd><dt>Recordings</dt><dd>40</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>2048 Hz</dd><dt>Duration</dt><dd>26.2 h</dd><dt>Size</dt><dd>47.6 GB</dd><dt>Tasks</dt><dd><code>AuditoryOddballChords</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.1.1</dd><dt>Sidecars</dt><dd>events · events.json · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003570</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003570">EEGDash/ds003570</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003570.v1.0.0">10.18112/openneuro.ds003570.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003570">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/ds003570">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003570.croissant.json" download>Croissant</a></div></aside>
...
<p class="eegdash-ed-deck">40-participant EEG dataset — EEG: Improvisation and Musical Structures.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Andrew Goldman</strong> · <strong>Tyreek Jackson</strong> · Paul Sajda<br/><span class="role">Senior author</span> <strong>Paul Sajda</strong><br/><span class="role">Year</span> 2021 · Distributed via OpenNeuro<br/><span class="role">Funding</span> Presidential Scholars in Society and Neuroscience program at Columbia University · Army Research Laboratory under Cooperative Agreement Number W911NF-15-2-0074</div><div class="eegdash-ed-pills"><span class="pill">EEG · 64 ch</span><span class="pill">2048 Hz</span><span class="pill is-info">BIDS 1.1.1</span><span class="pill">Task · AuditoryOddballChords</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=40, range 18–42 yr, mean 25.3 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=7"><div style="width:100%; height:96px; background:#6b7785; flex-shrink:0;" title="15-19: other n=7"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=12"><div style="width:100%; height:166px; background:#6b7785; flex-shrink:0;" title="20-24: other n=12"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=13"><div style="width:100%; height:180px; background:#6b7785; flex-shrink:0;" title="25-29: other n=13"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=6"><div style="width:100%; height:83px; background:#6b7785; flex-shrink:0;" title="30-34: other n=6"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="35-39: n=1"><div style="width:100%; height:13px; background:#6b7785; flex-shrink:0;" title="35-39: other n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="40-44: n=1"><div style="width:100%; height:13px; background:#6b7785; flex-shrink:0;" title="40-44: other n=1"></div></div>
  </div>
  ...
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#6b7785; display:inline-block;"></i>Other · 40</span></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">64 ch · EEG · 2048 Hz · 40 subjects, 40 recordings</span>
  </div>
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003570</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Goldman2021</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003570</code> · <code>Goldman2021</code></span></div>
...
* [eegdash.dataset.DS003505](eegdash.dataset.DS003505.md)
* [eegdash.dataset.DS004477](eegdash.dataset.DS004477.md)
* [eegdash.dataset.DS003626](eegdash.dataset.DS003626.md)

<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003570</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003570.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003570">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003570.v1.0.0">10.18112/openneuro.ds003570.v1.0.0</a></b></div></footer>
