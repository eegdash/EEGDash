...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS007640</b></div><div>Iss. 7640 · 23 subjects · 94 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Dataset of emotion recognition using validated video stimuli…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS007640</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-020-00630-y">10.1038/s41597-020-00630-y</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>23</dd><dt>Recordings</dt><dd>94</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>Varies</dd><dt>Sample rate</dt><dd>1024 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>88.8 GB</dd><dt>Tasks</dt><dd>4 tasks · <code>HAHV</code> · <code>HALV</code> · …</dd><dt>Sessions</dt><dd>4 · <code>01</code> … <code>04</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>TBD</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds007640</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds007640.v1.0.1">10.18112/openneuro.ds007640.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds007640">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-020-00630-y">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/DS007640.croissant.json" download>Croissant</a></div></aside>

# DS007640: meg dataset, 23 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Dataset of emotion recognition using validated video stimuli with large-scale behavioral survey and MEG recordings","alternateName":"DS007640","description":"Dataset of emotion recognition using validated video stimuli with large-scale behavioral survey and MEG recordings. meg dataset accessible via EEGDash as \`\`DS007640\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS007640.html","keywords":["meg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds007640.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds007640.v1.0.1","https://openneuro.org/datasets/ds007640","https://nemar.org/dataexplorer/detail?dataset_id=ds007640"],"creator":[{"@type":"Person","name":"Moon-A Yoo"},{"@type":"Person","name":"Dong-Uk Kim"},{"@type":"Person","name":"Soo-In Choi"},{"@type":"Person","name":"Min-Young Kim"},{"@type":"Person","name":"Sung-Phil Kim"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Dataset of emotion recognition using validated video stimuli with large-scale behavioral survey and MEG recordings*

**Citation:** Moon-A Yoo, Dong-Uk Kim, Soo-In Choi, Min-Young Kim, Sung-Phil Kim (—). *Dataset of emotion recognition using validated video stimuli with large-scale behavioral survey and MEG recordings*. [10.18112/openneuro.ds007640.v1.0.1](https://doi.org/10.18112/openneuro.ds007640.v1.0.1)

<p class="eegdash-ed-deck">23-participant MEG dataset — Dataset of emotion recognition using validated video stimuli with large-scale behavioral survey and MEG recordings.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Moon-A Yoo</strong> · <strong>Dong-Uk Kim</strong> · Soo-In Choi · Min-Young Kim · Sung-Phil Kim</div><div class="eegdash-ed-pills"><span class="pill">1024 Hz</span><span class="pill is-info">BIDS TBD</span><span class="pill">4 tasks</span><span class="pill">4 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=23, range 21–40 yr, mean 26.7 yr · sex per subject not reported)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="20-24: 10"></div><div style="flex:1 1 0; min-width:0; height:125px; background:#006ca3;" title="25-29: 7"></div><div style="flex:1 1 0; min-width:0; height:90px; background:#006ca3;" title="30-34: 5"></div><div style="flex:1 1 0; min-width:0; height:18px; background:#006ca3;" title="40-44: 1"></div>
  </div>
  ...
  <p><strong>Sampling frequencies</strong>: 1024.0 Hz (n=94 recordings)</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">— ch · MEG · 1024 Hz · 23 subjects, 94 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-04 · ses-01 · task-HAHV</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>23 subjects and 94 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds007640" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_meg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?meg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds007640&sub=04&ses=01&task=HAHV&ext=fif&suffix=meg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live MEG trace viewer for ds007640 — sub-04 · ses-01 · task-HAHV"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — MEG · 142 sensors — 142 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=34e4181c3db0b2ca&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 900px; display: block;"
    title="Topomap of MEG · 142 sensors"
    referrerpolicy="no-referrer">
  </iframe>
</details></div></div></div>
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds007640). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds007640" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds007640/code/ds007640_histogram.png"
      alt="NEMAR pipeline statistics — DS007640"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds007640/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS007640"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds007640">
  <div class="ee-bar">
...
| License        | CC0                                                                                                                       |
| Citation / DOI | [doi:10.18112/openneuro.ds007640.v1.0.1](https://doi.org/10.18112/openneuro.ds007640.v1.0.1)                              |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds007640) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds007640) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS007640</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS007640</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS007640</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS007640.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds007640.v1.0.1">10.18112/openneuro.ds007640.v1.0.1</a></b></div></footer>
