...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003739</b></div><div>Iss. 3739 · 30 subjects · 120 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Perturbed beam-walking task</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003739</dd><dt>Version</dt><dd>v1.0.2</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1523/eneuro.0207-18.2018">10.1523/eneuro.0207-18.2018</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>30</dd><dt>Recordings</dt><dd>120</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>149</dd><dt>Sample rate</dt><dd>256 Hz</dd><dt>Duration</dt><dd>20.6 h</dd><dt>Size</dt><dd>10.9 GB</dd><dt>Tasks</dt><dd>4 tasks · <code>pullstand</code> · <code>pullwalk</code> · …</dd><dt>Sessions</dt><dd>4 · <code>01</code> … <code>04</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>v1.6.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003739</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="motor">Motor</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003739">EEGDash/ds003739</a></dd><dt>Citations</dt><dd>5</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003739.v1.0.2">10.18112/openneuro.ds003739.v1.0.2</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003739">OpenNeuro</a><a href="https://doi.org/10.1523/eneuro.0207-18.2018">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003739">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003739.croissant.json" download>Croissant</a></div></aside>

# DS003739: eeg dataset, 30 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Perturbed beam-walking task","alternateName":"DS003739","description":"Perturbed beam-walking task. eeg dataset accessible via EEGDash as \`\`DS003739\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS003739.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds003739.v1.0.2","sameAs":["https://doi.org/10.18112/openneuro.ds003739.v1.0.2","https://openneuro.org/datasets/ds003739","https://nemar.org/dataexplorer/detail?dataset_id=ds003739"],"creator":[{"@type":"Person","name":"Steven Peterson"},{"@type":"Person","name":"Daniel Ferris"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Perturbed beam-walking task*

**Citation:** Steven Peterson, Daniel Ferris (—). *Perturbed beam-walking task*. [10.18112/openneuro.ds003739.v1.0.2](https://doi.org/10.18112/openneuro.ds003739.v1.0.2)

<p class="eegdash-ed-deck">30-participant EEG dataset — Perturbed beam-walking task.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Steven Peterson</strong> · <strong>Daniel Ferris</strong><br/><span class="role">Funding</span> National Science Foundation (DGE 1256260) · Army Research Laboratory (W911NF-10-2-0022) · + 1 more</div><div class="eegdash-ed-pills"><span class="pill">EEG · 149 ch</span><span class="pill">256 Hz</span><span class="pill is-info">BIDS v1.6.0</span><span class="pill">4 tasks</span><span class="pill">4 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="motor">Motor</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=30, range 18–34 yr, mean 22.5 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=13"><div style="width:100%; height:180px; background:#6b7785; flex-shrink:0;" title="15-19: other n=13"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=9"><div style="width:100%; height:124px; background:#6b7785; flex-shrink:0;" title="20-24: other n=9"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=4"><div style="width:100%; height:55px; background:#6b7785; flex-shrink:0;" title="25-29: other n=4"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=4"><div style="width:100%; height:55px; background:#6b7785; flex-shrink:0;" title="30-34: other n=4"></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">149 ch · EEG · 256 Hz · 30 subjects, 120 recordings</span>
  </div>
  ...
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=41346331c9e9a945&embed=1"
    loading="lazy"
    width="100%" height="640"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003739) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003739) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003739</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Peterson2021_Perturbed_beam_walking</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003739</code> · <code>Peterson2021_Perturbed_beam_walking</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003739</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003739.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003739">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003739.v1.0.2">10.18112/openneuro.ds003739.v1.0.2</a></b></div></footer>
