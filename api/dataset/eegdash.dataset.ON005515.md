...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON005515</b></div><div>Iss. 5515 · 533 subjects · 2516 recordings · CC-BY-SA 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Healthy Brain Network (HBN) EEG - Release 10</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON005515</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-SA 4.0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2024.10.03.615261">10.1101/2024.10.03.615261</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>533</dd><dt>Recordings</dt><dd>2516</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>129</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>183 h</dd><dt>Size</dt><dd>160.6 GB</dd><dt>Tasks</dt><dd>8 tasks · <code>DespicableMe</code> · <code>DiaryOfAWimpyKid</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on005515</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on005515">10.82901/nemar.on005515</a></div><div class="actions"><a href="https://openneuro.org/datasets/on005515">OpenNeuro</a><a href="https://doi.org/10.1101/2024.10.03.615261">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON005515.croissant.json" download>Croissant</a></div></aside>

# ON005515: eeg dataset, 533 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Healthy Brain Network (HBN) EEG - Release 10","alternateName":"ON005515","description":"Healthy Brain Network (HBN) EEG - Release 10. eeg dataset accessible via EEGDash as \`\`ON005515\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON005515.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on005515","sameAs":["https://doi.org/10.82901/nemar.on005515","https://openneuro.org/datasets/on005515","https://nemar.org/dataexplorer/detail?dataset_id=on005515"],"creator":[{"@type":"Person","name":"Seyed Yahya Shirazi"},{"@type":"Person","name":"Alexandre Franco"},{"@type":"Person","name":"Maurício Scopel Hoffmann"},{"@type":"Person","name":"Nathalia B. Esper"},{"@type":"Person","name":"Dung Truong"},{"@type":"Person","name":"Arnaud Delorme"},{"@type":"Person","name":"Michael Milham"},{"@type":"Person","name":"Scott Makeig"}],"license":"https://creativecommons.org/licenses/by-sa/4.0/"}</script>

*Healthy Brain Network (HBN) EEG - Release 10*

**Citation:** Seyed Yahya Shirazi, Alexandre Franco, Maurício Scopel Hoffmann, Nathalia B. Esper, Dung Truong, Arnaud Delorme, Michael Milham, Scott Makeig (20). *Healthy Brain Network (HBN) EEG - Release 10*. [10.82901/nemar.on005515](https://doi.org/10.82901/nemar.on005515)
...
```python
dataset = ON005515(cache_dir="./data", subject="01")
```
...
@dataset{on005515,
  ...
  doi = {10.82901/nemar.on005515},
  url = {https://doi.org/10.82901/nemar.on005515},
}
```
...
[DOI](https://doi.org/10.82901/nemar.on005515)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-NDARAA396TWZ · task-DespicableMe</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on005515" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on005515&sub=NDARAA396TWZ&task=DespicableMe&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on005515 — sub-NDARAA396TWZ · task-DespicableMe"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on005515). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on005515" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on005515/code/on005515_histogram.png"
      alt="NEMAR pipeline statistics — ON005515"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on005515/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON005515"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on005515">
  <div class="ee-bar">
...
| Citation / DOI | [10.82901/nemar.on005515](https://doi.org/10.82901/nemar.on005515)                                                                            |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on005515) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on005515)                     |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON005515</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON005515</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON005515</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON005515.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC-BY-SA 4.0 · <b><a href="https://doi.org/10.82901/nemar.on005515">10.82901/nemar.on005515</a></b></div></footer>
