...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON000117</b></div><div>Iss. 117 · 17 subjects · 104 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Multisubject, multimodal face processing</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON000117</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/sdata.2015.1">10.1038/sdata.2015.1</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>17</dd><dt>Recordings</dt><dd>104</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>394</dd><dt>Sample rate</dt><dd>1100 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>169.4 GB</dd><dt>Tasks</dt><dd><code>facerecognition</code> · <code>noise</code></dd><dt>Sessions</dt><dd>9 · <code>20090409</code> … <code>meg</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.0.2</dd><dt>Sidecars</dt><dd>events · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on000117</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on000117">10.82901/nemar.on000117</a></div><div class="actions"><a href="https://openneuro.org/datasets/on000117">OpenNeuro</a><a href="https://doi.org/10.1038/sdata.2015.1">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON000117.croissant.json" download>Croissant</a></div></aside>

# ON000117: meg dataset, 17 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Multisubject, multimodal face processing","alternateName":"ON000117","description":"Multisubject, multimodal face processing. meg dataset accessible via EEGDash as \`\`ON000117\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON000117.html","keywords":["meg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on000117","sameAs":["https://doi.org/10.82901/nemar.on000117","https://openneuro.org/datasets/on000117","https://nemar.org/dataexplorer/detail?dataset_id=on000117"],"creator":[{"@type":"Person","name":"Wakeman, DG"},{"@type":"Person","name":"Henson, RN"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2015-01-01"}</script>

*Multisubject, multimodal face processing*

**Citation:** Wakeman, DG, Henson, RN (2015). *Multisubject, multimodal face processing*. [10.82901/nemar.on000117](https://doi.org/10.82901/nemar.on000117)

<p class="eegdash-ed-deck">17-participant MEG dataset — Multisubject, multimodal face processing.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Wakeman, DG</strong> · <strong>Henson, RN</strong><br/><span class="role">Year</span> 2015 · Distributed via NeMAR<br/><span class="role">Funding</span> UK Medical Research Council (SUAG/010 RG91365), Elekta Ltd.</div><div class="eegdash-ed-pills"><span class="pill">MEG · 394 ch</span><span class="pill">1100 Hz</span><span class="pill is-info">BIDS 1.0.2</span><span class="pill">2 tasks</span><span class="pill">9 sessions</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
: > Wakeman, D.G. & Henson, R.N. (2015). A multi-subject, multi-modal human neuroimaging dataset. Sci. Data 2:150001 doi: 10.1038/sdata.2015.1
  <br/>
  [DOI](https://doi.org/10.82901/nemar.on000117)
  <br/>
...
<div class="eegdash-ed-figpair">
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on000117" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_meg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?meg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on000117&sub=01&ses=meg&task=facerecognition&run=01&ext=fif&suffix=meg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live MEG trace viewer for on000117 — sub-01 · ses-meg · task-facerecognition · run-01"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on000117). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on000117" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on000117/code/on000117_histogram.png"
      alt="NEMAR pipeline statistics — ON000117"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on000117/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON000117"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on000117">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `ON000117`                                                                                                                |
| Year           | 2015                                                                                                                      |
| Authors        | Wakeman, DG, Henson, RN                                                                                                   |
| License        | CC0                                                                                                                       |
| Citation / DOI | [10.82901/nemar.on000117](https://doi.org/10.82901/nemar.on000117)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on000117) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on000117) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON000117</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON000117</code></span></div>
