...
- Prerequisites:
  ...
  /auto_examples/tutorials/40_features/plot_40_first_features (how
...
```none
saved: /tmp/eegdash_save_1_w512_c/windows
...
```none
reload OK: type=BaseConcatDataset, n=2, read_s=0.0060
```
...
```none
Zarr write_s=0.0156, read_s=0.0057, size_mb=0.0080
```
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0155, read_s=0.0118, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_1_w512_c/windows/0 already exists. Please select
