...
<details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-13 · ses-2 · task-p300 · run-1</strong></summary>
  ...
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000323&sub=13&ses=2&task=p300&run=1&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000323 — sub-13 · ses-2 · task-p300 · run-1"
    referrerpolicy="no-referrer">
  </iframe>
</details>
