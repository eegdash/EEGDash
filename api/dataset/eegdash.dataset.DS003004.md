...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003004</b></div><div>Iss. 3004 · 34 subjects · 34 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Imagined Emotion Study</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003004</dd><dt>Version</dt><dd>v1.1.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Updated</dt><dd>2022-08-23</dd><dt>Contact</dt><dd>Dung Truong, Arnaud Delorme, Kay Robbins</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>34</dd><dt>Recordings</dt><dd>34</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>224 (3), 219 (3), 221 (2), 214 (2), 212 (2), 201, 218, 222, 235, 209, 180, 229, 215, 206, 213, 207, 134, 232, 227, 220, 226, 223, 208, 196, 231, 189, 211</dd><dt>Sample rate</dt><dd>256 Hz</dd><dt>Duration</dt><dd>49.1 h</dd><dt>Size</dt><dd>36.0 GB</dd><dt>Tasks</dt><dd><code>ImaginedEmotion</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.1.1</dd><dt>Sidecars</dt><dd>events · events.json · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003004</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003004">EEGDash/ds003004</a></dd><dt>Citations</dt><dd>7</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003004.v1.1.1">10.18112/openneuro.ds003004.v1.1.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003004">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/ds003004">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003004.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=34, range 18–38 yr, mean 25.2 yr · sex per subject not reported)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="flex:1 1 0; min-width:0; height:22px; background:#006ca3;" title="15-19: 2"></div><div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="20-24: 16"></div><div style="flex:1 1 0; min-width:0; height:123px; background:#006ca3;" title="25-29: 11"></div><div style="flex:1 1 0; min-width:0; height:33px; background:#006ca3;" title="30-34: 3"></div><div style="flex:1 1 0; min-width:0; height:22px; background:#006ca3;" title="35-39: 2"></div>
  </div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">224 (3), 219 (3), 221 (2), 214 (2), 212 (2), 201, 218, 222, 235, 209, 180, 229, 215, 206, 213, 207, 134, 232, 227, 220, 226, 223, 208, 196, 231, 189, 211 ch · EEG · 256 Hz · 34 subjects, 34 recordings</span>
  </div>
  ...
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=534d32817812e697&embed=1"
    loading="lazy"
    width="100%" height="640"
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003004</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Onton2020</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003004</code> · <code>Onton2020</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003004</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003004.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003004">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003004.v1.1.1">10.18112/openneuro.ds003004.v1.1.1</a></b></div></footer>
