...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS007524</b></div><div>Iss. 7524 · 50 subjects · 500 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · LittlePrince_MEG_French_Read_Pallier2025</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS007524</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Updated</dt><dd>2026-04-03</dd><dt>Contact</dt><dd>Christophe Pallier</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>50</dd><dt>Recordings</dt><dd>500</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>346 (414), 339 (27), 338 (9)</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>64.0 h</dd><dt>Size</dt><dd>298.6 GB</dd><dt>Tasks</dt><dd><code>read</code></dd><dt>Sessions</dt><dd><code>01</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.6.0</dd><dt>Sidecars</dt><dd>coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds007524</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="other">Other</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds007524">EEGDash/ds007524</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds007524.v1.0.1">10.18112/openneuro.ds007524.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds007524">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/ds007524">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS007524.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=24"><div style="width:100%; height:37px; background:#006ca3; flex-shrink:0;" title="20-24: female n=5"></div><div style="width:100%; height:142px; background:#f7941d; flex-shrink:0;" title="20-24: male n=19"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=2"><div style="width:100%; height:7px; background:#006ca3; flex-shrink:0;" title="25-29: female n=1"></div><div style="width:100%; height:7px; background:#f7941d; flex-shrink:0;" title="25-29: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=20"><div style="width:100%; height:15px; background:#006ca3; flex-shrink:0;" title="30-34: female n=2"></div><div style="width:100%; height:135px; background:#f7941d; flex-shrink:0;" title="30-34: male n=18"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="35-39: n=1"><div style="width:100%; height:7px; background:#006ca3; flex-shrink:0;" title="35-39: female n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="40-44: n=2"><div style="width:100%; height:7px; background:#006ca3; flex-shrink:0;" title="40-44: female n=1"></div><div style="width:100%; height:7px; background:#f7941d; flex-shrink:0;" title="40-44: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="45-49: n=1"><div style="width:100%; height:7px; background:#f7941d; flex-shrink:0;" title="45-49: male n=1"></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-13 · ses-01 · task-read · run-02</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>50 subjects and 500 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds007524" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_meg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?meg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds007524&sub=13&ses=01&task=read&run=02&ext=fif&suffix=meg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live MEG trace viewer for ds007524 — sub-13 · ses-01 · task-read · run-02"
...
* [eegdash.dataset.DS003568](eegdash.dataset.DS003568.md)
* [eegdash.dataset.DS002550](eegdash.dataset.DS002550.md)
* [eegdash.dataset.DS006502](eegdash.dataset.DS006502.md)
* [eegdash.dataset.DS005810](eegdash.dataset.DS005810.md)

<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS007524</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS007524.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds007524">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds007524.v1.0.1">10.18112/openneuro.ds007524.v1.0.1</a></b></div></footer>
