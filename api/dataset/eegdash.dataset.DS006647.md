...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006647</b></div><div>Iss. 6647 · 4 subjects · 4 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Poetry Assessment EEG Dataset 2</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006647</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1080/10400419.2025.2466571">10.1080/10400419.2025.2466571</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>4</dd><dt>Recordings</dt><dd>4</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>70</dd><dt>Sample rate</dt><dd>512 Hz</dd><dt>Duration</dt><dd>8.7 h</dd><dt>Size</dt><dd>4.3 GB</dd><dt>Tasks</dt><dd><code>readpoetry</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006647</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006647">EEGDash/ds006647</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006647.v1.0.1">10.18112/openneuro.ds006647.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006647">OpenNeuro</a><a href="https://doi.org/10.1080/10400419.2025.2466571">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006647">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006647.croissant.json" download>Croissant</a></div></aside>

# DS006647: eeg dataset, 4 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Poetry Assessment EEG Dataset 2","alternateName":"DS006647","description":"Poetry Assessment EEG Dataset 2. eeg dataset accessible via EEGDash as \`\`DS006647\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006647.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006647.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds006647.v1.0.1","https://openneuro.org/datasets/ds006647","https://nemar.org/dataexplorer/detail?dataset_id=ds006647"],"creator":[{"@type":"Person","name":"Soma Chaudhuri"},{"@type":"Person","name":"Joydeep Bhattacharya"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Poetry Assessment EEG Dataset 2*

**Citation:** Soma Chaudhuri, Joydeep Bhattacharya (—). *Poetry Assessment EEG Dataset 2*. [10.18112/openneuro.ds006647.v1.0.1](https://doi.org/10.18112/openneuro.ds006647.v1.0.1)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-002 · task-readpoetry</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds006647" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006647&sub=002&task=readpoetry&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds006647 — sub-002 · task-readpoetry"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006647) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006647) |
