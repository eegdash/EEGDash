...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006317</b></div><div>Iss. 6317 · 2 subjects · 64 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Chisco-2.0</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006317</dd><dt>Version</dt><dd>v1.1.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-025-05957-y">10.1038/s41597-025-05957-y</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>2</dd><dt>Recordings</dt><dd>64</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>127</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>62.1 h</dd><dt>Size</dt><dd>52.9 GB</dd><dt>Tasks</dt><dd><code>para1</code> · <code>para2</code></dd><dt>Sessions</dt><dd>4 · <code>01</code> … <code>04</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.10.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006317</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006317">EEGDash/ds006317</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006317.v1.1.1">10.18112/openneuro.ds006317.v1.1.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006317">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-025-05957-y">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006317">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006317.croissant.json" download>Croissant</a></div></aside>

# DS006317: eeg dataset, 2 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Chisco-2.0","alternateName":"DS006317","description":"Chisco-2.0. eeg dataset accessible via EEGDash as \`\`DS006317\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006317.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006317.v1.1.1","sameAs":["https://doi.org/10.18112/openneuro.ds006317.v1.1.1","https://openneuro.org/datasets/ds006317","https://nemar.org/dataexplorer/detail?dataset_id=ds006317"],"creator":[{"@type":"Person","name":"Zihan Zhang"},{"@type":"Person","name":"Yu Bao"},{"@type":"Person","name":"Tianyi Jiang"},{"@type":"Person","name":"Xiao Ding"},{"@type":"Person","name":"Xia Liang"},{"@type":"Person","name":"Juntong Du"},{"@type":"Person","name":"Yi Zhao"},{"@type":"Person","name":"Kai Xiong"},{"@type":"Person","name":"Bing Qin"},{"@type":"Person","name":"Ting Liu"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2019-01-01"}</script>

*Chisco-2.0*

**Citation:** Zihan Zhang, Yu Bao, Tianyi Jiang, Xiao Ding, Xia Liang, Juntong Du, Yi Zhao, Kai Xiong, Bing Qin, Ting Liu (2019). *Chisco-2.0*. [10.18112/openneuro.ds006317.v1.1.1](https://doi.org/10.18112/openneuro.ds006317.v1.1.1)

<p class="eegdash-ed-deck">2-participant EEG dataset — Chisco-2.0.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Zihan Zhang</strong> · <strong>Yu Bao</strong> · Tianyi Jiang · Xiao Ding · Xia Liang · Juntong Du · …<br/><span class="role">Year</span> 2019 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 127 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.10.0</span><span class="pill">2 tasks</span><span class="pill">4 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">127 ch · EEG · 1000 Hz · 2 subjects, 64 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-01 · ses-02 · task-para2 · run-02</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>2 subjects and 64 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006317" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006317&sub=01&ses=02&task=para2&run=02&ext=edf&embed=1"
    loading="lazy"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006317) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006317) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006317</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Zhang2025_Chisco_2_0</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006317</code> · <code>Zhang2025_Chisco_2_0</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006317</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006317.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006317">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006317.v1.1.1">10.18112/openneuro.ds006317.v1.1.1</a></b></div></footer>
