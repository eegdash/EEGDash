...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS002094</b></div><div>Iss. 2094 · 20 subjects · 43 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Single-pulse open-loop TMS-EEG dataset</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS002094</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1093/cercor/bhy255">10.1093/cercor/bhy255</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>20</dd><dt>Recordings</dt><dd>43</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>30</dd><dt>Sample rate</dt><dd>5000 Hz</dd><dt>Duration</dt><dd>19.6 h</dd><dt>Size</dt><dd>39.4 GB</dd><dt>Tasks</dt><dd><code>rest</code> · <code>tmseeg1</code> · <code>tmseeg2</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.3.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>70% · Good</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds002094</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds002094">EEGDash/ds002094</a></dd><dt>Citations</dt><dd>30</dd></dl><div class="actions"><a href="https://openneuro.org/datasets/ds002094">OpenNeuro</a><a href="https://doi.org/10.1093/cercor/bhy255">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds002094">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS002094.croissant.json" download>Croissant</a></div></aside>

# DS002094: eeg dataset, 20 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Single-pulse open-loop TMS-EEG dataset","alternateName":"DS002094","description":"Single-pulse open-loop TMS-EEG dataset. eeg dataset accessible via EEGDash as \`\`DS002094\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS002094.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"sameAs":["https://openneuro.org/datasets/ds002094","https://nemar.org/dataexplorer/detail?dataset_id=ds002094"],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Single-pulse open-loop TMS-EEG dataset*

**Citation:** Unknown (—). *Single-pulse open-loop TMS-EEG dataset*.

<p class="eegdash-ed-deck">20-participant EEG dataset — Single-pulse open-loop TMS-EEG dataset.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> Authors unspecified</div><div class="eegdash-ed-pills"><span class="pill">EEG · 30 ch</span><span class="pill">5000 Hz</span><span class="pill is-info">BIDS 1.3.0</span><span class="pill">3 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">30 ch · EEG · 5000 Hz · 20 subjects, 43 recordings</span>
  </div>
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds002094) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds002094) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS002094</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>DS2094_Single_pulse</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS002094</code> · <code>DS2094_Single_pulse</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS002094</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS002094.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds002094">Hugging Face mirror</a></div><div>CC0 · <b><span style="opacity:.6">DOI not on file</span></b></div></footer>
