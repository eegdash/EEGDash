...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS004830</b></div><div>Iss. 4830 · 12 subjects · 14 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Spatial Attention Decoding using fNIRS During Complex Scene A…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS004830</dd><dt>Version</dt><dd>v2.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.3389/fnhum.2024.1329086">10.3389/fnhum.2024.1329086</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>12</dd><dt>Recordings</dt><dd>14</dd><dt>Modality</dt><dd>fNIRS</dd><dt>Channels</dt><dd>72 (27), 84 (6)</dd><dt>Sample rate</dt><dd>50 Hz</dd><dt>Duration</dt><dd>10.0 h</dd><dt>Size</dt><dd>2.2 GB</dd><dt>Tasks</dt><dd><code>overt</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.1</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds004830</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds004830">EEGDash/ds004830</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds004830.v2.0.0">10.18112/openneuro.ds004830.v2.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds004830">OpenNeuro</a><a href="https://doi.org/10.3389/fnhum.2024.1329086">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds004830">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS004830.croissant.json" download>Croissant</a></div></aside>

# DS004830: fnirs dataset, 12 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Spatial Attention Decoding using fNIRS During Complex Scene Analysis","alternateName":"DS004830","description":"Spatial Attention Decoding using fNIRS During Complex Scene Analysis. fnirs dataset accessible via EEGDash as \`\`DS004830\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS004830.html","keywords":["fnirs","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds004830.v2.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds004830.v2.0.0","https://openneuro.org/datasets/ds004830","https://nemar.org/dataexplorer/detail?dataset_id=ds004830"],"creator":[{"@type":"Person","name":"Matthew Ning"},{"@type":"Person","name":"Sudan Duwadi"},{"@type":"Person","name":"Meryem A. Yucel"},{"@type":"Person","name":"Alexander Von Luhmann"},{"@type":"Person","name":"David A. Boas"},{"@type":"Person","name":"Kamal Sen"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Spatial Attention Decoding using fNIRS During Complex Scene Analysis*

**Citation:** Matthew Ning, Sudan Duwadi, Meryem A. Yucel, Alexander Von Luhmann, David A. Boas, Kamal Sen (20). *Spatial Attention Decoding using fNIRS During Complex Scene Analysis*. [10.18112/openneuro.ds004830.v2.0.0](https://doi.org/10.18112/openneuro.ds004830.v2.0.0)

<p class="eegdash-ed-deck">12-participant fNIRS dataset — Spatial Attention Decoding using fNIRS During Complex Scene Analysis.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Matthew Ning</strong> · <strong>Sudan Duwadi</strong> · Meryem A. Yucel · Alexander Von Luhmann · David A. Boas · Kamal Sen<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">fNIRS · 72 (27), 84 (6) ch</span><span class="pill">50 Hz</span><span class="pill is-info">BIDS 1.7.1</span><span class="pill">Task · overt</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <p><strong>Total recording duration</strong>: 10 h 1 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">72 (27), 84 (6) ch · fNIRS · 50 Hz · 12 subjects, 14 recordings</span>
  </div>
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds004830) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds004830) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS004830</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Ning2023</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS004830</code> · <code>Ning2023</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS004830</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS004830.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds004830">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds004830.v2.0.0">10.18112/openneuro.ds004830.v2.0.0</a></b></div></footer>
