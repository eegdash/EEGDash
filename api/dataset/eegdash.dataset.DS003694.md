...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003694</b></div><div>Iss. 3694 · 28 subjects · 132 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · MEGMEM</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003694</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2020.01.22.915330">10.1101/2020.01.22.915330</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>28</dd><dt>Recordings</dt><dd>132</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>327 (109), 319 (19), 336 (4)</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>218.5 GB</dd><dt>Tasks</dt><dd><code>MEM</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.0.2</dd><dt>Sidecars</dt><dd>events · channels</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003694</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="memory">Memory</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003694">EEGDash/ds003694</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003694.v1.0.0">10.18112/openneuro.ds003694.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003694">OpenNeuro</a><a href="https://doi.org/10.1101/2020.01.22.915330">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003694">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003694.croissant.json" download>Croissant</a></div></aside>

# DS003694: meg dataset, 28 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"MEGMEM","alternateName":"DS003694","description":"MEGMEM. meg dataset accessible via EEGDash as \`\`DS003694\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS003694.html","keywords":["meg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds003694.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds003694.v1.0.0","https://openneuro.org/datasets/ds003694","https://nemar.org/dataexplorer/detail?dataset_id=ds003694"],"creator":[{"@type":"Person","name":"Benjamin J. Griffiths"},{"@type":"Person","name":"María Carmen Martín-Buro"},{"@type":"Person","name":"Bernhard Staresina"},{"@type":"Person","name":"Simon Hanslmayr"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*MEGMEM*

**Citation:** Benjamin J. Griffiths, María Carmen Martín-Buro, Bernhard Staresina, Simon Hanslmayr (—). *MEGMEM*. [10.18112/openneuro.ds003694.v1.0.0](https://doi.org/10.18112/openneuro.ds003694.v1.0.0)

<p class="eegdash-ed-deck">28-participant MEG dataset — MEGMEM.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Benjamin J. Griffiths</strong> · <strong>María Carmen Martín-Buro</strong> · Bernhard Staresina · Simon Hanslmayr</div><div class="eegdash-ed-pills"><span class="pill">MEG · 327 (109), 319 (19), 336 (4) ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.0.2</span><span class="pill">Task · MEM</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="memory">Memory</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:17%; background:#009E73; flex-shrink:0;" title="319 ch: 19"></div><div style="width:28px; height:100%; background:#009E73; flex-shrink:0;" title="327 ch: 109"></div><div style="width:28px; height:3%; background:#009E73; flex-shrink:0;" title="336 ch: 4"></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">319</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">327</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">336</span>
  </div>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 1000.0 Hz (n=132 recordings)</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">327 (109), 319 (19), 336 (4) ch · MEG · 1000 Hz · 28 subjects, 132 recordings</span>
  </div>
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds003694). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds003694" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds003694/code/ds003694_histogram.png"
      alt="NEMAR pipeline statistics — DS003694"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds003694/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS003694"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds003694">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003694) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003694) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003694</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Griffiths2021</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003694</code> · <code>Griffiths2021</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003694</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003694.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003694">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003694.v1.0.0">10.18112/openneuro.ds003694.v1.0.0</a></b></div></footer>
