...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS004796</b></div><div>Iss. 4796 · 79 subjects · 235 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · A Polish Electroencephalography, Alzheimer’s Risk-genes, Life…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS004796</dd><dt>Version</dt><dd>v1.1.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-024-03106-5">10.1038/s41597-024-03106-5</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>79</dd><dt>Recordings</dt><dd>235</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>127</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>44.3 h</dd><dt>Size</dt><dd>240.2 GB</dd><dt>Tasks</dt><dd><code>msit</code> · <code>rest</code> · <code>sternberg</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.0.2</dd><dt>Sidecars</dt><dd>events</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds004796</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual/resting-state">Visual/Resting State</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="memory/resting-state">Memory/Resting state</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds004796">EEGDash/ds004796</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds004796.v1.1.0">10.18112/openneuro.ds004796.v1.1.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds004796">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-024-03106-5">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds004796">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS004796.croissant.json" download>Croissant</a></div></aside>

# DS004796: eeg dataset, 79 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"A Polish Electroencephalography, Alzheimer’s Risk-genes, Lifestyle and Neuroimaging (PEARL-Neuro) Database","alternateName":"DS004796","description":"A Polish Electroencephalography, Alzheimer’s Risk-genes, Lifestyle and Neuroimaging (PEARL-Neuro) Database. eeg dataset accessible via EEGDash as \`\`DS004796\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS004796.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds004796.v1.1.0","sameAs":["https://doi.org/10.18112/openneuro.ds004796.v1.1.0","https://openneuro.org/datasets/ds004796","https://nemar.org/dataexplorer/detail?dataset_id=ds004796"],"creator":[{"@type":"Person","name":"Dzianok Patrycja"},{"@type":"Person","name":"Kublik Ewa"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/","datePublished":"2024-01-01"}</script>

*A Polish Electroencephalography, Alzheimer’s Risk-genes, Lifestyle and Neuroimaging (PEARL-Neuro) Database*

**Citation:** Dzianok Patrycja, Kublik Ewa (2024). *A Polish Electroencephalography, Alzheimer’s Risk-genes, Lifestyle and Neuroimaging (PEARL-Neuro) Database*. [10.18112/openneuro.ds004796.v1.1.0](https://doi.org/10.18112/openneuro.ds004796.v1.1.0)

<p class="eegdash-ed-deck">79-participant EEG dataset — A Polish Electroencephalography, Alzheimer’s Risk-genes, Lifestyle and Neuroimaging (PEARL-Neuro) Database.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Dzianok Patrycja</strong> · <strong>Kublik Ewa</strong><br/><span class="role">Year</span> 2024 · Distributed via OpenNeuro<br/><span class="role">Funding</span> Polish National Science Center (NCN) grant no. 2018/31/N/HS6/03551</div><div class="eegdash-ed-pills"><span class="pill">EEG · 127 ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.0.2</span><span class="pill">3 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual/resting-state">Visual/Resting State</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="memory/resting-state">Memory/Resting state</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=79, range 50–63 yr, mean 55.1 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="50-54: n=33"><div style="width:100%; height:152px; background:#6b7785; flex-shrink:0;" title="50-54: other n=33"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="55-59: n=39"><div style="width:100%; height:180px; background:#6b7785; flex-shrink:0;" title="55-59: other n=39"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="60-64: n=7"><div style="width:100%; height:32px; background:#6b7785; flex-shrink:0;" title="60-64: other n=7"></div></div>
  </div>
  ...
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#6b7785; display:inline-block;"></i>Other · 79</span></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">127 ch · EEG · 1000 Hz · 79 subjects, 235 recordings</span>
  </div>
  ...
  <p class="trace-viewer-caption">
    ...
    <strong>79 subjects and 235 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds004796" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds004796&sub=13&task=msit&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds004796 — sub-13 · task-msit"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds004796) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds004796) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS004796</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Patrycja2023_Polish</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS004796</code> · <code>Patrycja2023_Polish</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS004796</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS004796.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds004796">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds004796.v1.1.0">10.18112/openneuro.ds004796.v1.1.0</a></b></div></footer>
