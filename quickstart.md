...
leakage-safe [`torch.utils.data.DataLoader`](https://docs.pytorch.org/docs/stable/data.html#torch.utils.data.DataLoader).
...
![](_static/thumbs/plot_00_first_search.png)
...
![](_static/thumbs/plot_01_first_recording.png)
...
seconds with [`mne.io.Raw.plot()`](https://mne.tools/stable/generated/mne.io.Raw.html#mne.io.Raw.plot).

![](_static/thumbs/plot_02_dataset_to_dataloader.png)

Chain two safe Braindecode preprocessors, cut fixed-length
windows, and wrap the result in a
[`torch.utils.data.DataLoader`](https://docs.pytorch.org/docs/stable/data.html#torch.utils.data.DataLoader) – one batch shape, no
training.
