...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006065</b></div><div>Iss. 6065 · 7 subjects · 45 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · TSS_iEEG</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006065</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1016/j.brs.2021.10.220">10.1016/j.brs.2021.10.220</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>7</dd><dt>Recordings</dt><dd>45</dd><dt>Modality</dt><dd>iEEG</dd><dt>Channels</dt><dd>168 (15), 175 (10), 181 (5), 82 (5), 68 (5), 43 (5)</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>10.7 h</dd><dt>Size</dt><dd>9.6 GB</dd><dt>Tasks</dt><dd>10 tasks · <code>cl</code> · <code>clcontrol</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8</dd><dt>Sidecars</dt><dd>channels · electrodes · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006065</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="surgery">Surgery</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006065">EEGDash/ds006065</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006065.v1.0.0">10.18112/openneuro.ds006065.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006065">OpenNeuro</a><a href="https://doi.org/10.1016/j.brs.2021.10.220">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006065">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006065.croissant.json" download>Croissant</a></div></aside>

# DS006065: ieeg dataset, 7 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"TSS_iEEG","alternateName":"DS006065","description":"TSS_iEEG. ieeg dataset accessible via EEGDash as \`\`DS006065\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006065.html","keywords":["ieeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006065.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds006065.v1.0.0","https://openneuro.org/datasets/ds006065","https://nemar.org/dataexplorer/detail?dataset_id=ds006065"],"creator":[{"@type":"Person","name":"James Kragel"},{"@type":"Person","name":"Joel Voss"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*TSS_iEEG*

**Citation:** James Kragel, Joel Voss (20). *TSS_iEEG*. [10.18112/openneuro.ds006065.v1.0.0](https://doi.org/10.18112/openneuro.ds006065.v1.0.0)

<p class="eegdash-ed-deck">7-participant iEEG dataset — TSS_iEEG.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>James Kragel</strong> · <strong>Joel Voss</strong><br/><span class="role">Year</span> 20 · Distributed via OpenNeuro<br/><span class="role">Funding</span> This research was funded by the National Institute Of Neurological Disorders and Stroke under Award Number R01NS113804</div><div class="eegdash-ed-pills"><span class="pill">iEEG · 168 (15), 175 (10), 181 (5), 82 (5), 68 (5), 43 (5) ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.8</span><span class="pill">10 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="surgery">Surgery</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">168 (15), 175 (10), 181 (5), 82 (5), 68 (5), 43 (5) ch · iEEG · 500 Hz · 7 subjects, 45 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-p18 · task-restpre</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>7 subjects and 45 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds006065" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_ieeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?ieeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006065&sub=p18&task=restpre&ext=vhdr&suffix=ieeg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live iEEG trace viewer for ds006065 — sub-p18 · task-restpre"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds006065) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds006065) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006065</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Kragel2025</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006065</code> · <code>Kragel2025</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006065</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006065.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006065">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006065.v1.0.0">10.18112/openneuro.ds006065.v1.0.0</a></b></div></footer>
