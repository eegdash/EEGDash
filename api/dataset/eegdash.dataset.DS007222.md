...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS007222</b></div><div>Iss. 7222 · 15 subjects · 75 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Visual Occlusions with Treadmill Walking Speeds EEG</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS007222</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1162/imag.a.1039">10.1162/imag.a.1039</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>15</dd><dt>Recordings</dt><dd>75</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>265 (55), 263 (10), 252 (5), 195 (5)</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>3.8 h</dd><dt>Size</dt><dd>3.3 GB</dd><dt>Tasks</dt><dd>5 tasks · <code>treadmill00flow00</code> · <code>treadmill04flow00</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.10.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds007222</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds007222.v1.0.0">10.18112/openneuro.ds007222.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds007222">OpenNeuro</a><a href="https://doi.org/10.1162/imag.a.1039">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/DS007222.croissant.json" download>Croissant</a></div></aside>

# DS007222: eeg dataset, 15 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Visual Occlusions with Treadmill Walking Speeds EEG","alternateName":"DS007222","description":"Visual Occlusions with Treadmill Walking Speeds EEG. eeg dataset accessible via EEGDash as \`\`DS007222\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS007222.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds007222.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds007222.v1.0.0","https://openneuro.org/datasets/ds007222","https://nemar.org/dataexplorer/detail?dataset_id=ds007222"],"creator":[{"@type":"Person","name":"Jonel Morris"},{"@type":"Person","name":"Kenneth Cruz"},{"@type":"Person","name":"Raydeep Kainth"},{"@type":"Person","name":"Daniel Ferris"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Visual Occlusions with Treadmill Walking Speeds EEG*

**Citation:** Jonel Morris, Kenneth Cruz, Raydeep Kainth, Daniel Ferris (19). *Visual Occlusions with Treadmill Walking Speeds EEG*. [10.18112/openneuro.ds007222.v1.0.0](https://doi.org/10.18112/openneuro.ds007222.v1.0.0)

<p class="eegdash-ed-deck">15-participant EEG dataset — Visual Occlusions with Treadmill Walking Speeds EEG.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Jonel Morris</strong> · <strong>Kenneth Cruz</strong> · Raydeep Kainth · Daniel Ferris<br/><span class="role">Year</span> 19 · Distributed via OpenNeuro<br/><span class="role">Funding</span> The National Institutes of Health (R01NS104772)</div><div class="eegdash-ed-pills"><span class="pill">EEG · 265 (55), 263 (10), 252 (5), 195 (5) ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.10.0</span><span class="pill">5 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=15, range 14–29 yr, mean 21.0 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="10-14: n=1"><div style="width:100%; height:25px; background:#006ca3; flex-shrink:0;" title="10-14: female n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=5"><div style="width:100%; height:25px; background:#006ca3; flex-shrink:0;" title="15-19: female n=1"></div><div style="width:100%; height:102px; background:#f7941d; flex-shrink:0;" title="15-19: male n=4"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=7"><div style="width:100%; height:154px; background:#006ca3; flex-shrink:0;" title="20-24: female n=6"></div><div style="width:100%; height:25px; background:#f7941d; flex-shrink:0;" title="20-24: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=2"><div style="width:100%; height:51px; background:#006ca3; flex-shrink:0;" title="25-29: female n=2"></div></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">10</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">15</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">20</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">25</span>
  </div>
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 10</span><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#f7941d; display:inline-block;"></i>Male · 5</span></div>
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:9%; background:#009E73; flex-shrink:0;" title="195 ch: 5"></div><div style="width:28px; height:9%; background:#009E73; flex-shrink:0;" title="252 ch: 5"></div><div style="width:28px; height:18%; background:#009E73; flex-shrink:0;" title="263 ch: 10"></div><div style="width:28px; height:100%; background:#009E73; flex-shrink:0;" title="265 ch: 55"></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">195</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">252</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">263</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">265</span>
  </div>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 500.0 Hz (n=75 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 3 h 47 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">265 (55), 263 (10), 252 (5), 195 (5) ch · EEG · 500 Hz · 15 subjects, 75 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-13 · task-treadmill00flow00</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>15 subjects and 75 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds007222" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds007222&sub=13&task=treadmill00flow00&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds007222 — sub-13 · task-treadmill00flow00"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — EEG · 120 sensors — 120 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=cde85a1b95fef329&embed=1"
    loading="lazy"
    width="100%" height="640"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds007222). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds007222" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds007222/code/ds007222_histogram.png"
      alt="NEMAR pipeline statistics — DS007222"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds007222/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS007222"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds007222">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `DS007222`                                                                                                                |
| Year           | 19                                                                                                                        |
| Authors        | Jonel Morris, Kenneth Cruz, Raydeep Kainth, Daniel Ferris                                                                 |
| License        | CC0                                                                                                                       |
| Citation / DOI | [doi:10.18112/openneuro.ds007222.v1.0.0](https://doi.org/10.18112/openneuro.ds007222.v1.0.0)                              |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds007222) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds007222) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS007222</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS007222</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS007222</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS007222.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds007222.v1.0.0">10.18112/openneuro.ds007222.v1.0.0</a></b></div></footer>
