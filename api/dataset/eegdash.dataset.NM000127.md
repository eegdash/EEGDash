...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000127</b></div><div>Iss. 127 · 40 subjects · 240 recordings · CC BY 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Kim2025 – 40-class beta-range SSVEP speller dataset</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000127</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC BY 4.0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-025-06032-2">10.1038/s41597-025-06032-2</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>40</dd><dt>Recordings</dt><dd>240</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>31</dd><dt>Sample rate</dt><dd>1024 Hz</dd><dt>Duration</dt><dd>18.9 h</dd><dt>Size</dt><dd>8.1 GB</dd><dt>Tasks</dt><dd><code>ssvep</code></dd><dt>Sessions</dt><dd>6 · <code>0</code> … <code>5</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000127</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000127">10.82901/nemar.nm000127</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000127">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-025-06032-2">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/NM000127.croissant.json" download>Croissant</a></div></aside>

# NM000127: eeg dataset, 40 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Kim2025 – 40-class beta-range SSVEP speller dataset","alternateName":"NM000127","description":"Kim2025 – 40-class beta-range SSVEP speller dataset. eeg dataset accessible via EEGDash as \`\`NM000127\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000127.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.nm000127","sameAs":["https://doi.org/10.82901/nemar.nm000127","https://openneuro.org/datasets/nm000127","https://nemar.org/dataexplorer/detail?dataset_id=nm000127"],"creator":[{"@type":"Person","name":"Heegyu Kim"},{"@type":"Person","name":"Kyungho Won"},{"@type":"Person","name":"Minkyu Ahn"},{"@type":"Person","name":"Sung Chan Jun"}],"license":"https://creativecommons.org/licenses/by/4.0/","datePublished":"2019-01-01"}</script>

*Kim2025 – 40-class beta-range SSVEP speller dataset*

**Citation:** Heegyu Kim, Kyungho Won, Minkyu Ahn, Sung Chan Jun (2019). *Kim2025 – 40-class beta-range SSVEP speller dataset*. [10.82901/nemar.nm000127](https://doi.org/10.82901/nemar.nm000127)

<p class="eegdash-ed-deck">40-participant EEG dataset — Kim2025 – 40-class beta-range SSVEP speller dataset.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Heegyu Kim</strong> · <strong>Kyungho Won</strong> · Minkyu Ahn · Sung Chan Jun<br/><span class="role">Year</span> 2019 · Distributed via NeMAR</div><div class="eegdash-ed-pills"><span class="pill">EEG · 31 ch</span><span class="pill">1024 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">Task · ssvep</span><span class="pill">6 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
[DOI](https://doi.org/10.82901/nemar.nm000127)
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=40, range 23–23 yr, mean 22.0 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=40"><div style="width:100%; height:67px; background:#006ca3; flex-shrink:0;" title="20-24: female n=15"></div><div style="width:100%; height:112px; background:#f7941d; flex-shrink:0;" title="20-24: male n=25"></div></div>
  </div>
  ...
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 15</span><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#f7941d; display:inline-block;"></i>Male · 25</span></div>
  ...
  <div class="sex-wrap" style="display:flex; align-items:center; gap:30px; flex-wrap:wrap;">
    ...
    <div class="sex-legend" style="flex:1; font-family:JetBrains Mono,monospace; font-size:13px; min-width:220px;"><div class="row"><div class="sw" style="background:#006ca3"></div><div class="lbl">Female</div><div class="v">15</div></div><div class="row"><div class="sw" style="background:#f7941d"></div><div class="lbl">Male</div><div class="v">25</div></div><div class="row ratio"><div class="sw" style="visibility:hidden"></div><div class="lbl">F : M ratio</div><div class="v">0.60 : 1</div></div></div>
  </div>
  <div class="sex-note" style="margin-top:14px; font-size:13px; color:#34404e; line-height:1.5; max-width:520px; font-family:Spectral,Georgia,serif;">38% female · n = 40 subjects with reported sex.</div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">31 ch · EEG · 1024 Hz · 40 subjects, 240 recordings</span>
  </div>
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/nm000127" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000127&sub=13&ses=4&task=ssvep&run=0&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000127 — sub-13 · ses-4 · task-ssvep · run-0"
...
| License        | CC BY 4.0                                                                                                                 |
| Citation / DOI | [10.82901/nemar.nm000127](https://doi.org/10.82901/nemar.nm000127)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000127) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000127) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000127</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Kim2025_SSVEP</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000127</code> · <code>Kim2025_SSVEP</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000127</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000127.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC BY 4.0 · <b><a href="https://doi.org/10.82901/nemar.nm000127">10.82901/nemar.nm000127</a></b></div></footer>
