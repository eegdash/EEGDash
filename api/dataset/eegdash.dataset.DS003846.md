...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003846</b></div><div>Iss. 3846 · 19 subjects · 50 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Prediction Error</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003846</dd><dt>Version</dt><dd>v2.0.2</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1145/3290605.3300657">10.1145/3290605.3300657</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>19</dd><dt>Recordings</dt><dd>50</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>64</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>22.7 h</dd><dt>Size</dt><dd>11.4 GB</dd><dt>Tasks</dt><dd><code>PredictionError</code></dd><dt>Sessions</dt><dd>5 · <code>EMS</code> … <code>Visual</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003846</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="multisensory">Multisensory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="decision-making">Decision-making</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003846">EEGDash/ds003846</a></dd><dt>Citations</dt><dd>5</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003846.v2.0.2">10.18112/openneuro.ds003846.v2.0.2</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003846">OpenNeuro</a><a href="https://doi.org/10.1145/3290605.3300657">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003846">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003846.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=19, range 18–34 yr, mean 26.7 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=1"><div style="width:100%; height:16px; background:#6b7785; flex-shrink:0;" title="15-19: other n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=3"><div style="width:100%; height:49px; background:#6b7785; flex-shrink:0;" title="20-24: other n=3"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=11"><div style="width:100%; height:180px; background:#6b7785; flex-shrink:0;" title="25-29: other n=11"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=4"><div style="width:100%; height:65px; background:#6b7785; flex-shrink:0;" title="30-34: other n=4"></div></div>
  </div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-13 · ses-EMS · task-PredictionError</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>19 subjects and 50 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds003846" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds003846&sub=13&ses=EMS&task=PredictionError&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds003846 — sub-13 · ses-EMS · task-PredictionError"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — EEG · 63 sensors — 63 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=f4aab38742d2138a&embed=1"
    loading="lazy"
    width="100%" height="640"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003846) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003846) |
