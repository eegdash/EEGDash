...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003682</b></div><div>Iss. 3682 · 28 subjects · 336 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Model-based aversive learning in humans is supported by prefe…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003682</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1126/sciadv.abf9616">10.1126/sciadv.abf9616</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>28</dd><dt>Recordings</dt><dd>336</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>414</dd><dt>Sample rate</dt><dd>1200 Hz</dd><dt>Duration</dt><dd>31.8 h</dd><dt>Size</dt><dd>302.0 GB</dd><dt>Tasks</dt><dd><code>AversiveLearningReplay</code></dd><dt>Sessions</dt><dd><code>01</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>v1.5.0</dd><dt>Sidecars</dt><dd>events · channels · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003682</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003682">EEGDash/ds003682</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003682.v1.0.0">10.18112/openneuro.ds003682.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003682">OpenNeuro</a><a href="https://doi.org/10.1126/sciadv.abf9616">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003682">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003682.croissant.json" download>Croissant</a></div></aside>

# DS003682: meg dataset, 28 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Model-based aversive learning in humans is supported by preferential task state reactivation","alternateName":"DS003682","description":"Model-based aversive learning in humans is supported by preferential task state reactivation. meg dataset accessible via EEGDash as \`\`DS003682\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS003682.html","keywords":["meg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds003682.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds003682.v1.0.0","https://openneuro.org/datasets/ds003682","https://nemar.org/dataexplorer/detail?dataset_id=ds003682"],"creator":[{"@type":"Person","name":"Toby Wise"},{"@type":"Person","name":"Yunzhe Liu"},{"@type":"Person","name":"Fatima Chowdhury"},{"@type":"Person","name":"Raymond J. Dolan"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Model-based aversive learning in humans is supported by preferential task state reactivation*

**Citation:** Toby Wise, Yunzhe Liu, Fatima Chowdhury, Raymond J. Dolan (—). *Model-based aversive learning in humans is supported by preferential task state reactivation*. [10.18112/openneuro.ds003682.v1.0.0](https://doi.org/10.18112/openneuro.ds003682.v1.0.0)

<p class="eegdash-ed-deck">28-participant MEG dataset — Model-based aversive learning in humans is supported by preferential task state reactivation.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Toby Wise</strong> · <strong>Yunzhe Liu</strong> · Fatima Chowdhury · Raymond J. Dolan</div><div class="eegdash-ed-pills"><span class="pill">MEG · 414 ch</span><span class="pill">1200 Hz</span><span class="pill is-info">BIDS v1.5.0</span><span class="pill">Task · AversiveLearningReplay</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 414 ch (n=336 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 1200.0 Hz (n=336 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">414 ch · MEG · 1200 Hz · 28 subjects, 336 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-021 · ses-01 · task-AversiveLearningReplay · run-06</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>28 subjects and 336 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds003682" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_meg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?meg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds003682&sub=021&ses=01&task=AversiveLearningReplay&run=06&ext=fif&suffix=meg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live MEG trace viewer for ds003682 — sub-021 · ses-01 · task-AversiveLearningReplay · run-06"
    referrerpolicy="no-referrer">
  </iframe>
</details></div><div class="figpair-cell figpair-montage"><details class="electrode-explorer">
  <summary>Electrode layout — MEG · 272 sensors — 272 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=0af747058c25e9dc&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 900px; display: block;"
    title="Topomap of MEG · 272 sensors"
    referrerpolicy="no-referrer">
  </iframe>
</details></div></div></div>
...
<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds003682" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds003682/code/ds003682_histogram.png"
      alt="NEMAR pipeline statistics — DS003682"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds003682/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS003682"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds003682">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003682) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003682) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003682</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Wise2021</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003682</code> · <code>Wise2021</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003682</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003682.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003682">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003682.v1.0.0">10.18112/openneuro.ds003682.v1.0.0</a></b></div></footer>
