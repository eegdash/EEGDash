...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS004738</b></div><div>Iss. 4738 · 4 subjects · 25 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · sfb_meg_phantom (B04/C01)</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS004738</dd><dt>Version</dt><dd>v1.0.1</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1016/j.brs.2024.01.005">10.1016/j.brs.2024.01.005</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>4</dd><dt>Recordings</dt><dd>25</dd><dt>Modality</dt><dd>MEG</dd><dt>Channels</dt><dd>323 (13), 160 (12)</dd><dt>Sample rate</dt><dd>5000 Hz</dd><dt>Duration</dt><dd>26 min</dd><dt>Size</dt><dd>6.1 GB</dd><dt>Tasks</dt><dd><code>dip13</code> · <code>dip13mov</code></dd><dt>Sessions</dt><dd>2 · <code>220426</code> · <code>220616</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.2.0</dd><dt>Sidecars</dt><dd>channels · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds004738</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds004738">EEGDash/ds004738</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds004738.v1.0.1">10.18112/openneuro.ds004738.v1.0.1</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds004738">OpenNeuro</a><a href="https://doi.org/10.1016/j.brs.2024.01.005">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds004738">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS004738.croissant.json" download>Croissant</a></div></aside>

# DS004738: meg dataset, 4 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"sfb_meg_phantom (B04/C01)","alternateName":"DS004738","description":"sfb_meg_phantom (B04/C01). meg dataset accessible via EEGDash as \`\`DS004738\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS004738.html","keywords":["meg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds004738.v1.0.1","sameAs":["https://doi.org/10.18112/openneuro.ds004738.v1.0.1","https://openneuro.org/datasets/ds004738","https://nemar.org/dataexplorer/detail?dataset_id=ds004738"],"creator":[{"@type":"Person","name":"Bahne H. Bahners"},{"@type":"Person","name":"Roxanne Lofredi"},{"@type":"Person","name":"Tilmann Sander"},{"@type":"Person","name":"Alfons Schnitzler"},{"@type":"Person","name":"Andrea A. Kuhn"},{"@type":"Person","name":"Esther Florin"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*sfb_meg_phantom (B04/C01)*

**Citation:** Bahne H. Bahners, Roxanne Lofredi, Tilmann Sander, Alfons Schnitzler, Andrea A. Kuhn, Esther Florin (20). *sfb_meg_phantom (B04/C01)*. [10.18112/openneuro.ds004738.v1.0.1](https://doi.org/10.18112/openneuro.ds004738.v1.0.1)

<p class="eegdash-ed-deck">4-participant MEG dataset — sfb_meg_phantom (B04/C01).</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Bahne H. Bahners</strong> · <strong>Roxanne Lofredi</strong> · Tilmann Sander · Alfons Schnitzler · Andrea A. Kuhn · Esther Florin<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro<br/><span class="role">Funding</span> Funded by the Deutsche Forschungsgemeinschaft (DFG, German Research Foundation), Project ID 424778381, TRR 295.</div><div class="eegdash-ed-pills"><span class="pill">MEG · 323 (13), 160 (12) ch</span><span class="pill">5000 Hz</span><span class="pill is-info">BIDS 1.2.0</span><span class="pill">2 tasks</span><span class="pill">2 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="other">Other</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">323 (13), 160 (12) ch · MEG · 5000 Hz · 4 subjects, 25 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-abtpc · ses-220616 · task-dip13mov</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>4 subjects and 25 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds004738" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_meg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?meg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds004738&sub=abtpc&ses=220616&task=dip13mov&ext=fif&suffix=meg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live MEG trace viewer for ds004738 — sub-abtpc · ses-220616 · task-dip13mov"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds004738) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds004738) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS004738</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Bahners2023</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS004738</code> · <code>Bahners2023</code></span></div>
...
* [eegdash.dataset.DS002885](eegdash.dataset.DS002885.md)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS004738</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS004738.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds004738">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds004738.v1.0.1">10.18112/openneuro.ds004738.v1.0.1</a></b></div></footer>
