...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON004588</b></div><div>Iss. 4588 · 42 subjects · 42 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Neuma</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON004588</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41597-023-02392-9">10.1038/s41597-023-02392-9</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>42</dd><dt>Recordings</dt><dd>42</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>24</dd><dt>Sample rate</dt><dd>300 Hz</dd><dt>Duration</dt><dd>5.0 h</dd><dt>Size</dt><dd>602.0 MB</dd><dt>Tasks</dt><dd><code>unnamed</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on004588</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on004588">10.82901/nemar.on004588</a></div><div class="actions"><a href="https://openneuro.org/datasets/on004588">OpenNeuro</a><a href="https://doi.org/10.1038/s41597-023-02392-9">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON004588.croissant.json" download>Croissant</a></div></aside>

# ON004588: eeg dataset, 42 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Neuma","alternateName":"ON004588","description":"Neuma. eeg dataset accessible via EEGDash as \`\`ON004588\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON004588.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on004588","sameAs":["https://doi.org/10.82901/nemar.on004588","https://openneuro.org/datasets/on004588","https://nemar.org/dataexplorer/detail?dataset_id=on004588"],"creator":[{"@type":"Person","name":"Kostas Georgiadis"},{"@type":"Person","name":"Fotis P. Kalaganis"},{"@type":"Person","name":"Kyriakos Riskos"},{"@type":"Person","name":"Eleytheria Matta"},{"@type":"Person","name":"Vangelis P. Oikonomou"},{"@type":"Person","name":"Yfantidou Ioanna"},{"@type":"Person","name":"Dimitris Chantziaras"},{"@type":"Person","name":"Kyriakos Pantouvakis"},{"@type":"Person","name":"Spiros Nikolopoulos"},{"@type":"Person","name":"Nikos A. Laskaris"},{"@type":"Person","name":"Ioannis Kompatsiaris"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Neuma*

**Citation:** Kostas Georgiadis, Fotis P. Kalaganis, Kyriakos Riskos, Eleytheria Matta, Vangelis P. Oikonomou, Yfantidou Ioanna, Dimitris Chantziaras, Kyriakos Pantouvakis, Spiros Nikolopoulos, Nikos A. Laskaris, Ioannis Kompatsiaris (—). *Neuma*. [10.82901/nemar.on004588](https://doi.org/10.82901/nemar.on004588)

<p class="eegdash-ed-deck">42-participant EEG dataset — Neuma.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Kostas Georgiadis</strong> · <strong>Fotis P. Kalaganis</strong> · Kyriakos Riskos · Eleytheria Matta · Vangelis P. Oikonomou · Yfantidou Ioanna · …</div><div class="eegdash-ed-pills"><span class="pill">EEG · 24 ch</span><span class="pill">300 Hz</span><span class="pill is-info">BIDS 1.8.0</span><span class="pill">Task · unnamed</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
```python
dataset = ON004588(cache_dir="./data", subject="01")
```
...
@dataset{on004588,
  ...
  doi = {10.82901/nemar.on004588},
  url = {https://doi.org/10.82901/nemar.on004588},
}
```
...
[DOI](https://doi.org/10.82901/nemar.on004588)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-S01 · task-unnamed</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on004588" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on004588&sub=S01&task=unnamed&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on004588 — sub-S01 · task-unnamed"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on004588). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on004588" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on004588/code/on004588_histogram.png"
      alt="NEMAR pipeline statistics — ON004588"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on004588/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON004588"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on004588">
  <div class="ee-bar">
...
| License        | CC0                                                                                                                                                                                                                         |
| Citation / DOI | [10.82901/nemar.on004588](https://doi.org/10.82901/nemar.on004588)                                                                                                                                                          |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on004588) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on004588)                                                                                                   |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON004588</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON004588</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON004588</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON004588.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on004588">10.82901/nemar.on004588</a></b></div></footer>
