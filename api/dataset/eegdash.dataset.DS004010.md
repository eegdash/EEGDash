...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=24, range 18–27 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:90%; background:#4472c4; flex-shrink:0;" title="15-19: 10"></div><div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="20-24: 11"></div><div style="width:28px; height:27%; background:#4472c4; flex-shrink:0;" title="25-29: 3"></div>
  </div>
