...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS005185</b></div><div>Iss. 5185 · 20 subjects · 356 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Ear-EEG Sleep Monitoring 2019 (EESM19)</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS005185</dd><dt>Version</dt><dd>v1.0.2</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1038/s41598-019-53115-3">10.1038/s41598-019-53115-3</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>20</dd><dt>Recordings</dt><dd>356</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>25</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>13.7 h</dd><dt>Size</dt><dd>783.2 GB</dd><dt>Tasks</dt><dd><code>ASSR</code> · <code>electrodeTestLab</code> · <code>sleep</code></dd><dt>Sessions</dt><dd>16 · <code>001</code> … <code>016</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds005185</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="sleep">Sleep</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds005185">EEGDash/ds005185</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds005185.v1.0.2">10.18112/openneuro.ds005185.v1.0.2</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds005185">OpenNeuro</a><a href="https://doi.org/10.1038/s41598-019-53115-3">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds005185">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS005185.croissant.json" download>Croissant</a></div></aside>

# DS005185: eeg dataset, 20 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Ear-EEG Sleep Monitoring 2019 (EESM19)","alternateName":"DS005185","description":"Ear-EEG Sleep Monitoring 2019 (EESM19). eeg dataset accessible via EEGDash as \`\`DS005185\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS005185.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds005185.v1.0.2","sameAs":["https://doi.org/10.18112/openneuro.ds005185.v1.0.2","https://openneuro.org/datasets/ds005185","https://nemar.org/dataexplorer/detail?dataset_id=ds005185"],"creator":[{"@type":"Person","name":"Kaare B. Mikkelsen"},{"@type":"Person","name":"Preben Kidmose"},{"@type":"Person","name":"Yousef Rezaei Tabar"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Ear-EEG Sleep Monitoring 2019 (EESM19)*

**Citation:** Kaare B. Mikkelsen, Preben Kidmose, Yousef Rezaei Tabar (20). *Ear-EEG Sleep Monitoring 2019 (EESM19)*. [10.18112/openneuro.ds005185.v1.0.2](https://doi.org/10.18112/openneuro.ds005185.v1.0.2)

<p class="eegdash-ed-deck">20-participant EEG dataset — Ear-EEG Sleep Monitoring 2019 (EESM19).</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Kaare B. Mikkelsen</strong> · <strong>Preben Kidmose</strong> · Yousef Rezaei Tabar<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">EEG · 25 ch</span><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill">3 tasks</span><span class="pill">16 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="sleep">Sleep</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="sleep">Sleep</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <p><strong>Total recording duration</strong>: 13 h 40 min</p>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-019 · ses-014 · task-sleep</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>20 subjects and 356 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds005185" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds005185&sub=019&ses=014&task=sleep&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds005185 — sub-019 · ses-014 · task-sleep"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds005185) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds005185) |
