...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>EEG2025R11</b></div><div>Iss. 202511 · 430 subjects · 3397 recordings · CC-BY-SA 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Healthy Brain Network (HBN) EEG - Release 11 (BDF Converted)</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>EEG2025R11</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-SA 4.0</dd><dt>Updated</dt><dd>2025-03-05</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>430</dd><dt>Recordings</dt><dd>3397</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>129</dd><dt>Sample rate</dt><dd>100 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>43.8 GB</dd><dt>Tasks</dt><dd>8 tasks · <code>DespicableMe</code> · <code>DiaryOfAWimpyKid</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd><span class='dim'>not yet probed</span></dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="development">Development</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/eeg2025r11">EEGDash/eeg2025r11</a></dd></dl><div class="actions"><a href="https://openneuro.org/datasets/eeg2025r11">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/eeg2025r11">🤗 HF</a><a href="../../_static/dataset_generated/croissant/EEG2025R11.croissant.json" download>Croissant</a></div></aside>

# EEG2025R11: eeg dataset, 430 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Healthy Brain Network (HBN) EEG - Release 11 (BDF Converted)","alternateName":"EEG2025R11","description":"Healthy Brain Network (HBN) EEG - Release 11 (BDF Converted). eeg dataset accessible via EEGDash as \`\`EEG2025R11\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.EEG2025R11.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"sameAs":["https://openneuro.org/datasets/eeg2025r11","https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r11","https://nemar.org/dataexplorer/detail/EEG2025r11"],"creator":[{"@type":"Person","name":"Seyed Yahya Shirazi"},{"@type":"Person","name":"Alexandre Franco"},{"@type":"Person","name":"Maurício Scopel Hoffmann"},{"@type":"Person","name":"Nathalia B. Esper"},{"@type":"Person","name":"Dung Truong"},{"@type":"Person","name":"Arnaud Delorme"},{"@type":"Person","name":"Michael Milham"},{"@type":"Person","name":"Scott Makeig"}],"license":"https://creativecommons.org/licenses/by-sa/4.0/","datePublished":"2025-01-01"}</script>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=430, range 5–22 yr, mean 9.9 yr · sex per subject not reported)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="flex:1 1 0; min-width:0; height:180px; background:#006ca3;" title="5-9: 226"></div><div style="flex:1 1 0; min-width:0; height:128px; background:#006ca3;" title="10-14: 161"></div><div style="flex:1 1 0; min-width:0; height:29px; background:#006ca3;" title="15-19: 37"></div><div style="flex:1 1 0; min-width:0; height:4px; background:#006ca3;" title="20-24: 6"></div>
  </div>
  ...
  <p><strong>Sampling frequencies</strong>: 100.0 Hz (n=3397 recordings)</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">129 ch · EEG · 100 Hz · 430 subjects, 3397 recordings</span>
  </div>
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r11). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r11" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/eeg2025r11/code/eeg2025r11_histogram.png"
      alt="NEMAR pipeline statistics — EEG2025R11"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/eeg2025r11/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — EEG2025R11"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="eeg2025r11">
  <div class="ee-bar">
...
| Dataset ID     | `EEG2025R11`                                                                                                                                                                                   |
|----------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Title          | Healthy Brain Network (HBN) EEG - Release 11 (BDF Converted)                                                                                                                                   |
| Author (year)  | `Shirazi2025_R11_bdf`                                                                                                                                                                          |
| Canonical      | `HBN_r11_bdf`                                                                                                                                                                                  |
| Importable as  | `EEG2025R11`, `Shirazi2025_R11_bdf`, `HBN_r11_bdf`                                                                                                                                             |
| Year           | 2025                                                                                                                                                                                           |
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/eeg2025r11) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r11) | [Source URL](https://nemar.org/dataexplorer/detail/EEG2025r11) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">EEG2025R11</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Shirazi2025_R11_bdf</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v"><code>HBN_r11_bdf</code></span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>EEG2025R11</code> · <code>Shirazi2025_R11_bdf</code> · <code>HBN_r11_bdf</code></span></div>
...
OpenNeuro dataset: [https://openneuro.org/datasets/EEG2025r11](https://openneuro.org/datasets/EEG2025r11)
NeMAR dataset: [https://nemar.org/dataexplorer/detail?dataset_id=EEG2025r11](https://nemar.org/dataexplorer/detail?dataset_id=EEG2025r11)
...
* [eegdash.dataset.EEG2025R10](eegdash.dataset.EEG2025R10.md)

<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — EEG2025R11</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/EEG2025R11.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/eeg2025r11">Hugging Face mirror</a></div><div>CC-BY-SA 4.0 · <b><span style="opacity:.6">DOI not on file</span></b></div></footer>
