...
<details class="electrode-explorer">
  <summary>Electrode layout — EEG · 221 sensors — 221 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=b9931189caa0c8a3&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 900px; display: block;"
    title="Topomap of EEG · 221 sensors"
