...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000188</b></div><div>Iss. 188 · 10 subjects · 30 recordings · CC-BY-NC-ND-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · BNCI 2014-009 P300 dataset</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000188</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-NC-ND-4.0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1088/1741-2560/11/3/035008">10.1088/1741-2560/11/3/035008</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>10</dd><dt>Recordings</dt><dd>30</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>16</dd><dt>Sample rate</dt><dd>256 Hz</dd><dt>Duration</dt><dd>1.6 h</dd><dt>Size</dt><dd>70.9 MB</dd><dt>Tasks</dt><dd><code>p300</code></dd><dt>Sessions</dt><dd>3 · <code>0</code> · <code>1</code> · <code>2</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000188</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000188">10.82901/nemar.nm000188</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000188">OpenNeuro</a><a href="https://doi.org/10.1088/1741-2560/11/3/035008">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/NM000188.croissant.json" download>Croissant</a></div></aside>

# NM000188: eeg dataset, 10 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"BNCI 2014-009 P300 dataset","alternateName":"NM000188","description":"BNCI 2014-009 P300 dataset. eeg dataset accessible via EEGDash as \`\`NM000188\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000188.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.nm000188","sameAs":["https://doi.org/10.82901/nemar.nm000188","https://openneuro.org/datasets/nm000188","https://nemar.org/dataexplorer/detail?dataset_id=nm000188","https://nemar.org/dataexplorer/detail/nm000188"],"creator":[{"@type":"Person","name":"P Aricò"},{"@type":"Person","name":"F Aloise"},{"@type":"Person","name":"F Schettini"},{"@type":"Person","name":"S Salinari"},{"@type":"Person","name":"D Mattia"},{"@type":"Person","name":"F Cincotti"}],"license":"CC-BY-NC-ND-4.0","datePublished":"2013-01-01"}</script>

*BNCI 2014-009 P300 dataset*

**Citation:** P Aricò, F Aloise, F Schettini, S Salinari, D Mattia, F Cincotti (2013). *BNCI 2014-009 P300 dataset*. [10.82901/nemar.nm000188](https://doi.org/10.82901/nemar.nm000188)

<p class="eegdash-ed-deck">10-participant EEG dataset — BNCI 2014-009 P300 dataset.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>P Aricò</strong> · <strong>F Aloise</strong> · F Schettini · S Salinari · D Mattia · F Cincotti<br/><span class="role">Year</span> 2013 · Distributed via NeMAR</div><div class="eegdash-ed-pills"><span class="pill">EEG · 16 ch</span><span class="pill">256 Hz</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">Task · p300</span><span class="pill">3 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
[DOI](https://doi.org/10.82901/nemar.nm000188)
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=10, range 22–40 yr, mean 26.8 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=5"><div style="width:100%; height:180px; background:#006ca3; flex-shrink:0;" title="20-24: female n=5"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=3"><div style="width:100%; height:108px; background:#006ca3; flex-shrink:0;" title="25-29: female n=3"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="35-39: n=1"><div style="width:100%; height:36px; background:#006ca3; flex-shrink:0;" title="35-39: female n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="40-44: n=1"><div style="width:100%; height:36px; background:#006ca3; flex-shrink:0;" title="40-44: female n=1"></div></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">20</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">25</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">35</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">40</span>
  </div>
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 10</span></div>
  ...
  <div class="sex-wrap" style="display:flex; align-items:center; gap:30px; flex-wrap:wrap;">
    ...
    <div class="sex-legend" style="flex:1; font-family:JetBrains Mono,monospace; font-size:13px; min-width:220px;"><div class="row"><div class="sw" style="background:#006ca3"></div><div class="lbl">Female</div><div class="v">10</div></div></div>
  </div>


</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 16 ch (n=30 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 256.0 Hz (n=30 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 1 h 38 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">16 ch · EEG · 256 Hz · 10 subjects, 30 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-6 · ses-2 · task-p300 · run-0</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/nm000188" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000188&sub=6&ses=2&task=p300&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000188 — sub-6 · ses-2 · task-p300 · run-0"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=nm000188). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000188" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000188/code/nm000188_histogram.png"
      alt="NEMAR pipeline statistics — NM000188"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000188/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000188"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000188">
  <div class="ee-bar">
...
| License        | CC-BY-NC-ND-4.0                                                                                                                                                                          |
| Citation / DOI | [10.82901/nemar.nm000188](https://doi.org/10.82901/nemar.nm000188)                                                                                                                       |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000188) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000188) | [Source URL](https://nemar.org/dataexplorer/detail/nm000188) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000188</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Arico2014</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000188</code> · <code>Arico2014</code></span></div>
...
* [eegdash.dataset.NM000186](eegdash.dataset.NM000186.md)
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000188</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000188.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC-BY-NC-ND-4.0 · <b><a href="https://doi.org/10.82901/nemar.nm000188">10.82901/nemar.nm000188</a></b></div></footer>
