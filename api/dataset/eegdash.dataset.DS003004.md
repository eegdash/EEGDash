...
<div class="eegdash-ed-figpair">
  ...
  <summary>Electrode layout — EEG · 196 sensors — 196 channels</summary>
  <iframe
    data-src="https://electrodes.eegdash.org/?montage=b2bb0cf8672fd588&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 900px; display: block;"
    title="Topomap of EEG · 196 sensors"
    referrerpolicy="no-referrer">
  </iframe>
</details></div></div></div>
