...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003848</b></div><div>Iss. 3848 · 6 subjects · 22 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Dataset Clinical Epilepsy iEEG to BIDS - RESPect_longterm_iEEG</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003848</dd><dt>Version</dt><dd>v1.0.3</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1007/s12021-022-09567-6">10.1007/s12021-022-09567-6</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>6</dd><dt>Recordings</dt><dd>22</dd><dt>Modality</dt><dd>iEEG</dd><dt>Channels</dt><dd>133 (18), 68 (4)</dd><dt>Sample rate</dt><dd>2048 Hz · mixed</dd><dt>Duration</dt><dd>20.3 h</dd><dt>Size</dt><dd>99.3 GB</dd><dt>Tasks</dt><dd>6 tasks · <code>CHOCS1</code> · <code>Rest</code> · …</dd><dt>Sessions</dt><dd><code>1</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>Brain Imaging Data Structure Specification v1.6.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · electrodes · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003848</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="epilepsy">Epilepsy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003848">EEGDash/ds003848</a></dd><dt>Citations</dt><dd>1</dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003848.v1.0.3">10.18112/openneuro.ds003848.v1.0.3</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003848">OpenNeuro</a><a href="https://doi.org/10.1007/s12021-022-09567-6">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003848">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003848.croissant.json" download>Croissant</a></div></aside>

# DS003848: ieeg dataset, 6 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Dataset Clinical Epilepsy iEEG to BIDS - RESPect_longterm_iEEG","alternateName":"DS003848","description":"Dataset Clinical Epilepsy iEEG to BIDS - RESPect_longterm_iEEG. ieeg dataset accessible via EEGDash as \`\`DS003848\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS003848.html","keywords":["ieeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds003848.v1.0.3","sameAs":["https://doi.org/10.18112/openneuro.ds003848.v1.0.3","https://openneuro.org/datasets/ds003848","https://nemar.org/dataexplorer/detail?dataset_id=ds003848"],"creator":[{"@type":"Person","name":"van Blooijs D."},{"@type":"Person","name":"Demuru M."},{"@type":"Person","name":"Zweiphenning W"},{"@type":"Person","name":"Hermes D."},{"@type":"Person","name":"Leijten F."},{"@type":"Person","name":"Zijlmans M."}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Dataset Clinical Epilepsy iEEG to BIDS - RESPect_longterm_iEEG*

**Citation:** van Blooijs D., Demuru M., Zweiphenning W, Hermes D., Leijten F., Zijlmans M. (20). *Dataset Clinical Epilepsy iEEG to BIDS - RESPect_longterm_iEEG*. [10.18112/openneuro.ds003848.v1.0.3](https://doi.org/10.18112/openneuro.ds003848.v1.0.3)

<p class="eegdash-ed-deck">6-participant iEEG dataset — Dataset Clinical Epilepsy iEEG to BIDS - RESPect_longterm_iEEG.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>van Blooijs D.</strong> · <strong>Demuru M.</strong> · Zweiphenning W · Hermes D. · Leijten F. · Zijlmans M.<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro<br/><span class="role">Funding</span> Epi-Sign Project · Alexandre Suerman Stipendium 2015 · + 1 more</div><div class="eegdash-ed-pills"><span class="pill">iEEG · 133 (18), 68 (4) ch</span><span class="pill">2048 Hz · mixed</span><span class="pill is-info">BIDS Brain Imaging Data Structure Specification v1.6.0</span><span class="pill">6 tasks</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="epilepsy">Epilepsy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="other">Other</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="clinical/intervention">Clinical/Intervention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=6, range 14–46 yr, mean 25.3 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="10-14: n=2"><div style="width:100%; height:90px; background:#006ca3; flex-shrink:0;" title="10-14: female n=1"></div><div style="width:100%; height:90px; background:#f7941d; flex-shrink:0;" title="10-14: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=2"><div style="width:100%; height:180px; background:#f7941d; flex-shrink:0;" title="15-19: male n=2"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="45-49: n=2"><div style="width:100%; height:90px; background:#006ca3; flex-shrink:0;" title="45-49: female n=1"></div><div style="width:100%; height:90px; background:#f7941d; flex-shrink:0;" title="45-49: male n=1"></div></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">10</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">15</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">45</span>
  </div>
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 2</span><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#f7941d; display:inline-block;"></i>Male · 4</span></div>
  ...
  <div class="sex-wrap" style="display:flex; align-items:center; gap:30px; flex-wrap:wrap;">
    ...
    <div class="sex-legend" style="flex:1; font-family:JetBrains Mono,monospace; font-size:13px; min-width:220px;"><div class="row"><div class="sw" style="background:#006ca3"></div><div class="lbl">Female</div><div class="v">2</div></div><div class="row"><div class="sw" style="background:#f7941d"></div><div class="lbl">Male</div><div class="v">4</div></div><div class="row ratio"><div class="sw" style="visibility:hidden"></div><div class="lbl">F : M ratio</div><div class="v">0.50 : 1</div></div></div>
  </div>
  <div class="sex-note" style="margin-top:14px; font-size:13px; color:#34404e; line-height:1.5; max-width:520px; font-family:Spectral,Georgia,serif;">33% female · n = 6 subjects with reported sex.</div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-RESP0699 · ses-1 · task-sleep · run-020722</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>6 subjects and 22 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/ds003848" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_ieeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?ieeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds003848&sub=RESP0699&ses=1&task=sleep&run=020722&ext=vhdr&suffix=ieeg&embed=1"
    loading="lazy"
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003848) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003848) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003848</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Blooijs2021</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003848</code> · <code>Blooijs2021</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003848</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003848.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003848">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003848.v1.0.3">10.18112/openneuro.ds003848.v1.0.3</a></b></div></footer>
