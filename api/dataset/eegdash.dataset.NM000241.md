...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000241</b></div><div>Iss. 241 · 2 subjects · 18 recordings · CC BY 4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · CerebroVoice</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000241</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC BY 4.0</dd><dt>Updated</dt><dd>2026-04-12</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>2</dd><dt>Recordings</dt><dd>18</dd><dt>Modality</dt><dd>iEEG</dd><dt>Channels</dt><dd>114 (6), 158 (6), 316 (3), 228 (3)</dd><dt>Sample rate</dt><dd>200 Hz</dd><dt>Duration</dt><dd>3.8 h</dd><dt>Size</dt><dd>1.9 GB</dd><dt>Tasks</dt><dd>9 tasks · <code>chinesebbs</code> · <code>chinesehga</code> · …</dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · channels · electrodes · coordsystem</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000241</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000241">EEGDash/nm000241</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.5281/zenodo.13332808">10.5281/zenodo.13332808</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000241">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000241">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000241.croissant.json" download>Croissant</a></div></aside>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">114 (6), 158 (6), 316 (3), 228 (3) ch · iEEG · 200 Hz · 2 subjects, 18 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-1 · task-chinesebbs</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>2 subjects and 18 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000241" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_ieeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?ieeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000241&sub=1&task=chinesebbs&ext=vhdr&suffix=ieeg&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live iEEG trace viewer for nm000241 — sub-1 · task-chinesebbs"
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000241</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Zhang2019</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000241</code> · <code>Zhang2019</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000241</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000241.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000241">Hugging Face mirror</a></div><div>CC BY 4.0 · <b><a href="https://doi.org/10.5281/zenodo.13332808">10.5281/zenodo.13332808</a></b></div></footer>
