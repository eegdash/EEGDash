...
```none
saved: /tmp/eegdash_save_9e4k0jbj/windows
...
```none
reload OK: type=BaseConcatDataset, n=2, read_s=0.0066
```
...
```none
Zarr write_s=0.0174, read_s=0.0066, size_mb=0.0080
```
...
Pz_mean       float64
window_idx      int64
Parquet write_s=0.0163, read_s=0.0125, size_mb=0.0024
```
...
```none
Caught FileExistsError: Subdirectory /tmp/eegdash_save_9e4k0jbj/windows/0 already exists. Please select
