...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS003822</b></div><div>Iss. 3822 · 25 subjects · 25 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · EEG</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS003822</dd><dt>Version</dt><dd>v1.1.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1523/jneurosci.2036-14.2015">10.1523/jneurosci.2036-14.2015</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>25</dd><dt>Recordings</dt><dd>25</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>Varies</dd><dt>Sample rate</dt><dd>500 Hz</dd><dt>Duration</dt><dd>12.9 h</dd><dt>Size</dt><dd>5.8 GB</dd><dt>Tasks</dt><dd><code>ProbabilisticSelection</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.1.1</dd><dt>Sidecars</dt><dd>events · events.json · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>80% · Good</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds003822</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds003822">EEGDash/ds003822</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds003822.v1.1.0">10.18112/openneuro.ds003822.v1.1.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds003822">OpenNeuro</a><a href="https://doi.org/10.1523/jneurosci.2036-14.2015">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds003822">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS003822.croissant.json" download>Croissant</a></div></aside>

# DS003822: eeg dataset, 25 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"EEG: Probabilistic Learning with Affective Feedback: Exp #1","alternateName":"DS003822","description":"EEG: Probabilistic Learning with Affective Feedback: Exp #1. eeg dataset accessible via EEGDash as \`\`DS003822\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS003822.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds003822.v1.1.0","sameAs":["https://doi.org/10.18112/openneuro.ds003822.v1.1.0","https://openneuro.org/datasets/ds003822","https://nemar.org/dataexplorer/detail?dataset_id=ds003822"],"creator":[{"@type":"Person","name":"Darin R. Brown"},{"@type":"Person","name":"Trevor Jackson"},{"@type":"Person","name":"James F Cavanagh"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*EEG: Probabilistic Learning with Affective Feedback: Exp #1*

**Citation:** Darin R. Brown, Trevor Jackson, James F Cavanagh (20). *EEG: Probabilistic Learning with Affective Feedback: Exp #1*. [10.18112/openneuro.ds003822.v1.1.0](https://doi.org/10.18112/openneuro.ds003822.v1.1.0)

<p class="eegdash-ed-deck">25-participant EEG dataset — EEG: Probabilistic Learning with Affective Feedback: Exp #1.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Darin R. Brown</strong> · <strong>Trevor Jackson</strong> · James F Cavanagh<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro</div><div class="eegdash-ed-pills"><span class="pill">500 Hz</span><span class="pill is-info">BIDS 1.1.1</span><span class="pill">Task · ProbabilisticSelection</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="affect">Affect</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=25, range 18–36 yr, mean 21.7 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="15-19: n=13"><div style="width:100%; height:124px; background:#006ca3; flex-shrink:0;" title="15-19: female n=9"></div><div style="width:100%; height:55px; background:#f7941d; flex-shrink:0;" title="15-19: male n=4"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=8"><div style="width:100%; height:69px; background:#006ca3; flex-shrink:0;" title="20-24: female n=5"></div><div style="width:100%; height:41px; background:#f7941d; flex-shrink:0;" title="20-24: male n=3"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="25-29: n=1"><div style="width:100%; height:13px; background:#f7941d; flex-shrink:0;" title="25-29: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=1"><div style="width:100%; height:13px; background:#f7941d; flex-shrink:0;" title="30-34: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="35-39: n=2"><div style="width:100%; height:13px; background:#006ca3; flex-shrink:0;" title="35-39: female n=1"></div><div style="width:100%; height:13px; background:#f7941d; flex-shrink:0;" title="35-39: male n=1"></div></div>
  </div>
  ...
  <div style="display:flex; gap:18px; margin-top:8px; font-size:11px;"><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#006ca3; display:inline-block;"></i>Female · 15</span><span style="display:inline-flex; align-items:center; gap:6px;"><i style="width:10px; height:10px; background:#f7941d; display:inline-block;"></i>Male · 10</span></div>
  ...
  <p><strong>Total recording duration</strong>: 12 h 52 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">— ch · EEG · 500 Hz · 25 subjects, 25 recordings</span>
  </div>
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds003822" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds003822&sub=021&task=ProbabilisticSelection&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds003822 — sub-021 · task-ProbabilisticSelection"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds003822). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds003822" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds003822/code/ds003822_histogram.png"
      alt="NEMAR pipeline statistics — DS003822"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds003822/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS003822"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds003822">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds003822) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds003822) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS003822</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Brown2021_Probabilistic_Learning</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS003822</code> · <code>Brown2021_Probabilistic_Learning</code></span></div>
...
* [eegdash.dataset.DS003753](eegdash.dataset.DS003753.md)

<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS003822</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS003822.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds003822">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds003822.v1.1.0">10.18112/openneuro.ds003822.v1.1.0</a></b></div></footer>
