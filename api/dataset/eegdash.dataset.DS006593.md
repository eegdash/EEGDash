...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS006593</b></div><div>Iss. 6593 · 21 subjects · 21 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · cBCI Matrix Multimodal Dataset</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS006593</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.3217/978-3-99161-050-2-196">10.3217/978-3-99161-050-2-196</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>21</dd><dt>Recordings</dt><dd>21</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>19</dd><dt>Sample rate</dt><dd>300 Hz</dd><dt>Duration</dt><dd>5.6 h</dd><dt>Size</dt><dd>616.8 MB</dd><dt>Tasks</dt><dd><code>MatrixCalibration</code></dd><dt>Sessions</dt><dd><code>01</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.7.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds006593</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/ds006593">EEGDash/ds006593</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds006593.v1.0.0">10.18112/openneuro.ds006593.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds006593">OpenNeuro</a><a href="https://doi.org/10.3217/978-3-99161-050-2-196">Read paper</a><a href="https://huggingface.co/datasets/EEGDash/ds006593">🤗 HF</a><a href="../../_static/dataset_generated/croissant/DS006593.croissant.json" download>Croissant</a></div></aside>

# DS006593: eeg dataset, 21 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"cBCI Matrix Multimodal Dataset","alternateName":"DS006593","description":"cBCI Matrix Multimodal Dataset. eeg dataset accessible via EEGDash as \`\`DS006593\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS006593.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds006593.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds006593.v1.0.0","https://openneuro.org/datasets/ds006593","https://nemar.org/dataexplorer/detail?dataset_id=ds006593"],"creator":[{"@type":"Person","name":"Basak Celik"},{"@type":"Person","name":"Tab Memmott"},{"@type":"Person","name":"Matthew Lawhead"},{"@type":"Person","name":"Srikar Ananthoju"},{"@type":"Person","name":"Deniz Erdogmus"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*cBCI Matrix Multimodal Dataset*

**Citation:** Basak Celik, Tab Memmott, Matthew Lawhead, Srikar Ananthoju, Deniz Erdogmus (20). *cBCI Matrix Multimodal Dataset*. [10.18112/openneuro.ds006593.v1.0.0](https://doi.org/10.18112/openneuro.ds006593.v1.0.0)

<p class="eegdash-ed-deck">21-participant EEG dataset — cBCI Matrix Multimodal Dataset.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Basak Celik</strong> · <strong>Tab Memmott</strong> · Matthew Lawhead · Srikar Ananthoju · Deniz Erdogmus<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro<br/><span class="role">Funding</span> This research was funded by the National Institutes of Health (DC009834).</div><div class="eegdash-ed-pills"><span class="pill">EEG · 19 ch</span><span class="pill">300 Hz</span><span class="pill is-info">BIDS 1.7.0</span><span class="pill">Task · MatrixCalibration</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 19 ch (n=21 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 300.0 Hz (n=21 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 5 h 36 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">19 ch · EEG · 300 Hz · 21 subjects, 21 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-S016 · ses-01 · task-MatrixCalibration · run-01</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds006593" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds006593&sub=S016&ses=01&task=MatrixCalibration&run=01&ext=vhdr&embed=1"
    loading="lazy"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds006593). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds006593" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds006593/code/ds006593_histogram.png"
      alt="NEMAR pipeline statistics — DS006593"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds006593/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS006593"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds006593">
  <div class="ee-bar">
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS006593</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Celik2025</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS006593</code> · <code>Celik2025</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS006593</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS006593.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/ds006593">Hugging Face mirror</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds006593.v1.0.0">10.18112/openneuro.ds006593.v1.0.0</a></b></div></footer>
