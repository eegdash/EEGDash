...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON002578</b></div><div>Iss. 2578 · 2 subjects · 2 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Visual Oddball Task (256 channels)</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON002578</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1371/journal.pbio.0020176">10.1371/journal.pbio.0020176</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>2</dd><dt>Recordings</dt><dd>2</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>256</dd><dt>Sample rate</dt><dd>256 Hz</dd><dt>Duration</dt><dd>1.5 h</dd><dt>Size</dt><dd>1.3 GB</dd><dt>Tasks</dt><dd><code>attention</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.8.0</dd><dt>Sidecars</dt><dd>events · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on002578</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on002578">10.82901/nemar.on002578</a></div><div class="actions"><a href="https://openneuro.org/datasets/on002578">OpenNeuro</a><a href="https://doi.org/10.1371/journal.pbio.0020176">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON002578.croissant.json" download>Croissant</a></div></aside>

# ON002578: eeg dataset, 2 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Visual Oddball Task (256 channels)","alternateName":"ON002578","description":"Visual Oddball Task (256 channels). eeg dataset accessible via EEGDash as \`\`ON002578\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON002578.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on002578","sameAs":["https://doi.org/10.82901/nemar.on002578","https://openneuro.org/datasets/on002578","https://nemar.org/dataexplorer/detail?dataset_id=on002578"],"creator":[{"@type":"Person","name":"Arnaud Delorme"},{"@type":"Person","name":"Scott Makeig"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Visual Oddball Task (256 channels)*

**Citation:** Arnaud Delorme, Scott Makeig (20). *Visual Oddball Task (256 channels)*. [10.82901/nemar.on002578](https://doi.org/10.82901/nemar.on002578)

<p class="eegdash-ed-deck">2-participant EEG dataset — Visual Oddball Task (256 channels).</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Arnaud Delorme</strong> · <strong>Scott Makeig</strong><br/><span class="role">Year</span> 20 · Distributed via NeMAR</div><div class="eegdash-ed-pills"><span class="pill">EEG · 256 ch</span><span class="pill">256 Hz</span><span class="pill is-info">BIDS 1.8.0</span><span class="pill">Task · attention</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-001 · task-attention</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on002578" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on002578&sub=001&task=attention&ext=set&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on002578 — sub-001 · task-attention"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on002578). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on002578" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on002578/code/on002578_histogram.png"
      alt="NEMAR pipeline statistics — ON002578"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on002578/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON002578"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on002578">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `ON002578`                                                                                                                |
| Year           | 20                                                                                                                        |
| Authors        | Arnaud Delorme, Scott Makeig                                                                                              |
| License        | CC0                                                                                                                       |
| Citation / DOI | [10.82901/nemar.on002578](https://doi.org/10.82901/nemar.on002578)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on002578) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on002578) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON002578</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON002578</code></span></div>
...
* [eegdash.dataset.ON004852](eegdash.dataset.ON004852.md)

<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON002578</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON002578.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on002578">10.82901/nemar.on002578</a></b></div></footer>
