...
- Source: OpenNeuro
- OpenNeuro: [hbn_r10_bdf_mini](https://openneuro.org/datasets/hbn_r10_bdf_mini)
- NeMAR: [hbn_r10_bdf_mini](https://nemar.org/dataexplorer/detail?dataset_id=hbn_r10_bdf_mini)
...
Use the `HBN_r10_bdf_mini` class to access this dataset programmatically.
