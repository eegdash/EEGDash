...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000169</b></div><div>Iss. 169 · 8 subjects · 8 recordings · CC-BY-NC-ND-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · BNCI 2014-008 P300 dataset (ALS patients)</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000169</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-NC-ND-4.0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.3389/fnhum.2013.00732">10.3389/fnhum.2013.00732</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>8</dd><dt>Recordings</dt><dd>8</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>8</dd><dt>Sample rate</dt><dd>256 Hz</dd><dt>Duration</dt><dd>3.0 h</dd><dt>Size</dt><dd>75.9 MB</dd><dt>Tasks</dt><dd><code>p300</code></dd><dt>Sessions</dt><dd><code>0</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000169</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="other">Other</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.nm000169">10.82901/nemar.nm000169</a></div><div class="actions"><a href="https://openneuro.org/datasets/nm000169">OpenNeuro</a><a href="https://doi.org/10.3389/fnhum.2013.00732">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/NM000169.croissant.json" download>Croissant</a></div></aside>

# NM000169: eeg dataset, 8 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"BNCI 2014-008 P300 dataset (ALS patients)","alternateName":"NM000169","description":"BNCI 2014-008 P300 dataset (ALS patients). eeg dataset accessible via EEGDash as \`\`NM000169\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000169.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.nm000169","sameAs":["https://doi.org/10.82901/nemar.nm000169","https://openneuro.org/datasets/nm000169","https://nemar.org/dataexplorer/detail?dataset_id=nm000169"],"creator":[{"@type":"Person","name":"Angela Riccio"},{"@type":"Person","name":"Luca Simione"},{"@type":"Person","name":"Francesca Schettini"},{"@type":"Person","name":"Alessia Pizzimenti"},{"@type":"Person","name":"Maurizio Inghilleri"},{"@type":"Person","name":"Marta Olivetti Belardinelli"},{"@type":"Person","name":"Donatella Mattia"},{"@type":"Person","name":"Febo Cincotti"}],"license":"CC-BY-NC-ND-4.0","datePublished":"2013-01-01"}</script>

*BNCI 2014-008 P300 dataset (ALS patients)*

**Citation:** Angela Riccio, Luca Simione, Francesca Schettini, Alessia Pizzimenti, Maurizio Inghilleri, Marta Olivetti Belardinelli, Donatella Mattia, Febo Cincotti (2013). *BNCI 2014-008 P300 dataset (ALS patients)*. [10.82901/nemar.nm000169](https://doi.org/10.82901/nemar.nm000169)
...
<div class="eegdash-ed-figpair">
  ...
  <summary>Live trace viewer — <strong>sub-6 · ses-0 · task-p300 · run-0</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/nm000169" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000169&sub=6&ses=0&task=p300&run=0&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000169 — sub-6 · ses-0 · task-p300 · run-0"
...
| License        | CC-BY-NC-ND-4.0                                                                                                                                         |
| Citation / DOI | [10.82901/nemar.nm000169](https://doi.org/10.82901/nemar.nm000169)                                                                                      |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000169) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000169)                               |
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000169</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000169.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC-BY-NC-ND-4.0 · <b><a href="https://doi.org/10.82901/nemar.nm000169">10.82901/nemar.nm000169</a></b></div></footer>
