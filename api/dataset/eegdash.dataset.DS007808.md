...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>OpenNeuro<span class="crumb-sep">›</span><b>DS007808</b></div><div>Iss. 7808 · 3 subjects · 1974 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · EEG-Speech Brain Decoding Dataset</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>DS007808</dd><dt>Version</dt><dd>v1.0.0</dd><dt>Source</dt><dd>OpenNeuro</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1088/1741-2552/ae54d0">10.1088/1741-2552/ae54d0</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>3</dd><dt>Recordings</dt><dd>1974</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>140 (1512), 90 (172), 139 (152), 75 (138)</dd><dt>Sample rate</dt><dd>1200 Hz · mixed</dd><dt>Duration</dt><dd>1020 h</dd><dt>Size</dt><dd>1.5 TB</dd><dt>Tasks</dt><dd><code>listening</code> · <code>listeningcovert</code> · <code>speechopen</code></dd><dt>Sessions</dt><dd>312 · <code>20230829</code> … <code>20250730</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · channels · electrodes · coordsystem · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://openneuro.org/ds007808</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.18112/openneuro.ds007808.v1.0.0">10.18112/openneuro.ds007808.v1.0.0</a></div><div class="actions"><a href="https://openneuro.org/datasets/ds007808">OpenNeuro</a><a href="https://doi.org/10.1088/1741-2552/ae54d0">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/DS007808.croissant.json" download>Croissant</a></div></aside>

# DS007808: eeg dataset, 3 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"EEG-Speech Brain Decoding Dataset","alternateName":"DS007808","description":"EEG-Speech Brain Decoding Dataset. eeg dataset accessible via EEGDash as \`\`DS007808\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.DS007808.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.18112/openneuro.ds007808.v1.0.0","sameAs":["https://doi.org/10.18112/openneuro.ds007808.v1.0.0","https://openneuro.org/datasets/ds007808","https://nemar.org/dataexplorer/detail?dataset_id=ds007808"],"creator":[{"@type":"Person","name":"Motoshige Sato"},{"@type":"Person","name":"Ilya Horiguchi"},{"@type":"Person","name":"Masakazu Inoue"},{"@type":"Person","name":"Kenichi Tomeoka"},{"@type":"Person","name":"Eri Hatakeyama"},{"@type":"Person","name":"Yuya Kita"},{"@type":"Person","name":"Atsushi Yamamoto"},{"@type":"Person","name":"Ippei Fujisawa"},{"@type":"Person","name":"Shuntaro Sasai"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*EEG-Speech Brain Decoding Dataset*

**Citation:** Motoshige Sato, Ilya Horiguchi, Masakazu Inoue, Kenichi Tomeoka, Eri Hatakeyama, Yuya Kita, Atsushi Yamamoto, Ippei Fujisawa, Shuntaro Sasai (20). *EEG-Speech Brain Decoding Dataset*. [10.18112/openneuro.ds007808.v1.0.0](https://doi.org/10.18112/openneuro.ds007808.v1.0.0)

<p class="eegdash-ed-deck">3-participant EEG dataset — EEG-Speech Brain Decoding Dataset.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Motoshige Sato</strong> · <strong>Ilya Horiguchi</strong> · Masakazu Inoue · Kenichi Tomeoka · Eri Hatakeyama · Yuya Kita · …<br/><span class="role">Year</span> 20 · Distributed via OpenNeuro<br/><span class="role">Funding</span> JST, Moonshot R&D Grant Number JPMJMS2012</div><div class="eegdash-ed-pills"><span class="pill">EEG · 140 (1512), 90 (172), 139 (152), 75 (138) ch</span><span class="pill">1200 Hz · mixed</span><span class="pill is-info">BIDS 1.9.0</span><span class="pill">3 tasks</span><span class="pill">312 sessions</span><span class="pill tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span><span class="pill tag" data-tag-kind="dataset-modality" data-tag-value="auditory">Auditory</span><span class="pill tag" data-tag-kind="dataset-type" data-tag-value="perception">Perception</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution by gender</strong> (n=3, range 22–44 yr, mean 32.7 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:180px; border-bottom:1px solid #34404e;">
    <div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="20-24: n=1"><div style="width:100%; height:180px; background:#f7941d; flex-shrink:0;" title="20-24: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="30-34: n=1"><div style="width:100%; height:180px; background:#f7941d; flex-shrink:0;" title="30-34: male n=1"></div></div><div style="display:flex; flex-direction:column-reverse; justify-content:flex-start; gap:1px; flex:1 1 0; min-width:0;" title="40-44: n=1"><div style="width:100%; height:180px; background:#f7941d; flex-shrink:0;" title="40-44: male n=1"></div></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">20</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">30</span><span style="flex:1 1 0; min-width:0; text-align:center; overflow:hidden; white-space:nowrap;">40</span>
  </div>
  ...
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:9%; background:#009E73; flex-shrink:0;" title="75 ch: 138"></div><div style="width:28px; height:11%; background:#009E73; flex-shrink:0;" title="90 ch: 172"></div><div style="width:28px; height:10%; background:#009E73; flex-shrink:0;" title="139 ch: 152"></div><div style="width:28px; height:100%; background:#009E73; flex-shrink:0;" title="140 ch: 1512"></div>
  </div>
  <div class="eeg-chart-labels" style="display:flex; gap:2px; font-size:10px;">
    <span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">75</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">90</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">139</span><span style="width:28px; text-align:center; overflow:hidden; white-space:nowrap; font-size:9px;">140</span>
  </div>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  ...
  <p><strong>Total recording duration</strong>: 1020 h</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">140 (1512), 90 (172), 139 (152), 75 (138) ch · EEG · 1200 Hz · mixed · 3 subjects, 1974 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-01 · ses-20231213 · task-speechopen · run-01</strong></summary>
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/ds007808" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=ds007808&sub=01&ses=20231213&task=speechopen&run=01&ext=edf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for ds007808 — sub-01 · ses-20231213 · task-speechopen · run-01"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=ds007808). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=ds007808" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/ds007808/code/ds007808_histogram.png"
      alt="NEMAR pipeline statistics — DS007808"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/ds007808/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — DS007808"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="ds007808">
  <div class="ee-bar">
...
| License        | CC0                                                                                                                                          |
| Citation / DOI | [doi:10.18112/openneuro.ds007808.v1.0.0](https://doi.org/10.18112/openneuro.ds007808.v1.0.0)                                                 |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/ds007808) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=ds007808)                    |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">DS007808</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>DS007808</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — DS007808</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/DS007808.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.18112/openneuro.ds007808.v1.0.0">10.18112/openneuro.ds007808.v1.0.0</a></b></div></footer>
