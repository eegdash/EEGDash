...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>ON003825</b></div><div>Iss. 3825 · 50 subjects · 50 recordings · CC0</div></div><div class="eegdash-ed-kicker">Dataset Brief · Human electroencephalography recordings from 50 subjects for…</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>ON003825</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC0</dd><dt>Paper DOI</dt><dd><a href="https://doi.org/10.1101/2021.06.03.447008">10.1101/2021.06.03.447008</a></dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>50</dd><dt>Recordings</dt><dd>50</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>63 (48), 128 (2)</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>—</dd><dt>Size</dt><dd>60.2 GB</dd><dt>Tasks</dt><dd><code>rsvp</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.0.2</dd><dt>Sidecars</dt><dd>events · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>100% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/on003825</code></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/EEGDash">org listing</a></dd></dl><div class="doi"><span>Persistent identifier</span><a href="https://doi.org/10.82901/nemar.on003825">10.82901/nemar.on003825</a></div><div class="actions"><a href="https://openneuro.org/datasets/on003825">OpenNeuro</a><a href="https://doi.org/10.1101/2021.06.03.447008">Read paper</a><a href="https://huggingface.co/EEGDash">🤗 Org</a><a href="../../_static/dataset_generated/croissant/ON003825.croissant.json" download>Croissant</a></div></aside>

# ON003825: eeg dataset, 50 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"Human electroencephalography recordings from 50 subjects for 22,248 images from 1,854 object concepts","alternateName":"ON003825","description":"Human electroencephalography recordings from 50 subjects for 22,248 images from 1,854 object concepts. eeg dataset accessible via EEGDash as \`\`ON003825\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.ON003825.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"identifier":"doi:10.82901/nemar.on003825","sameAs":["https://doi.org/10.82901/nemar.on003825","https://openneuro.org/datasets/on003825","https://nemar.org/dataexplorer/detail?dataset_id=on003825"],"creator":[{"@type":"Person","name":"Grootswagers, Tijl"},{"@type":"Person","name":"Zhou, Ivy"},{"@type":"Person","name":"Robinson, Amanda"},{"@type":"Person","name":"Hebart, Martin"},{"@type":"Person","name":"Carlson, Thomas"}],"license":"https://creativecommons.org/publicdomain/zero/1.0/"}</script>

*Human electroencephalography recordings from 50 subjects for 22,248 images from 1,854 object concepts*

**Citation:** Grootswagers, Tijl, Zhou, Ivy, Robinson, Amanda, Hebart, Martin, Carlson, Thomas (20). *Human electroencephalography recordings from 50 subjects for 22,248 images from 1,854 object concepts*. [10.82901/nemar.on003825](https://doi.org/10.82901/nemar.on003825)

<p class="eegdash-ed-deck">50-participant EEG dataset — Human electroencephalography recordings from 50 subjects for 22,248 images from 1,854 object concepts.</p><div class="eegdash-ed-byline"><span class="role">Data &amp; curation</span> <strong>Grootswagers, Tijl</strong> · <strong>Zhou, Ivy</strong> · Robinson, Amanda · Hebart, Martin · Carlson, Thomas<br/><span class="role">Year</span> 20 · Distributed via NeMAR<br/><span class="role">Funding</span> ARC DP160101300 (TAC) · ARC DP200101787 (TAC) · + 1 more</div><div class="eegdash-ed-pills"><span class="pill">EEG · 63 (48), 128 (2) ch</span><span class="pill">1000 Hz</span><span class="pill is-info">BIDS 1.0.2</span><span class="pill">Task · rsvp</span></div><div class="eegdash-ed-layers"><div><div class="ly-lbl"><span>Layer 01</span><b>Study</b></div><div class="ly-tit">What was asked</div><div class="ly-dsc">Hypothesis, independent &amp; dependent variables, paradigm, cohort, and the editorial caveats around what the recordings can and cannot answer.</div></div><div><div class="ly-lbl"><span>Layer 02</span><b>Signal · BIDS</b></div><div class="ly-tit">What was recorded</div><div class="ly-dsc">Sidecars, channels &amp; electrodes, coordinate system, event semantics, and quality stats from the NEMAR pipeline when available.</div></div><div><div class="ly-lbl"><span>Layer 03</span><b>Training · ML</b></div><div class="ly-tit">What you can train on</div><div class="ly-dsc">Recommended access modes — MNE Raw, braindecode windows, PyTorch DataLoader — plus the targets the metadata makes addressable.</div></div></div><div class="eegdash-ed-secnum">§ 01<b>Access · Get started</b></div>
...
> project ([https://osf.io/jum2f/](https://osf.io/jum2f/), file `images_THINGS.zip`, ~5 GB,
...
<div class="eegdash-ed-figpair">
  ...
  <p class="trace-viewer-caption">
    ...
    Browse the full set on <a href="https://openneuro.org/datasets/on003825" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=on003825&sub=01&task=rsvp&ext=vhdr&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for on003825 — sub-01 · task-rsvp"
...
The plots below are generated by [NEMAR’s automated EEG pipeline](https://nemar.org/dataexplorer/detail?dataset_id=on003825). The histogram shows pipeline success for data cleaning and ICA decomposition, the percentage of data frames and EEG channels retained after artefact removal, line noise per channel (RMS, dB), and the age/gender distribution of participants.

<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=on003825" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/on003825/code/on003825_histogram.png"
      alt="NEMAR pipeline statistics — ON003825"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/on003825/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — ON003825"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="on003825">
  <div class="ee-bar">
...
| Author (year)  | —                                                                                                                         |
| Canonical      | —                                                                                                                         |
| Importable as  | `ON003825`                                                                                                                |
| Year           | 20                                                                                                                        |
| Authors        | Grootswagers, Tijl, Zhou, Ivy, Robinson, Amanda, Hebart, Martin, Carlson, Thomas                                          |
| License        | CC0                                                                                                                       |
| Citation / DOI | [10.82901/nemar.on003825](https://doi.org/10.82901/nemar.on003825)                                                        |
| Source links   | [OpenNeuro](https://openneuro.org/datasets/on003825) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=on003825) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">ON003825</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
    ...
    <div class="apicard-ids">
      ...
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>ON003825</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — ON003825</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/ON003825.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/EEGDash">Hugging Face org</a></div><div>CC0 · <b><a href="https://doi.org/10.82901/nemar.on003825">10.82901/nemar.on003825</a></b></div></footer>
