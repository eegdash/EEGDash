...
The underlying code is manually maintained and not autogenerated. --><div class="eegdash-ed-issue"><div class="crumb">EEGdash<span class="crumb-sep">›</span>NeMAR<span class="crumb-sep">›</span><b>NM000211</b></div><div>Iss. 211 · 15 subjects · 240 recordings · CC-BY-NC-ND-4.0</div></div><div class="eegdash-ed-kicker">Dataset Brief · RSVP ERP dataset for authentication from Zhang et al 2025</div><aside class="eegdash-ed-rail"><h4>Field card</h4><dl><dt class="hdr">Identity</dt><dd class="hdrpad"></dd><dt>Dataset</dt><dd>NM000211</dd><dt>Version</dt><dd>—</dd><dt>Source</dt><dd>NeMAR</dd><dt>License</dt><dd>CC-BY-NC-ND-4.0</dd><dt>Updated</dt><dd>2026-03-24</dd><dt class="hdr">Signal</dt><dd class="hdrpad"></dd><dt>Subjects</dt><dd>15</dd><dt>Recordings</dt><dd>240</dd><dt>Modality</dt><dd>EEG</dd><dt>Channels</dt><dd>57</dd><dt>Sample rate</dt><dd>1000 Hz</dd><dt>Duration</dt><dd>15.0 h</dd><dt>Size</dt><dd>8.7 GB</dd><dt>Tasks</dt><dd><code>p300</code></dd><dt>Sessions</dt><dd>4 · <code>0</code> … <code>3</code></dd><dt class="hdr">BIDS</dt><dd class="hdrpad"></dd><dt>BIDSVersion</dt><dd>1.9.0</dd><dt>Sidecars</dt><dd>events · events.json · channels · eeg.json</dd><dt>Events ann.</dt><dd>—</dd><dt>Metadata</dt><dd>90% · Complete</dd><dt>Storage</dt><dd><code>s3://nemar/nm000211</code></dd><dt class="hdr">Tags</dt><dd class="hdrpad"></dd><dt>Pathology</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-pathology" data-tag-value="healthy">Healthy</span></dd><dt>Paradigm</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-modality" data-tag-value="visual">Visual</span></dd><dt>Type</dt><dd><span class="tag rail-tag" data-tag-kind="dataset-type" data-tag-value="attention">Attention</span></dd><dt class="hdr">ML &amp; Reach</dt><dd class="hdrpad"></dd><dt>HF mirror</dt><dd><a href="https://huggingface.co/datasets/EEGDash/nm000211">EEGDash/nm000211</a></dd></dl><div class="actions"><a href="https://openneuro.org/datasets/nm000211">OpenNeuro</a><a href="https://huggingface.co/datasets/EEGDash/nm000211">🤗 HF</a><a href="../../_static/dataset_generated/croissant/NM000211.croissant.json" download>Croissant</a></div></aside>

# NM000211: eeg dataset, 15 subjects

<script type="application/ld+json">{"@context":"https://schema.org","@type":"Dataset","name":"RSVP ERP dataset for authentication from Zhang et al 2025","alternateName":"NM000211","description":"RSVP ERP dataset for authentication from Zhang et al 2025. eeg dataset accessible via EEGDash as \`\`NM000211\`\` with standardized BIDS metadata.","url":"https://eegdash.org/api/dataset/eegdash.dataset.NM000211.html","keywords":["eeg","BIDS","neuroscience","EEG","MEG"],"isAccessibleForFree":true,"includedInDataCatalog":{"@type":"DataCatalog","name":"EEG Dash","url":"https://eegdash.org/"},"sameAs":["https://openneuro.org/datasets/nm000211","https://nemar.org/dataexplorer/detail?dataset_id=nm000211","https://nemar.org/dataexplorer/detail/nm000211"],"creator":[{"@type":"Person","name":"Yufeng Zhang"},{"@type":"Person","name":"Hongxin Zhang"},{"@type":"Person","name":"Yixuan Li"},{"@type":"Person","name":"Yijun Wang"},{"@type":"Person","name":"Xiaorong Gao"},{"@type":"Person","name":"Chen Yang"}],"license":"CC-BY-NC-ND-4.0","datePublished":"2025-01-01"}</script>
...
<div class="eegdash-ed-cohort-grid"><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Channel counts</strong>: 57 ch (n=240 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Sampling frequencies</strong>: 1000.0 Hz (n=240 recordings)</p>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Total recording duration</strong>: 15 h 1 min</p>
...
<div class="eegdash-ed-figpair">
  <div class="figpair-meta">
    ...
    <span class="right">57 ch · EEG · 1000 Hz · 15 subjects, 240 recordings</span>
  </div>
  <div class="figpair-grid"><div class="figpair-cell figpair-trace"><details class="trace-viewer">
  <summary>Live trace viewer — <strong>sub-13 · ses-3 · task-p300 · run-2</strong></summary>
  <p class="trace-viewer-caption">
    Showing <strong>one</strong> representative recording out of
    <strong>15 subjects and 240 recordings</strong> in this dataset.
    Browse the full set on <a href="https://openneuro.org/datasets/nm000211" target="_blank" rel="noopener">OpenNeuro</a>;
    drop any other <code>_eeg.{set,edf,bdf,vhdr}</code> file onto the
    viewer (or pass <code>?eeg=&lt;url&gt;</code>) to inspect it.
  </p>
  <iframe
    data-src="https://eegdash.github.io/eegdash-viewer/?dataset=nm000211&sub=13&ses=3&task=p300&run=2&ext=bdf&embed=1"
    loading="lazy"
    width="100%" height="640"
    style="border: 1px solid var(--pst-color-border); border-radius: 8px; max-width: 1200px; display: block; background: transparent;"
    title="Live EEG trace viewer for nm000211 — sub-13 · ses-3 · task-p300 · run-2"
...
<div class="nemar-analysis-section">
  <a href="https://nemar.org/dataexplorer/detail?dataset_id=nm000211" target="_blank" rel="noopener noreferrer">
    <img
      src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/nm000211/code/nm000211_histogram.png"
      alt="NEMAR pipeline statistics — NM000211"
      loading="lazy"
  ...
  <img
    src="https://nemar.org/dataexplorer/download?filepath=/data/nemar/openneuro//processed/event_summaries/nm000211/word_cloud.svg&file_type=svg"
    alt="HED event descriptors word cloud — NM000211"
    loading="lazy"
...
<div class="eegdash-explorer" data-dataset-id="nm000211">
  <div class="ee-bar">
...
| Source links   | [OpenNeuro](https://openneuro.org/datasets/nm000211) | [NeMAR](https://nemar.org/dataexplorer/detail?dataset_id=nm000211) | [Source URL](https://nemar.org/dataexplorer/detail/nm000211) |
...
<div class="eegdash-ed-apicard">
  ...
  <div class="apicard-body">
    <div class="apicard-sig">
      ...
      <div class="sig-line"><span class="ns">eegdash.dataset.</span><b class="cls-name">NM000211</b><span class="paren">(</span><span class="arg">cache_dir</span>, <span class="arg">query</span>=<span class="lit">None</span>, <span class="arg">s3_bucket</span>=<span class="lit">None</span>, <span class="arg">\*\*kwargs</span><span class="paren">)</span></div>
      <div class="sig-base">Bases: <code>EEGDashDataset</code></div>
    </div>
    <div class="apicard-ids">
      <div class="id-row"><span class="k">Author (year)</span><span class="v"><b>Zhang2025_RSVP</b></span></div>
      <div class="id-row"><span class="k">Canonical</span><span class="v">—</span></div>
      <div class="id-row"><span class="k">Importable as</span><span class="v"><code>NM000211</code> · <code>Zhang2025_RSVP</code></span></div>
...
<footer class="eegdash-ed-colophon"><div>EEGdash · <b>The Dataset Brief — NM000211</b></div><div>FAIR exports · <a href="#dataset-information">schema.org/Dataset</a> · <a href="../../_static/dataset_generated/croissant/NM000211.croissant.json" download>Croissant 1.0</a> · <a href="https://huggingface.co/datasets/EEGDash/nm000211">Hugging Face mirror</a></div><div>CC-BY-NC-ND-4.0 · <b><span style="opacity:.6">DOI not on file</span></b></div></footer>
