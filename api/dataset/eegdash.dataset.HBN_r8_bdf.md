...
- Source: OpenNeuro
- OpenNeuro: [hbn_r8_bdf](https://openneuro.org/datasets/hbn_r8_bdf)
- NeMAR: [hbn_r8_bdf](https://nemar.org/dataexplorer/detail?dataset_id=hbn_r8_bdf)
...
Use the `HBN_r8_bdf` class to access this dataset programmatically.
