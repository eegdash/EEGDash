...
# =============================================================================
class TestPaths:
    def test_get_default_cache_dir_env_var(self, tmp_path, monkeypatch):
    ...
    def test_get_default_cache_dir_local_fallback(self, monkeypatch):
    ...
    def test_get_default_cache_dir_mne_fallback(self, tmp_path, monkeypatch):
...
class TestDecorators:
    def test_bivariate_feature_directed(self):
    ...
    def test_feature_predecessor_empty(self):
    ...
    def test_feature_kind_decorator(self):
...
class TestDatasetBase:
    def test_eegdashraw_len_with_sfreq_ntimes(self, tmp_path):
...
# =============================================================================
class TestHBNPreprocessing:
    def test_hbn_preprocessor_no_annotations(self):
        ...
        raw.set_annotations(
            mne.Annotations(onset=[0], duration=[1], description=["other"])
        )
    ...
    def test_hbn_preprocessor_with_valid_annotations(self):
...
# =============================================================================
class TestFeatureBankUtils:
    def test_get_valid_freq_band_assertions(self):
    ...
    def test_slice_freq_band_none_limits(self):
    ...
    def test_reduce_freq_bands(self):
...
# =============================================================================
class TestEEGDashInit:
    def test_lazy_import_eegdash(self):
    ...
    def test_lazy_import_datasets(self):
...
class TestDatasetRegistry:
    def test_register_with_api_failure_csv_fallback(self, tmp_path):
    ...
    def test_register_empty_dataset_id_skip(self, tmp_path):
    ...
    def test_register_add_to_all(self, tmp_path):
...
class TestDownloader:
    def test_download_file_remote_size_none(self, tmp_path):
    ...
    def test_download_file_incomplete(self, tmp_path):
    ...
    def test_remote_size_returns_none_on_exception(self):
    ...
    def test_remote_size_invalid_size_type(self):
...
class TestSchemas:
    ...
    def test_validate_record_missing_storage(self):
    ...
    def test_sanitize_run_for_mne(self):
...
class TestSpectralFeatures:
    ...
    def test_spectral_bands_power(self):
...
# =============================================================================
class TestLocalBIDS:
    def test_normalize_modalities_none(self):
    ...
    def test_normalize_modalities_list(self):
    ...
    def test_normalize_modalities_string(self):
    ...
    def test_discover_local_bids_records_invalid_extension(self, tmp_path):
...
# =============================================================================
class TestCSPFeatures:
    def test_csp_full_workflow(self):
    ...
    def test_csp_strict_criterion_error(self):
...
class TestSignalFeatures:
    def test_signal_hilbert_preprocessor(self):
    ...
    def test_signal_zero_crossings(self):
    ...
    def test_signal_hjorth_features(self):
...
class TestBIDSMetadata:
    def test_merge_query_with_empty_kwargs(self):
    ...
    def test_participants_row_for_subject_no_file(self, tmp_path):
    ...
    def test_participants_row_for_subject_empty_df(self, tmp_path):
        """Test when participants.tsv is empty."""
        from eegdash import bids_metadata
    ...
    def test_merge_participants_fields(self):
        """Test merge_participants_fields (lines 342, etc)."""
        from eegdash import bids_metadata

        description = {"existing": "value"}
        participants_row = {"age": "25", "sex": "F", "participant_id": "sub-01"}

        result = bids_metadata.merge_participants_fields(
    ...
    def test_attach_participants_extras_to_raw(self):
        """Test attach_participants_extras (lines 387, 392, 395)."""
        from eegdash import bids_metadata

        mock_raw = MagicMock()
        mock_raw.info = {}

        extras = {"age": "30", "handedness": "right"}
        bids_metadata.attach_participants_extras(mock_raw, {}, extras)

        assert mock_raw.info["subject_info"]["participants_extras"]["age"] == "30"

    def test_attach_participants_extras_empty(self):
        """Test attach_participants_extras with empty extras (line 409)."""
        from eegdash import bids_metadata
        ...
        # Empty extras should do nothing
        bids_metadata.attach_participants_extras(mock_raw, description, {})
        # Should not have modified anything
        assert "subject_info" not in mock_raw.info

    def test_attach_participants_extras_with_series(self):
        """Test attach_participants_extras with pandas Series description (lines 409-414)."""
        from eegdash import bids_metadata
        ...
        bids_metadata.attach_participants_extras(mock_raw, description, extras)

        # Check that the raw info was updated
        assert (
            mock_raw.info["subject_info"]["participants_extras"]["new_field"]
            == "new_value"
        )
    ...
    def test_normalize_key(self):
        ...
        assert bids_metadata.normalize_key("Participant ID") == "participant_id"
        assert bids_metadata.normalize_key("AGE") == "age"
        assert bids_metadata.normalize_key("hand-edness") == "hand_edness"
