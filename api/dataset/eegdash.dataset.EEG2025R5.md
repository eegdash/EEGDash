...
Modality: eeg Subjects: 330 Recordings: 3326 License: CC-BY-SA 4.0 Source: nemar
...
- Source: nemar
- OpenNeuro: [eeg2025r5](https://openneuro.org/datasets/eeg2025r5)
- NeMAR: [eeg2025r5](https://nemar.org/dataexplorer/detail?dataset_id=eeg2025r5)
...
<div class="eegdash-stats-section" style="margin-bottom:1rem;">
  <p><strong>Age distribution</strong> (n=330, range 5–20 yr)</p>
  <div class="eeg-chart-row" style="display:flex; align-items:flex-end; gap:2px; height:60px;">
    <div style="width:28px; height:100%; background:#4472c4; flex-shrink:0;" title="5-9: 168"></div><div style="width:28px; height:71%; background:#4472c4; flex-shrink:0;" title="10-14: 120"></div><div style="width:28px; height:23%; background:#4472c4; flex-shrink:0;" title="15-19: 39"></div><div style="width:28px; height:1%; background:#4472c4; flex-shrink:0;" title="20-24: 3"></div>
  </div>
  ...
  <div style="display:flex; height:22px; width:100%; max-width:400px; border-radius:4px; overflow:hidden;">
    <div style="width:33.0%; background:#e07ab5; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Female: 109">109</div><div style="width:67.0%; background:#4472c4; display:inline-flex; align-items:center; justify-content:center; color:#fff; font-size:11px; min-width:2px;" title="Male: 221">221</div>
  </div>
  <div style="font-size:11px;margin-top:4px;"><span style="display:inline-block;width:12px;height:12px;background:#e07ab5;border-radius:2px;margin-right:4px;"></span>Female&nbsp;&nbsp;<span style="display:inline-block;width:12px;height:12px;background:#4472c4;border-radius:2px;margin-right:4px;"></span>Male&nbsp;&nbsp;<strong>Total: 330</strong></div>
</div><div class="eegdash-stats-section" style="margin-bottom:1rem;">
...
Use the `EEG2025R5` class to access this dataset programmatically.
